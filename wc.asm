...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 68 05 00 00       	call   5a4 <open>
  ...
  59:	e8 2e 05 00 00       	call   58c <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 f9 04 00 00       	call   564 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  6e:	68 1b 0a 00 00       	push   $0xa1b
  73:	6a 01                	push   $0x1
  75:	e8 56 06 00 00       	call   6d0 <printf>
      exit();
  7a:	e8 e5 04 00 00       	call   564 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  81:	68 42 0a 00 00       	push   $0xa42
  86:	6a 00                	push   $0x0
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 d2 04 00 00       	call   564 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  c8:	68 40 0e 00 00       	push   $0xe40
  cd:	ff 75 08             	push   0x8(%ebp)
  d0:	e8 a7 04 00 00       	call   57c <read>
  ...
  f4:	74 42                	je     138 <wc+0x98>
      if(buf[i] == '\n')
  f6:	0f be 87 40 0e 00 00 	movsbl 0xe40(%edi),%eax
        l++;
 ...
 14e:	53                   	push   %ebx
 14f:	68 0e 0a 00 00       	push   $0xa0e
 154:	6a 01                	push   $0x1
 156:	e8 75 05 00 00       	call   6d0 <printf>
}
 ...
 166:	50                   	push   %eax
 167:	50                   	push   %eax
 168:	68 fe 09 00 00       	push   $0x9fe
 16d:	6a 01                	push   $0x1
 16f:	e8 5c 05 00 00       	call   6d0 <printf>
    exit();
 174:	e8 eb 03 00 00       	call   564 <exit>
 ...
 62c:	89 d1                	mov    %edx,%ecx
{
 ...
 659:	0f b6 92 a4 0a 00 00 	movzbl 0xaa4(%edx),%edx
 ...
 6d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 749:	ff 24 85 4c 0a 00 00 	jmp    *0xa4c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 857:	90                   	nop
          s = "(null)";
 858:	ba 43 0a 00 00       	mov    $0xa43,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 871:	a1 40 10 00 00       	mov    0x1040,%eax
{
 ...
 8b1:	5b                   	pop    %ebx
  freep = p;
 8b2:	89 15 40 10 00 00    	mov    %edx,0x1040
}
 8b8:	5e                   	pop    %esi
 8b9:	5f                   	pop    %edi
 8ba:	5d                   	pop    %ebp
 ...
 8e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8ec:	89 15 40 10 00 00    	mov    %edx,0x1040
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 909:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 90c:	8b 3d 40 10 00 00    	mov    0x1040,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 94f:	73 4f                	jae    9a0 <malloc+0xa0>
    ...
    if(p == freep)
 951:	8b 3d 40 10 00 00    	mov    0x1040,%edi
 ...
 97a:	e8 f1 fe ff ff       	call   870 <free>
  return freep;
 97f:	8b 15 40 10 00 00    	mov    0x1040,%edx
 ...
 9ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9af:	89 15 40 10 00 00    	mov    %edx,0x1040
}
 ...
 9bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 9c0:	c7 05 40 10 00 00 44 	movl   $0x1044,0x1040
 9c7:	10 00 00 
    base.s.size = 0;
 9ca:	bf 44 10 00 00       	mov    $0x1044,%edi
    base.s.ptr = freep = prevp = &base;
 9cf:	c7 05 44 10 00 00 44 	movl   $0x1044,0x1044
 9d6:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 9db:	c7 05 48 10 00 00 00 	movl   $0x0,0x1048
 9e2:	00 00 00 
    if(p->s.size >= nunits){
