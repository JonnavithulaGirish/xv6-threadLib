...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 1a 05 00 00       	call   556 <open>
  ...
  59:	e8 e0 04 00 00       	call   53e <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 ab 04 00 00       	call   516 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  6e:	68 cb 09 00 00       	push   $0x9cb
  73:	6a 01                	push   $0x1
  75:	e8 06 06 00 00       	call   680 <printf>
      exit();
  7a:	e8 97 04 00 00       	call   516 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 84 04 00 00       	call   516 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 59 04 00 00       	call   52e <read>
 ...
 154:	6a 01                	push   $0x1
 156:	e8 25 05 00 00       	call   680 <printf>
}
 ...
 16d:	6a 01                	push   $0x1
 16f:	e8 0c 05 00 00       	call   680 <printf>
    exit();
 174:	e8 9d 03 00 00       	call   516 <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 71 02 00 00       	call   52e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 34 02 00 00       	call   556 <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 37 02 00 00       	call   56e <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 fd 01 00 00       	call   53e <close>
  return r;
...
void lock_acquire(lock_t *lock){
 ...
 3eb:	75 f3                	jne    3e0 <thread_create+0x10>
    __sync_synchronize();
 3ed:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	void *stack= malloc(PGSIZE*2);
 3f2:	83 ec 0c             	sub    $0xc,%esp
 3f5:	68 00 20 00 00       	push   $0x2000
 3fa:	e8 b1 04 00 00       	call   8b0 <malloc>
}

void lock_release(lock_t *lock){
   __sync_synchronize();
 3ff:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 404:	c7 05 e4 0f 00 00 00 	movl   $0x0,0xfe4
 40b:	00 00 00 
	if((uint)stack % PGSIZE)
 40e:	89 c2                	mov    %eax,%edx
 410:	83 c4 10             	add    $0x10,%esp
 413:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 419:	74 07                	je     422 <thread_create+0x52>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
 41b:	29 d0                	sub    %edx,%eax
 41d:	05 00 10 00 00       	add    $0x1000,%eax
	int result = clone(start_routine,arg1, arg2 ,stack);
 422:	50                   	push   %eax
 423:	ff 75 10             	push   0x10(%ebp)
 426:	ff 75 0c             	push   0xc(%ebp)
 429:	ff 75 08             	push   0x8(%ebp)
 42c:	e8 85 01 00 00       	call   5b6 <clone>
}
 431:	c9                   	leave  
 432:	c3                   	ret    
...
int thread_join(){
 ...
 44a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int result= join(&stack);
 451:	50                   	push   %eax
 452:	e8 67 01 00 00       	call   5be <join>
    while(xchg(&(lock->mutex), 1) != 0);
 ...
 46a:	f0 87 05 e0 0f 00 00 	lock xchg %eax,0xfe0
 471:	85 c0                	test   %eax,%eax
 473:	75 f3                	jne    468 <thread_join+0x28>
    __sync_synchronize();
 475:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	free(stack);
 47a:	83 ec 0c             	sub    $0xc,%esp
 47d:	ff 75 f4             	push   -0xc(%ebp)
 480:	e8 9b 03 00 00       	call   820 <free>
   __sync_synchronize();
 485:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 48a:	c7 05 e0 0f 00 00 00 	movl   $0x0,0xfe0
 491:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 4a0:	c7 05 e4 0f 00 00 00 	movl   $0x0,0xfe4
 4a7:	00 00 00 
 4aa:	c7 05 e0 0f 00 00 00 	movl   $0x0,0xfe0
 4b1:	00 00 00 
}
 4b4:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 4d7:	75 f7                	jne    4d0 <lock_acquire+0x10>
    __sync_synchronize();
 4d9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
 4de:	5d                   	pop    %ebp
 4df:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 4e3:	8b 45 08             	mov    0x8(%ebp),%eax
   __sync_synchronize();
 4e6:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 4eb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 4f1:	5d                   	pop    %ebp
 4f2:	c3                   	ret    
 ...
 5dc:	89 d1                	mov    %edx,%ecx
{
 ...
 609:	0f b6 92 40 0a 00 00 	movzbl 0xa40(%edx),%edx
 ...
 689:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6f9:	ff 24 85 e8 09 00 00 	jmp    *0x9e8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 807:	90                   	nop
          s = "(null)";
 808:	ba df 09 00 00       	mov    $0x9df,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 821:	a1 e8 0f 00 00       	mov    0xfe8,%eax
{
 ...
 861:	5b                   	pop    %ebx
  freep = p;
 862:	89 15 e8 0f 00 00    	mov    %edx,0xfe8
}
 868:	5e                   	pop    %esi
 869:	5f                   	pop    %edi
 86a:	5d                   	pop    %ebp
 ...
 899:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 89c:	89 15 e8 0f 00 00    	mov    %edx,0xfe8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8bc:	8b 3d e8 0f 00 00    	mov    0xfe8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8ff:	73 4f                	jae    950 <malloc+0xa0>
    ...
    if(p == freep)
 901:	8b 3d e8 0f 00 00    	mov    0xfe8,%edi
 ...
 92a:	e8 f1 fe ff ff       	call   820 <free>
  return freep;
 92f:	8b 15 e8 0f 00 00    	mov    0xfe8,%edx
 ...
 95c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 95f:	89 15 e8 0f 00 00    	mov    %edx,0xfe8
}
 ...
 96f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 970:	c7 05 e8 0f 00 00 ec 	movl   $0xfec,0xfe8
 977:	0f 00 00 
    base.s.size = 0;
 97a:	bf ec 0f 00 00       	mov    $0xfec,%edi
    base.s.ptr = freep = prevp = &base;
 97f:	c7 05 ec 0f 00 00 ec 	movl   $0xfec,0xfec
 986:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 989:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 98b:	c7 05 f0 0f 00 00 00 	movl   $0x0,0xff0
 992:	00 00 00 
    if(p->s.size >= nunits){
