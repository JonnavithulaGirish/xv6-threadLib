...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  13:	e8 3c 05 00 00       	call   554 <getpid>
  ...
  4d:	e8 22 05 00 00       	call   574 <clone>
  ...
  8f:	5b                   	pop    %ebx
  90:	ff 35 e8 0d 00 00    	push   0xde8
  96:	e8 69 04 00 00       	call   504 <kill>
  9b:	e8 34 04 00 00       	call   4d4 <exit>

   stack = sbrk(0);
  a0:	83 ec 0c             	sub    $0xc,%esp
  a3:	6a 00                	push   $0x0
  a5:	e8 b2 04 00 00       	call   55c <sbrk>
 ...
 188:	e8 e7 03 00 00       	call   574 <clone>
 ...
 1ad:	e8 2e 06 00 00       	call   7e0 <free>
   exit();
 1b2:	e8 1d 03 00 00       	call   4d4 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1c3:	83 ec 08             	sub    $0x8,%esp
   exit();
 1c6:	e8 09 03 00 00       	call   4d4 <exit>
 ...
 2f9:	31 db                	xor    %ebx,%ebx
{
 ...
 305:	57                   	push   %edi
 306:	6a 00                	push   $0x0
 308:	e8 df 01 00 00       	call   4ec <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 36d:	e8 a2 01 00 00       	call   514 <open>
  if(fd < 0)
 ...
 381:	50                   	push   %eax
 382:	e8 a5 01 00 00       	call   52c <fstat>
  close(fd);
 387:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 38a:	89 c6                	mov    %eax,%esi
  close(fd);
 38c:	e8 6b 01 00 00       	call   4fc <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 43a:	e8 35 01 00 00       	call   574 <clone>
}
 43f:	c9                   	leave  
 440:	c3                   	ret    
...
int thread_join(){
 ...
 467:	7e 0d                	jle    476 <thread_join+0x26>
 469:	8b 7d f4             	mov    -0xc(%ebp),%edi
 46c:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
free(void *ap)
{
 ...
 7e1:	a1 ec 0d 00 00       	mov    0xdec,%eax
{
 ...
 821:	5b                   	pop    %ebx
  freep = p;
 822:	89 15 ec 0d 00 00    	mov    %edx,0xdec
}
 828:	5e                   	pop    %esi
 829:	5f                   	pop    %edi
 82a:	5d                   	pop    %ebp
 ...
 859:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 85c:	89 15 ec 0d 00 00    	mov    %edx,0xdec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 879:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 87c:	8b 3d ec 0d 00 00    	mov    0xdec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8bf:	73 4f                	jae    910 <malloc+0xa0>
    ...
    if(p == freep)
 8c1:	8b 3d ec 0d 00 00    	mov    0xdec,%edi
 ...
 8ea:	e8 f1 fe ff ff       	call   7e0 <free>
  return freep;
 8ef:	8b 15 ec 0d 00 00    	mov    0xdec,%edx
 ...
 91c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 91f:	89 15 ec 0d 00 00    	mov    %edx,0xdec
}
 ...
 92f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 930:	c7 05 ec 0d 00 00 f0 	movl   $0xdf0,0xdec
 937:	0d 00 00 
    base.s.size = 0;
 93a:	bf f0 0d 00 00       	mov    $0xdf0,%edi
    base.s.ptr = freep = prevp = &base;
 93f:	c7 05 f0 0d 00 00 f0 	movl   $0xdf0,0xdf0
 946:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 949:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 94b:	c7 05 f4 0d 00 00 00 	movl   $0x0,0xdf4
 952:	00 00 00 
    if(p->s.size >= nunits){
