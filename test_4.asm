...
main(int argc, char *argv[])
{
  ...
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 8c 0e 00 00       	mov    %eax,0xe8c
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  4d:	e8 b4 05 00 00       	call   606 <clone>
  52:	83 c4 10             	add    $0x10,%esp
  55:	83 f8 ff             	cmp    $0xffffffff,%eax
  58:	74 46                	je     a0 <main+0xa0>
  5a:	6a 21                	push   $0x21
  5c:	68 f8 09 00 00       	push   $0x9f8
  61:	68 01 0a 00 00       	push   $0xa01
  66:	6a 01                	push   $0x1
  68:	e8 63 06 00 00       	call   6d0 <printf>
  6d:	83 c4 0c             	add    $0xc,%esp
  70:	68 5c 0a 00 00       	push   $0xa5c
  75:	68 13 0a 00 00       	push   $0xa13
  7a:	6a 01                	push   $0x1
  7c:	e8 4f 06 00 00       	call   6d0 <printf>
  81:	5a                   	pop    %edx
  82:	59                   	pop    %ecx
  83:	68 27 0a 00 00       	push   $0xa27
  88:	6a 01                	push   $0x1
  8a:	e8 41 06 00 00       	call   6d0 <printf>
  8f:	5b                   	pop    %ebx
  90:	ff 35 8c 0e 00 00    	push   0xe8c
  96:	e8 fb 04 00 00       	call   596 <kill>
  9b:	e8 c6 04 00 00       	call   566 <exit>

   stack = sbrk(0);
  a0:	83 ec 0c             	sub    $0xc,%esp
  a3:	6a 00                	push   $0x0
  a5:	e8 44 05 00 00       	call   5ee <sbrk>
 ...
 188:	e8 79 04 00 00       	call   606 <clone>
 ...
 19c:	50                   	push   %eax
 19d:	50                   	push   %eax
 19e:	68 4e 0a 00 00       	push   $0xa4e
 1a3:	6a 01                	push   $0x1
 1a5:	e8 26 05 00 00       	call   6d0 <printf>
   free(p);
 1aa:	89 1c 24             	mov    %ebx,(%esp)
 1ad:	e8 be 06 00 00       	call   870 <free>
   exit();
 1b2:	e8 af 03 00 00       	call   566 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1c3:	83 ec 08             	sub    $0x8,%esp
   exit();
 1c6:	e8 9b 03 00 00       	call   566 <exit>
 ...
 2f9:	31 db                	xor    %ebx,%ebx
{
 ...
 305:	57                   	push   %edi
 306:	6a 00                	push   $0x0
 308:	e8 71 02 00 00       	call   57e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 36d:	e8 34 02 00 00       	call   5a6 <open>
  if(fd < 0)
 ...
 381:	50                   	push   %eax
 382:	e8 37 02 00 00       	call   5be <fstat>
  close(fd);
 387:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 38a:	89 c6                	mov    %eax,%esi
  close(fd);
 38c:	e8 fd 01 00 00       	call   58e <close>
  return r;
...
xchg(volatile uint *addr, uint newval)
{
 ...
 432:	f0 87 05 94 0e 00 00 	lock xchg %eax,0xe94
  lock_init(&lk_join);
}
...
void lock_acquire(lock_t *lock){
 ...
 43b:	75 f3                	jne    430 <thread_create+0x10>
    __sync_synchronize();
 43d:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	void *stack= malloc(PGSIZE*2);
 442:	83 ec 0c             	sub    $0xc,%esp
 445:	68 00 20 00 00       	push   $0x2000
 44a:	e8 b1 04 00 00       	call   900 <malloc>
}

void lock_release(lock_t *lock){
   __sync_synchronize();
 44f:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 454:	c7 05 94 0e 00 00 00 	movl   $0x0,0xe94
 45b:	00 00 00 
	if((uint)stack % PGSIZE)
 45e:	89 c2                	mov    %eax,%edx
 460:	83 c4 10             	add    $0x10,%esp
 463:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 469:	74 07                	je     472 <thread_create+0x52>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
 46b:	29 d0                	sub    %edx,%eax
 46d:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 47c:	e8 85 01 00 00       	call   606 <clone>
}
 481:	c9                   	leave  
 482:	c3                   	ret    
...
int thread_join(){
 ...
 49a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int result= join(&stack);
 4a1:	50                   	push   %eax
 4a2:	e8 67 01 00 00       	call   60e <join>
    while(xchg(&(lock->mutex), 1) != 0);
 ...
 4ba:	f0 87 05 90 0e 00 00 	lock xchg %eax,0xe90
 4c1:	85 c0                	test   %eax,%eax
 4c3:	75 f3                	jne    4b8 <thread_join+0x28>
    __sync_synchronize();
 4c5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	free(stack);
 4ca:	83 ec 0c             	sub    $0xc,%esp
 4cd:	ff 75 f4             	push   -0xc(%ebp)
 4d0:	e8 9b 03 00 00       	call   870 <free>
   __sync_synchronize();
 4d5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 4da:	c7 05 90 0e 00 00 00 	movl   $0x0,0xe90
 4e1:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 4f0:	c7 05 94 0e 00 00 00 	movl   $0x0,0xe94
 4f7:	00 00 00 
 4fa:	c7 05 90 0e 00 00 00 	movl   $0x0,0xe90
 501:	00 00 00 
}
 504:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 527:	75 f7                	jne    520 <lock_acquire+0x10>
    __sync_synchronize();
 529:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
 52e:	5d                   	pop    %ebp
 52f:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 533:	8b 45 08             	mov    0x8(%ebp),%eax
   __sync_synchronize();
 536:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 53b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 541:	5d                   	pop    %ebp
 542:	c3                   	ret    
 ...
 6d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 857:	90                   	nop
          s = "(null)";
 858:	ba a8 0a 00 00       	mov    $0xaa8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 871:	a1 98 0e 00 00       	mov    0xe98,%eax
{
 ...
 8b1:	5b                   	pop    %ebx
  freep = p;
 8b2:	89 15 98 0e 00 00    	mov    %edx,0xe98
}
 8b8:	5e                   	pop    %esi
 8b9:	5f                   	pop    %edi
 8ba:	5d                   	pop    %ebp
 ...
 8e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8ec:	89 15 98 0e 00 00    	mov    %edx,0xe98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 909:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 90c:	8b 3d 98 0e 00 00    	mov    0xe98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 94f:	73 4f                	jae    9a0 <malloc+0xa0>
    ...
    if(p == freep)
 951:	8b 3d 98 0e 00 00    	mov    0xe98,%edi
 ...
 97a:	e8 f1 fe ff ff       	call   870 <free>
  return freep;
 97f:	8b 15 98 0e 00 00    	mov    0xe98,%edx
 ...
 9ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9af:	89 15 98 0e 00 00    	mov    %edx,0xe98
}
 ...
 9bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 9c0:	c7 05 98 0e 00 00 9c 	movl   $0xe9c,0xe98
 9c7:	0e 00 00 
    base.s.size = 0;
 9ca:	bf 9c 0e 00 00       	mov    $0xe9c,%edi
    base.s.ptr = freep = prevp = &base;
 9cf:	c7 05 9c 0e 00 00 9c 	movl   $0xe9c,0xe9c
 9d6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 9db:	c7 05 a0 0e 00 00 00 	movl   $0x0,0xea0
 9e2:	00 00 00 
    if(p->s.size >= nunits){
