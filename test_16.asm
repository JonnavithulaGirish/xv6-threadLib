...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 2d 06 00 00       	call   644 <getpid>
  ...
  1a:	c7 45 f0 23 00 00 00 	movl   $0x23,-0x10(%ebp)
   ppid = getpid();
  21:	a3 10 0f 00 00       	mov    %eax,0xf10
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 3);
  51:	83 3d 0c 0f 00 00 03 	cmpl   $0x3,0xf0c
  ...
  b0:	5b                   	pop    %ebx
  b1:	ff 35 10 0f 00 00    	push   0xf10
  b7:	e8 38 05 00 00       	call   5f4 <kill>
  bc:	e8 03 05 00 00       	call   5c4 <exit>
   assert(thread_pid > 0);
  c1:	6a 20                	push   $0x20
  ...
  e7:	e8 44 06 00 00       	call   730 <printf>
   exit();
  ec:	e8 d3 04 00 00       	call   5c4 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
void nested_worker(void *arg1, void *arg2){
 ...
 116:	75 2a                	jne    142 <nested_worker+0x42>
   assert(global == 2);
 118:	83 3d 0c 0f 00 00 02 	cmpl   $0x2,0xf0c
 ...
 177:	59                   	pop    %ecx
 178:	ff 35 10 0f 00 00    	push   0xf10
 17e:	e8 71 04 00 00       	call   5f4 <kill>
 183:	e8 3c 04 00 00       	call   5c4 <exit>
   assert(arg1_int == 35);
 188:	6a 2e                	push   $0x2e
 ...
 1a3:	eb b8                	jmp    15d <nested_worker+0x5d>
   global++;
 1a5:	c7 05 0c 0f 00 00 03 	movl   $0x3,0xf0c
 1ac:	00 00 00 
   exit();
 1af:	e8 10 04 00 00       	call   5c4 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1df:	75 2a                	jne    20b <worker+0x4b>
   assert(global == 1);
 1e1:	83 3d 0c 0f 00 00 01 	cmpl   $0x1,0xf0c
 ...
 240:	5b                   	pop    %ebx
 241:	ff 35 10 0f 00 00    	push   0xf10
 247:	e8 a8 03 00 00       	call   5f4 <kill>
 24c:	e8 73 03 00 00       	call   5c4 <exit>
   assert(arg1_int == 35);
 251:	6a 39                	push   $0x39
 ...
 277:	68 00 01 00 00       	push   $0x100
   global++;
 27c:	c7 05 0c 0f 00 00 02 	movl   $0x2,0xf0c
 283:	00 00 00 
   int nested_thread_pid = thread_create(nested_worker, &arg1_int, &arg2_int);
 ...
 2b4:	e9 6d ff ff ff       	jmp    226 <worker+0x66>
   exit();
 2b9:	e8 06 03 00 00       	call   5c4 <exit>
 ...
 3e9:	31 db                	xor    %ebx,%ebx
{
 ...
 3f5:	57                   	push   %edi
 3f6:	6a 00                	push   $0x0
 3f8:	e8 df 01 00 00       	call   5dc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 45d:	e8 a2 01 00 00       	call   604 <open>
  if(fd < 0)
 ...
 471:	50                   	push   %eax
 472:	e8 a5 01 00 00       	call   61c <fstat>
  close(fd);
 477:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 47a:	89 c6                	mov    %eax,%esi
  close(fd);
 47c:	e8 6b 01 00 00       	call   5ec <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 52a:	e8 35 01 00 00       	call   664 <clone>
}
 52f:	c9                   	leave  
 530:	c3                   	ret    
...
int thread_join(){
 547:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 54a:	50                   	push   %eax
 54b:	e8 1c 01 00 00       	call   66c <join>
  if(pid >0 ){
 ...
 557:	7e 0d                	jle    566 <thread_join+0x26>
 559:	8b 7d f4             	mov    -0xc(%ebp),%edi
 55c:	b9 00 10 00 00       	mov    $0x1000,%ecx
 561:	31 c0                	xor    %eax,%eax
 563:	fc                   	cld    
 564:	f3 aa                	rep stos %al,%es:(%edi)
    memset(stack,0,PGSIZE);
  }
  return pid;
}
 566:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
void lock_release(lock_t *lock){
 ...
 5b6:	83 40 04 01          	addl   $0x1,0x4(%eax)
 5ba:	5d                   	pop    %ebp
 5bb:	c3                   	ret    
 ...
 68c:	89 d1                	mov    %edx,%ecx
{
 ...
 6fe:	56                   	push   %esi
 6ff:	57                   	push   %edi
 700:	e8 df fe ff ff       	call   5e4 <write>
  while(--i >= 0)
 ...
 739:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 775:	57                   	push   %edi
 776:	56                   	push   %esi
 777:	e8 68 fe ff ff       	call   5e4 <write>
 ...
 7ce:	e8 11 fe ff ff       	call   5e4 <write>
        putc(fd, c);
 ...
 7df:	57                   	push   %edi
 7e0:	56                   	push   %esi
 7e1:	e8 fe fd ff ff       	call   5e4 <write>
        putc(fd, c);
 ...
 84b:	57                   	push   %edi
 84c:	56                   	push   %esi
 84d:	e8 92 fd ff ff       	call   5e4 <write>
        while(*s != 0){
 ...
 88c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 88f:	e8 50 fd ff ff       	call   5e4 <write>
        ap++;
...
free(void *ap)
{
 ...
 8d1:	a1 14 0f 00 00       	mov    0xf14,%eax
{
 ...
 911:	5b                   	pop    %ebx
  freep = p;
 912:	89 15 14 0f 00 00    	mov    %edx,0xf14
}
 918:	5e                   	pop    %esi
 919:	5f                   	pop    %edi
 91a:	5d                   	pop    %ebp
 ...
 949:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 94c:	89 15 14 0f 00 00    	mov    %edx,0xf14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 96c:	8b 3d 14 0f 00 00    	mov    0xf14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9af:	73 4f                	jae    a00 <malloc+0xa0>
    ...
    if(p == freep)
 9b1:	8b 3d 14 0f 00 00    	mov    0xf14,%edi
 ...
 9c3:	e8 84 fc ff ff       	call   64c <sbrk>
  if(p == (char*)-1)
 ...
 9da:	e8 f1 fe ff ff       	call   8d0 <free>
  return freep;
 9df:	8b 15 14 0f 00 00    	mov    0xf14,%edx
 ...
 a0c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a0f:	89 15 14 0f 00 00    	mov    %edx,0xf14
}
 ...
 a1f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a20:	c7 05 14 0f 00 00 18 	movl   $0xf18,0xf14
 a27:	0f 00 00 
    base.s.size = 0;
 a2a:	bf 18 0f 00 00       	mov    $0xf18,%edi
    base.s.ptr = freep = prevp = &base;
 a2f:	c7 05 18 0f 00 00 18 	movl   $0xf18,0xf18
 a36:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a39:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a3b:	c7 05 1c 0f 00 00 00 	movl   $0x0,0xf1c
 a42:	00 00 00 
    if(p->s.size >= nunits){
