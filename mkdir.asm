...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 92 04 00 00       	call   4cc <mkdir>
  ...
  exit();
  4b:	e8 14 04 00 00       	call   464 <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  53:	68 0f 09 00 00       	push   $0x90f
  58:	6a 02                	push   $0x2
  ...
  6b:	6a 02                	push   $0x2
  6d:	e8 5e 05 00 00       	call   5d0 <printf>
    exit();
  72:	e8 ed 03 00 00       	call   464 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 bf 02 00 00       	call   47c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 82 02 00 00       	call   4a4 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 85 02 00 00       	call   4bc <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 4b 02 00 00       	call   48c <close>
  return r;
...
void lock_init(lock_t *lock) {
  lock->ticket = 0;
 2dc:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  lock->turn = 0;
 2e3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 2ea:	f0 0f c1 45 f0       	lock xadd %eax,-0x10(%ebp)
}
...
void lock_acquire(lock_t *lock){
 ...
 2f2:	39 c2                	cmp    %eax,%edx
 2f4:	74 24                	je     31a <thread_create+0x4a>
 ...
 303:	52                   	push   %edx
 304:	68 2b 09 00 00       	push   $0x92b
 309:	6a 01                	push   $0x1
 30b:	e8 c0 02 00 00       	call   5d0 <printf>
  while(lock->turn != myturn){
 310:	8b 55 f4             	mov    -0xc(%ebp),%edx
 313:	83 c4 10             	add    $0x10,%esp
 316:	39 d3                	cmp    %edx,%ebx
 318:	75 e6                	jne    300 <thread_create+0x30>
	void *stack= malloc(PGSIZE*2);
 31a:	83 ec 0c             	sub    $0xc,%esp
 31d:	68 00 20 00 00       	push   $0x2000
 322:	e8 d9 04 00 00       	call   800 <malloc>
  }
}
...
void lock_release(lock_t *lock){
 ...
 330:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 336:	74 07                	je     33f <thread_create+0x6f>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
 338:	29 d0                	sub    %edx,%eax
 33a:	05 00 10 00 00       	add    $0x1000,%eax
	int result = clone(start_routine,arg1, arg2 ,stack);
 33f:	50                   	push   %eax
 340:	ff 75 10             	push   0x10(%ebp)
 343:	ff 75 0c             	push   0xc(%ebp)
 346:	ff 75 08             	push   0x8(%ebp)
 349:	e8 b6 01 00 00       	call   504 <clone>
}
...
int thread_join(){
 ...
 368:	6a 04                	push   $0x4
 36a:	e8 91 04 00 00       	call   800 <malloc>
 36f:	89 45 ec             	mov    %eax,-0x14(%ebp)
	int result= join(&stack);
 372:	8d 45 ec             	lea    -0x14(%ebp),%eax
 375:	89 04 24             	mov    %eax,(%esp)
 378:	e8 8f 01 00 00       	call   50c <join>
  lock->ticket = 0;
 ...
 392:	f0 0f c1 45 f0       	lock xadd %eax,-0x10(%ebp)
  while(lock->turn != myturn){
 397:	8b 55 f4             	mov    -0xc(%ebp),%edx
 39a:	83 c4 10             	add    $0x10,%esp
 39d:	39 c2                	cmp    %eax,%edx
 39f:	74 21                	je     3c2 <thread_join+0x62>
 ...
 3ab:	52                   	push   %edx
 3ac:	68 2b 09 00 00       	push   $0x92b
 3b1:	6a 01                	push   $0x1
 3b3:	e8 18 02 00 00       	call   5d0 <printf>
  while(lock->turn != myturn){
 3b8:	8b 55 f4             	mov    -0xc(%ebp),%edx
 3bb:	83 c4 10             	add    $0x10,%esp
 3be:	39 d3                	cmp    %edx,%ebx
 3c0:	75 e6                	jne    3a8 <thread_join+0x48>
	free(stack);
 3c2:	83 ec 0c             	sub    $0xc,%esp
 3c5:	ff 75 ec             	push   -0x14(%ebp)
 3c8:	e8 a3 03 00 00       	call   770 <free>
}
...
void lock_init(lock_t *lock) {
 ...
 3e6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
 3ec:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
 3f3:	5d                   	pop    %ebp
 3f4:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 40c:	53                   	push   %ebx
 40d:	f0 0f c1 06          	lock xadd %eax,(%esi)
  while(lock->turn != myturn){
 411:	8b 56 04             	mov    0x4(%esi),%edx
 414:	39 d0                	cmp    %edx,%eax
 416:	74 22                	je     43a <lock_acquire+0x3a>
 418:	89 c3                	mov    %eax,%ebx
 41a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    printf(1,"ulib lock value %d\n",lock->turn);
 420:	83 ec 04             	sub    $0x4,%esp
 423:	52                   	push   %edx
 424:	68 2b 09 00 00       	push   $0x92b
 429:	6a 01                	push   $0x1
 42b:	e8 a0 01 00 00       	call   5d0 <printf>
  while(lock->turn != myturn){
 430:	8b 56 04             	mov    0x4(%esi),%edx
 433:	83 c4 10             	add    $0x10,%esp
 436:	39 da                	cmp    %ebx,%edx
 438:	75 e6                	jne    420 <lock_acquire+0x20>
}
...
void lock_release(lock_t *lock){
 ...
 453:	8b 45 08             	mov    0x8(%ebp),%eax
  lock->turn = lock->turn + 1;
 456:	83 40 04 01          	addl   $0x1,0x4(%eax)
 45a:	5d                   	pop    %ebp
 45b:	c3                   	ret    
 ...
 52c:	89 d1                	mov    %edx,%ecx
{
 ...
 59e:	56                   	push   %esi
 59f:	57                   	push   %edi
 5a0:	e8 df fe ff ff       	call   484 <write>
  while(--i >= 0)
 ...
 5d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 615:	57                   	push   %edi
 616:	56                   	push   %esi
 617:	e8 68 fe ff ff       	call   484 <write>
 ...
 66e:	e8 11 fe ff ff       	call   484 <write>
        putc(fd, c);
 ...
 67f:	57                   	push   %edi
 680:	56                   	push   %esi
 681:	e8 fe fd ff ff       	call   484 <write>
        putc(fd, c);
 ...
 6eb:	57                   	push   %edi
 6ec:	56                   	push   %esi
 6ed:	e8 92 fd ff ff       	call   484 <write>
        while(*s != 0){
 ...
 72c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 72f:	e8 50 fd ff ff       	call   484 <write>
        ap++;
 ...
 757:	90                   	nop
          s = "(null)";
 758:	ba 3f 09 00 00       	mov    $0x93f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 771:	a1 0c 0d 00 00       	mov    0xd0c,%eax
{
 ...
 7b1:	5b                   	pop    %ebx
  freep = p;
 7b2:	89 15 0c 0d 00 00    	mov    %edx,0xd0c
}
 7b8:	5e                   	pop    %esi
 7b9:	5f                   	pop    %edi
 7ba:	5d                   	pop    %ebp
 ...
 7e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ec:	89 15 0c 0d 00 00    	mov    %edx,0xd0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 809:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 80c:	8b 3d 0c 0d 00 00    	mov    0xd0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 84f:	73 4f                	jae    8a0 <malloc+0xa0>
    ...
    if(p == freep)
 851:	8b 3d 0c 0d 00 00    	mov    0xd0c,%edi
 ...
 863:	e8 84 fc ff ff       	call   4ec <sbrk>
  if(p == (char*)-1)
 ...
 87a:	e8 f1 fe ff ff       	call   770 <free>
  return freep;
 87f:	8b 15 0c 0d 00 00    	mov    0xd0c,%edx
 ...
 8ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8af:	89 15 0c 0d 00 00    	mov    %edx,0xd0c
}
 ...
 8bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8c0:	c7 05 0c 0d 00 00 10 	movl   $0xd10,0xd0c
 8c7:	0d 00 00 
    base.s.size = 0;
 8ca:	bf 10 0d 00 00       	mov    $0xd10,%edi
    base.s.ptr = freep = prevp = &base;
 8cf:	c7 05 10 0d 00 00 10 	movl   $0xd10,0xd10
 8d6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8db:	c7 05 14 0d 00 00 00 	movl   $0x0,0xd14
 8e2:	00 00 00 
    if(p->s.size >= nunits){
