...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 b2 03 00 00       	call   3ec <mkdir>
  ...
  exit();
  4b:	e8 34 03 00 00       	call   384 <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 7e 04 00 00       	call   4f0 <printf>
    exit();
  72:	e8 0d 03 00 00       	call   384 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 df 01 00 00       	call   39c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 a2 01 00 00       	call   3c4 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 a5 01 00 00       	call   3dc <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 6b 01 00 00       	call   3ac <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2ea:	e8 35 01 00 00       	call   424 <clone>
}
 2ef:	c9                   	leave  
 2f0:	c3                   	ret    
...
int thread_join(){
 307:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 30a:	50                   	push   %eax
 30b:	e8 1c 01 00 00       	call   42c <join>
  if(pid >0 ){
 ...
 317:	7e 0d                	jle    326 <thread_join+0x26>
 319:	8b 7d f4             	mov    -0xc(%ebp),%edi
 31c:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
void lock_acquire(lock_t *lock){
 ...
 35b:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 35f:	8b 52 04             	mov    0x4(%edx),%edx
...
void lock_release(lock_t *lock){
 ...
 376:	83 40 04 01          	addl   $0x1,0x4(%eax)
 37a:	5d                   	pop    %ebp
 37b:	c3                   	ret    
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 535:	57                   	push   %edi
 536:	56                   	push   %esi
 537:	e8 68 fe ff ff       	call   3a4 <write>
 ...
 58e:	e8 11 fe ff ff       	call   3a4 <write>
        putc(fd, c);
 ...
 59f:	57                   	push   %edi
 5a0:	56                   	push   %esi
 5a1:	e8 fe fd ff ff       	call   3a4 <write>
        putc(fd, c);
 ...
 60b:	57                   	push   %edi
 60c:	56                   	push   %esi
 60d:	e8 92 fd ff ff       	call   3a4 <write>
        while(*s != 0){
 ...
 64c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 64f:	e8 50 fd ff ff       	call   3a4 <write>
        ap++;
...
free(void *ap)
{
 ...
 691:	a1 08 0c 00 00       	mov    0xc08,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 08 0c 00 00    	mov    %edx,0xc08
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 08 0c 00 00    	mov    %edx,0xc08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 08 0c 00 00    	mov    0xc08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 08 0c 00 00    	mov    0xc08,%edi
 ...
 783:	e8 84 fc ff ff       	call   40c <sbrk>
  if(p == (char*)-1)
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 08 0c 00 00    	mov    0xc08,%edx
 ...
 7e7:	0c 00 00 
    base.s.size = 0;
 7ea:	bf 0c 0c 00 00       	mov    $0xc0c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 10 0c 00 00 00 	movl   $0x0,0xc10
 802:	00 00 00 
    if(p->s.size >= nunits){
