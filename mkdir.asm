...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 44 04 00 00       	call   47e <mkdir>
...
xchg(volatile uint *addr, uint newval)
{
 ...
 2e2:	f0 87 05 b0 0c 00 00 	lock xchg %eax,0xcb0
  lock_init(&lk_join);
}
...
void lock_release(lock_t *lock){
 ...
 304:	c7 05 b0 0c 00 00 00 	movl   $0x0,0xcb0
 30b:	00 00 00 
...
int thread_join(){
 ...
 36a:	f0 87 05 ac 0c 00 00 	lock xchg %eax,0xcac
 ...
 385:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 38a:	c7 05 ac 0c 00 00 00 	movl   $0x0,0xcac
 391:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 3a0:	c7 05 b0 0c 00 00 00 	movl   $0x0,0xcb0
 3a7:	00 00 00 
 3aa:	c7 05 ac 0c 00 00 00 	movl   $0x0,0xcac
 3b1:	00 00 00 
}
 3b4:	c3                   	ret    
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 509:	0f b6 92 3c 09 00 00 	movzbl 0x93c(%edx),%edx
 ...
 589:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f9:	ff 24 85 e4 08 00 00 	jmp    *0x8e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 707:	90                   	nop
          s = "(null)";
 708:	ba db 08 00 00       	mov    $0x8db,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 721:	a1 b4 0c 00 00       	mov    0xcb4,%eax
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	89 15 b4 0c 00 00    	mov    %edx,0xcb4
}
 768:	5e                   	pop    %esi
 769:	5f                   	pop    %edi
 76a:	5d                   	pop    %ebp
 ...
 799:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 79c:	89 15 b4 0c 00 00    	mov    %edx,0xcb4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 3d b4 0c 00 00    	mov    0xcb4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 4f                	jae    850 <malloc+0xa0>
    ...
    if(p == freep)
 801:	8b 3d b4 0c 00 00    	mov    0xcb4,%edi
 ...
 82a:	e8 f1 fe ff ff       	call   720 <free>
  return freep;
 82f:	8b 15 b4 0c 00 00    	mov    0xcb4,%edx
 ...
 85c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 85f:	89 15 b4 0c 00 00    	mov    %edx,0xcb4
}
 ...
 86f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 b4 0c 00 00 b8 	movl   $0xcb8,0xcb4
 877:	0c 00 00 
    base.s.size = 0;
 87a:	bf b8 0c 00 00       	mov    $0xcb8,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 b8 0c 00 00 b8 	movl   $0xcb8,0xcb8
 886:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 88b:	c7 05 bc 0c 00 00 00 	movl   $0x0,0xcbc
 892:	00 00 00 
    if(p->s.size >= nunits){
