...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 e0 04 00 00       	call   4f6 <getpid>
  16:	a3 34 0d 00 00       	mov    %eax,0xd34

   int fork_pid = fork();
  1b:	e8 4e 04 00 00       	call   46e <fork>
   if(fork_pid == 0) {
  ...
  2c:	50                   	push   %eax
  2d:	e8 ec 04 00 00       	call   51e <join>
   assert(join_pid == -1);
  32:	83 c4 10             	add    $0x10,%esp
  35:	83 c0 01             	add    $0x1,%eax
  38:	74 68                	je     a2 <main+0xa2>
  3a:	6a 22                	push   $0x22
  3c:	68 08 09 00 00       	push   $0x908
  41:	68 11 09 00 00       	push   $0x911
  46:	6a 01                	push   $0x1
  48:	e8 93 05 00 00       	call   5e0 <printf>
  4d:	83 c4 0c             	add    $0xc,%esp
  50:	68 47 09 00 00       	push   $0x947
  55:	68 26 09 00 00       	push   $0x926
  5a:	6a 01                	push   $0x1
  5c:	e8 7f 05 00 00       	call   5e0 <printf>
  61:	5a                   	pop    %edx
  62:	59                   	pop    %ecx
  63:	68 3a 09 00 00       	push   $0x93a
  68:	6a 01                	push   $0x1
  6a:	e8 71 05 00 00       	call   5e0 <printf>
  6f:	58                   	pop    %eax
  70:	ff 35 34 0d 00 00    	push   0xd34
  76:	e8 2b 04 00 00       	call   4a6 <kill>
  7b:	e8 f6 03 00 00       	call   476 <exit>
   assert(fork_pid > 0);
  80:	6a 1e                	push   $0x1e
  82:	68 08 09 00 00       	push   $0x908
  87:	68 11 09 00 00       	push   $0x911
  8c:	6a 01                	push   $0x1
  8e:	e8 4d 05 00 00       	call   5e0 <printf>
  93:	83 c4 0c             	add    $0xc,%esp
  96:	68 19 09 00 00       	push   $0x919
  9b:	eb b8                	jmp    55 <main+0x55>
     exit();
  9d:	e8 d4 03 00 00       	call   476 <exit>

   assert(wait() > 0);
  a2:	e8 d7 03 00 00       	call   47e <wait>
  a7:	85 c0                	test   %eax,%eax
  a9:	7e 13                	jle    be <main+0xbe>
   printf(1, "TEST PASSED\n");
  ab:	50                   	push   %eax
  ac:	50                   	push   %eax
  ad:	68 61 09 00 00       	push   $0x961
  b2:	6a 01                	push   $0x1
  b4:	e8 27 05 00 00       	call   5e0 <printf>
   exit();
  b9:	e8 b8 03 00 00       	call   476 <exit>
   assert(wait() > 0);
  be:	6a 24                	push   $0x24
  c0:	68 08 09 00 00       	push   $0x908
  c5:	68 11 09 00 00       	push   $0x911
  ca:	6a 01                	push   $0x1
  cc:	e8 0f 05 00 00       	call   5e0 <printf>
  d1:	83 c4 0c             	add    $0xc,%esp
  d4:	68 56 09 00 00       	push   $0x956
 ...
 209:	31 db                	xor    %ebx,%ebx
{
 ...
 215:	57                   	push   %edi
 216:	6a 00                	push   $0x0
 218:	e8 71 02 00 00       	call   48e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 27d:	e8 34 02 00 00       	call   4b6 <open>
  if(fd < 0)
 ...
 291:	50                   	push   %eax
 292:	e8 37 02 00 00       	call   4ce <fstat>
  close(fd);
 297:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 29a:	89 c6                	mov    %eax,%esi
  close(fd);
 29c:	e8 fd 01 00 00       	call   49e <close>
  return r;
...
xchg(volatile uint *addr, uint newval)
{
 ...
 331:	ba 01 00 00 00       	mov    $0x1,%edx
 336:	89 e5                	mov    %esp,%ebp
 338:	83 ec 08             	sub    $0x8,%esp
 33b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 33f:	90                   	nop
 340:	89 d0                	mov    %edx,%eax
 342:	f0 87 05 3c 0d 00 00 	lock xchg %eax,0xd3c
  lock_init(&lk_join);
}
...
void lock_acquire(lock_t *lock){
 ...
 34b:	75 f3                	jne    340 <thread_create+0x10>
    __sync_synchronize();
 34d:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	void *stack= malloc(PGSIZE*2);
 352:	83 ec 0c             	sub    $0xc,%esp
 355:	68 00 20 00 00       	push   $0x2000
 35a:	e8 b1 04 00 00       	call   810 <malloc>
}

void lock_release(lock_t *lock){
   __sync_synchronize();
 35f:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 364:	c7 05 3c 0d 00 00 00 	movl   $0x0,0xd3c
 36b:	00 00 00 
	if((uint)stack % PGSIZE)
 36e:	89 c2                	mov    %eax,%edx
 370:	83 c4 10             	add    $0x10,%esp
 373:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 379:	74 07                	je     382 <thread_create+0x52>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
 37b:	29 d0                	sub    %edx,%eax
 37d:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 38c:	e8 85 01 00 00       	call   516 <clone>
}
 391:	c9                   	leave  
 392:	c3                   	ret    
...
int thread_join(){
 ...
 3aa:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int result= join(&stack);
 3b1:	50                   	push   %eax
 3b2:	e8 67 01 00 00       	call   51e <join>
    while(xchg(&(lock->mutex), 1) != 0);
 ...
 3ca:	f0 87 05 38 0d 00 00 	lock xchg %eax,0xd38
 3d1:	85 c0                	test   %eax,%eax
 3d3:	75 f3                	jne    3c8 <thread_join+0x28>
    __sync_synchronize();
 3d5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	free(stack);
 3da:	83 ec 0c             	sub    $0xc,%esp
 3dd:	ff 75 f4             	push   -0xc(%ebp)
 3e0:	e8 9b 03 00 00       	call   780 <free>
   __sync_synchronize();
 3e5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 3ea:	c7 05 38 0d 00 00 00 	movl   $0x0,0xd38
 3f1:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 400:	c7 05 3c 0d 00 00 00 	movl   $0x0,0xd3c
 407:	00 00 00 
 40a:	c7 05 38 0d 00 00 00 	movl   $0x0,0xd38
 411:	00 00 00 
}
 414:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 437:	75 f7                	jne    430 <lock_acquire+0x10>
    __sync_synchronize();
 439:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
 43e:	5d                   	pop    %ebp
 43f:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 443:	8b 45 08             	mov    0x8(%ebp),%eax
   __sync_synchronize();
 446:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 ...
 53c:	89 d1                	mov    %edx,%ecx
{
 ...
 569:	0f b6 92 d0 09 00 00 	movzbl 0x9d0(%edx),%edx
 ...
 5e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 659:	ff 24 85 78 09 00 00 	jmp    *0x978(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 767:	90                   	nop
          s = "(null)";
 768:	ba 6e 09 00 00       	mov    $0x96e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 781:	a1 40 0d 00 00       	mov    0xd40,%eax
{
 ...
 7c1:	5b                   	pop    %ebx
  freep = p;
 7c2:	89 15 40 0d 00 00    	mov    %edx,0xd40
}
 7c8:	5e                   	pop    %esi
 7c9:	5f                   	pop    %edi
 7ca:	5d                   	pop    %ebp
 ...
 7f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7fc:	89 15 40 0d 00 00    	mov    %edx,0xd40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 819:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 81c:	8b 3d 40 0d 00 00    	mov    0xd40,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 85f:	73 4f                	jae    8b0 <malloc+0xa0>
    ...
    if(p == freep)
 861:	8b 3d 40 0d 00 00    	mov    0xd40,%edi
 ...
 88a:	e8 f1 fe ff ff       	call   780 <free>
  return freep;
 88f:	8b 15 40 0d 00 00    	mov    0xd40,%edx
 ...
 8bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8bf:	89 15 40 0d 00 00    	mov    %edx,0xd40
}
 ...
 8cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8d0:	c7 05 40 0d 00 00 44 	movl   $0xd44,0xd40
 8d7:	0d 00 00 
    base.s.size = 0;
 8da:	bf 44 0d 00 00       	mov    $0xd44,%edi
    base.s.ptr = freep = prevp = &base;
 8df:	c7 05 44 0d 00 00 44 	movl   $0xd44,0xd44
 8e6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8eb:	c7 05 48 0d 00 00 00 	movl   $0x0,0xd48
 8f2:	00 00 00 
    if(p->s.size >= nunits){
