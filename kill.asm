...
main(int argc, char **argv)
{
  ...
  39:	e8 36 04 00 00       	call   474 <kill>
  for(i=1; i<argc; i++)
  ...
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  4c:	68 d8 08 00 00       	push   $0x8d8
  51:	6a 02                	push   $0x2
  53:	e8 58 05 00 00       	call   5b0 <printf>
    exit();
  58:	e8 e7 03 00 00       	call   444 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 50c:	89 d1                	mov    %edx,%ecx
{
 ...
 539:	0f b6 92 60 09 00 00 	movzbl 0x960(%edx),%edx
 ...
 5b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 629:	ff 24 85 08 09 00 00 	jmp    *0x908(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 737:	90                   	nop
          s = "(null)";
 738:	ba 00 09 00 00       	mov    $0x900,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 751:	a1 cc 0c 00 00       	mov    0xccc,%eax
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	89 15 cc 0c 00 00    	mov    %edx,0xccc
}
 798:	5e                   	pop    %esi
 799:	5f                   	pop    %edi
 79a:	5d                   	pop    %ebp
 ...
 7c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7cc:	89 15 cc 0c 00 00    	mov    %edx,0xccc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 3d cc 0c 00 00    	mov    0xccc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 82f:	73 4f                	jae    880 <malloc+0xa0>
    ...
    if(p == freep)
 831:	8b 3d cc 0c 00 00    	mov    0xccc,%edi
 ...
 85a:	e8 f1 fe ff ff       	call   750 <free>
  return freep;
 85f:	8b 15 cc 0c 00 00    	mov    0xccc,%edx
 ...
 88c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 88f:	89 15 cc 0c 00 00    	mov    %edx,0xccc
}
 ...
 89f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8a0:	c7 05 cc 0c 00 00 d0 	movl   $0xcd0,0xccc
 8a7:	0c 00 00 
    base.s.size = 0;
 8aa:	bf d0 0c 00 00       	mov    $0xcd0,%edi
    base.s.ptr = freep = prevp = &base;
 8af:	c7 05 d0 0c 00 00 d0 	movl   $0xcd0,0xcd0
 8b6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8bb:	c7 05 d4 0c 00 00 00 	movl   $0x0,0xcd4
 8c2:	00 00 00 
    if(p->s.size >= nunits){
