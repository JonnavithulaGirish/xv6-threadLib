...
main(int argc, char **argv)
{
  ...
  39:	e8 e8 03 00 00       	call   426 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 ac 03 00 00       	call   3f6 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  4c:	68 88 08 00 00       	push   $0x888
  51:	6a 02                	push   $0x2
  53:	e8 08 05 00 00       	call   560 <printf>
    exit();
  58:	e8 99 03 00 00       	call   3f6 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 71 02 00 00       	call   40e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 34 02 00 00       	call   436 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 37 02 00 00       	call   44e <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 fd 01 00 00       	call   41e <close>
  return r;
...
xchg(volatile uint *addr, uint newval)
{
 ...
 2b1:	ba 01 00 00 00       	mov    $0x1,%edx
 2b6:	89 e5                	mov    %esp,%ebp
 2b8:	83 ec 08             	sub    $0x8,%esp
 2bb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 2bf:	90                   	nop
 2c0:	89 d0                	mov    %edx,%eax
 2c2:	f0 87 05 70 0c 00 00 	lock xchg %eax,0xc70
  lock_init(&lk_join);
}
...
void lock_acquire(lock_t *lock){
 ...
 2cb:	75 f3                	jne    2c0 <thread_create+0x10>
    __sync_synchronize();
 2cd:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	void *stack= malloc(PGSIZE*2);
 2d2:	83 ec 0c             	sub    $0xc,%esp
 2d5:	68 00 20 00 00       	push   $0x2000
 2da:	e8 b1 04 00 00       	call   790 <malloc>
}

void lock_release(lock_t *lock){
   __sync_synchronize();
 2df:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 2e4:	c7 05 70 0c 00 00 00 	movl   $0x0,0xc70
 2eb:	00 00 00 
	if((uint)stack % PGSIZE)
 2ee:	89 c2                	mov    %eax,%edx
 2f0:	83 c4 10             	add    $0x10,%esp
 2f3:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 2f9:	74 07                	je     302 <thread_create+0x52>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
 2fb:	29 d0                	sub    %edx,%eax
 2fd:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 30c:	e8 85 01 00 00       	call   496 <clone>
}
 311:	c9                   	leave  
 312:	c3                   	ret    
...
int thread_join(){
 ...
 32a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int result= join(&stack);
 331:	50                   	push   %eax
 332:	e8 67 01 00 00       	call   49e <join>
    while(xchg(&(lock->mutex), 1) != 0);
 337:	83 c4 10             	add    $0x10,%esp
 33a:	ba 01 00 00 00       	mov    $0x1,%edx
	int result= join(&stack);
 33f:	89 c3                	mov    %eax,%ebx
    while(xchg(&(lock->mutex), 1) != 0);
 341:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 348:	89 d0                	mov    %edx,%eax
 34a:	f0 87 05 6c 0c 00 00 	lock xchg %eax,0xc6c
 351:	85 c0                	test   %eax,%eax
 353:	75 f3                	jne    348 <thread_join+0x28>
    __sync_synchronize();
 355:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	free(stack);
 35a:	83 ec 0c             	sub    $0xc,%esp
 35d:	ff 75 f4             	push   -0xc(%ebp)
 360:	e8 9b 03 00 00       	call   700 <free>
   __sync_synchronize();
 365:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 36a:	c7 05 6c 0c 00 00 00 	movl   $0x0,0xc6c
 371:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 380:	c7 05 70 0c 00 00 00 	movl   $0x0,0xc70
 387:	00 00 00 
 38a:	c7 05 6c 0c 00 00 00 	movl   $0x0,0xc6c
 391:	00 00 00 
}
 394:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 3b7:	75 f7                	jne    3b0 <lock_acquire+0x10>
    __sync_synchronize();
 3b9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
 3be:	5d                   	pop    %ebp
 3bf:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 3c3:	8b 45 08             	mov    0x8(%ebp),%eax
   __sync_synchronize();
 3c6:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 3cb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 3d1:	5d                   	pop    %ebp
 3d2:	c3                   	ret    
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 52e:	56                   	push   %esi
 52f:	57                   	push   %edi
 530:	e8 e1 fe ff ff       	call   416 <write>
  while(--i >= 0)
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a5:	57                   	push   %edi
 5a6:	56                   	push   %esi
 5a7:	e8 6a fe ff ff       	call   416 <write>
 ...
 5fe:	e8 13 fe ff ff       	call   416 <write>
        putc(fd, c);
 ...
 60f:	57                   	push   %edi
 610:	56                   	push   %esi
 611:	e8 00 fe ff ff       	call   416 <write>
        putc(fd, c);
 ...
 67b:	57                   	push   %edi
 67c:	56                   	push   %esi
 67d:	e8 94 fd ff ff       	call   416 <write>
        while(*s != 0){
 ...
 6bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6bf:	e8 52 fd ff ff       	call   416 <write>
        ap++;
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba 9c 08 00 00       	mov    $0x89c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 701:	a1 74 0c 00 00       	mov    0xc74,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 74 0c 00 00    	mov    %edx,0xc74
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 74 0c 00 00    	mov    %edx,0xc74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d 74 0c 00 00    	mov    0xc74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d 74 0c 00 00    	mov    0xc74,%edi
 ...
 7f3:	e8 86 fc ff ff       	call   47e <sbrk>
  if(p == (char*)-1)
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 74 0c 00 00    	mov    0xc74,%edx
 ...
 83c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 83f:	89 15 74 0c 00 00    	mov    %edx,0xc74
}
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 74 0c 00 00 78 	movl   $0xc78,0xc74
 857:	0c 00 00 
    base.s.size = 0;
 85a:	bf 78 0c 00 00       	mov    $0xc78,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 78 0c 00 00 78 	movl   $0xc78,0xc78
 866:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 7c 0c 00 00 00 	movl   $0x0,0xc7c
 872:	00 00 00 
    if(p->s.size >= nunits){
