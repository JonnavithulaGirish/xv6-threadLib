...
int main(int argc, char *argv[])
{
  ...
  4d:	e8 22 05 00 00       	call   574 <open>
   assert(fd == 3);
  ...
  8f:	5e                   	pop    %esi
  90:	ff 35 6c 0e 00 00    	push   0xe6c
  96:	e8 c9 04 00 00       	call   564 <kill>
  9b:	e8 94 04 00 00       	call   534 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  b6:	e8 19 05 00 00       	call   5d4 <clone>
   assert(clone_pid > 0);
  ...
  cf:	90                   	nop
   while(!newfd);
  d0:	a1 68 0e 00 00       	mov    0xe68,%eax
  d5:	85 c0                	test   %eax,%eax
  d7:	74 f7                	je     d0 <main+0xd0>
   assert(write(newfd, "goodbye\n", 8) == -1);
  d9:	a1 68 0e 00 00       	mov    0xe68,%eax
  de:	52                   	push   %edx
  df:	6a 08                	push   $0x8
  e1:	68 46 0a 00 00       	push   $0xa46
  e6:	50                   	push   %eax
  e7:	e8 68 04 00 00       	call   554 <write>
 ...
 128:	e8 af 04 00 00       	call   5dc <join>
 ...
 198:	e8 a3 06 00 00       	call   840 <free>
   exit();
 19d:	e8 92 03 00 00       	call   534 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1bd:	6a 03                	push   $0x3
 1bf:	e8 90 03 00 00       	call   554 <write>
 ...
 201:	58                   	pop    %eax
 202:	ff 35 6c 0e 00 00    	push   0xe6c
 208:	e8 57 03 00 00       	call   564 <kill>
 20d:	e8 22 03 00 00       	call   534 <exit>
   xchg(&newfd, open("tmp2", O_WRONLY|O_CREATE));
 212:	50                   	push   %eax
 213:	50                   	push   %eax
 214:	68 01 02 00 00       	push   $0x201
 219:	68 1d 0a 00 00       	push   $0xa1d
 21e:	e8 51 03 00 00       	call   574 <open>
xchg(volatile uint *addr, uint newval)
{
 ...
 223:	f0 87 05 68 0e 00 00 	lock xchg %eax,0xe68
   exit();
 22a:	e8 05 03 00 00       	call   534 <exit>
 22f:	90                   	nop
 ...
 359:	31 db                	xor    %ebx,%ebx
{
 ...
 365:	57                   	push   %edi
 366:	6a 00                	push   $0x0
 368:	e8 df 01 00 00       	call   54c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3cd:	e8 a2 01 00 00       	call   574 <open>
  if(fd < 0)
 ...
 3e1:	50                   	push   %eax
 3e2:	e8 a5 01 00 00       	call   58c <fstat>
  close(fd);
 3e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 3ea:	89 c6                	mov    %eax,%esi
  close(fd);
 3ec:	e8 6b 01 00 00       	call   55c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 49a:	e8 35 01 00 00       	call   5d4 <clone>
}
 49f:	c9                   	leave  
 4a0:	c3                   	ret    
...
int thread_join(){
 ...
 4c7:	7e 0d                	jle    4d6 <thread_join+0x26>
 4c9:	8b 7d f4             	mov    -0xc(%ebp),%edi
 4cc:	b9 00 10 00 00       	mov    $0x1000,%ecx
 4d1:	31 c0                	xor    %eax,%eax
 4d3:	fc                   	cld    
 4d4:	f3 aa                	rep stos %al,%es:(%edi)
    memset(stack,0,PGSIZE);
  }
  return pid;
}
 4d6:	8b 7d fc             	mov    -0x4(%ebp),%edi
