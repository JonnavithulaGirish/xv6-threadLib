...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 e4 0e 00 00       	call   f14 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 77 0e 00 00       	call   ecc <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 75 0e 00 00       	call   edc <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 41 0e 00 00       	call   efc <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 4f 0e 00 00       	call   f44 <chdir>
  ...
  exit();
     11a:	e8 b5 0d 00 00       	call   ed4 <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 4a 0d 00 00       	call   ed4 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 31 0d 00 00       	call   ecc <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 29 0d 00 00       	call   f0c <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 cf 0c 00 00       	call   ed4 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 c5 0c 00 00       	call   ee4 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 ad 0c 00 00       	call   efc <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 a4 0c 00 00       	call   efc <close>
    wait();
     258:	e8 7f 0c 00 00       	call   edc <wait>
    wait();
     25d:	e8 7a 0c 00 00       	call   edc <wait>
    break;
    ...
    wait();
     270:	e8 67 0c 00 00       	call   edc <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 71 0c 00 00       	call   efc <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 7c 0c 00 00       	call   f14 <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 79 0d 00 00       	call   1040 <printf>
      exit();
     2c7:	e8 08 0c 00 00       	call   ed4 <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 19 0c 00 00       	call   efc <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 60 0c 00 00       	call   f4c <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 07 0c 00 00       	call   efc <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 fe 0b 00 00       	call   efc <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 eb 0b 00 00       	call   efc <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 32 0c 00 00       	call   f4c <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 d9 0b 00 00       	call   efc <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 d0 0b 00 00       	call   efc <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 28 1b 00 00       	push   $0x1b28
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 30 1b 00 00       	push   $0x1b30
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 30 1b 00 00       	push   $0x1b30
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 df 01 00 00       	call   eec <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 a2 01 00 00       	call   f14 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 a5 01 00 00       	call   f2c <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 6b 01 00 00       	call   efc <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
   ...
   return clone(start_routine, arg1, arg2, stack);
     ...
     e3a:	e8 35 01 00 00       	call   f74 <clone>
}
     e3f:	c9                   	leave  
     e40:	c3                   	ret    
...
int thread_join(){
  ...
  void *stack;
  int pid= join(&stack);
     e54:	8d 45 f4             	lea    -0xc(%ebp),%eax
int thread_join(){
     e57:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
     e5a:	50                   	push   %eax
     e5b:	e8 1c 01 00 00       	call   f7c <join>
  if(pid >0 ){
  ...
  if(pid >0 ){
     ...
     e67:	7e 0d                	jle    e76 <thread_join+0x26>
     e69:	8b 7d f4             	mov    -0xc(%ebp),%edi
     e6c:	b9 00 10 00 00       	mov    $0x1000,%ecx
     e71:	31 c0                	xor    %eax,%eax
     e73:	fc                   	cld    
     e74:	f3 aa                	rep stos %al,%es:(%edi)
    memset(stack,0,PGSIZE);
  }
  return pid;
}
     e76:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
void lock_init(lock_t *lock) {
  ...
  lock->turn = 0;
     e8c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
     e93:	5d                   	pop    %ebp
     e94:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
  ...
  asm volatile("lock; xaddl %%eax, %2;" :
     ea1:	b8 01 00 00 00       	mov    $0x1,%eax
     ea6:	89 e5                	mov    %esp,%ebp
     ea8:	8b 55 08             	mov    0x8(%ebp),%edx
     eab:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
     eaf:	8b 52 04             	mov    0x4(%edx),%edx
     eb2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
     eb8:	39 c2                	cmp    %eax,%edx
     eba:	75 fc                	jne    eb8 <lock_acquire+0x18>
}
     ebc:	5d                   	pop    %ebp
     ebd:	c3                   	ret    
...
void lock_release(lock_t *lock){
  ...
  lock->turn = lock->turn + 1;
     ec6:	83 40 04 01          	addl   $0x1,0x4(%eax)
     eca:	5d                   	pop    %ebp
     ecb:	c3                   	ret    
...
SYSCALL(fork)
     ecc:	b8 01 00 00 00       	mov    $0x1,%eax
     ed1:	cd 40                	int    $0x40
     ed3:	c3                   	ret    

00000ed4 <exit>:
SYSCALL(exit)
     ed4:	b8 02 00 00 00       	mov    $0x2,%eax
     ed9:	cd 40                	int    $0x40
     edb:	c3                   	ret    

00000edc <wait>:
SYSCALL(wait)
     edc:	b8 03 00 00 00       	mov    $0x3,%eax
     ee1:	cd 40                	int    $0x40
     ee3:	c3                   	ret    

00000ee4 <pipe>:
SYSCALL(pipe)
     ee4:	b8 04 00 00 00       	mov    $0x4,%eax
     ee9:	cd 40                	int    $0x40
     eeb:	c3                   	ret    

00000eec <read>:
SYSCALL(read)
     eec:	b8 05 00 00 00       	mov    $0x5,%eax
     ef1:	cd 40                	int    $0x40
     ef3:	c3                   	ret    

00000ef4 <write>:
SYSCALL(write)
     ef4:	b8 10 00 00 00       	mov    $0x10,%eax
     ef9:	cd 40                	int    $0x40
     efb:	c3                   	ret    

00000efc <close>:
SYSCALL(close)
     efc:	b8 15 00 00 00       	mov    $0x15,%eax
     f01:	cd 40                	int    $0x40
     f03:	c3                   	ret    

00000f04 <kill>:
SYSCALL(kill)
     f04:	b8 06 00 00 00       	mov    $0x6,%eax
     f09:	cd 40                	int    $0x40
     f0b:	c3                   	ret    

00000f0c <exec>:
SYSCALL(exec)
     f0c:	b8 07 00 00 00       	mov    $0x7,%eax
     f11:	cd 40                	int    $0x40
     f13:	c3                   	ret    

00000f14 <open>:
SYSCALL(open)
     f14:	b8 0f 00 00 00       	mov    $0xf,%eax
     f19:	cd 40                	int    $0x40
     f1b:	c3                   	ret    
...
00000f2c <fstat>:
SYSCALL(fstat)
     f2c:	b8 08 00 00 00       	mov    $0x8,%eax
     f31:	cd 40                	int    $0x40
     f33:	c3                   	ret    

00000f34 <link>:
SYSCALL(link)
     f34:	b8 13 00 00 00       	mov    $0x13,%eax
     f39:	cd 40                	int    $0x40
     f3b:	c3                   	ret    

00000f3c <mkdir>:
SYSCALL(mkdir)
     f3c:	b8 14 00 00 00       	mov    $0x14,%eax
     f41:	cd 40                	int    $0x40
     f43:	c3                   	ret    

00000f44 <chdir>:
SYSCALL(chdir)
     f44:	b8 09 00 00 00       	mov    $0x9,%eax
     f49:	cd 40                	int    $0x40
     f4b:	c3                   	ret    

00000f4c <dup>:
SYSCALL(dup)
     f4c:	b8 0a 00 00 00       	mov    $0xa,%eax
     f51:	cd 40                	int    $0x40
     f53:	c3                   	ret    

00000f54 <getpid>:
SYSCALL(getpid)
     f54:	b8 0b 00 00 00       	mov    $0xb,%eax
     f59:	cd 40                	int    $0x40
     f5b:	c3                   	ret    

00000f5c <sbrk>:
SYSCALL(sbrk)
     f5c:	b8 0c 00 00 00       	mov    $0xc,%eax
     f61:	cd 40                	int    $0x40
     f63:	c3                   	ret    

00000f64 <sleep>:
SYSCALL(sleep)
     f64:	b8 0d 00 00 00       	mov    $0xd,%eax
     f69:	cd 40                	int    $0x40
     f6b:	c3                   	ret    

00000f6c <uptime>:
SYSCALL(uptime)
     f6c:	b8 0e 00 00 00       	mov    $0xe,%eax
     f71:	cd 40                	int    $0x40
     f73:	c3                   	ret    

00000f74 <clone>:
SYSCALL(clone)
     f74:	b8 16 00 00 00       	mov    $0x16,%eax
     f79:	cd 40                	int    $0x40
     f7b:	c3                   	ret    

00000f7c <join>:
SYSCALL(join)
     f7c:	b8 17 00 00 00       	mov    $0x17,%eax
     f81:	cd 40                	int    $0x40
     f83:	c3                   	ret    
     ...
     f9c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    100e:	56                   	push   %esi
    100f:	57                   	push   %edi
    1010:	e8 df fe ff ff       	call   ef4 <write>
  while(--i >= 0)
    ...
    1049:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1085:	57                   	push   %edi
    1086:	56                   	push   %esi
    1087:	e8 68 fe ff ff       	call   ef4 <write>
  ...
  write(fd, &c, 1);
    ...
    10de:	e8 11 fe ff ff       	call   ef4 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10ef:	57                   	push   %edi
    10f0:	56                   	push   %esi
    10f1:	e8 fe fd ff ff       	call   ef4 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    115b:	57                   	push   %edi
    115c:	56                   	push   %esi
    115d:	e8 92 fd ff ff       	call   ef4 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    119f:	e8 50 fd ff ff       	call   ef4 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12d3:	e8 84 fc ff ff       	call   f5c <sbrk>
  if(p == (char*)-1)
