...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      24:	6a 02                	push   $0x2
      26:	68 e9 14 00 00       	push   $0x14e9
      2b:	e8 c4 0f 00 00       	call   ff4 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d 42 1c 00 00 20 	cmpb   $0x20,0x1c42
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 57 0f 00 00       	call   fac <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 55 0f 00 00       	call   fbc <wait>
  printf(2, "$ ");
      67:	83 ec 08             	sub    $0x8,%esp
      6a:	68 48 14 00 00       	push   $0x1448
      6f:	6a 02                	push   $0x2
      71:	e8 aa 10 00 00       	call   1120 <printf>
  memset(buf, 0, nbuf);
      76:	83 c4 0c             	add    $0xc,%esp
      79:	6a 64                	push   $0x64
      7b:	6a 00                	push   $0x0
      7d:	68 40 1c 00 00       	push   $0x1c40
      82:	e8 09 0c 00 00       	call   c90 <memset>
  gets(buf, nbuf);
      87:	58                   	pop    %eax
      88:	5a                   	pop    %edx
      89:	6a 64                	push   $0x64
      8b:	68 40 1c 00 00       	push   $0x1c40
      90:	e8 5b 0c 00 00       	call   cf0 <gets>
  if(buf[0] == 0) // EOF
      95:	0f b6 05 40 1c 00 00 	movzbl 0x1c40,%eax
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a7:	80 3d 41 1c 00 00 64 	cmpb   $0x64,0x1c41
      ae:	75 a0                	jne    50 <main+0x50>
      b0:	eb 8e                	jmp    40 <main+0x40>
      close(fd);
      b2:	83 ec 0c             	sub    $0xc,%esp
      b5:	50                   	push   %eax
      b6:	e8 21 0f 00 00       	call   fdc <close>
      break;
      bb:	83 c4 10             	add    $0x10,%esp
      be:	eb a7                	jmp    67 <main+0x67>
      runcmd(parsecmd(buf));
      c0:	83 ec 0c             	sub    $0xc,%esp
      c3:	68 40 1c 00 00       	push   $0x1c40
      c8:	e8 93 0a 00 00       	call   b60 <parsecmd>
      cd:	89 04 24             	mov    %eax,(%esp)
      d0:	e8 db 00 00 00       	call   1b0 <runcmd>
      buf[strlen(buf)-1] = 0;  // chop \n
      d5:	83 ec 0c             	sub    $0xc,%esp
      d8:	68 40 1c 00 00       	push   $0x1c40
      dd:	e8 7e 0b 00 00       	call   c60 <strlen>
      if(chdir(buf+3) < 0)
      e2:	c7 04 24 43 1c 00 00 	movl   $0x1c43,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      e9:	c6 80 3f 1c 00 00 00 	movb   $0x0,0x1c3f(%eax)
      if(chdir(buf+3) < 0)
      f0:	e8 2f 0f 00 00       	call   1024 <chdir>
      f5:	83 c4 10             	add    $0x10,%esp
      f8:	85 c0                	test   %eax,%eax
      fa:	0f 89 67 ff ff ff    	jns    67 <main+0x67>
        printf(2, "cannot cd %s\n", buf+3);
     100:	51                   	push   %ecx
     101:	68 43 1c 00 00       	push   $0x1c43
     106:	68 f1 14 00 00       	push   $0x14f1
     10b:	6a 02                	push   $0x2
     10d:	e8 0e 10 00 00       	call   1120 <printf>
     112:	83 c4 10             	add    $0x10,%esp
     115:	e9 4d ff ff ff       	jmp    67 <main+0x67>
  exit();
     11a:	e8 95 0e 00 00       	call   fb4 <exit>
    panic("fork");
     11f:	83 ec 0c             	sub    $0xc,%esp
     122:	68 4b 14 00 00       	push   $0x144b
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 48 14 00 00       	push   $0x1448
     143:	6a 02                	push   $0x2
     145:	e8 d6 0f 00 00       	call   1120 <printf>
  memset(buf, 0, nbuf);
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 e5 14 00 00       	push   $0x14e5
     17e:	6a 02                	push   $0x2
     180:	e8 9b 0f 00 00       	call   1120 <printf>
  exit();
     185:	e8 2a 0e 00 00       	call   fb4 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 11 0e 00 00       	call   fac <fork>
  if(pid == -1)
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 4b 14 00 00       	push   $0x144b
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 00 15 00 00 	jmp    *0x1500(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 09 0e 00 00       	call   fec <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     1e3:	83 c4 0c             	add    $0xc,%esp
     1e6:	ff 73 04             	push   0x4(%ebx)
     1e9:	68 57 14 00 00       	push   $0x1457
     1ee:	6a 02                	push   $0x2
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 af 0d 00 00       	call   fb4 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 a5 0d 00 00       	call   fc4 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 8d 0d 00 00       	call   fdc <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 84 0d 00 00       	call   fdc <close>
    wait();
     258:	e8 5f 0d 00 00       	call   fbc <wait>
    wait();
     25d:	e8 5a 0d 00 00       	call   fbc <wait>
    break;
    ...
    wait();
     270:	e8 47 0d 00 00       	call   fbc <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 51 0d 00 00       	call   fdc <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 5c 0d 00 00       	call   ff4 <open>
    ...
    panic("runcmd");
     ...
     2ad:	68 50 14 00 00       	push   $0x1450
     2b2:	e8 b9 fe ff ff       	call   170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2b7:	51                   	push   %ecx
     2b8:	ff 73 08             	push   0x8(%ebx)
     2bb:	68 67 14 00 00       	push   $0x1467
     2c0:	6a 02                	push   $0x2
     2c2:	e8 59 0e 00 00       	call   1120 <printf>
      exit();
     2c7:	e8 e8 0c 00 00       	call   fb4 <exit>
      panic("pipe");
     2cc:	83 ec 0c             	sub    $0xc,%esp
     2cf:	68 77 14 00 00       	push   $0x1477
     2d4:	e8 97 fe ff ff       	call   170 <panic>
      close(1);
     2d9:	83 ec 0c             	sub    $0xc,%esp
     2dc:	6a 01                	push   $0x1
     2de:	e8 f9 0c 00 00       	call   fdc <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 40 0d 00 00       	call   102c <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 e7 0c 00 00       	call   fdc <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 de 0c 00 00       	call   fdc <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 cb 0c 00 00       	call   fdc <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 12 0d 00 00       	call   102c <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 b9 0c 00 00       	call   fdc <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 b0 0c 00 00       	call   fdc <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     347:	6a 54                	push   $0x54
     349:	e8 02 10 00 00       	call   1350 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     377:	6a 18                	push   $0x18
     379:	e8 d2 0f 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3c7:	6a 0c                	push   $0xc
     3c9:	e8 82 0f 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     447:	6a 08                	push   $0x8
     449:	e8 02 0f 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 34 1c 00 00       	push   $0x1c34
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 34 1c 00 00       	push   $0x1c34
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 2c 1c 00 00       	push   $0x1c2c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 34 1c 00 00       	push   $0x1c34
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 34 1c 00 00       	push   $0x1c34
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 99 14 00 00       	push   $0x1499
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     6c2:	e8 89 0c 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     721:	e8 2a 0c 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     77e:	68 7c 14 00 00       	push   $0x147c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 9c 14 00 00       	push   $0x149c
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     7bb:	6a 54                	push   $0x54
     7bd:	e8 8e 0b 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 b3 14 00 00       	push   $0x14b3
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 a5 14 00 00       	push   $0x14a5
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 9e 14 00 00       	push   $0x149e
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 b8 14 00 00       	push   $0x14b8
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     90d:	e8 3e 0a 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000940 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     972:	e8 d9 09 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 ba 14 00 00       	push   $0x14ba
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 b6 14 00 00       	push   $0x14b6
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     9ed:	e8 5e 09 00 00       	call   1350 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 9c 14 00 00       	push   $0x149c
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 d8 14 00 00       	push   $0x14d8
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 18 15 00 00 	jmp    *0x1518(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 43 15 00 00       	push   $0x1543
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 da 14 00 00       	push   $0x14da
     bb5:	6a 02                	push   $0x2
     bb7:	e8 64 05 00 00       	call   1120 <printf>
    panic("syntax");
     bbc:	c7 04 24 9e 14 00 00 	movl   $0x149e,(%esp)
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 bf 02 00 00       	call   fcc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 82 02 00 00       	call   ff4 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 85 02 00 00       	call   100c <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 4b 02 00 00       	call   fdc <close>
  return r;
...
void lock_init(lock_t *lock) {
  lock->ticket = 0;
     e2c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  lock->turn = 0;
     e33:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
     e3a:	f0 0f c1 45 f0       	lock xadd %eax,-0x10(%ebp)
}

void lock_acquire(lock_t *lock){
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn){
     e3f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     e42:	39 c2                	cmp    %eax,%edx
     e44:	74 24                	je     e6a <thread_create+0x4a>
     e46:	89 c3                	mov    %eax,%ebx
     e48:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     e4f:	90                   	nop
    printf(1,"ulib lock value %d\n",lock->turn);
     e50:	83 ec 04             	sub    $0x4,%esp
     e53:	52                   	push   %edx
     e54:	68 30 15 00 00       	push   $0x1530
     e59:	6a 01                	push   $0x1
     e5b:	e8 c0 02 00 00       	call   1120 <printf>
  while(lock->turn != myturn){
     e60:	8b 55 f4             	mov    -0xc(%ebp),%edx
     e63:	83 c4 10             	add    $0x10,%esp
     e66:	39 d3                	cmp    %edx,%ebx
     e68:	75 e6                	jne    e50 <thread_create+0x30>
	void *stack= malloc(PGSIZE*2);
     e6a:	83 ec 0c             	sub    $0xc,%esp
     e6d:	68 00 20 00 00       	push   $0x2000
     e72:	e8 d9 04 00 00       	call   1350 <malloc>
  }
}
...
void lock_release(lock_t *lock){
  lock->turn = lock->turn + 1;
	...
	if((uint)stack % PGSIZE)
     ...
     e80:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
     e86:	74 07                	je     e8f <thread_create+0x6f>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
     e88:	29 d0                	sub    %edx,%eax
     e8a:	05 00 10 00 00       	add    $0x1000,%eax
	int result = clone(start_routine,arg1, arg2 ,stack);
     e8f:	50                   	push   %eax
     e90:	ff 75 10             	push   0x10(%ebp)
     e93:	ff 75 0c             	push   0xc(%ebp)
     e96:	ff 75 08             	push   0x8(%ebp)
     e99:	e8 b6 01 00 00       	call   1054 <clone>
}
...
int thread_join(){
     ...
     eb3:	56                   	push   %esi
     eb4:	53                   	push   %ebx
     eb5:	83 ec 1c             	sub    $0x1c,%esp
	void *stack = malloc(sizeof(void*));
     eb8:	6a 04                	push   $0x4
     eba:	e8 91 04 00 00       	call   1350 <malloc>
     ebf:	89 45 ec             	mov    %eax,-0x14(%ebp)
	int result= join(&stack);
     ec2:	8d 45 ec             	lea    -0x14(%ebp),%eax
     ec5:	89 04 24             	mov    %eax,(%esp)
     ec8:	e8 8f 01 00 00       	call   105c <join>
  lock->ticket = 0;
     ecd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
	int result= join(&stack);
     ed4:	89 c6                	mov    %eax,%esi
  lock->turn = 0;
     ed6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
     edd:	b8 01 00 00 00       	mov    $0x1,%eax
     ee2:	f0 0f c1 45 f0       	lock xadd %eax,-0x10(%ebp)
  while(lock->turn != myturn){
     ee7:	8b 55 f4             	mov    -0xc(%ebp),%edx
     eea:	83 c4 10             	add    $0x10,%esp
     eed:	39 c2                	cmp    %eax,%edx
     eef:	74 21                	je     f12 <thread_join+0x62>
    ...
    printf(1,"ulib lock value %d\n",lock->turn);
     ...
     efb:	52                   	push   %edx
     efc:	68 30 15 00 00       	push   $0x1530
     f01:	6a 01                	push   $0x1
     f03:	e8 18 02 00 00       	call   1120 <printf>
  while(lock->turn != myturn){
     f08:	8b 55 f4             	mov    -0xc(%ebp),%edx
     f0b:	83 c4 10             	add    $0x10,%esp
     f0e:	39 d3                	cmp    %edx,%ebx
     f10:	75 e6                	jne    ef8 <thread_join+0x48>
	free(stack);
     f12:	83 ec 0c             	sub    $0xc,%esp
     f15:	ff 75 ec             	push   -0x14(%ebp)
     f18:	e8 a3 03 00 00       	call   12c0 <free>
}
     f1d:	8d 65 f8             	lea    -0x8(%ebp),%esp
     f20:	89 f0                	mov    %esi,%eax
     f22:	5b                   	pop    %ebx
     f23:	5e                   	pop    %esi
     f24:	5d                   	pop    %ebp
     f25:	c3                   	ret    
...
void lock_init(lock_t *lock) {
  ...
  lock->ticket = 0;
     f36:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
     f3c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
     f43:	5d                   	pop    %ebp
     f44:	c3                   	ret    
...
00000f50 <lock_acquire>:
void lock_acquire(lock_t *lock){
     f50:	55                   	push   %ebp
     f51:	b8 01 00 00 00       	mov    $0x1,%eax
     f56:	89 e5                	mov    %esp,%ebp
     f58:	56                   	push   %esi
     f59:	8b 75 08             	mov    0x8(%ebp),%esi
     f5c:	53                   	push   %ebx
     f5d:	f0 0f c1 06          	lock xadd %eax,(%esi)
  while(lock->turn != myturn){
     f61:	8b 56 04             	mov    0x4(%esi),%edx
     f64:	39 d0                	cmp    %edx,%eax
     f66:	74 22                	je     f8a <lock_acquire+0x3a>
     f68:	89 c3                	mov    %eax,%ebx
     f6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    printf(1,"ulib lock value %d\n",lock->turn);
     f70:	83 ec 04             	sub    $0x4,%esp
     f73:	52                   	push   %edx
     f74:	68 30 15 00 00       	push   $0x1530
     f79:	6a 01                	push   $0x1
     f7b:	e8 a0 01 00 00       	call   1120 <printf>
  while(lock->turn != myturn){
     f80:	8b 56 04             	mov    0x4(%esi),%edx
     f83:	83 c4 10             	add    $0x10,%esp
     f86:	39 da                	cmp    %ebx,%edx
     f88:	75 e6                	jne    f70 <lock_acquire+0x20>
}
     f8a:	8d 65 f8             	lea    -0x8(%ebp),%esp
     f8d:	5b                   	pop    %ebx
     f8e:	5e                   	pop    %esi
     f8f:	5d                   	pop    %ebp
     f90:	c3                   	ret    
...
00000fa0 <lock_release>:
void lock_release(lock_t *lock){
     fa0:	55                   	push   %ebp
     fa1:	89 e5                	mov    %esp,%ebp
     fa3:	8b 45 08             	mov    0x8(%ebp),%eax
  lock->turn = lock->turn + 1;
     fa6:	83 40 04 01          	addl   $0x1,0x4(%eax)
     faa:	5d                   	pop    %ebp
     fab:	c3                   	ret    
...
SYSCALL(fork)
     fac:	b8 01 00 00 00       	mov    $0x1,%eax
     fb1:	cd 40                	int    $0x40
     fb3:	c3                   	ret    

00000fb4 <exit>:
SYSCALL(exit)
     fb4:	b8 02 00 00 00       	mov    $0x2,%eax
     fb9:	cd 40                	int    $0x40
     fbb:	c3                   	ret    

00000fbc <wait>:
SYSCALL(wait)
     fbc:	b8 03 00 00 00       	mov    $0x3,%eax
     fc1:	cd 40                	int    $0x40
     fc3:	c3                   	ret    

00000fc4 <pipe>:
SYSCALL(pipe)
     fc4:	b8 04 00 00 00       	mov    $0x4,%eax
     fc9:	cd 40                	int    $0x40
     fcb:	c3                   	ret    

00000fcc <read>:
SYSCALL(read)
     fcc:	b8 05 00 00 00       	mov    $0x5,%eax
     fd1:	cd 40                	int    $0x40
     fd3:	c3                   	ret    

00000fd4 <write>:
SYSCALL(write)
     fd4:	b8 10 00 00 00       	mov    $0x10,%eax
     fd9:	cd 40                	int    $0x40
     fdb:	c3                   	ret    

00000fdc <close>:
SYSCALL(close)
     fdc:	b8 15 00 00 00       	mov    $0x15,%eax
     fe1:	cd 40                	int    $0x40
     fe3:	c3                   	ret    

00000fe4 <kill>:
SYSCALL(kill)
     fe4:	b8 06 00 00 00       	mov    $0x6,%eax
     fe9:	cd 40                	int    $0x40
     feb:	c3                   	ret    

00000fec <exec>:
SYSCALL(exec)
     fec:	b8 07 00 00 00       	mov    $0x7,%eax
     ff1:	cd 40                	int    $0x40
     ff3:	c3                   	ret    

00000ff4 <open>:
SYSCALL(open)
     ff4:	b8 0f 00 00 00       	mov    $0xf,%eax
     ff9:	cd 40                	int    $0x40
     ffb:	c3                   	ret    

00000ffc <mknod>:
SYSCALL(mknod)
     ffc:	b8 11 00 00 00       	mov    $0x11,%eax
    1001:	cd 40                	int    $0x40
    1003:	c3                   	ret    

00001004 <unlink>:
SYSCALL(unlink)
    1004:	b8 12 00 00 00       	mov    $0x12,%eax
    1009:	cd 40                	int    $0x40
    100b:	c3                   	ret    

0000100c <fstat>:
SYSCALL(fstat)
    100c:	b8 08 00 00 00       	mov    $0x8,%eax
    1011:	cd 40                	int    $0x40
    1013:	c3                   	ret    

00001014 <link>:
SYSCALL(link)
    1014:	b8 13 00 00 00       	mov    $0x13,%eax
    1019:	cd 40                	int    $0x40
    101b:	c3                   	ret    

0000101c <mkdir>:
SYSCALL(mkdir)
    101c:	b8 14 00 00 00       	mov    $0x14,%eax
    1021:	cd 40                	int    $0x40
    1023:	c3                   	ret    

00001024 <chdir>:
SYSCALL(chdir)
    1024:	b8 09 00 00 00       	mov    $0x9,%eax
    1029:	cd 40                	int    $0x40
    102b:	c3                   	ret    

0000102c <dup>:
SYSCALL(dup)
    102c:	b8 0a 00 00 00       	mov    $0xa,%eax
    1031:	cd 40                	int    $0x40
    1033:	c3                   	ret    

00001034 <getpid>:
SYSCALL(getpid)
    1034:	b8 0b 00 00 00       	mov    $0xb,%eax
    1039:	cd 40                	int    $0x40
    103b:	c3                   	ret    

0000103c <sbrk>:
SYSCALL(sbrk)
    103c:	b8 0c 00 00 00       	mov    $0xc,%eax
    1041:	cd 40                	int    $0x40
    1043:	c3                   	ret    

00001044 <sleep>:
SYSCALL(sleep)
    1044:	b8 0d 00 00 00       	mov    $0xd,%eax
    1049:	cd 40                	int    $0x40
    104b:	c3                   	ret    

0000104c <uptime>:
SYSCALL(uptime)
    104c:	b8 0e 00 00 00       	mov    $0xe,%eax
    1051:	cd 40                	int    $0x40
    1053:	c3                   	ret    

00001054 <clone>:
SYSCALL(clone)
    1054:	b8 16 00 00 00       	mov    $0x16,%eax
    1059:	cd 40                	int    $0x40
    105b:	c3                   	ret    

0000105c <join>:
SYSCALL(join)
    105c:	b8 17 00 00 00       	mov    $0x17,%eax
    1061:	cd 40                	int    $0x40
    1063:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    1074:	56                   	push   %esi
    1075:	53                   	push   %ebx
    1076:	83 ec 3c             	sub    $0x3c,%esp
    1079:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    107c:	89 d1                	mov    %edx,%ecx
{
    107e:	89 45 b8             	mov    %eax,-0x48(%ebp)
  if(sgn && xx < 0){
    1081:	85 d2                	test   %edx,%edx
    1083:	0f 89 7f 00 00 00    	jns    1108 <printint+0x98>
    1089:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    108d:	74 79                	je     1108 <printint+0x98>
    neg = 1;
    108f:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    x = -xx;
    1096:	f7 d9                	neg    %ecx
  } else {
    x = xx;
  ...
  i = 0;
    ...
    109a:	8d 75 d7             	lea    -0x29(%ebp),%esi
    109d:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    10a0:	89 c8                	mov    %ecx,%eax
    10a2:	31 d2                	xor    %edx,%edx
    10a4:	89 cf                	mov    %ecx,%edi
    10a6:	f7 75 c4             	divl   -0x3c(%ebp)
    10a9:	0f b6 92 a4 15 00 00 	movzbl 0x15a4(%edx),%edx
    10b0:	89 45 c0             	mov    %eax,-0x40(%ebp)
    10b3:	89 d8                	mov    %ebx,%eax
    10b5:	8d 5b 01             	lea    0x1(%ebx),%ebx
  }while((x /= base) != 0);
    10b8:	8b 4d c0             	mov    -0x40(%ebp),%ecx
    buf[i++] = digits[x % base];
    10bb:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
    10be:	39 7d c4             	cmp    %edi,-0x3c(%ebp)
    10c1:	76 dd                	jbe    10a0 <printint+0x30>
  if(neg)
    10c3:	8b 4d bc             	mov    -0x44(%ebp),%ecx
    10c6:	85 c9                	test   %ecx,%ecx
    10c8:	74 0c                	je     10d6 <printint+0x66>
    buf[i++] = '-';
    10ca:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    buf[i++] = digits[x % base];
    10cf:	89 d8                	mov    %ebx,%eax
    buf[i++] = '-';
    10d1:	ba 2d 00 00 00       	mov    $0x2d,%edx

  while(--i >= 0)
    10d6:	8b 7d b8             	mov    -0x48(%ebp),%edi
    10d9:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    10dd:	eb 07                	jmp    10e6 <printint+0x76>
    10df:	90                   	nop
    putc(fd, buf[i]);
    10e0:	0f b6 13             	movzbl (%ebx),%edx
    10e3:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
    10e6:	83 ec 04             	sub    $0x4,%esp
    10e9:	88 55 d7             	mov    %dl,-0x29(%ebp)
    10ec:	6a 01                	push   $0x1
    10ee:	56                   	push   %esi
    10ef:	57                   	push   %edi
    10f0:	e8 df fe ff ff       	call   fd4 <write>
  while(--i >= 0)
    10f5:	83 c4 10             	add    $0x10,%esp
    10f8:	39 de                	cmp    %ebx,%esi
    10fa:	75 e4                	jne    10e0 <printint+0x70>
}
  ...
  neg = 0;
    1108:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
    110f:	eb 87                	jmp    1098 <printint+0x28>
    1111:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1118:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    111f:	90                   	nop
...
{
    112c:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    112f:	0f b6 13             	movzbl (%ebx),%edx
    1132:	84 d2                	test   %dl,%dl
    1134:	74 6a                	je     11a0 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    1136:	8d 45 10             	lea    0x10(%ebp),%eax
    1139:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    113c:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    113f:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    1141:	89 45 d0             	mov    %eax,-0x30(%ebp)
    1144:	eb 36                	jmp    117c <printf+0x5c>
    1146:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    114d:	8d 76 00             	lea    0x0(%esi),%esi
    1150:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    1153:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    1158:	83 f8 25             	cmp    $0x25,%eax
    115b:	74 15                	je     1172 <printf+0x52>
  write(fd, &c, 1);
    115d:	83 ec 04             	sub    $0x4,%esp
    1160:	88 55 e7             	mov    %dl,-0x19(%ebp)
    1163:	6a 01                	push   $0x1
    1165:	57                   	push   %edi
    1166:	56                   	push   %esi
    1167:	e8 68 fe ff ff       	call   fd4 <write>
    116c:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    116f:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    1172:	0f b6 13             	movzbl (%ebx),%edx
    1175:	83 c3 01             	add    $0x1,%ebx
    1178:	84 d2                	test   %dl,%dl
    117a:	74 24                	je     11a0 <printf+0x80>
    c = fmt[i] & 0xff;
    117c:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    117f:	85 c9                	test   %ecx,%ecx
    1181:	74 cd                	je     1150 <printf+0x30>
      }
    } else if(state == '%'){
    1183:	83 f9 25             	cmp    $0x25,%ecx
    1186:	75 ea                	jne    1172 <printf+0x52>
      if(c == 'd'){
    1188:	83 f8 25             	cmp    $0x25,%eax
    118b:	0f 84 07 01 00 00    	je     1298 <printf+0x178>
    1191:	83 e8 63             	sub    $0x63,%eax
    1194:	83 f8 15             	cmp    $0x15,%eax
    1197:	77 17                	ja     11b0 <printf+0x90>
    1199:	ff 24 85 4c 15 00 00 	jmp    *0x154c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    11b3:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    11b6:	6a 01                	push   $0x1
    11b8:	57                   	push   %edi
    11b9:	56                   	push   %esi
    11ba:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    11be:	e8 11 fe ff ff       	call   fd4 <write>
        putc(fd, c);
    11c3:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    11c7:	83 c4 0c             	add    $0xc,%esp
    11ca:	88 55 e7             	mov    %dl,-0x19(%ebp)
    11cd:	6a 01                	push   $0x1
    11cf:	57                   	push   %edi
    11d0:	56                   	push   %esi
    11d1:	e8 fe fd ff ff       	call   fd4 <write>
        putc(fd, c);
    11d6:	83 c4 10             	add    $0x10,%esp
      state = 0;
    11d9:	31 c9                	xor    %ecx,%ecx
    11db:	eb 95                	jmp    1172 <printf+0x52>
    11dd:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    11e0:	83 ec 0c             	sub    $0xc,%esp
    11e3:	b9 10 00 00 00       	mov    $0x10,%ecx
    11e8:	6a 00                	push   $0x0
    11ea:	8b 45 d0             	mov    -0x30(%ebp),%eax
    11ed:	8b 10                	mov    (%eax),%edx
    11ef:	89 f0                	mov    %esi,%eax
    11f1:	e8 7a fe ff ff       	call   1070 <printint>
        ap++;
    11f6:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    11fa:	83 c4 10             	add    $0x10,%esp
      state = 0;
    11fd:	31 c9                	xor    %ecx,%ecx
    11ff:	e9 6e ff ff ff       	jmp    1172 <printf+0x52>
    1204:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    1208:	8b 45 d0             	mov    -0x30(%ebp),%eax
    120b:	8b 10                	mov    (%eax),%edx
        ap++;
    120d:	83 c0 04             	add    $0x4,%eax
    1210:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    1213:	85 d2                	test   %edx,%edx
    1215:	0f 84 8d 00 00 00    	je     12a8 <printf+0x188>
        while(*s != 0){
    121b:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    121e:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    1220:	84 c0                	test   %al,%al
    1222:	0f 84 4a ff ff ff    	je     1172 <printf+0x52>
    1228:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    122b:	89 d3                	mov    %edx,%ebx
  ...
  write(fd, &c, 1);
    ...
    123b:	57                   	push   %edi
    123c:	56                   	push   %esi
    123d:	e8 92 fd ff ff       	call   fd4 <write>
        while(*s != 0){
    1242:	0f b6 03             	movzbl (%ebx),%eax
    1245:	83 c4 10             	add    $0x10,%esp
    1248:	84 c0                	test   %al,%al
    124a:	75 e4                	jne    1230 <printf+0x110>
      state = 0;
    124c:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    124f:	31 c9                	xor    %ecx,%ecx
    1251:	e9 1c ff ff ff       	jmp    1172 <printf+0x52>
    ...
    1268:	6a 01                	push   $0x1
    126a:	e9 7b ff ff ff       	jmp    11ea <printf+0xca>
    126f:	90                   	nop
        putc(fd, *ap);
  ...
  write(fd, &c, 1);
    ...
    127b:	56                   	push   %esi
        putc(fd, *ap);
    127c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    127f:	e8 50 fd ff ff       	call   fd4 <write>
        ap++;
    1284:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    1288:	83 c4 10             	add    $0x10,%esp
      state = 0;
    128b:	31 c9                	xor    %ecx,%ecx
    128d:	e9 e0 fe ff ff       	jmp    1172 <printf+0x52>
    1292:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    1298:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    129b:	83 ec 04             	sub    $0x4,%esp
    129e:	e9 2a ff ff ff       	jmp    11cd <printf+0xad>
    12a3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    12a7:	90                   	nop
          s = "(null)";
    12a8:	ba 44 15 00 00       	mov    $0x1544,%edx
        while(*s != 0){
    12ad:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    12b0:	b8 28 00 00 00       	mov    $0x28,%eax
    12b5:	89 d3                	mov    %edx,%ebx
    12b7:	e9 74 ff ff ff       	jmp    1230 <printf+0x110>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12c1:	a1 a4 1c 00 00       	mov    0x1ca4,%eax
{
  ...
  freep = p;
    ...
    1301:	5b                   	pop    %ebx
  freep = p;
    1302:	89 15 a4 1c 00 00    	mov    %edx,0x1ca4
}
    1308:	5e                   	pop    %esi
    1309:	5f                   	pop    %edi
    130a:	5d                   	pop    %ebp
  ...
  freep = p;
    133c:	89 15 a4 1c 00 00    	mov    %edx,0x1ca4
    p->s.size += bp->s.size;
    1342:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    1345:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    1348:	89 0a                	mov    %ecx,(%edx)
}
    134a:	5b                   	pop    %ebx
    134b:	5e                   	pop    %esi
    134c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    135c:	8b 3d a4 1c 00 00    	mov    0x1ca4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1373:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    1375:	8b 4a 04             	mov    0x4(%edx),%ecx
    1378:	39 f1                	cmp    %esi,%ecx
    137a:	73 6a                	jae    13e6 <malloc+0x96>
    137c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1381:	39 de                	cmp    %ebx,%esi
    1383:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    1386:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    138d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1390:	eb 17                	jmp    13a9 <malloc+0x59>
    1392:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1398:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    139a:	8b 48 04             	mov    0x4(%eax),%ecx
    139d:	39 f1                	cmp    %esi,%ecx
    139f:	73 4f                	jae    13f0 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    13a1:	8b 3d a4 1c 00 00    	mov    0x1ca4,%edi
    13a7:	89 c2                	mov    %eax,%edx
    13a9:	39 d7                	cmp    %edx,%edi
    13ab:	75 eb                	jne    1398 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    13ad:	83 ec 0c             	sub    $0xc,%esp
    13b0:	ff 75 e4             	push   -0x1c(%ebp)
    13b3:	e8 84 fc ff ff       	call   103c <sbrk>
  if(p == (char*)-1)
    13b8:	83 c4 10             	add    $0x10,%esp
    13bb:	83 f8 ff             	cmp    $0xffffffff,%eax
    13be:	74 1c                	je     13dc <malloc+0x8c>
  hp->s.size = nu;
    13c0:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    13c3:	83 ec 0c             	sub    $0xc,%esp
    13c6:	83 c0 08             	add    $0x8,%eax
    13c9:	50                   	push   %eax
    13ca:	e8 f1 fe ff ff       	call   12c0 <free>
  return freep;
    13cf:	8b 15 a4 1c 00 00    	mov    0x1ca4,%edx
      if((p = morecore(nunits)) == 0)
    13d5:	83 c4 10             	add    $0x10,%esp
    13d8:	85 d2                	test   %edx,%edx
    13da:	75 bc                	jne    1398 <malloc+0x48>
        return 0;
  }
}
    ...
    13e8:	89 fa                	mov    %edi,%edx
    13ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    13f0:	39 ce                	cmp    %ecx,%esi
    13f2:	74 4c                	je     1440 <malloc+0xf0>
        p->s.size -= nunits;
    13f4:	29 f1                	sub    %esi,%ecx
    13f6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    13f9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    13fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    13ff:	89 15 a4 1c 00 00    	mov    %edx,0x1ca4
}
    ...
    140f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1410:	c7 05 a4 1c 00 00 a8 	movl   $0x1ca8,0x1ca4
    1417:	1c 00 00 
    base.s.size = 0;
    141a:	bf a8 1c 00 00       	mov    $0x1ca8,%edi
    base.s.ptr = freep = prevp = &base;
    141f:	c7 05 a8 1c 00 00 a8 	movl   $0x1ca8,0x1ca8
    1426:	1c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1429:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    142b:	c7 05 ac 1c 00 00 00 	movl   $0x0,0x1cac
    1432:	00 00 00 
    if(p->s.size >= nunits){
    1435:	e9 42 ff ff ff       	jmp    137c <malloc+0x2c>
    143a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    1440:	8b 08                	mov    (%eax),%ecx
    1442:	89 0a                	mov    %ecx,(%edx)
    1444:	eb b9                	jmp    13ff <malloc+0xaf>
