...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      24:	6a 02                	push   $0x2
      26:	68 99 14 00 00       	push   $0x1499
      2b:	e8 76 0f 00 00       	call   fa6 <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 09 0f 00 00       	call   f5e <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 07 0f 00 00       	call   f6e <wait>
  printf(2, "$ ");
      67:	83 ec 08             	sub    $0x8,%esp
      6a:	68 f8 13 00 00       	push   $0x13f8
      6f:	6a 02                	push   $0x2
      71:	e8 5a 10 00 00       	call   10d0 <printf>
  memset(buf, 0, nbuf);
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 d3 0e 00 00       	call   f8e <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 e1 0e 00 00       	call   fd6 <chdir>
     ...
     106:	68 a1 14 00 00       	push   $0x14a1
     10b:	6a 02                	push   $0x2
     10d:	e8 be 0f 00 00       	call   10d0 <printf>
     112:	83 c4 10             	add    $0x10,%esp
     115:	e9 4d ff ff ff       	jmp    67 <main+0x67>
  exit();
     11a:	e8 47 0e 00 00       	call   f66 <exit>
    panic("fork");
     11f:	83 ec 0c             	sub    $0xc,%esp
     122:	68 fb 13 00 00       	push   $0x13fb
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 f8 13 00 00       	push   $0x13f8
     143:	6a 02                	push   $0x2
     145:	e8 86 0f 00 00       	call   10d0 <printf>
  memset(buf, 0, nbuf);
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 95 14 00 00       	push   $0x1495
     17e:	6a 02                	push   $0x2
     180:	e8 4b 0f 00 00       	call   10d0 <printf>
  exit();
     185:	e8 dc 0d 00 00       	call   f66 <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 c3 0d 00 00       	call   f5e <fork>
  if(pid == -1)
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 fb 13 00 00       	push   $0x13fb
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 b0 14 00 00 	jmp    *0x14b0(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 bb 0d 00 00       	call   f9e <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     1e3:	83 c4 0c             	add    $0xc,%esp
     1e6:	ff 73 04             	push   0x4(%ebx)
     1e9:	68 07 14 00 00       	push   $0x1407
     1ee:	6a 02                	push   $0x2
     1f0:	e8 db 0e 00 00       	call   10d0 <printf>
    break;
     1f5:	83 c4 10             	add    $0x10,%esp
     1f8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     1ff:	90                   	nop
    exit();
     200:	e8 61 0d 00 00       	call   f66 <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 57 0d 00 00       	call   f76 <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 3f 0d 00 00       	call   f8e <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 36 0d 00 00       	call   f8e <close>
    wait();
     258:	e8 11 0d 00 00       	call   f6e <wait>
    wait();
     25d:	e8 0c 0d 00 00       	call   f6e <wait>
    break;
    ...
    wait();
     270:	e8 f9 0c 00 00       	call   f6e <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 03 0d 00 00       	call   f8e <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 0e 0d 00 00       	call   fa6 <open>
    ...
    panic("runcmd");
     ...
     2ad:	68 00 14 00 00       	push   $0x1400
     2b2:	e8 b9 fe ff ff       	call   170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2b7:	51                   	push   %ecx
     2b8:	ff 73 08             	push   0x8(%ebx)
     2bb:	68 17 14 00 00       	push   $0x1417
     2c0:	6a 02                	push   $0x2
     2c2:	e8 09 0e 00 00       	call   10d0 <printf>
      exit();
     2c7:	e8 9a 0c 00 00       	call   f66 <exit>
      panic("pipe");
     2cc:	83 ec 0c             	sub    $0xc,%esp
     2cf:	68 27 14 00 00       	push   $0x1427
     2d4:	e8 97 fe ff ff       	call   170 <panic>
      close(1);
     2d9:	83 ec 0c             	sub    $0xc,%esp
     2dc:	6a 01                	push   $0x1
     2de:	e8 ab 0c 00 00       	call   f8e <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 f2 0c 00 00       	call   fde <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 99 0c 00 00       	call   f8e <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 90 0c 00 00       	call   f8e <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 7d 0c 00 00       	call   f8e <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 c4 0c 00 00       	call   fde <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 6b 0c 00 00       	call   f8e <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 62 0c 00 00       	call   f8e <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     347:	6a 54                	push   $0x54
     349:	e8 b2 0f 00 00       	call   1300 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     377:	6a 18                	push   $0x18
     379:	e8 82 0f 00 00       	call   1300 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3c7:	6a 0c                	push   $0xc
     3c9:	e8 32 0f 00 00       	call   1300 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     407:	6a 0c                	push   $0xc
     409:	e8 f2 0e 00 00       	call   1300 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     447:	6a 08                	push   $0x8
     449:	e8 b2 0e 00 00       	call   1300 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 49 14 00 00       	push   $0x1449
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 2c 14 00 00       	push   $0x142c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 4c 14 00 00       	push   $0x144c
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 63 14 00 00       	push   $0x1463
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 55 14 00 00       	push   $0x1455
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 4e 14 00 00       	push   $0x144e
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 68 14 00 00       	push   $0x1468
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 6a 14 00 00       	push   $0x146a
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 66 14 00 00       	push   $0x1466
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 4c 14 00 00       	push   $0x144c
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 88 14 00 00       	push   $0x1488
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 c8 14 00 00 	jmp    *0x14c8(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 16 14 00 00       	push   $0x1416
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 8a 14 00 00       	push   $0x148a
     bb5:	6a 02                	push   $0x2
     bb7:	e8 14 05 00 00       	call   10d0 <printf>
    panic("syntax");
     bbc:	c7 04 24 4e 14 00 00 	movl   $0x144e,(%esp)
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 71 02 00 00       	call   f7e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 34 02 00 00       	call   fa6 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 37 02 00 00       	call   fbe <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 fd 01 00 00       	call   f8e <close>
  return r;
...
void lock_acquire(lock_t *lock){
  // The xchg is atomic.
    while(xchg(&(lock->mutex), 1) != 0);
     ...
     e3b:	75 f3                	jne    e30 <thread_create+0x10>
    __sync_synchronize();
     e3d:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	void *stack= malloc(PGSIZE*2);
     e42:	83 ec 0c             	sub    $0xc,%esp
     e45:	68 00 20 00 00       	push   $0x2000
     e4a:	e8 b1 04 00 00       	call   1300 <malloc>
}

void lock_release(lock_t *lock){
   __sync_synchronize();
     e4f:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
     e54:	c7 05 48 1c 00 00 00 	movl   $0x0,0x1c48
     e5b:	00 00 00 
	if((uint)stack % PGSIZE)
     e5e:	89 c2                	mov    %eax,%edx
     e60:	83 c4 10             	add    $0x10,%esp
     e63:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
     e69:	74 07                	je     e72 <thread_create+0x52>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
     e6b:	29 d0                	sub    %edx,%eax
     e6d:	05 00 10 00 00       	add    $0x1000,%eax
	int result = clone(start_routine,arg1, arg2 ,stack);
     e72:	50                   	push   %eax
     e73:	ff 75 10             	push   0x10(%ebp)
     e76:	ff 75 0c             	push   0xc(%ebp)
     e79:	ff 75 08             	push   0x8(%ebp)
     e7c:	e8 85 01 00 00       	call   1006 <clone>
}
     e81:	c9                   	leave  
     e82:	c3                   	ret    
     e83:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
int thread_join(){
	...
	int result= join(&stack);
     e94:	8d 45 f4             	lea    -0xc(%ebp),%eax
int thread_join(){
     e97:	83 ec 20             	sub    $0x20,%esp
	void *stack = 0;
     e9a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int result= join(&stack);
     ea1:	50                   	push   %eax
     ea2:	e8 67 01 00 00       	call   100e <join>
    while(xchg(&(lock->mutex), 1) != 0);
     ea7:	83 c4 10             	add    $0x10,%esp
     eaa:	ba 01 00 00 00       	mov    $0x1,%edx
	int result= join(&stack);
     eaf:	89 c3                	mov    %eax,%ebx
    while(xchg(&(lock->mutex), 1) != 0);
     eb1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     eb8:	89 d0                	mov    %edx,%eax
     eba:	f0 87 05 44 1c 00 00 	lock xchg %eax,0x1c44
     ec1:	85 c0                	test   %eax,%eax
     ec3:	75 f3                	jne    eb8 <thread_join+0x28>
    __sync_synchronize();
     ec5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	free(stack);
     eca:	83 ec 0c             	sub    $0xc,%esp
     ecd:	ff 75 f4             	push   -0xc(%ebp)
     ed0:	e8 9b 03 00 00       	call   1270 <free>
   __sync_synchronize();
     ed5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
     eda:	c7 05 44 1c 00 00 00 	movl   $0x0,0x1c44
     ee1:	00 00 00 
}
     ee4:	89 d8                	mov    %ebx,%eax
     ee6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
     ee9:	c9                   	leave  
     eea:	c3                   	ret    
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
     ef0:	c7 05 48 1c 00 00 00 	movl   $0x0,0x1c48
     ef7:	00 00 00 
     efa:	c7 05 44 1c 00 00 00 	movl   $0x0,0x1c44
     f01:	00 00 00 
}
     f04:	c3                   	ret    
     f05:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     f0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

00000f10 <lock_acquire>:
void lock_acquire(lock_t *lock){
     f10:	55                   	push   %ebp
     f11:	b9 01 00 00 00       	mov    $0x1,%ecx
     f16:	89 e5                	mov    %esp,%ebp
     f18:	8b 55 08             	mov    0x8(%ebp),%edx
     f1b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     f1f:	90                   	nop
     f20:	89 c8                	mov    %ecx,%eax
     f22:	f0 87 02             	lock xchg %eax,(%edx)
    while(xchg(&(lock->mutex), 1) != 0);
     f25:	85 c0                	test   %eax,%eax
     f27:	75 f7                	jne    f20 <lock_acquire+0x10>
    __sync_synchronize();
     f29:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
     f2e:	5d                   	pop    %ebp
     f2f:	c3                   	ret    

00000f30 <lock_release>:
void lock_release(lock_t *lock){
     f30:	55                   	push   %ebp
     f31:	89 e5                	mov    %esp,%ebp
     f33:	8b 45 08             	mov    0x8(%ebp),%eax
   __sync_synchronize();
     f36:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
     f3b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
     f41:	5d                   	pop    %ebp
     f42:	c3                   	ret    
     f43:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
void lock_init(lock_t *lock) {
  ...
  lock->mutex = 0;
     ...
     f56:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
     f5c:	5d                   	pop    %ebp
     f5d:	c3                   	ret    
...
0000100e <join>:
SYSCALL(join)
    100e:	b8 17 00 00 00       	mov    $0x17,%eax
    1013:	cd 40                	int    $0x40
    1015:	c3                   	ret    
    ...
    102c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1059:	0f b6 92 40 15 00 00 	movzbl 0x1540(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    109e:	56                   	push   %esi
    109f:	57                   	push   %edi
    10a0:	e8 e1 fe ff ff       	call   f86 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    10d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    10dc:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    10df:	0f b6 13             	movzbl (%ebx),%edx
    10e2:	84 d2                	test   %dl,%dl
    10e4:	74 6a                	je     1150 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    10e6:	8d 45 10             	lea    0x10(%ebp),%eax
    10e9:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    10ec:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    10ef:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    10f1:	89 45 d0             	mov    %eax,-0x30(%ebp)
    10f4:	eb 36                	jmp    112c <printf+0x5c>
    10f6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    10fd:	8d 76 00             	lea    0x0(%esi),%esi
    1100:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    1103:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    1108:	83 f8 25             	cmp    $0x25,%eax
    110b:	74 15                	je     1122 <printf+0x52>
  write(fd, &c, 1);
    110d:	83 ec 04             	sub    $0x4,%esp
    1110:	88 55 e7             	mov    %dl,-0x19(%ebp)
    1113:	6a 01                	push   $0x1
    1115:	57                   	push   %edi
    1116:	56                   	push   %esi
    1117:	e8 6a fe ff ff       	call   f86 <write>
    111c:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    111f:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    1122:	0f b6 13             	movzbl (%ebx),%edx
    1125:	83 c3 01             	add    $0x1,%ebx
    1128:	84 d2                	test   %dl,%dl
    112a:	74 24                	je     1150 <printf+0x80>
    c = fmt[i] & 0xff;
    112c:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    112f:	85 c9                	test   %ecx,%ecx
    1131:	74 cd                	je     1100 <printf+0x30>
      }
    } else if(state == '%'){
    1133:	83 f9 25             	cmp    $0x25,%ecx
    1136:	75 ea                	jne    1122 <printf+0x52>
      if(c == 'd'){
    1138:	83 f8 25             	cmp    $0x25,%eax
    113b:	0f 84 07 01 00 00    	je     1248 <printf+0x178>
    1141:	83 e8 63             	sub    $0x63,%eax
    1144:	83 f8 15             	cmp    $0x15,%eax
    1147:	77 17                	ja     1160 <printf+0x90>
    1149:	ff 24 85 e8 14 00 00 	jmp    *0x14e8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1163:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    1166:	6a 01                	push   $0x1
    1168:	57                   	push   %edi
    1169:	56                   	push   %esi
    116a:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    116e:	e8 13 fe ff ff       	call   f86 <write>
        putc(fd, c);
    1173:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    1177:	83 c4 0c             	add    $0xc,%esp
    117a:	88 55 e7             	mov    %dl,-0x19(%ebp)
    117d:	6a 01                	push   $0x1
    117f:	57                   	push   %edi
    1180:	56                   	push   %esi
    1181:	e8 00 fe ff ff       	call   f86 <write>
        putc(fd, c);
    1186:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1189:	31 c9                	xor    %ecx,%ecx
    118b:	eb 95                	jmp    1122 <printf+0x52>
    118d:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    1190:	83 ec 0c             	sub    $0xc,%esp
    1193:	b9 10 00 00 00       	mov    $0x10,%ecx
    1198:	6a 00                	push   $0x0
    119a:	8b 45 d0             	mov    -0x30(%ebp),%eax
    119d:	8b 10                	mov    (%eax),%edx
    119f:	89 f0                	mov    %esi,%eax
    11a1:	e8 7a fe ff ff       	call   1020 <printint>
        ap++;
    11a6:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    11aa:	83 c4 10             	add    $0x10,%esp
      state = 0;
    11ad:	31 c9                	xor    %ecx,%ecx
    11af:	e9 6e ff ff ff       	jmp    1122 <printf+0x52>
    11b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    11b8:	8b 45 d0             	mov    -0x30(%ebp),%eax
    11bb:	8b 10                	mov    (%eax),%edx
        ap++;
    11bd:	83 c0 04             	add    $0x4,%eax
    11c0:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    11c3:	85 d2                	test   %edx,%edx
    11c5:	0f 84 8d 00 00 00    	je     1258 <printf+0x188>
        while(*s != 0){
    11cb:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    11ce:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    11d0:	84 c0                	test   %al,%al
    11d2:	0f 84 4a ff ff ff    	je     1122 <printf+0x52>
    11d8:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
  ...
  write(fd, &c, 1);
    ...
    11eb:	57                   	push   %edi
    11ec:	56                   	push   %esi
    11ed:	e8 94 fd ff ff       	call   f86 <write>
        while(*s != 0){
    11f2:	0f b6 03             	movzbl (%ebx),%eax
    11f5:	83 c4 10             	add    $0x10,%esp
    11f8:	84 c0                	test   %al,%al
    11fa:	75 e4                	jne    11e0 <printf+0x110>
      state = 0;
    11fc:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    11ff:	31 c9                	xor    %ecx,%ecx
    1201:	e9 1c ff ff ff       	jmp    1122 <printf+0x52>
    ...
    1218:	6a 01                	push   $0x1
    121a:	e9 7b ff ff ff       	jmp    119a <printf+0xca>
    121f:	90                   	nop
        putc(fd, *ap);
    1220:	8b 45 d0             	mov    -0x30(%ebp),%eax
  write(fd, &c, 1);
  ...
  write(fd, &c, 1);
    122f:	e8 52 fd ff ff       	call   f86 <write>
        ap++;
    1234:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    1238:	83 c4 10             	add    $0x10,%esp
      state = 0;
    123b:	31 c9                	xor    %ecx,%ecx
    123d:	e9 e0 fe ff ff       	jmp    1122 <printf+0x52>
    1242:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    1248:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    124b:	83 ec 04             	sub    $0x4,%esp
    124e:	e9 2a ff ff ff       	jmp    117d <printf+0xad>
    1253:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1257:	90                   	nop
          s = "(null)";
    1258:	ba e0 14 00 00       	mov    $0x14e0,%edx
        while(*s != 0){
    125d:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    1260:	b8 28 00 00 00       	mov    $0x28,%eax
    1265:	89 d3                	mov    %edx,%ebx
    1267:	e9 74 ff ff ff       	jmp    11e0 <printf+0x110>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1271:	a1 4c 1c 00 00       	mov    0x1c4c,%eax
{
    1276:	89 e5                	mov    %esp,%ebp
    1278:	57                   	push   %edi
    1279:	56                   	push   %esi
    127a:	53                   	push   %ebx
    127b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bp = (Header*)ap - 1;
    127e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1281:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1288:	89 c2                	mov    %eax,%edx
    128a:	8b 00                	mov    (%eax),%eax
    128c:	39 ca                	cmp    %ecx,%edx
    128e:	73 30                	jae    12c0 <free+0x50>
    1290:	39 c1                	cmp    %eax,%ecx
    1292:	72 04                	jb     1298 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1294:	39 c2                	cmp    %eax,%edx
    1296:	72 f0                	jb     1288 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    1298:	8b 73 fc             	mov    -0x4(%ebx),%esi
    129b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    129e:	39 f8                	cmp    %edi,%eax
    12a0:	74 30                	je     12d2 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    12a2:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    12a5:	8b 42 04             	mov    0x4(%edx),%eax
    12a8:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    12ab:	39 f1                	cmp    %esi,%ecx
    12ad:	74 3a                	je     12e9 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    12af:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    12b1:	5b                   	pop    %ebx
  freep = p;
    12b2:	89 15 4c 1c 00 00    	mov    %edx,0x1c4c
}
    12b8:	5e                   	pop    %esi
    12b9:	5f                   	pop    %edi
    12ba:	5d                   	pop    %ebp
    ...
    12c2:	72 c4                	jb     1288 <free+0x18>
    12c4:	39 c1                	cmp    %eax,%ecx
    12c6:	73 c0                	jae    1288 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    12c8:	8b 73 fc             	mov    -0x4(%ebx),%esi
    12cb:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    12ce:	39 f8                	cmp    %edi,%eax
    12d0:	75 d0                	jne    12a2 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    12d2:	03 70 04             	add    0x4(%eax),%esi
    12d5:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    12d8:	8b 02                	mov    (%edx),%eax
    12da:	8b 00                	mov    (%eax),%eax
    12dc:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    12df:	8b 42 04             	mov    0x4(%edx),%eax
    12e2:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    12e5:	39 f1                	cmp    %esi,%ecx
    12e7:	75 c6                	jne    12af <free+0x3f>
    p->s.size += bp->s.size;
    12e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    12ec:	89 15 4c 1c 00 00    	mov    %edx,0x1c4c
    p->s.size += bp->s.size;
    12f2:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    12f5:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    12f8:	89 0a                	mov    %ecx,(%edx)
}
    12fa:	5b                   	pop    %ebx
    12fb:	5e                   	pop    %esi
    12fc:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    130c:	8b 3d 4c 1c 00 00    	mov    0x1c4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1312:	8d 70 07             	lea    0x7(%eax),%esi
    1315:	c1 ee 03             	shr    $0x3,%esi
    1318:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    131b:	85 ff                	test   %edi,%edi
    131d:	0f 84 9d 00 00 00    	je     13c0 <malloc+0xc0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1323:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    1325:	8b 4a 04             	mov    0x4(%edx),%ecx
    1328:	39 f1                	cmp    %esi,%ecx
    132a:	73 6a                	jae    1396 <malloc+0x96>
    132c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1331:	39 de                	cmp    %ebx,%esi
    1333:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    1336:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    133d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1340:	eb 17                	jmp    1359 <malloc+0x59>
    1342:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1348:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    134a:	8b 48 04             	mov    0x4(%eax),%ecx
    134d:	39 f1                	cmp    %esi,%ecx
    134f:	73 4f                	jae    13a0 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1351:	8b 3d 4c 1c 00 00    	mov    0x1c4c,%edi
    1357:	89 c2                	mov    %eax,%edx
    1359:	39 d7                	cmp    %edx,%edi
    135b:	75 eb                	jne    1348 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    135d:	83 ec 0c             	sub    $0xc,%esp
    1360:	ff 75 e4             	push   -0x1c(%ebp)
    1363:	e8 86 fc ff ff       	call   fee <sbrk>
  if(p == (char*)-1)
    1368:	83 c4 10             	add    $0x10,%esp
    136b:	83 f8 ff             	cmp    $0xffffffff,%eax
    136e:	74 1c                	je     138c <malloc+0x8c>
  hp->s.size = nu;
    1370:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    1373:	83 ec 0c             	sub    $0xc,%esp
    1376:	83 c0 08             	add    $0x8,%eax
    1379:	50                   	push   %eax
    137a:	e8 f1 fe ff ff       	call   1270 <free>
  return freep;
    137f:	8b 15 4c 1c 00 00    	mov    0x1c4c,%edx
      if((p = morecore(nunits)) == 0)
    1385:	83 c4 10             	add    $0x10,%esp
    1388:	85 d2                	test   %edx,%edx
    138a:	75 bc                	jne    1348 <malloc+0x48>
        return 0;
  }
}
    ...
    139a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    13a0:	39 ce                	cmp    %ecx,%esi
    13a2:	74 4c                	je     13f0 <malloc+0xf0>
        p->s.size -= nunits;
    13a4:	29 f1                	sub    %esi,%ecx
    13a6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    13a9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    13ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    13af:	89 15 4c 1c 00 00    	mov    %edx,0x1c4c
}
    ...
    13bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    13c0:	c7 05 4c 1c 00 00 50 	movl   $0x1c50,0x1c4c
    13c7:	1c 00 00 
    base.s.size = 0;
    13ca:	bf 50 1c 00 00       	mov    $0x1c50,%edi
    base.s.ptr = freep = prevp = &base;
    13cf:	c7 05 50 1c 00 00 50 	movl   $0x1c50,0x1c50
    13d6:	1c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    13d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    13db:	c7 05 54 1c 00 00 00 	movl   $0x0,0x1c54
    13e2:	00 00 00 
    if(p->s.size >= nunits){
    13e5:	e9 42 ff ff ff       	jmp    132c <malloc+0x2c>
    13ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    13f0:	8b 08                	mov    (%eax),%ecx
    13f2:	89 0a                	mov    %ecx,(%edx)
    13f4:	eb b9                	jmp    13af <malloc+0xaf>
