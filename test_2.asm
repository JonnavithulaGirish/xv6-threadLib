...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
   ppid = getpid();
  13:	e8 0e 06 00 00       	call   626 <getpid>
   void *stack, *p = malloc(PGSIZE * 2);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 b8 0e 00 00       	mov    %eax,0xeb8
   void *stack, *p = malloc(PGSIZE * 2);
  25:	e8 16 09 00 00       	call   940 <malloc>
   assert(p != NULL);
  ...
  55:	e8 ec 05 00 00       	call   646 <clone>
   assert(clone_pid > 0);
  ...
  92:	6a 28                	push   $0x28
  94:	68 38 0a 00 00       	push   $0xa38
  99:	68 41 0a 00 00       	push   $0xa41
  9e:	6a 01                	push   $0x1
  a0:	e8 6b 06 00 00       	call   710 <printf>
  a5:	83 c4 0c             	add    $0xc,%esp
  a8:	68 99 0a 00 00       	push   $0xa99
   assert(clone_pid > 0);
  ad:	68 55 0a 00 00       	push   $0xa55
  b2:	6a 01                	push   $0x1
  b4:	e8 57 06 00 00       	call   710 <printf>
  b9:	5a                   	pop    %edx
  ba:	59                   	pop    %ecx
  bb:	68 69 0a 00 00       	push   $0xa69
  c0:	6a 01                	push   $0x1
  c2:	e8 49 06 00 00       	call   710 <printf>
  c7:	5b                   	pop    %ebx
  c8:	ff 35 b8 0e 00 00    	push   0xeb8
  ce:	e8 03 05 00 00       	call   5d6 <kill>
  d3:	e8 ce 04 00 00       	call   5a6 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  eb:	68 41 0a 00 00       	push   $0xa41
  f0:	6a 01                	push   $0x1
  f2:	e8 19 06 00 00       	call   710 <printf>
  f7:	83 c4 0c             	add    $0xc,%esp
  fa:	68 8e 0a 00 00       	push   $0xa8e
  ff:	eb ac                	jmp    ad <main+0xad>
   assert(clone_pid > 0);
 101:	6a 25                	push   $0x25
 103:	68 38 0a 00 00       	push   $0xa38
 108:	68 41 0a 00 00       	push   $0xa41
 10d:	6a 01                	push   $0x1
 10f:	e8 fc 05 00 00       	call   710 <printf>
 114:	83 c4 0c             	add    $0xc,%esp
 117:	68 80 0a 00 00       	push   $0xa80
 11c:	eb 8f                	jmp    ad <main+0xad>
   assert(p != NULL);
 11e:	6a 1e                	push   $0x1e
 120:	68 38 0a 00 00       	push   $0xa38
 125:	68 41 0a 00 00       	push   $0xa41
 12a:	6a 01                	push   $0x1
 12c:	e8 df 05 00 00       	call   710 <printf>
 131:	83 c4 0c             	add    $0xc,%esp
 134:	68 76 0a 00 00       	push   $0xa76
 139:	e9 6f ff ff ff       	jmp    ad <main+0xad>
   printf(1, "TEST PASSED\n");
 13e:	50                   	push   %eax
 13f:	50                   	push   %eax
 140:	68 a4 0a 00 00       	push   $0xaa4
 145:	6a 01                	push   $0x1
 147:	e8 c4 05 00 00       	call   710 <printf>
   
   void *join_stack;
   int join_pid = join(&join_stack);
 14c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
 14f:	89 04 24             	mov    %eax,(%esp)
 152:	e8 f7 04 00 00       	call   64e <join>
   assert(join_pid == clone_pid);
 157:	83 c4 10             	add    $0x10,%esp
 15a:	39 c6                	cmp    %eax,%esi
 15c:	74 20                	je     17e <main+0x17e>
 15e:	6a 2d                	push   $0x2d
 160:	68 38 0a 00 00       	push   $0xa38
 165:	68 41 0a 00 00       	push   $0xa41
 16a:	6a 01                	push   $0x1
 16c:	e8 9f 05 00 00       	call   710 <printf>
 171:	83 c4 0c             	add    $0xc,%esp
 174:	68 b1 0a 00 00       	push   $0xab1
 179:	e9 2f ff ff ff       	jmp    ad <main+0xad>
   free(p);
 17e:	83 ec 0c             	sub    $0xc,%esp
 181:	53                   	push   %ebx
 182:	e8 29 07 00 00       	call   8b0 <free>
   exit();
 187:	e8 1a 04 00 00       	call   5a6 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1b7:	6a 38                	push   $0x38
 1b9:	68 38 0a 00 00       	push   $0xa38
 1be:	68 41 0a 00 00       	push   $0xa41
 1c3:	6a 01                	push   $0x1
 1c5:	e8 46 05 00 00       	call   710 <printf>
 1ca:	83 c4 0c             	add    $0xc,%esp
 1cd:	68 49 0a 00 00       	push   $0xa49
 1d2:	68 55 0a 00 00       	push   $0xa55
 1d7:	6a 01                	push   $0x1
 1d9:	e8 32 05 00 00       	call   710 <printf>
 1de:	58                   	pop    %eax
 1df:	5a                   	pop    %edx
 1e0:	68 69 0a 00 00       	push   $0xa69
 1e5:	6a 01                	push   $0x1
 1e7:	e8 24 05 00 00       	call   710 <printf>
 1ec:	59                   	pop    %ecx
 1ed:	ff 35 b8 0e 00 00    	push   0xeb8
 1f3:	e8 de 03 00 00       	call   5d6 <kill>
 1f8:	e8 a9 03 00 00       	call   5a6 <exit>
   global = tmp1 + tmp2;
 1fd:	01 d9                	add    %ebx,%ecx
 1ff:	89 0d ac 0e 00 00    	mov    %ecx,0xeac
   exit();
 205:	e8 9c 03 00 00       	call   5a6 <exit>
 ...
 339:	31 db                	xor    %ebx,%ebx
{
 ...
 345:	57                   	push   %edi
 346:	6a 00                	push   $0x0
 348:	e8 71 02 00 00       	call   5be <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3ad:	e8 34 02 00 00       	call   5e6 <open>
  if(fd < 0)
 ...
 3c1:	50                   	push   %eax
 3c2:	e8 37 02 00 00       	call   5fe <fstat>
  close(fd);
 3c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 3ca:	89 c6                	mov    %eax,%esi
  close(fd);
 3cc:	e8 fd 01 00 00       	call   5ce <close>
  return r;
...
void lock_acquire(lock_t *lock){
 ...
 47b:	75 f3                	jne    470 <thread_create+0x10>
    __sync_synchronize();
 47d:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	void *stack= malloc(PGSIZE*2);
 482:	83 ec 0c             	sub    $0xc,%esp
 485:	68 00 20 00 00       	push   $0x2000
 48a:	e8 b1 04 00 00       	call   940 <malloc>
}

void lock_release(lock_t *lock){
   __sync_synchronize();
 48f:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 494:	c7 05 c0 0e 00 00 00 	movl   $0x0,0xec0
 49b:	00 00 00 
	if((uint)stack % PGSIZE)
 49e:	89 c2                	mov    %eax,%edx
 4a0:	83 c4 10             	add    $0x10,%esp
 4a3:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 4a9:	74 07                	je     4b2 <thread_create+0x52>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
 4ab:	29 d0                	sub    %edx,%eax
 4ad:	05 00 10 00 00       	add    $0x1000,%eax
 ...
 4bc:	e8 85 01 00 00       	call   646 <clone>
}
 4c1:	c9                   	leave  
 4c2:	c3                   	ret    
...
int thread_join(){
 ...
 4da:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int result= join(&stack);
 4e1:	50                   	push   %eax
 4e2:	e8 67 01 00 00       	call   64e <join>
    while(xchg(&(lock->mutex), 1) != 0);
 ...
 4fa:	f0 87 05 bc 0e 00 00 	lock xchg %eax,0xebc
 501:	85 c0                	test   %eax,%eax
 503:	75 f3                	jne    4f8 <thread_join+0x28>
    __sync_synchronize();
 505:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	free(stack);
 50a:	83 ec 0c             	sub    $0xc,%esp
 50d:	ff 75 f4             	push   -0xc(%ebp)
 510:	e8 9b 03 00 00       	call   8b0 <free>
   __sync_synchronize();
 515:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 51a:	c7 05 bc 0e 00 00 00 	movl   $0x0,0xebc
 521:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 530:	c7 05 c0 0e 00 00 00 	movl   $0x0,0xec0
 537:	00 00 00 
 53a:	c7 05 bc 0e 00 00 00 	movl   $0x0,0xebc
 541:	00 00 00 
}
 544:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 567:	75 f7                	jne    560 <lock_acquire+0x10>
    __sync_synchronize();
 569:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
 56e:	5d                   	pop    %ebp
 56f:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 573:	8b 45 08             	mov    0x8(%ebp),%eax
   __sync_synchronize();
 576:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 57b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 581:	5d                   	pop    %ebp
 582:	c3                   	ret    
...
000005a6 <exit>:
SYSCALL(exit)
 5a6:	b8 02 00 00 00       	mov    $0x2,%eax
 5ab:	cd 40                	int    $0x40
 5ad:	c3                   	ret    

000005ae <wait>:
SYSCALL(wait)
 5ae:	b8 03 00 00 00       	mov    $0x3,%eax
 5b3:	cd 40                	int    $0x40
 5b5:	c3                   	ret    

000005b6 <pipe>:
SYSCALL(pipe)
 5b6:	b8 04 00 00 00       	mov    $0x4,%eax
 5bb:	cd 40                	int    $0x40
 5bd:	c3                   	ret    

000005be <read>:
SYSCALL(read)
 5be:	b8 05 00 00 00       	mov    $0x5,%eax
 5c3:	cd 40                	int    $0x40
 5c5:	c3                   	ret    

000005c6 <write>:
SYSCALL(write)
 5c6:	b8 10 00 00 00       	mov    $0x10,%eax
 5cb:	cd 40                	int    $0x40
 5cd:	c3                   	ret    

000005ce <close>:
SYSCALL(close)
 5ce:	b8 15 00 00 00       	mov    $0x15,%eax
 5d3:	cd 40                	int    $0x40
 5d5:	c3                   	ret    

000005d6 <kill>:
SYSCALL(kill)
 5d6:	b8 06 00 00 00       	mov    $0x6,%eax
 5db:	cd 40                	int    $0x40
 5dd:	c3                   	ret    

000005de <exec>:
SYSCALL(exec)
 5de:	b8 07 00 00 00       	mov    $0x7,%eax
 5e3:	cd 40                	int    $0x40
 5e5:	c3                   	ret    

000005e6 <open>:
SYSCALL(open)
 5e6:	b8 0f 00 00 00       	mov    $0xf,%eax
 5eb:	cd 40                	int    $0x40
 5ed:	c3                   	ret    

000005ee <mknod>:
SYSCALL(mknod)
 5ee:	b8 11 00 00 00       	mov    $0x11,%eax
 5f3:	cd 40                	int    $0x40
 5f5:	c3                   	ret    

000005f6 <unlink>:
SYSCALL(unlink)
 5f6:	b8 12 00 00 00       	mov    $0x12,%eax
 5fb:	cd 40                	int    $0x40
 5fd:	c3                   	ret    

000005fe <fstat>:
SYSCALL(fstat)
 5fe:	b8 08 00 00 00       	mov    $0x8,%eax
 603:	cd 40                	int    $0x40
 605:	c3                   	ret    

00000606 <link>:
SYSCALL(link)
 606:	b8 13 00 00 00       	mov    $0x13,%eax
 60b:	cd 40                	int    $0x40
 60d:	c3                   	ret    

0000060e <mkdir>:
SYSCALL(mkdir)
 60e:	b8 14 00 00 00       	mov    $0x14,%eax
 613:	cd 40                	int    $0x40
 615:	c3                   	ret    

00000616 <chdir>:
SYSCALL(chdir)
 616:	b8 09 00 00 00       	mov    $0x9,%eax
 61b:	cd 40                	int    $0x40
 61d:	c3                   	ret    

0000061e <dup>:
SYSCALL(dup)
 61e:	b8 0a 00 00 00       	mov    $0xa,%eax
 623:	cd 40                	int    $0x40
 625:	c3                   	ret    

00000626 <getpid>:
SYSCALL(getpid)
 626:	b8 0b 00 00 00       	mov    $0xb,%eax
 62b:	cd 40                	int    $0x40
 62d:	c3                   	ret    

0000062e <sbrk>:
SYSCALL(sbrk)
 62e:	b8 0c 00 00 00       	mov    $0xc,%eax
 633:	cd 40                	int    $0x40
 635:	c3                   	ret    

00000636 <sleep>:
SYSCALL(sleep)
 636:	b8 0d 00 00 00       	mov    $0xd,%eax
 63b:	cd 40                	int    $0x40
 63d:	c3                   	ret    

0000063e <uptime>:
SYSCALL(uptime)
 63e:	b8 0e 00 00 00       	mov    $0xe,%eax
 643:	cd 40                	int    $0x40
 645:	c3                   	ret    

00000646 <clone>:
SYSCALL(clone)
 646:	b8 16 00 00 00       	mov    $0x16,%eax
 64b:	cd 40                	int    $0x40
 64d:	c3                   	ret    

0000064e <join>:
SYSCALL(join)
 64e:	b8 17 00 00 00       	mov    $0x17,%eax
 653:	cd 40                	int    $0x40
 655:	c3                   	ret    
 ...
 66c:	89 d1                	mov    %edx,%ecx
{
 ...
 699:	0f b6 92 28 0b 00 00 	movzbl 0xb28(%edx),%edx
 ...
 6de:	56                   	push   %esi
 6df:	57                   	push   %edi
 6e0:	e8 e1 fe ff ff       	call   5c6 <write>
  while(--i >= 0)
 ...
 719:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 755:	57                   	push   %edi
 756:	56                   	push   %esi
 757:	e8 6a fe ff ff       	call   5c6 <write>
 ...
 789:	ff 24 85 d0 0a 00 00 	jmp    *0xad0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7ae:	e8 13 fe ff ff       	call   5c6 <write>
        putc(fd, c);
 ...
 7bf:	57                   	push   %edi
 7c0:	56                   	push   %esi
 7c1:	e8 00 fe ff ff       	call   5c6 <write>
        putc(fd, c);
 ...
 82b:	57                   	push   %edi
 82c:	56                   	push   %esi
 82d:	e8 94 fd ff ff       	call   5c6 <write>
        while(*s != 0){
 ...
 86c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 86f:	e8 52 fd ff ff       	call   5c6 <write>
        ap++;
 ...
 897:	90                   	nop
          s = "(null)";
 898:	ba c7 0a 00 00       	mov    $0xac7,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8b1:	a1 c4 0e 00 00       	mov    0xec4,%eax
{
 ...
 8f1:	5b                   	pop    %ebx
  freep = p;
 8f2:	89 15 c4 0e 00 00    	mov    %edx,0xec4
}
 8f8:	5e                   	pop    %esi
 8f9:	5f                   	pop    %edi
 8fa:	5d                   	pop    %ebp
 ...
 929:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 92c:	89 15 c4 0e 00 00    	mov    %edx,0xec4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 949:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 94c:	8b 3d c4 0e 00 00    	mov    0xec4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 98f:	73 4f                	jae    9e0 <malloc+0xa0>
    ...
    if(p == freep)
 991:	8b 3d c4 0e 00 00    	mov    0xec4,%edi
 ...
 9a3:	e8 86 fc ff ff       	call   62e <sbrk>
  if(p == (char*)-1)
 ...
 9ba:	e8 f1 fe ff ff       	call   8b0 <free>
  return freep;
 9bf:	8b 15 c4 0e 00 00    	mov    0xec4,%edx
 ...
 9ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9ef:	89 15 c4 0e 00 00    	mov    %edx,0xec4
}
 ...
 9ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a00:	c7 05 c4 0e 00 00 c8 	movl   $0xec8,0xec4
 a07:	0e 00 00 
    base.s.size = 0;
 a0a:	bf c8 0e 00 00       	mov    $0xec8,%edi
    base.s.ptr = freep = prevp = &base;
 a0f:	c7 05 c8 0e 00 00 c8 	movl   $0xec8,0xec8
 a16:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a19:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a1b:	c7 05 cc 0e 00 00 00 	movl   $0x0,0xecc
 a22:	00 00 00 
    if(p->s.size >= nunits){
