...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 ab 05 00 00       	call   5c4 <getpid>
  ...
  60:	c7 45 e0 18 00 00 00 	movl   $0x18,-0x20(%ebp)
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  67:	e8 78 05 00 00       	call   5e4 <clone>
   assert(clone_pid > 0);
  ...
  7b:	50                   	push   %eax
  7c:	e8 6b 05 00 00       	call   5ec <join>
  ...
  bd:	5b                   	pop    %ebx
  be:	ff 35 60 0e 00 00    	push   0xe60
  c4:	e8 ab 04 00 00       	call   574 <kill>
  c9:	e8 76 04 00 00       	call   544 <exit>
  ce:	6a 25                	push   $0x25
 ...
 10b:	eb 96                	jmp    a3 <main+0xa3>
   assert(global == 2);
 10d:	83 3d 5c 0e 00 00 02 	cmpl   $0x2,0xe5c
 ...
 167:	e8 e4 06 00 00       	call   850 <free>
   exit();
 16c:	e8 d3 03 00 00       	call   544 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 196:	75 2a                	jne    1c2 <worker+0x42>
   assert(global == 1);
 198:	83 3d 5c 0e 00 00 01 	cmpl   $0x1,0xe5c
 ...
 1f7:	59                   	pop    %ecx
 1f8:	ff 35 60 0e 00 00    	push   0xe60
 1fe:	e8 71 03 00 00       	call   574 <kill>
 203:	e8 3c 03 00 00       	call   544 <exit>
   assert(tmp1 == 42);
 208:	6a 36                	push   $0x36
 ...
 223:	eb b8                	jmp    1dd <worker+0x5d>
   global++;
 225:	c7 05 5c 0e 00 00 02 	movl   $0x2,0xe5c
 22c:	00 00 00 
   exit();
