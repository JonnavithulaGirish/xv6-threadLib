...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 fd 05 00 00       	call   614 <getpid>
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 2);
  51:	83 3d b4 0e 00 00 02 	cmpl   $0x2,0xeb4
  ...
  91:	68 8c 0a 00 00       	push   $0xa8c
  96:	68 45 0a 00 00       	push   $0xa45
  9b:	6a 01                	push   $0x1
  9d:	e8 5e 06 00 00       	call   700 <printf>
  a2:	5a                   	pop    %edx
  a3:	59                   	pop    %ecx
  a4:	68 59 0a 00 00       	push   $0xa59
  a9:	6a 01                	push   $0x1
  ab:	e8 50 06 00 00       	call   700 <printf>
  b0:	5b                   	pop    %ebx
  b1:	ff 35 b8 0e 00 00    	push   0xeb8
  b7:	e8 08 05 00 00       	call   5c4 <kill>
  bc:	e8 d3 04 00 00       	call   594 <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  ...
  d7:	68 7d 0a 00 00       	push   $0xa7d
  dc:	eb b8                	jmp    96 <main+0x96>

   printf(1, "TEST PASSED\n");
  de:	50                   	push   %eax
  df:	50                   	push   %eax
  e0:	68 af 0a 00 00       	push   $0xaaf
  e5:	6a 01                	push   $0x1
  e7:	e8 14 06 00 00       	call   700 <printf>
   exit();
  ec:	e8 a3 04 00 00       	call   594 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 116:	75 78                	jne    190 <worker+0x90>
   assert(global == 1);
 118:	83 3d b4 0e 00 00 01 	cmpl   $0x1,0xeb4
 11f:	75 52                	jne    173 <worker+0x73>
   global++;
 121:	c7 05 b4 0e 00 00 02 	movl   $0x2,0xeb4
 128:	00 00 00 
   // no exit() in thread
}
 12b:	c9                   	leave  
 ...
 143:	68 3a 0a 00 00       	push   $0xa3a
   assert(tmp2 == 24);
 148:	68 45 0a 00 00       	push   $0xa45
 14d:	6a 01                	push   $0x1
 14f:	e8 ac 05 00 00       	call   700 <printf>
 154:	58                   	pop    %eax
 155:	5a                   	pop    %edx
 156:	68 59 0a 00 00       	push   $0xa59
 15b:	6a 01                	push   $0x1
 15d:	e8 9e 05 00 00       	call   700 <printf>
 162:	59                   	pop    %ecx
 163:	ff 35 b8 0e 00 00    	push   0xeb8
 169:	e8 56 04 00 00       	call   5c4 <kill>
 16e:	e8 21 04 00 00       	call   594 <exit>
   assert(global == 1);
 173:	6a 2e                	push   $0x2e
 ...
 65c:	89 d1                	mov    %edx,%ecx
{
 ...
 689:	0f b6 92 30 0b 00 00 	movzbl 0xb30(%edx),%edx
 ...
 709:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 779:	ff 24 85 d8 0a 00 00 	jmp    *0xad8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 887:	90                   	nop
          s = "(null)";
 888:	ba d0 0a 00 00       	mov    $0xad0,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 bc 0e 00 00       	mov    0xebc,%eax
{
 ...
 8e1:	5b                   	pop    %ebx
  freep = p;
 8e2:	89 15 bc 0e 00 00    	mov    %edx,0xebc
}
 8e8:	5e                   	pop    %esi
 8e9:	5f                   	pop    %edi
 8ea:	5d                   	pop    %ebp
 ...
 919:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 91c:	89 15 bc 0e 00 00    	mov    %edx,0xebc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 939:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 93c:	8b 3d bc 0e 00 00    	mov    0xebc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 97f:	73 4f                	jae    9d0 <malloc+0xa0>
    ...
    if(p == freep)
 981:	8b 3d bc 0e 00 00    	mov    0xebc,%edi
 ...
 9aa:	e8 f1 fe ff ff       	call   8a0 <free>
  return freep;
 9af:	8b 15 bc 0e 00 00    	mov    0xebc,%edx
 ...
 9dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9df:	89 15 bc 0e 00 00    	mov    %edx,0xebc
}
 ...
 9ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 bc 0e 00 00 c0 	movl   $0xec0,0xebc
 9f7:	0e 00 00 
    base.s.size = 0;
 9fa:	bf c0 0e 00 00       	mov    $0xec0,%edi
    base.s.ptr = freep = prevp = &base;
 9ff:	c7 05 c0 0e 00 00 c0 	movl   $0xec0,0xec0
 a06:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
