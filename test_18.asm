...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 42 06 00 00       	call   656 <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 14 0f 00 00       	push   $0xf14
   ppid = getpid();
  1c:	a3 1c 0f 00 00       	mov    %eax,0xf1c
   lock_init(&lock);
  21:	e8 9a 05 00 00       	call   5c0 <lock_init>
  ...
  70:	6a 01                	push   $0x1
  72:	e8 c9 06 00 00       	call   740 <printf>
  77:	83 c4 0c             	add    $0xc,%esp
  7a:	68 81 0a 00 00       	push   $0xa81
   }

   for (i = 0; i < num_threads; i++) {
      int join_pid = thread_join();
      assert(join_pid > 0);
  7f:	68 90 0a 00 00       	push   $0xa90
  84:	6a 01                	push   $0x1
  86:	e8 b5 06 00 00       	call   740 <printf>
  8b:	5a                   	pop    %edx
  8c:	59                   	pop    %ecx
  8d:	68 a4 0a 00 00       	push   $0xaa4
  92:	6a 01                	push   $0x1
  94:	e8 a7 06 00 00       	call   740 <printf>
  99:	5b                   	pop    %ebx
  9a:	ff 35 1c 0f 00 00    	push   0xf1c
  a0:	e8 61 05 00 00       	call   606 <kill>
  a5:	e8 2c 05 00 00       	call   5d6 <exit>
   for (i = 0; i < num_threads; i++) {
 ...
 11d:	e8 1e 06 00 00       	call   740 <printf>
   exit();
 122:	e8 af 04 00 00       	call   5d6 <exit>
...
void worker2(void *arg1,void *arg2){
 ...
 133:	83 ec 14             	sub    $0x14,%esp
    int j;
    lock_acquire(&lock);
 136:	68 14 0f 00 00       	push   $0xf14
 13b:	e8 40 04 00 00       	call   580 <lock_acquire>
    for(j=0;j<50;j++);
    global++;
    lock_release(&lock);
 140:	c7 04 24 14 0f 00 00 	movl   $0xf14,(%esp)
    global++;
 147:	83 05 18 0f 00 00 01 	addl   $0x1,0xf18
    lock_release(&lock);
 14e:	e8 4d 04 00 00       	call   5a0 <lock_release>
    exit();
 153:	e8 7e 04 00 00       	call   5d6 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 164:	83 ec 10             	sub    $0x10,%esp
    ...
    lock_acquire(&lock);
 167:	68 14 0f 00 00       	push   $0xf14
 16c:	e8 0f 04 00 00       	call   580 <lock_acquire>
    int j;
    for(j = 0; j < 50; j++); // take some time
    global++;
    lock_release(&lock);
 171:	c7 04 24 14 0f 00 00 	movl   $0xf14,(%esp)
    global++;
 178:	83 05 18 0f 00 00 01 	addl   $0x1,0xf18
    lock_release(&lock);
 17f:	e8 1c 04 00 00       	call   5a0 <lock_release>
 ...
 1af:	6a 4b                	push   $0x4b
 1b1:	68 68 0a 00 00       	push   $0xa68
 1b6:	68 72 0a 00 00       	push   $0xa72
 1bb:	6a 01                	push   $0x1
 1bd:	e8 7e 05 00 00       	call   740 <printf>
 1c2:	83 c4 0c             	add    $0xc,%esp
 1c5:	68 ec 0a 00 00       	push   $0xaec
    assert(nested_join_pid > 0);
 1ca:	68 90 0a 00 00       	push   $0xa90
 1cf:	6a 01                	push   $0x1
 1d1:	e8 6a 05 00 00       	call   740 <printf>
 1d6:	58                   	pop    %eax
 1d7:	5a                   	pop    %edx
 1d8:	68 a4 0a 00 00       	push   $0xaa4
 1dd:	6a 01                	push   $0x1
 1df:	e8 5c 05 00 00       	call   740 <printf>
 1e4:	59                   	pop    %ecx
 1e5:	ff 35 1c 0f 00 00    	push   0xf1c
 1eb:	e8 16 04 00 00       	call   606 <kill>
 1f0:	e8 e1 03 00 00       	call   5d6 <exit>
    assert(nested_thread_pid > 0);
 1f5:	6a 47                	push   $0x47
 1f7:	68 68 0a 00 00       	push   $0xa68
 1fc:	68 72 0a 00 00       	push   $0xa72
 201:	6a 01                	push   $0x1
 203:	e8 38 05 00 00       	call   740 <printf>
 208:	83 c4 0c             	add    $0xc,%esp
 20b:	68 7a 0a 00 00       	push   $0xa7a
 210:	eb b8                	jmp    1ca <worker+0x6a>
    assert(nested_join_pid > 0);
 212:	6a 49                	push   $0x49
 214:	68 68 0a 00 00       	push   $0xa68
 219:	68 72 0a 00 00       	push   $0xa72
 21e:	6a 01                	push   $0x1
 220:	e8 1b 05 00 00       	call   740 <printf>
 225:	83 c4 0c             	add    $0xc,%esp
 228:	68 b1 0a 00 00       	push   $0xab1
...
xchg(volatile uint *addr, uint newval)
{
 ...
 4a2:	f0 87 05 24 0f 00 00 	lock xchg %eax,0xf24
  lock_init(&lk_join);
}
...
void lock_release(lock_t *lock){
 ...
 4c4:	c7 05 24 0f 00 00 00 	movl   $0x0,0xf24
 4cb:	00 00 00 
...
int thread_join(){
 ...
 52a:	f0 87 05 20 0f 00 00 	lock xchg %eax,0xf20
 ...
 545:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 54a:	c7 05 20 0f 00 00 00 	movl   $0x0,0xf20
 551:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 560:	c7 05 24 0f 00 00 00 	movl   $0x0,0xf24
 567:	00 00 00 
 56a:	c7 05 20 0f 00 00 00 	movl   $0x0,0xf20
 571:	00 00 00 
}
 574:	c3                   	ret    
 ...
 69c:	89 d1                	mov    %edx,%ecx
{
 ...
 6c9:	0f b6 92 70 0b 00 00 	movzbl 0xb70(%edx),%edx
 ...
 749:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7b9:	ff 24 85 18 0b 00 00 	jmp    *0xb18(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8c7:	90                   	nop
          s = "(null)";
 8c8:	ba 0f 0b 00 00       	mov    $0xb0f,%edx
        while(*s != 0){
