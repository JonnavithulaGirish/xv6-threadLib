...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 90 06 00 00       	call   6a4 <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 74 0f 00 00       	push   $0xf74
   ppid = getpid();
  1c:	a3 80 0f 00 00       	mov    %eax,0xf80
   lock_init(&lock);
  21:	e8 7a 05 00 00       	call   5a0 <lock_init>

   int i;
   for (i = 0; i < num_threads; i++) {
  26:	a1 70 0f 00 00       	mov    0xf70,%eax
  ...
  40:	a1 70 0f 00 00       	mov    0xf70,%eax
  ...
  70:	6a 01                	push   $0x1
  72:	e8 19 07 00 00       	call   790 <printf>
  77:	83 c4 0c             	add    $0xc,%esp
  7a:	68 d1 0a 00 00       	push   $0xad1
   }

   for (i = 0; i < num_threads; i++) {
      int join_pid = thread_join();
      assert(join_pid > 0);
  7f:	68 e0 0a 00 00       	push   $0xae0
  84:	6a 01                	push   $0x1
  86:	e8 05 07 00 00       	call   790 <printf>
  8b:	5a                   	pop    %edx
  8c:	59                   	pop    %ecx
  8d:	68 f4 0a 00 00       	push   $0xaf4
  92:	6a 01                	push   $0x1
  94:	e8 f7 06 00 00       	call   790 <printf>
  99:	5b                   	pop    %ebx
  9a:	ff 35 80 0f 00 00    	push   0xf80
  a0:	e8 af 05 00 00       	call   654 <kill>
  a5:	e8 7a 05 00 00       	call   624 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 70 0f 00 00       	mov    0xf70,%eax
  bd:	83 c3 01             	add    $0x1,%ebx
  c0:	39 d8                	cmp    %ebx,%eax
  c2:	7e 26                	jle    ea <main+0xea>
      int join_pid = thread_join();
  c4:	e8 57 04 00 00       	call   520 <thread_join>
      assert(join_pid > 0);
  c9:	85 c0                	test   %eax,%eax
  cb:	7f eb                	jg     b8 <main+0xb8>
  cd:	6a 2b                	push   $0x2b
  cf:	68 b8 0a 00 00       	push   $0xab8
  d4:	68 c2 0a 00 00       	push   $0xac2
  d9:	6a 01                	push   $0x1
  db:	e8 b0 06 00 00       	call   790 <printf>
  e0:	83 c4 0c             	add    $0xc,%esp
  e3:	68 08 0b 00 00       	push   $0xb08
  e8:	eb 95                	jmp    7f <main+0x7f>
   }

   assert(global == num_threads * 2);
  ea:	01 c0                	add    %eax,%eax
  ec:	3b 05 7c 0f 00 00    	cmp    0xf7c,%eax
  f2:	74 20                	je     114 <main+0x114>
  f4:	6a 2e                	push   $0x2e
  f6:	68 b8 0a 00 00       	push   $0xab8
  fb:	68 c2 0a 00 00       	push   $0xac2
 100:	6a 01                	push   $0x1
 102:	e8 89 06 00 00       	call   790 <printf>
 107:	83 c4 0c             	add    $0xc,%esp
 10a:	68 15 0b 00 00       	push   $0xb15
 ...
 11b:	6a 01                	push   $0x1
 11d:	e8 6e 06 00 00       	call   790 <printf>
   exit();
 122:	e8 fd 04 00 00       	call   624 <exit>
...
void worker2(void *arg1,void *arg2){
 ...
 133:	83 ec 14             	sub    $0x14,%esp
    int j;
    lock_acquire(&lock);
 136:	68 74 0f 00 00       	push   $0xf74
 13b:	e8 80 04 00 00       	call   5c0 <lock_acquire>
    for(j=0;j<50;j++);
    global++;
    lock_release(&lock);
 140:	c7 04 24 74 0f 00 00 	movl   $0xf74,(%esp)
    global++;
 147:	83 05 7c 0f 00 00 01 	addl   $0x1,0xf7c
    lock_release(&lock);
 14e:	e8 bd 04 00 00       	call   610 <lock_release>
    exit();
 153:	e8 cc 04 00 00       	call   624 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 164:	83 ec 10             	sub    $0x10,%esp
    ...
    lock_acquire(&lock);
 167:	68 74 0f 00 00       	push   $0xf74
 16c:	e8 4f 04 00 00       	call   5c0 <lock_acquire>
    int j;
    for(j = 0; j < 50; j++); // take some time
    global++;
    lock_release(&lock);
 171:	c7 04 24 74 0f 00 00 	movl   $0xf74,(%esp)
    global++;
 178:	83 05 7c 0f 00 00 01 	addl   $0x1,0xf7c
    lock_release(&lock);
 17f:	e8 8c 04 00 00       	call   610 <lock_release>
 ...
 19e:	e8 7d 03 00 00       	call   520 <thread_join>
 ...
 1af:	6a 4b                	push   $0x4b
 1b1:	68 b8 0a 00 00       	push   $0xab8
 1b6:	68 c2 0a 00 00       	push   $0xac2
 1bb:	6a 01                	push   $0x1
 1bd:	e8 ce 05 00 00       	call   790 <printf>
 1c2:	83 c4 0c             	add    $0xc,%esp
 1c5:	68 3c 0b 00 00       	push   $0xb3c
    assert(nested_join_pid > 0);
 1ca:	68 e0 0a 00 00       	push   $0xae0
 1cf:	6a 01                	push   $0x1
 1d1:	e8 ba 05 00 00       	call   790 <printf>
 1d6:	58                   	pop    %eax
 1d7:	5a                   	pop    %edx
 1d8:	68 f4 0a 00 00       	push   $0xaf4
 1dd:	6a 01                	push   $0x1
 1df:	e8 ac 05 00 00       	call   790 <printf>
 1e4:	59                   	pop    %ecx
 1e5:	ff 35 80 0f 00 00    	push   0xf80
 1eb:	e8 64 04 00 00       	call   654 <kill>
 1f0:	e8 2f 04 00 00       	call   624 <exit>
    assert(nested_thread_pid > 0);
 1f5:	6a 47                	push   $0x47
 1f7:	68 b8 0a 00 00       	push   $0xab8
 1fc:	68 c2 0a 00 00       	push   $0xac2
 201:	6a 01                	push   $0x1
 203:	e8 88 05 00 00       	call   790 <printf>
 208:	83 c4 0c             	add    $0xc,%esp
 20b:	68 ca 0a 00 00       	push   $0xaca
 210:	eb b8                	jmp    1ca <worker+0x6a>
    assert(nested_join_pid > 0);
 212:	6a 49                	push   $0x49
 214:	68 b8 0a 00 00       	push   $0xab8
 219:	68 c2 0a 00 00       	push   $0xac2
 21e:	6a 01                	push   $0x1
 220:	e8 6b 05 00 00       	call   790 <printf>
 225:	83 c4 0c             	add    $0xc,%esp
 228:	68 01 0b 00 00       	push   $0xb01
 ...
 6ec:	89 d1                	mov    %edx,%ecx
{
 ...
 719:	0f b6 92 d4 0b 00 00 	movzbl 0xbd4(%edx),%edx
 ...
 799:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 809:	ff 24 85 7c 0b 00 00 	jmp    *0xb7c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 917:	90                   	nop
          s = "(null)";
 918:	ba 73 0b 00 00       	mov    $0xb73,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 931:	a1 84 0f 00 00       	mov    0xf84,%eax
{
 ...
 971:	5b                   	pop    %ebx
  freep = p;
 972:	89 15 84 0f 00 00    	mov    %edx,0xf84
}
 978:	5e                   	pop    %esi
 979:	5f                   	pop    %edi
 97a:	5d                   	pop    %ebp
 ...
 9a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ac:	89 15 84 0f 00 00    	mov    %edx,0xf84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9cc:	8b 3d 84 0f 00 00    	mov    0xf84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a0f:	73 4f                	jae    a60 <malloc+0xa0>
    ...
    if(p == freep)
 a11:	8b 3d 84 0f 00 00    	mov    0xf84,%edi
 ...
 a3a:	e8 f1 fe ff ff       	call   930 <free>
  return freep;
 a3f:	8b 15 84 0f 00 00    	mov    0xf84,%edx
 ...
 a6c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a6f:	89 15 84 0f 00 00    	mov    %edx,0xf84
}
 ...
 a7f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a80:	c7 05 84 0f 00 00 88 	movl   $0xf88,0xf84
 a87:	0f 00 00 
    base.s.size = 0;
 a8a:	bf 88 0f 00 00       	mov    $0xf88,%edi
    base.s.ptr = freep = prevp = &base;
 a8f:	c7 05 88 0f 00 00 88 	movl   $0xf88,0xf88
 a96:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a99:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a9b:	c7 05 8c 0f 00 00 00 	movl   $0x0,0xf8c
 aa2:	00 00 00 
    if(p->s.size >= nunits){
