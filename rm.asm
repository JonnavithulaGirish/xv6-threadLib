...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 7a 04 00 00       	call   4b4 <unlink>
 ...
 52c:	89 d1                	mov    %edx,%ecx
{
 ...
 559:	0f b6 92 98 09 00 00 	movzbl 0x998(%edx),%edx
 ...
 5d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 649:	ff 24 85 40 09 00 00 	jmp    *0x940(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 757:	90                   	nop
          s = "(null)";
 758:	ba 39 09 00 00       	mov    $0x939,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 771:	a1 04 0d 00 00       	mov    0xd04,%eax
{
 ...
 7b1:	5b                   	pop    %ebx
  freep = p;
 7b2:	89 15 04 0d 00 00    	mov    %edx,0xd04
}
 7b8:	5e                   	pop    %esi
 7b9:	5f                   	pop    %edi
 7ba:	5d                   	pop    %ebp
 ...
 7e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ec:	89 15 04 0d 00 00    	mov    %edx,0xd04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 809:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 80c:	8b 3d 04 0d 00 00    	mov    0xd04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 84f:	73 4f                	jae    8a0 <malloc+0xa0>
    ...
    if(p == freep)
 851:	8b 3d 04 0d 00 00    	mov    0xd04,%edi
 ...
 87a:	e8 f1 fe ff ff       	call   770 <free>
  return freep;
 87f:	8b 15 04 0d 00 00    	mov    0xd04,%edx
 ...
 8ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8af:	89 15 04 0d 00 00    	mov    %edx,0xd04
}
 ...
 8bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8c0:	c7 05 04 0d 00 00 08 	movl   $0xd08,0xd04
 8c7:	0d 00 00 
    base.s.size = 0;
 8ca:	bf 08 0d 00 00       	mov    $0xd08,%edi
    base.s.ptr = freep = prevp = &base;
 8cf:	c7 05 08 0d 00 00 08 	movl   $0xd08,0xd08
 8d6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8db:	c7 05 0c 0d 00 00 00 	movl   $0x0,0xd0c
 8e2:	00 00 00 
    if(p->s.size >= nunits){
