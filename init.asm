...
main(void)
{
  ...
  19:	e8 16 04 00 00       	call   434 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 39 04 00 00       	call   46c <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 2d 04 00 00       	call   46c <dup>
  ...
  52:	e8 09 05 00 00       	call   560 <printf>
    pid = fork();
  57:	e8 90 03 00 00       	call   3ec <fork>
    if(pid < 0){
  ...
  70:	e8 87 03 00 00       	call   3fc <wait>
  ...
  9a:	e8 c1 04 00 00       	call   560 <printf>
      exit();
  9f:	e8 50 03 00 00       	call   3f4 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 88 0c 00 00       	push   $0xc88
  ab:	68 b6 08 00 00       	push   $0x8b6
  b0:	e8 77 03 00 00       	call   42c <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 9d 04 00 00       	call   560 <printf>
      exit();
  c3:	e8 2c 03 00 00       	call   3f4 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 88 08 00 00       	push   $0x888
  d2:	e8 65 03 00 00       	call   43c <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 88 08 00 00       	push   $0x888
  e0:	e8 4f 03 00 00       	call   434 <open>
 ...
 219:	31 db                	xor    %ebx,%ebx
{
 ...
 225:	57                   	push   %edi
 226:	6a 00                	push   $0x0
 228:	e8 df 01 00 00       	call   40c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 a2 01 00 00       	call   434 <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 a5 01 00 00       	call   44c <fstat>
  close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
  close(fd);
 2ac:	e8 6b 01 00 00       	call   41c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 35a:	e8 35 01 00 00       	call   494 <clone>
}
 35f:	c9                   	leave  
 360:	c3                   	ret    
...
int thread_join(){
 377:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 37a:	50                   	push   %eax
 37b:	e8 1c 01 00 00       	call   49c <join>
  if(pid >0 ){
 ...
 387:	7e 0d                	jle    396 <thread_join+0x26>
 389:	8b 7d f4             	mov    -0xc(%ebp),%edi
 38c:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
void lock_acquire(lock_t *lock){
 ...
 3cb:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 3cf:	8b 52 04             	mov    0x4(%edx),%edx
...
void lock_release(lock_t *lock){
 ...
 3e6:	83 40 04 01          	addl   $0x1,0x4(%eax)
 3ea:	5d                   	pop    %ebp
 3eb:	c3                   	ret    
 ...
 4bc:	89 d1                	mov    %edx,%ecx
{
 ...
 52e:	56                   	push   %esi
 52f:	57                   	push   %edi
 530:	e8 df fe ff ff       	call   414 <write>
  while(--i >= 0)
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a5:	57                   	push   %edi
 5a6:	56                   	push   %esi
 5a7:	e8 68 fe ff ff       	call   414 <write>
 ...
 5fe:	e8 11 fe ff ff       	call   414 <write>
        putc(fd, c);
 ...
 60f:	57                   	push   %edi
 610:	56                   	push   %esi
 611:	e8 fe fd ff ff       	call   414 <write>
        putc(fd, c);
 ...
 67b:	57                   	push   %edi
 67c:	56                   	push   %esi
 67d:	e8 92 fd ff ff       	call   414 <write>
        while(*s != 0){
 ...
 6bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6bf:	e8 50 fd ff ff       	call   414 <write>
        ap++;
...
free(void *ap)
{
 ...
 701:	a1 90 0c 00 00       	mov    0xc90,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 90 0c 00 00    	mov    %edx,0xc90
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 90 0c 00 00    	mov    %edx,0xc90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d 90 0c 00 00    	mov    0xc90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d 90 0c 00 00    	mov    0xc90,%edi
 ...
 7f3:	e8 84 fc ff ff       	call   47c <sbrk>
  if(p == (char*)-1)
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 90 0c 00 00    	mov    0xc90,%edx
 ...
 857:	0c 00 00 
    base.s.size = 0;
 85a:	bf 94 0c 00 00       	mov    $0xc94,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 98 0c 00 00 00 	movl   $0x0,0xc98
 872:	00 00 00 
    if(p->s.size >= nunits){
