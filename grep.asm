...
main(int argc, char *argv[])
{
  ...
  55:	e8 42 06 00 00       	call   69c <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 46 06 00 00       	call   6b4 <open>
  ...
  81:	e8 5a 07 00 00       	call   7e0 <printf>
      exit();
  86:	e8 e9 05 00 00       	call   674 <exit>
  }
  exit();
  8b:	e8 e4 05 00 00       	call   674 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 42 07 00 00       	call   7e0 <printf>
    exit();
  9e:	e8 d1 05 00 00       	call   674 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 c2 05 00 00       	call   674 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 7f 04 00 00       	call   68c <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 03 04 00 00       	call   694 <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 df 01 00 00       	call   68c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 a2 01 00 00       	call   6b4 <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 a5 01 00 00       	call   6cc <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 6b 01 00 00       	call   69c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 5da:	e8 35 01 00 00       	call   714 <clone>
}
 5df:	c9                   	leave  
 5e0:	c3                   	ret    
...
int thread_join(){
 5f7:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 5fa:	50                   	push   %eax
 5fb:	e8 1c 01 00 00       	call   71c <join>
  if(pid >0 ){
 ...
 607:	7e 0d                	jle    616 <thread_join+0x26>
 609:	8b 7d f4             	mov    -0xc(%ebp),%edi
 60c:	b9 00 10 00 00       	mov    $0x1000,%ecx
 611:	31 c0                	xor    %eax,%eax
 613:	fc                   	cld    
 614:	f3 aa                	rep stos %al,%es:(%edi)
    memset(stack,0,PGSIZE);
  }
  return pid;
}
 616:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
void lock_acquire(lock_t *lock){
 ...
 64b:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 64f:	8b 52 04             	mov    0x4(%edx),%edx
