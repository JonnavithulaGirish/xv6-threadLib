...
main(int argc, char *argv[])
{
  ...
  55:	e8 22 07 00 00       	call   77c <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 26 07 00 00       	call   794 <open>
  ...
  77:	50                   	push   %eax
  78:	ff 33                	push   (%ebx)
  7a:	68 08 0c 00 00       	push   $0xc08
  7f:	6a 01                	push   $0x1
  81:	e8 3a 08 00 00       	call   8c0 <printf>
      exit();
  86:	e8 c9 06 00 00       	call   754 <exit>
  }
  exit();
  8b:	e8 c4 06 00 00       	call   754 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  92:	68 e8 0b 00 00       	push   $0xbe8
  97:	6a 02                	push   $0x2
  99:	e8 22 08 00 00       	call   8c0 <printf>
    exit();
  9e:	e8 b1 06 00 00       	call   754 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 a2 06 00 00       	call   754 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 5f 05 00 00       	call   76c <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 e3 04 00 00       	call   774 <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 bf 02 00 00       	call   76c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 82 02 00 00       	call   794 <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 85 02 00 00       	call   7ac <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 4b 02 00 00       	call   77c <close>
  return r;
...
void lock_init(lock_t *lock) {
 ...
 5da:	f0 0f c1 45 f0       	lock xadd %eax,-0x10(%ebp)
}
...
void lock_acquire(lock_t *lock){
 ...
 5e4:	74 24                	je     60a <thread_create+0x4a>
 ...
 5f3:	52                   	push   %edx
 5f4:	68 1e 0c 00 00       	push   $0xc1e
 5f9:	6a 01                	push   $0x1
 5fb:	e8 c0 02 00 00       	call   8c0 <printf>
  while(lock->turn != myturn){
 600:	8b 55 f4             	mov    -0xc(%ebp),%edx
 603:	83 c4 10             	add    $0x10,%esp
 606:	39 d3                	cmp    %edx,%ebx
 608:	75 e6                	jne    5f0 <thread_create+0x30>
	void *stack= malloc(PGSIZE*2);
 60a:	83 ec 0c             	sub    $0xc,%esp
 60d:	68 00 20 00 00       	push   $0x2000
 612:	e8 d9 04 00 00       	call   af0 <malloc>
  }
}
...
void lock_release(lock_t *lock){
 ...
 620:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 626:	74 07                	je     62f <thread_create+0x6f>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
 628:	29 d0                	sub    %edx,%eax
 62a:	05 00 10 00 00       	add    $0x1000,%eax
	int result = clone(start_routine,arg1, arg2 ,stack);
 62f:	50                   	push   %eax
 630:	ff 75 10             	push   0x10(%ebp)
 633:	ff 75 0c             	push   0xc(%ebp)
 636:	ff 75 08             	push   0x8(%ebp)
 639:	e8 b6 01 00 00       	call   7f4 <clone>
}
...
int thread_join(){
 ...
 658:	6a 04                	push   $0x4
 65a:	e8 91 04 00 00       	call   af0 <malloc>
 65f:	89 45 ec             	mov    %eax,-0x14(%ebp)
	int result= join(&stack);
 662:	8d 45 ec             	lea    -0x14(%ebp),%eax
 665:	89 04 24             	mov    %eax,(%esp)
 668:	e8 8f 01 00 00       	call   7fc <join>
  lock->ticket = 0;
 ...
 682:	f0 0f c1 45 f0       	lock xadd %eax,-0x10(%ebp)
  while(lock->turn != myturn){
 687:	8b 55 f4             	mov    -0xc(%ebp),%edx
 68a:	83 c4 10             	add    $0x10,%esp
 68d:	39 c2                	cmp    %eax,%edx
 68f:	74 21                	je     6b2 <thread_join+0x62>
 ...
 69b:	52                   	push   %edx
 69c:	68 1e 0c 00 00       	push   $0xc1e
 6a1:	6a 01                	push   $0x1
 6a3:	e8 18 02 00 00       	call   8c0 <printf>
  while(lock->turn != myturn){
 6a8:	8b 55 f4             	mov    -0xc(%ebp),%edx
 6ab:	83 c4 10             	add    $0x10,%esp
 6ae:	39 d3                	cmp    %edx,%ebx
 6b0:	75 e6                	jne    698 <thread_join+0x48>
	free(stack);
 6b2:	83 ec 0c             	sub    $0xc,%esp
 6b5:	ff 75 ec             	push   -0x14(%ebp)
 6b8:	e8 a3 03 00 00       	call   a60 <free>
}
 6bd:	8d 65 f8             	lea    -0x8(%ebp),%esp
 6c0:	89 f0                	mov    %esi,%eax
 6c2:	5b                   	pop    %ebx
 6c3:	5e                   	pop    %esi
 6c4:	5d                   	pop    %ebp
 6c5:	c3                   	ret    
...
void lock_init(lock_t *lock) {
 ...
 6d3:	8b 45 08             	mov    0x8(%ebp),%eax
  lock->ticket = 0;
 6d6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
 6dc:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
 6e3:	5d                   	pop    %ebp
 6e4:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 6fc:	53                   	push   %ebx
 6fd:	f0 0f c1 06          	lock xadd %eax,(%esi)
  while(lock->turn != myturn){
 701:	8b 56 04             	mov    0x4(%esi),%edx
 704:	39 d0                	cmp    %edx,%eax
 706:	74 22                	je     72a <lock_acquire+0x3a>
 708:	89 c3                	mov    %eax,%ebx
 70a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    printf(1,"ulib lock value %d\n",lock->turn);
 710:	83 ec 04             	sub    $0x4,%esp
 713:	52                   	push   %edx
 714:	68 1e 0c 00 00       	push   $0xc1e
 719:	6a 01                	push   $0x1
 71b:	e8 a0 01 00 00       	call   8c0 <printf>
  while(lock->turn != myturn){
 720:	8b 56 04             	mov    0x4(%esi),%edx
 723:	83 c4 10             	add    $0x10,%esp
 726:	39 da                	cmp    %ebx,%edx
 728:	75 e6                	jne    710 <lock_acquire+0x20>
}
 72a:	8d 65 f8             	lea    -0x8(%ebp),%esp
 72d:	5b                   	pop    %ebx
 72e:	5e                   	pop    %esi
 72f:	5d                   	pop    %ebp
 730:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 743:	8b 45 08             	mov    0x8(%ebp),%eax
  lock->turn = lock->turn + 1;
 746:	83 40 04 01          	addl   $0x1,0x4(%eax)
 74a:	5d                   	pop    %ebp
 74b:	c3                   	ret    
...
000007f4 <clone>:
SYSCALL(clone)
 7f4:	b8 16 00 00 00       	mov    $0x16,%eax
 7f9:	cd 40                	int    $0x40
 7fb:	c3                   	ret    

000007fc <join>:
SYSCALL(join)
 7fc:	b8 17 00 00 00       	mov    $0x17,%eax
 801:	cd 40                	int    $0x40
 803:	c3                   	ret    
 ...
 81c:	89 d1                	mov    %edx,%ecx
{
 ...
 849:	0f b6 92 94 0c 00 00 	movzbl 0xc94(%edx),%edx
 ...
 88e:	56                   	push   %esi
 88f:	57                   	push   %edi
 890:	e8 df fe ff ff       	call   774 <write>
  while(--i >= 0)
 ...
 8c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 905:	57                   	push   %edi
 906:	56                   	push   %esi
 907:	e8 68 fe ff ff       	call   774 <write>
 ...
 939:	ff 24 85 3c 0c 00 00 	jmp    *0xc3c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 95e:	e8 11 fe ff ff       	call   774 <write>
        putc(fd, c);
 ...
 96f:	57                   	push   %edi
 970:	56                   	push   %esi
 971:	e8 fe fd ff ff       	call   774 <write>
        putc(fd, c);
 ...
 9db:	57                   	push   %edi
 9dc:	56                   	push   %esi
 9dd:	e8 92 fd ff ff       	call   774 <write>
        while(*s != 0){
 ...
 a1c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 a1f:	e8 50 fd ff ff       	call   774 <write>
        ap++;
 ...
 a47:	90                   	nop
          s = "(null)";
 a48:	ba 32 0c 00 00       	mov    $0xc32,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 a61:	a1 00 15 00 00       	mov    0x1500,%eax
{
 ...
 aa1:	5b                   	pop    %ebx
  freep = p;
 aa2:	89 15 00 15 00 00    	mov    %edx,0x1500
}
 aa8:	5e                   	pop    %esi
 aa9:	5f                   	pop    %edi
 aaa:	5d                   	pop    %ebp
 ...
 ad9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 adc:	89 15 00 15 00 00    	mov    %edx,0x1500
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 af9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 afc:	8b 3d 00 15 00 00    	mov    0x1500,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b3f:	73 4f                	jae    b90 <malloc+0xa0>
    ...
    if(p == freep)
 b41:	8b 3d 00 15 00 00    	mov    0x1500,%edi
 ...
 b53:	e8 84 fc ff ff       	call   7dc <sbrk>
  if(p == (char*)-1)
 ...
 b6a:	e8 f1 fe ff ff       	call   a60 <free>
  return freep;
 b6f:	8b 15 00 15 00 00    	mov    0x1500,%edx
 ...
 b9c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 b9f:	89 15 00 15 00 00    	mov    %edx,0x1500
}
 ...
 baf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 bb0:	c7 05 00 15 00 00 04 	movl   $0x1504,0x1500
 bb7:	15 00 00 
    base.s.size = 0;
 bba:	bf 04 15 00 00       	mov    $0x1504,%edi
    base.s.ptr = freep = prevp = &base;
 bbf:	c7 05 04 15 00 00 04 	movl   $0x1504,0x1504
 bc6:	15 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 bc9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 bcb:	c7 05 08 15 00 00 00 	movl   $0x0,0x1508
 bd2:	00 00 00 
    if(p->s.size >= nunits){
