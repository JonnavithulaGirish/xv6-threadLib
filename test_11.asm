   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 a9 05 00 00       	call   5c6 <getpid>
  1d:	a3 7c 0e 00 00       	mov    %eax,0xe7c

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 78 0e 00 00 01 	movl   $0x1,0xe78
  2f:	00 00 00 
  ...
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 78 0e 00 00       	mov    0xe78,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 5d 05 00 00       	call   5ce <sbrk>
  ...
  84:	50                   	push   %eax
  85:	50                   	push   %eax
  86:	68 49 0a 00 00       	push   $0xa49
  8b:	6a 01                	push   $0x1
  8d:	e8 1e 06 00 00       	call   6b0 <printf>
   exit();
  92:	e8 af 04 00 00       	call   546 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  99:	68 d8 09 00 00       	push   $0x9d8
  9e:	68 e2 09 00 00       	push   $0x9e2
  a3:	6a 01                	push   $0x1
  a5:	e8 06 06 00 00       	call   6b0 <printf>
  aa:	83 c4 0c             	add    $0xc,%esp
  ad:	68 17 0a 00 00       	push   $0xa17
      assert(join_pid == thread_pid);
  b2:	68 f6 09 00 00       	push   $0x9f6
  b7:	6a 01                	push   $0x1
  b9:	e8 f2 05 00 00       	call   6b0 <printf>
  be:	5a                   	pop    %edx
  bf:	59                   	pop    %ecx
  c0:	68 0a 0a 00 00       	push   $0xa0a
  c5:	6a 01                	push   $0x1
  c7:	e8 e4 05 00 00       	call   6b0 <printf>
  cc:	5b                   	pop    %ebx
  cd:	ff 35 7c 0e 00 00    	push   0xe7c
  d3:	e8 9e 04 00 00       	call   576 <kill>
  d8:	e8 69 04 00 00       	call   546 <exit>
  dd:	6a 22                	push   $0x22
  df:	68 d8 09 00 00       	push   $0x9d8
  e4:	68 e2 09 00 00       	push   $0x9e2
  e9:	6a 01                	push   $0x1
  eb:	e8 c0 05 00 00       	call   6b0 <printf>
  f0:	83 c4 0c             	add    $0xc,%esp
  f3:	68 26 0a 00 00       	push   $0xa26
  f8:	eb b8                	jmp    b2 <main+0xb2>
      assert(global == 5);
  fa:	6a 23                	push   $0x23
  fc:	68 d8 09 00 00       	push   $0x9d8
 101:	68 e2 09 00 00       	push   $0x9e2
 106:	6a 01                	push   $0x1
 108:	e8 a3 05 00 00       	call   6b0 <printf>
 10d:	83 c4 0c             	add    $0xc,%esp
 110:	68 3d 0a 00 00       	push   $0xa3d
 115:	eb 9b                	jmp    b2 <main+0xb2>
      assert((uint)sbrk(0) < (150 * 4096) && "shouldn't even come close");
 117:	6a 25                	push   $0x25
 119:	68 d8 09 00 00       	push   $0x9d8
 11e:	68 e2 09 00 00       	push   $0x9e2
 123:	6a 01                	push   $0x1
 125:	e8 86 05 00 00       	call   6b0 <printf>
 12a:	83 c4 0c             	add    $0xc,%esp
 12d:	68 58 0a 00 00       	push   $0xa58
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 78 0e 00 00       	mov    0xe78,%eax
 14b:	83 f8 01             	cmp    $0x1,%eax
 14e:	74 46                	je     196 <worker+0x56>
 150:	6a 2e                	push   $0x2e
 152:	68 d8 09 00 00       	push   $0x9d8
 157:	68 e2 09 00 00       	push   $0x9e2
 15c:	6a 01                	push   $0x1
 15e:	e8 4d 05 00 00       	call   6b0 <printf>
 163:	83 c4 0c             	add    $0xc,%esp
 166:	68 ea 09 00 00       	push   $0x9ea
 16b:	68 f6 09 00 00       	push   $0x9f6
 170:	6a 01                	push   $0x1
 172:	e8 39 05 00 00       	call   6b0 <printf>
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 0a 0a 00 00       	push   $0xa0a
 17e:	6a 01                	push   $0x1
 180:	e8 2b 05 00 00       	call   6b0 <printf>
 185:	59                   	pop    %ecx
 186:	ff 35 7c 0e 00 00    	push   0xe7c
 18c:	e8 e5 03 00 00       	call   576 <kill>
 191:	e8 b0 03 00 00       	call   546 <exit>
   global += 4;
 196:	a1 78 0e 00 00       	mov    0xe78,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 78 0e 00 00       	mov    %eax,0xe78
   exit();
 1a3:	e8 9e 03 00 00       	call   546 <exit>
...
xchg(volatile uint *addr, uint newval)
{
 ...
 412:	f0 87 05 84 0e 00 00 	lock xchg %eax,0xe84
  lock_init(&lk_join);
}
...
void lock_release(lock_t *lock){
 ...
 434:	c7 05 84 0e 00 00 00 	movl   $0x0,0xe84
 43b:	00 00 00 
...
int thread_join(){
 ...
 49a:	f0 87 05 80 0e 00 00 	lock xchg %eax,0xe80
 ...
 4b5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 4ba:	c7 05 80 0e 00 00 00 	movl   $0x0,0xe80
 4c1:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 4d0:	c7 05 84 0e 00 00 00 	movl   $0x0,0xe84
 4d7:	00 00 00 
 4da:	c7 05 80 0e 00 00 00 	movl   $0x0,0xe80
 4e1:	00 00 00 
}
 4e4:	c3                   	ret    
...
free(void *ap)
{
 ...
 851:	a1 88 0e 00 00       	mov    0xe88,%eax
{
 ...
 891:	5b                   	pop    %ebx
  freep = p;
 892:	89 15 88 0e 00 00    	mov    %edx,0xe88
}
 898:	5e                   	pop    %esi
 899:	5f                   	pop    %edi
 89a:	5d                   	pop    %ebp
 ...
 8c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8cc:	89 15 88 0e 00 00    	mov    %edx,0xe88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8ec:	8b 3d 88 0e 00 00    	mov    0xe88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 92f:	73 4f                	jae    980 <malloc+0xa0>
    ...
    if(p == freep)
 931:	8b 3d 88 0e 00 00    	mov    0xe88,%edi
 ...
 95a:	e8 f1 fe ff ff       	call   850 <free>
  return freep;
 95f:	8b 15 88 0e 00 00    	mov    0xe88,%edx
 ...
 98c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 98f:	89 15 88 0e 00 00    	mov    %edx,0xe88
}
 ...
 99f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 9a0:	c7 05 88 0e 00 00 8c 	movl   $0xe8c,0xe88
 9a7:	0e 00 00 
    base.s.size = 0;
 9aa:	bf 8c 0e 00 00       	mov    $0xe8c,%edi
    base.s.ptr = freep = prevp = &base;
 9af:	c7 05 8c 0e 00 00 8c 	movl   $0xe8c,0xe8c
 9b6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 9bb:	c7 05 90 0e 00 00 00 	movl   $0x0,0xe90
 9c2:	00 00 00 
    if(p->s.size >= nunits){
