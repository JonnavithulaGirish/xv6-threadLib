   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 17 05 00 00       	call   534 <getpid>
  1d:	a3 d8 0d 00 00       	mov    %eax,0xdd8

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 d4 0d 00 00 01 	movl   $0x1,0xdd4
  2f:	00 00 00 
  ...
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 d4 0d 00 00       	mov    0xdd4,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 cb 04 00 00       	call   53c <sbrk>
  ...
  8d:	e8 8e 05 00 00       	call   620 <printf>
   exit();
  92:	e8 1d 04 00 00       	call   4b4 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  ...
  cc:	5b                   	pop    %ebx
  cd:	ff 35 d8 0d 00 00    	push   0xdd8
  d3:	e8 0c 04 00 00       	call   4e4 <kill>
  d8:	e8 d7 03 00 00       	call   4b4 <exit>
  dd:	6a 22                	push   $0x22
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 d4 0d 00 00       	mov    0xdd4,%eax
 ...
 185:	59                   	pop    %ecx
 186:	ff 35 d8 0d 00 00    	push   0xdd8
 18c:	e8 53 03 00 00       	call   4e4 <kill>
 191:	e8 1e 03 00 00       	call   4b4 <exit>
   global += 4;
 196:	a1 d4 0d 00 00       	mov    0xdd4,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 d4 0d 00 00       	mov    %eax,0xdd4
   exit();
 1a3:	e8 0c 03 00 00       	call   4b4 <exit>
 ...
 2d9:	31 db                	xor    %ebx,%ebx
{
 ...
 2e5:	57                   	push   %edi
 2e6:	6a 00                	push   $0x0
 2e8:	e8 df 01 00 00       	call   4cc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 34d:	e8 a2 01 00 00       	call   4f4 <open>
  if(fd < 0)
 ...
 361:	50                   	push   %eax
 362:	e8 a5 01 00 00       	call   50c <fstat>
  close(fd);
 367:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 36a:	89 c6                	mov    %eax,%esi
  close(fd);
 36c:	e8 6b 01 00 00       	call   4dc <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 41a:	e8 35 01 00 00       	call   554 <clone>
}
 41f:	c9                   	leave  
 420:	c3                   	ret    
...
int thread_join(){
 437:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 43a:	50                   	push   %eax
 43b:	e8 1c 01 00 00       	call   55c <join>
  if(pid >0 ){
 440:	83 c4 10             	add    $0x10,%esp
  int pid= join(&stack);
 443:	89 c2                	mov    %eax,%edx
  if(pid >0 ){
 445:	85 c0                	test   %eax,%eax
 447:	7e 0d                	jle    456 <thread_join+0x26>
 449:	8b 7d f4             	mov    -0xc(%ebp),%edi
 44c:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
void lock_acquire(lock_t *lock){
 ...
 48b:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 48f:	8b 52 04             	mov    0x4(%edx),%edx
...
void lock_release(lock_t *lock){
 ...
 4a6:	83 40 04 01          	addl   $0x1,0x4(%eax)
 4aa:	5d                   	pop    %ebp
 4ab:	c3                   	ret    
 ...
 57c:	89 d1                	mov    %edx,%ecx
{
 ...
 5ee:	56                   	push   %esi
 5ef:	57                   	push   %edi
 5f0:	e8 df fe ff ff       	call   4d4 <write>
  while(--i >= 0)
 ...
 629:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 665:	57                   	push   %edi
 666:	56                   	push   %esi
 667:	e8 68 fe ff ff       	call   4d4 <write>
 ...
 6be:	e8 11 fe ff ff       	call   4d4 <write>
        putc(fd, c);
 ...
 6cf:	57                   	push   %edi
 6d0:	56                   	push   %esi
 6d1:	e8 fe fd ff ff       	call   4d4 <write>
        putc(fd, c);
 ...
 73b:	57                   	push   %edi
 73c:	56                   	push   %esi
 73d:	e8 92 fd ff ff       	call   4d4 <write>
        while(*s != 0){
 ...
 77c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 77f:	e8 50 fd ff ff       	call   4d4 <write>
        ap++;
...
free(void *ap)
{
 ...
 7c1:	a1 dc 0d 00 00       	mov    0xddc,%eax
{
 ...
 801:	5b                   	pop    %ebx
  freep = p;
 802:	89 15 dc 0d 00 00    	mov    %edx,0xddc
}
 808:	5e                   	pop    %esi
 809:	5f                   	pop    %edi
 80a:	5d                   	pop    %ebp
 ...
 839:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 83c:	89 15 dc 0d 00 00    	mov    %edx,0xddc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 859:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 85c:	8b 3d dc 0d 00 00    	mov    0xddc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 89f:	73 4f                	jae    8f0 <malloc+0xa0>
    ...
    if(p == freep)
 8a1:	8b 3d dc 0d 00 00    	mov    0xddc,%edi
 ...
 8b3:	e8 84 fc ff ff       	call   53c <sbrk>
  if(p == (char*)-1)
 ...
 8ca:	e8 f1 fe ff ff       	call   7c0 <free>
  return freep;
 8cf:	8b 15 dc 0d 00 00    	mov    0xddc,%edx
 ...
 8fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8ff:	89 15 dc 0d 00 00    	mov    %edx,0xddc
}
 ...
 90f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 910:	c7 05 dc 0d 00 00 e0 	movl   $0xde0,0xddc
 917:	0d 00 00 
    base.s.size = 0;
 91a:	bf e0 0d 00 00       	mov    $0xde0,%edi
    base.s.ptr = freep = prevp = &base;
 91f:	c7 05 e0 0d 00 00 e0 	movl   $0xde0,0xde0
 926:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 929:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 92b:	c7 05 e4 0d 00 00 00 	movl   $0x0,0xde4
 932:	00 00 00 
    if(p->s.size >= nunits){
