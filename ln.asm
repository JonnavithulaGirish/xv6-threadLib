   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 ab 04 00 00       	call   4d0 <printf>
    exit();
  25:	e8 3a 03 00 00       	call   364 <exit>
  }
  ...
  32:	e8 8d 03 00 00       	call   3c4 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 21 03 00 00       	call   364 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
...
free(void *ap)
{
 ...
 671:	a1 d0 0b 00 00       	mov    0xbd0,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 d0 0b 00 00    	mov    %edx,0xbd0
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 d0 0b 00 00    	mov    %edx,0xbd0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d d0 0b 00 00    	mov    0xbd0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d d0 0b 00 00    	mov    0xbd0,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 d0 0b 00 00    	mov    0xbd0,%edx
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf d4 0b 00 00       	mov    $0xbd4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 d8 0b 00 00 00 	movl   $0x0,0xbd8
 7e2:	00 00 00 
    if(p->s.size >= nunits){
