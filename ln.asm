   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  1e:	6a 02                	push   $0x2
  20:	e8 3b 05 00 00       	call   560 <printf>
    exit();
  25:	e8 cc 03 00 00       	call   3f6 <exit>
  }
...
xchg(volatile uint *addr, uint newval)
{
 ...
 2c2:	f0 87 05 78 0c 00 00 	lock xchg %eax,0xc78
  lock_init(&lk_join);
}
...
void lock_release(lock_t *lock){
 ...
 2e4:	c7 05 78 0c 00 00 00 	movl   $0x0,0xc78
 2eb:	00 00 00 
...
int thread_join(){
 ...
 34a:	f0 87 05 74 0c 00 00 	lock xchg %eax,0xc74
 ...
 365:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
 36a:	c7 05 74 0c 00 00 00 	movl   $0x0,0xc74
 371:	00 00 00 
}
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
 380:	c7 05 78 0c 00 00 00 	movl   $0x0,0xc78
 387:	00 00 00 
 38a:	c7 05 74 0c 00 00 00 	movl   $0x0,0xc74
 391:	00 00 00 
}
 394:	c3                   	ret    
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d9:	ff 24 85 b8 08 00 00 	jmp    *0x8b8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba af 08 00 00       	mov    $0x8af,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 701:	a1 7c 0c 00 00       	mov    0xc7c,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 7c 0c 00 00    	mov    %edx,0xc7c
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 7c 0c 00 00    	mov    %edx,0xc7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d 7c 0c 00 00    	mov    0xc7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d 7c 0c 00 00    	mov    0xc7c,%edi
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 7c 0c 00 00    	mov    0xc7c,%edx
 ...
 83c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 83f:	89 15 7c 0c 00 00    	mov    %edx,0xc7c
}
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 7c 0c 00 00 80 	movl   $0xc80,0xc7c
 857:	0c 00 00 
    base.s.size = 0;
 85a:	bf 80 0c 00 00       	mov    $0xc80,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 80 0c 00 00 80 	movl   $0xc80,0xc80
 866:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 84 0c 00 00 00 	movl   $0x0,0xc84
 872:	00 00 00 
    if(p->s.size >= nunits){
