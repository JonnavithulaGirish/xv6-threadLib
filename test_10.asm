...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 2d 05 00 00       	call   544 <getpid>
  ...
  1a:	c7 45 f0 23 00 00 00 	movl   $0x23,-0x10(%ebp)
   ppid = getpid();
  21:	a3 c4 0d 00 00       	mov    %eax,0xdc4
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 2);
  51:	83 3d c0 0d 00 00 02 	cmpl   $0x2,0xdc0
  ...
  b0:	5b                   	pop    %ebx
  b1:	ff 35 c4 0d 00 00    	push   0xdc4
  b7:	e8 38 04 00 00       	call   4f4 <kill>
  bc:	e8 03 04 00 00       	call   4c4 <exit>
   assert(thread_pid > 0);
  c1:	6a 1f                	push   $0x1f
  ...
  e7:	e8 44 05 00 00       	call   630 <printf>
   exit();
  ec:	e8 d3 03 00 00       	call   4c4 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 116:	75 2a                	jne    142 <worker+0x42>
   assert(global == 1);
 118:	83 3d c0 0d 00 00 01 	cmpl   $0x1,0xdc0
 ...
 177:	59                   	pop    %ecx
 178:	ff 35 c4 0d 00 00    	push   0xdc4
 17e:	e8 71 03 00 00       	call   4f4 <kill>
 183:	e8 3c 03 00 00       	call   4c4 <exit>
   assert(arg1_int == 35);
 188:	6a 2d                	push   $0x2d
 ...
 1a3:	eb b8                	jmp    15d <worker+0x5d>
   global++;
 1a5:	c7 05 c0 0d 00 00 02 	movl   $0x2,0xdc0
 1ac:	00 00 00 
   exit();
 1af:	e8 10 03 00 00       	call   4c4 <exit>
 ...
 2e9:	31 db                	xor    %ebx,%ebx
{
 ...
 2f5:	57                   	push   %edi
 2f6:	6a 00                	push   $0x0
 2f8:	e8 df 01 00 00       	call   4dc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 35d:	e8 a2 01 00 00       	call   504 <open>
  if(fd < 0)
 ...
 371:	50                   	push   %eax
 372:	e8 a5 01 00 00       	call   51c <fstat>
  close(fd);
 377:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 37a:	89 c6                	mov    %eax,%esi
  close(fd);
 37c:	e8 6b 01 00 00       	call   4ec <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 42a:	e8 35 01 00 00       	call   564 <clone>
}
 42f:	c9                   	leave  
 430:	c3                   	ret    
...
int thread_join(){
 ...
 457:	7e 0d                	jle    466 <thread_join+0x26>
 459:	8b 7d f4             	mov    -0xc(%ebp),%edi
 45c:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
void lock_acquire(lock_t *lock){
 ...
 49b:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 49f:	8b 52 04             	mov    0x4(%edx),%edx
...
free(void *ap)
{
 ...
 7d1:	a1 c8 0d 00 00       	mov    0xdc8,%eax
{
 ...
 811:	5b                   	pop    %ebx
  freep = p;
 812:	89 15 c8 0d 00 00    	mov    %edx,0xdc8
}
 818:	5e                   	pop    %esi
 819:	5f                   	pop    %edi
 81a:	5d                   	pop    %ebp
 ...
 849:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 84c:	89 15 c8 0d 00 00    	mov    %edx,0xdc8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 869:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 86c:	8b 3d c8 0d 00 00    	mov    0xdc8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8af:	73 4f                	jae    900 <malloc+0xa0>
    ...
    if(p == freep)
 8b1:	8b 3d c8 0d 00 00    	mov    0xdc8,%edi
 ...
 8da:	e8 f1 fe ff ff       	call   7d0 <free>
  return freep;
 8df:	8b 15 c8 0d 00 00    	mov    0xdc8,%edx
 ...
 90c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 90f:	89 15 c8 0d 00 00    	mov    %edx,0xdc8
}
 ...
 91f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 920:	c7 05 c8 0d 00 00 cc 	movl   $0xdcc,0xdc8
 927:	0d 00 00 
    base.s.size = 0;
 92a:	bf cc 0d 00 00       	mov    $0xdcc,%edi
    base.s.ptr = freep = prevp = &base;
 92f:	c7 05 cc 0d 00 00 cc 	movl   $0xdcc,0xdcc
 936:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 939:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 93b:	c7 05 d0 0d 00 00 00 	movl   $0x0,0xdd0
 942:	00 00 00 
    if(p->s.size >= nunits){
