  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 d9 03 00 00       	call   43c <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 dc 03 00 00       	call   484 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 a5 03 00 00       	call   464 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 9c 03 00 00       	call   46c <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 91 03 00 00       	call   484 <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 4d 03 00 00       	call   45c <read>
  for (i = 0; i < 20; i++)
 ...
 11a:	57                   	push   %edi
 11b:	e8 4c 03 00 00       	call   46c <close>

  wait();
 120:	e8 27 03 00 00       	call   44c <wait>

  exit();
 125:	e8 1a 03 00 00       	call   444 <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 df 01 00 00       	call   45c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 a2 01 00 00       	call   484 <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 a5 01 00 00       	call   49c <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 6b 01 00 00       	call   46c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 3aa:	e8 35 01 00 00       	call   4e4 <clone>
}
 3af:	c9                   	leave  
 3b0:	c3                   	ret    
...
int thread_join(){
 ...
 3d7:	7e 0d                	jle    3e6 <thread_join+0x26>
 3d9:	8b 7d f4             	mov    -0xc(%ebp),%edi
 3dc:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
void lock_acquire(lock_t *lock){
 ...
 41b:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 41f:	8b 52 04             	mov    0x4(%edx),%edx
 422:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 428:	39 c2                	cmp    %eax,%edx
 42a:	75 fc                	jne    428 <lock_acquire+0x18>
}
 42c:	5d                   	pop    %ebp
 42d:	c3                   	ret    
...
free(void *ap)
{
 ...
 751:	a1 b8 0c 00 00       	mov    0xcb8,%eax
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	89 15 b8 0c 00 00    	mov    %edx,0xcb8
}
 798:	5e                   	pop    %esi
 799:	5f                   	pop    %edi
 79a:	5d                   	pop    %ebp
 ...
 7c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7cc:	89 15 b8 0c 00 00    	mov    %edx,0xcb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 3d b8 0c 00 00    	mov    0xcb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 82f:	73 4f                	jae    880 <malloc+0xa0>
    ...
    if(p == freep)
 831:	8b 3d b8 0c 00 00    	mov    0xcb8,%edi
 ...
 85a:	e8 f1 fe ff ff       	call   750 <free>
  return freep;
 85f:	8b 15 b8 0c 00 00    	mov    0xcb8,%edx
 ...
 88c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 88f:	89 15 b8 0c 00 00    	mov    %edx,0xcb8
}
 ...
 89f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8a0:	c7 05 b8 0c 00 00 bc 	movl   $0xcbc,0xcb8
 8a7:	0c 00 00 
    base.s.size = 0;
 8aa:	bf bc 0c 00 00       	mov    $0xcbc,%edi
    base.s.ptr = freep = prevp = &base;
 8af:	c7 05 bc 0c 00 00 bc 	movl   $0xcbc,0xcbc
 8b6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8bb:	c7 05 c0 0c 00 00 00 	movl   $0x0,0xcc0
 8c2:	00 00 00 
    if(p->s.size >= nunits){
