...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 16 03 00 00       	call   32c <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 a0 03 00 00       	call   3c4 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 08 03 00 00       	call   334 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 df 01 00 00       	call   34c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 a2 01 00 00       	call   374 <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 a5 01 00 00       	call   38c <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 6b 01 00 00       	call   35c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 29a:	e8 35 01 00 00       	call   3d4 <clone>
}
 29f:	c9                   	leave  
 2a0:	c3                   	ret    
...
int thread_join(){
 2b7:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 2ba:	50                   	push   %eax
 2bb:	e8 1c 01 00 00       	call   3dc <join>
  if(pid >0 ){
 ...
 2c7:	7e 0d                	jle    2d6 <thread_join+0x26>
 2c9:	8b 7d f4             	mov    -0xc(%ebp),%edi
...
void lock_release(lock_t *lock){
 ...
 326:	83 40 04 01          	addl   $0x1,0x4(%eax)
 32a:	5d                   	pop    %ebp
 32b:	c3                   	ret    
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 46e:	56                   	push   %esi
 46f:	57                   	push   %edi
 470:	e8 df fe ff ff       	call   354 <write>
  while(--i >= 0)
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e5:	57                   	push   %edi
 4e6:	56                   	push   %esi
 4e7:	e8 68 fe ff ff       	call   354 <write>
 ...
 53e:	e8 11 fe ff ff       	call   354 <write>
        putc(fd, c);
 ...
 54f:	57                   	push   %edi
 550:	56                   	push   %esi
 551:	e8 fe fd ff ff       	call   354 <write>
        putc(fd, c);
 ...
 5bb:	57                   	push   %edi
 5bc:	56                   	push   %esi
 5bd:	e8 92 fd ff ff       	call   354 <write>
        while(*s != 0){
 ...
 5fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5ff:	e8 50 fd ff ff       	call   354 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 733:	e8 84 fc ff ff       	call   3bc <sbrk>
  if(p == (char*)-1)
