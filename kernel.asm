...
80100a0e:	e9 4d 3b 00 00       	jmp    80104560 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a44:	e8 e7 39 00 00       	call   80104430 <wakeup>
...
801022ad:	e8 7e 21 00 00       	call   80104430 <wakeup>
...
80102369:	e8 02 20 00 00       	call   80104370 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102d85:	e8 e6 15 00 00       	call   80104370 <sleep>
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 df 15 00 00       	call   80104430 <wakeup>
    release(&log.lock);
...
8010303a:	e8 c1 0d 00 00       	call   80103e00 <scheduler>
8010303f:	90                   	nop
...
8010355f:	e8 cc 0e 00 00       	call   80104430 <wakeup>
...
80103641:	e8 2a 0d 00 00       	call   80104370 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103715:	e8 56 0c 00 00       	call   80104370 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103776:	e8 b5 0c 00 00       	call   80104430 <wakeup>
  release(&p->lock);
...
80103803:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103809:	e8 b2 10 00 00       	call   801048c0 <release>
...
8010382b:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382e:	c7 40 14 b7 5c 10 80 	movl   $0x80105cb7,0x14(%eax)
  p->isthread = 0; 
...
80103847:	e8 94 11 00 00       	call   801049e0 <memset>
...
801038f0:	e8 5b 0e 00 00       	call   80104750 <initlock>
}
...
80103aa9:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
80103aac:	e8 1f 0d 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80103ab1:	e8 4a fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103abc:	e8 5f 0d 00 00       	call   80104820 <popcli>
  sz = curproc->sz;
...
80103ad7:	e8 44 0e 00 00       	call   80104920 <acquire>
...
80103b03:	83 ba 80 00 00 00 01 	cmpl   $0x1,0x80(%edx)
80103b0a:	75 e4                	jne    80103af0 <growproc+0x50>
        p->sz = sz;
80103b0c:	89 32                	mov    %esi,(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b0e:	81 c2 84 00 00 00    	add    $0x84,%edx
80103b14:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
80103b1a:	75 e2                	jne    80103afe <growproc+0x5e>
80103b1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&ptable.lock);
80103b20:	83 ec 0c             	sub    $0xc,%esp
80103b23:	68 20 1d 11 80       	push   $0x80111d20
80103b28:	e8 93 0d 00 00       	call   801048c0 <release>
  switchuvm(curproc);
80103b2d:	89 1c 24             	mov    %ebx,(%esp)
80103b30:	e8 1b 33 00 00       	call   80106e50 <switchuvm>
  return 0;
...
80103b4c:	e8 7f 35 00 00       	call   801070d0 <allocuvm>
...
80103b72:	e8 89 36 00 00       	call   80107200 <deallocuvm>
...
80103b96:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b99:	e8 32 0c 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80103b9e:	e8 5d fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ba3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ba9:	e8 72 0c 00 00       	call   80104820 <popcli>
  if((np = allocproc()) == 0){
...
80103bc8:	e8 d3 37 00 00       	call   801073a0 <copyuvm>
...
80103cb6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103cb9:	e8 12 0b 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80103cbe:	e8 3d fc ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103cc3:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80103cc9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  popcli();
80103ccc:	e8 4f 0b 00 00       	call   80104820 <popcli>
  if((uint)stack%PGSIZE!=0){
80103cd1:	f7 45 14 ff 0f 00 00 	testl  $0xfff,0x14(%ebp)
80103cd8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103cdb:	0f 85 14 01 00 00    	jne    80103df5 <clone+0x145>
	if((curproc->sz - (uint)stack) < PGSIZE){
80103ce1:	8b 02                	mov    (%edx),%eax
80103ce3:	2b 45 14             	sub    0x14(%ebp),%eax
80103ce6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80103ce9:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80103cee:	0f 86 01 01 00 00    	jbe    80103df5 <clone+0x145>
  if((np = allocproc()) == 0){
80103cf4:	e8 b7 fa ff ff       	call   801037b0 <allocproc>
80103cf9:	89 c3                	mov    %eax,%ebx
80103cfb:	85 c0                	test   %eax,%eax
80103cfd:	0f 84 f2 00 00 00    	je     80103df5 <clone+0x145>
  np->pgdir = curproc->pgdir;
80103d03:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  *np->tf = *curproc->tf;
80103d06:	8b 7b 18             	mov    0x18(%ebx),%edi
80103d09:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->pgdir = curproc->pgdir;
80103d0e:	8b 42 04             	mov    0x4(%edx),%eax
80103d11:	89 43 04             	mov    %eax,0x4(%ebx)
  np->sz = curproc->sz;
80103d14:	8b 02                	mov    (%edx),%eax
  np->parent = curproc;
80103d16:	89 53 14             	mov    %edx,0x14(%ebx)
  np->sz = curproc->sz;
80103d19:	89 03                	mov    %eax,(%ebx)
  ((uint *)stack)[size-3] = 0xFFFFFFFF;
80103d1b:	8b 45 14             	mov    0x14(%ebp),%eax
  *np->tf = *curproc->tf;
80103d1e:	8b 72 18             	mov    0x18(%edx),%esi
80103d21:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  ((uint *)stack)[size-2] = (uint)arg1;
80103d23:	8b 4d 14             	mov    0x14(%ebp),%ecx
  for(i = 0; i < NOFILE; i++)
80103d26:	31 f6                	xor    %esi,%esi
80103d28:	89 d7                	mov    %edx,%edi
  ((uint *)stack)[size-3] = 0xFFFFFFFF;
80103d2a:	c7 80 f4 0f 00 00 ff 	movl   $0xffffffff,0xff4(%eax)
80103d31:	ff ff ff 
  ((uint *)stack)[size-2] = (uint)arg1;
80103d34:	8b 45 0c             	mov    0xc(%ebp),%eax
  np->tf->ebp = (uint) stack +  PGSIZE - 3 * sizeof(void*);
80103d37:	81 c1 f4 0f 00 00    	add    $0xff4,%ecx
  ((uint *)stack)[size-2] = (uint)arg1;
80103d3d:	89 41 04             	mov    %eax,0x4(%ecx)
  ((uint *)stack)[size-1] = (uint)arg2;
80103d40:	8b 45 10             	mov    0x10(%ebp),%eax
80103d43:	89 41 08             	mov    %eax,0x8(%ecx)
  np->tf->ebp = (uint) stack +  PGSIZE - 3 * sizeof(void*);
80103d46:	8b 43 18             	mov    0x18(%ebx),%eax
80103d49:	89 48 08             	mov    %ecx,0x8(%eax)
  np->tf->esp = (uint) np->tf->ebp;
80103d4c:	8b 43 18             	mov    0x18(%ebx),%eax
80103d4f:	8b 48 08             	mov    0x8(%eax),%ecx
80103d52:	89 48 44             	mov    %ecx,0x44(%eax)
  np->tf->eip = (uint) fcn;
80103d55:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103d58:	8b 43 18             	mov    0x18(%ebx),%eax
80103d5b:	89 48 38             	mov    %ecx,0x38(%eax)
  np->stack = stack;
80103d5e:	8b 45 14             	mov    0x14(%ebp),%eax
  np->isthread =1;
80103d61:	c7 83 80 00 00 00 01 	movl   $0x1,0x80(%ebx)
80103d68:	00 00 00 
  np->stack = stack;
80103d6b:	89 43 7c             	mov    %eax,0x7c(%ebx)
  np->tf->eax = 0;
80103d6e:	8b 43 18             	mov    0x18(%ebx),%eax
80103d71:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103d78:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103d7f:	90                   	nop
    if(curproc->ofile[i])
80103d80:	8b 44 b7 28          	mov    0x28(%edi,%esi,4),%eax
80103d84:	85 c0                	test   %eax,%eax
80103d86:	74 10                	je     80103d98 <clone+0xe8>
      np->ofile[i] = filedup(curproc->ofile[i]);
...
80103d94:	89 44 b3 28          	mov    %eax,0x28(%ebx,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103d98:	83 c6 01             	add    $0x1,%esi
80103d9b:	83 fe 10             	cmp    $0x10,%esi
80103d9e:	75 e0                	jne    80103d80 <clone+0xd0>
  np->cwd = idup(curproc->cwd);
80103da0:	83 ec 0c             	sub    $0xc,%esp
80103da3:	ff 77 68             	push   0x68(%edi)
80103da6:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80103da9:	e8 a2 d9 ff ff       	call   80101750 <idup>
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103dae:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103db1:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103db4:	89 43 68             	mov    %eax,0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103db7:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103dba:	83 c2 6c             	add    $0x6c,%edx
80103dbd:	6a 10                	push   $0x10
80103dbf:	52                   	push   %edx
80103dc0:	50                   	push   %eax
80103dc1:	e8 da 0d 00 00       	call   80104ba0 <safestrcpy>
  pid = np->pid;
80103dc6:	8b 73 10             	mov    0x10(%ebx),%esi
  acquire(&ptable.lock);
80103dc9:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103dd0:	e8 4b 0b 00 00       	call   80104920 <acquire>
  np->state = RUNNABLE;
80103dd5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103ddc:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103de3:	e8 d8 0a 00 00       	call   801048c0 <release>
  return pid;
...
80103df4:	c3                   	ret    
		return -1;
80103df5:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103dfa:	eb ef                	jmp    80103deb <clone+0x13b>
...
80103e06:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103e09:	e8 f2 fa ff ff       	call   80103900 <mycpu>
  c->proc = 0;
...
80103e2e:	e8 ed 0a 00 00       	call   80104920 <acquire>
...
80103e50:	e8 fb 2f 00 00       	call   80106e50 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103e55:	58                   	pop    %eax
80103e56:	5a                   	pop    %edx
80103e57:	ff 73 1c             	push   0x1c(%ebx)
80103e5a:	57                   	push   %edi
      p->state = RUNNING;
80103e5b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103e62:	e8 94 0d 00 00       	call   80104bfb <swtch>
      switchkvm();
80103e67:	e8 d4 2f 00 00       	call   80106e40 <switchkvm>
      c->proc = 0;
80103e6c:	83 c4 10             	add    $0x10,%esp
80103e6f:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103e76:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e79:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103e7f:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80103e85:	75 b9                	jne    80103e40 <scheduler+0x40>
    release(&ptable.lock);
80103e87:	83 ec 0c             	sub    $0xc,%esp
80103e8a:	68 20 1d 11 80       	push   $0x80111d20
80103e8f:	e8 2c 0a 00 00       	call   801048c0 <release>
    sti();
80103e94:	83 c4 10             	add    $0x10,%esp
80103e97:	eb 87                	jmp    80103e20 <scheduler+0x20>
...
80103ea4:	53                   	push   %ebx
  pushcli();
80103ea5:	e8 26 09 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80103eaa:	e8 51 fa ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103eaf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103eb5:	e8 66 09 00 00       	call   80104820 <popcli>
  if(!holding(&ptable.lock))
80103eba:	83 ec 0c             	sub    $0xc,%esp
80103ebd:	68 20 1d 11 80       	push   $0x80111d20
80103ec2:	e8 b9 09 00 00       	call   80104880 <holding>
80103ec7:	83 c4 10             	add    $0x10,%esp
80103eca:	85 c0                	test   %eax,%eax
80103ecc:	74 4f                	je     80103f1d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103ece:	e8 2d fa ff ff       	call   80103900 <mycpu>
...
80103ee7:	75 41                	jne    80103f2a <sched+0x8a>
  intena = mycpu()->intena;
80103ee9:	e8 12 fa ff ff       	call   80103900 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103eee:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103ef1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103ef7:	e8 04 fa ff ff       	call   80103900 <mycpu>
80103efc:	83 ec 08             	sub    $0x8,%esp
80103eff:	ff 70 04             	push   0x4(%eax)
80103f02:	53                   	push   %ebx
80103f03:	e8 f3 0c 00 00       	call   80104bfb <swtch>
  mycpu()->intena = intena;
80103f08:	e8 f3 f9 ff ff       	call   80103900 <mycpu>
}
...
80103f66:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103f69:	e8 12 fa ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103f6e:	39 05 54 3e 11 80    	cmp    %eax,0x80113e54
80103f74:	0f 84 0f 01 00 00    	je     80104089 <exit+0x129>
...
80104003:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80104008:	75 e2                	jne    80103fec <exit+0x8c>
        p->parent = initproc;
8010400a:	8b 0d 54 3e 11 80    	mov    0x80113e54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104010:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
...
80104026:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
8010402c:	74 42                	je     80104070 <exit+0x110>
    if(p->parent == curproc){
8010402e:	39 5a 14             	cmp    %ebx,0x14(%edx)
80104031:	75 ed                	jne    80104020 <exit+0xc0>
      if (p->isthread != 1){ 
80104033:	83 ba 80 00 00 00 01 	cmpl   $0x1,0x80(%edx)
8010403a:	74 e4                	je     80104020 <exit+0xc0>
        if(p->state == ZOMBIE)
8010403c:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
        p->parent = initproc;
80104040:	89 4a 14             	mov    %ecx,0x14(%edx)
        if(p->state == ZOMBIE)
80104043:	75 db                	jne    80104020 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104045:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010404a:	eb 10                	jmp    8010405c <exit+0xfc>
8010404c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104050:	05 84 00 00 00       	add    $0x84,%eax
80104055:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
8010405a:	74 c4                	je     80104020 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
8010405c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104060:	75 ee                	jne    80104050 <exit+0xf0>
80104062:	3b 48 20             	cmp    0x20(%eax),%ecx
80104065:	75 e9                	jne    80104050 <exit+0xf0>
      p->state = RUNNABLE;
80104067:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
8010406e:	eb e0                	jmp    80104050 <exit+0xf0>
  curproc->state = ZOMBIE;
80104070:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80104077:	e8 24 fe ff ff       	call   80103ea0 <sched>
  panic("zombie exit");
8010407c:	83 ec 0c             	sub    $0xc,%esp
8010407f:	68 c8 7b 10 80       	push   $0x80107bc8
80104084:	e8 f7 c2 ff ff       	call   80100380 <panic>
    panic("init exiting");
80104089:	83 ec 0c             	sub    $0xc,%esp
8010408c:	68 bb 7b 10 80       	push   $0x80107bbb
80104091:	e8 ea c2 ff ff       	call   80100380 <panic>
...
801040a4:	53                   	push   %ebx
  pushcli();
801040a5:	e8 26 07 00 00       	call   801047d0 <pushcli>
  c = mycpu();
801040aa:	e8 51 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801040af:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040b5:	e8 66 07 00 00       	call   80104820 <popcli>
  acquire(&ptable.lock);
801040ba:	83 ec 0c             	sub    $0xc,%esp
801040bd:	68 20 1d 11 80       	push   $0x80111d20
801040c2:	e8 59 08 00 00       	call   80104920 <acquire>
801040c7:	83 c4 10             	add    $0x10,%esp
    havethreads = 0;
801040ca:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040cc:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801040d1:	eb 13                	jmp    801040e6 <join+0x46>
...
801040e4:	74 27                	je     8010410d <join+0x6d>
      if(p->parent != curproc ||  p->isthread!=1)
801040e6:	39 73 14             	cmp    %esi,0x14(%ebx)
801040e9:	75 ed                	jne    801040d8 <join+0x38>
801040eb:	83 bb 80 00 00 00 01 	cmpl   $0x1,0x80(%ebx)
801040f2:	75 e4                	jne    801040d8 <join+0x38>
      if(p->state == ZOMBIE){
801040f4:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801040f8:	74 66                	je     80104160 <join+0xc0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040fa:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havethreads = 1;
80104100:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104105:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
8010410b:	75 d9                	jne    801040e6 <join+0x46>
    if(!havethreads || curproc->killed){
8010410d:	85 c0                	test   %eax,%eax
8010410f:	0f 84 a7 00 00 00    	je     801041bc <join+0x11c>
80104115:	8b 46 24             	mov    0x24(%esi),%eax
80104118:	85 c0                	test   %eax,%eax
8010411a:	0f 85 9c 00 00 00    	jne    801041bc <join+0x11c>
  pushcli();
80104120:	e8 ab 06 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104125:	e8 d6 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010412a:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104130:	e8 eb 06 00 00       	call   80104820 <popcli>
  if(p == 0)
80104135:	85 db                	test   %ebx,%ebx
80104137:	0f 84 96 00 00 00    	je     801041d3 <join+0x133>
  p->chan = chan;
8010413d:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104140:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104147:	e8 54 fd ff ff       	call   80103ea0 <sched>
  p->chan = 0;
8010414c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80104153:	e9 72 ff ff ff       	jmp    801040ca <join+0x2a>
80104158:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010415f:	90                   	nop
        *stack = p->stack;
80104160:	8b 53 7c             	mov    0x7c(%ebx),%edx
80104163:	8b 45 08             	mov    0x8(%ebp),%eax
        kfree(p->kstack);
80104166:	83 ec 0c             	sub    $0xc,%esp
        *stack = p->stack;
80104169:	89 10                	mov    %edx,(%eax)
        pid = p->pid;
8010416b:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
8010416e:	ff 73 08             	push   0x8(%ebx)
80104171:	e8 4a e3 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
80104176:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        p->pid = 0;
8010417d:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104184:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010418b:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
8010418f:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80104196:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        p->stack = 0; 
8010419d:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        release(&ptable.lock);
801041a4:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801041ab:	e8 10 07 00 00       	call   801048c0 <release>
        return pid;
801041b0:	83 c4 10             	add    $0x10,%esp
}
801041b3:	8d 65 f8             	lea    -0x8(%ebp),%esp
801041b6:	89 f0                	mov    %esi,%eax
801041b8:	5b                   	pop    %ebx
801041b9:	5e                   	pop    %esi
801041ba:	5d                   	pop    %ebp
801041bb:	c3                   	ret    
...
801041bc:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801041bf:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801041c4:	68 20 1d 11 80       	push   $0x80111d20
801041c9:	e8 f2 06 00 00       	call   801048c0 <release>
      return -1;
801041ce:	83 c4 10             	add    $0x10,%esp
801041d1:	eb e0                	jmp    801041b3 <join+0x113>
    panic("sleep");
801041d3:	83 ec 0c             	sub    $0xc,%esp
801041d6:	68 d4 7b 10 80       	push   $0x80107bd4
...
801041e4:	53                   	push   %ebx
  pushcli();
801041e5:	e8 e6 05 00 00       	call   801047d0 <pushcli>
  c = mycpu();
801041ea:	e8 11 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801041ef:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801041f5:	e8 26 06 00 00       	call   80104820 <popcli>
  acquire(&ptable.lock);
801041fa:	83 ec 0c             	sub    $0xc,%esp
801041fd:	68 20 1d 11 80       	push   $0x80111d20
80104202:	e8 19 07 00 00       	call   80104920 <acquire>
80104207:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010420a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010420c:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80104211:	eb 13                	jmp    80104226 <wait+0x46>
80104213:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104217:	90                   	nop
80104218:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010421e:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80104224:	74 28                	je     8010424e <wait+0x6e>
      if(p->parent != curproc || p->isthread!=0)
80104226:	39 73 14             	cmp    %esi,0x14(%ebx)
80104229:	75 ed                	jne    80104218 <wait+0x38>
8010422b:	8b 8b 80 00 00 00    	mov    0x80(%ebx),%ecx
80104231:	85 c9                	test   %ecx,%ecx
80104233:	75 e3                	jne    80104218 <wait+0x38>
      if(p->state == ZOMBIE){
80104235:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104239:	74 65                	je     801042a0 <wait+0xc0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010423b:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80104241:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104246:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
8010424c:	75 d8                	jne    80104226 <wait+0x46>
    if(!havekids || curproc->killed){
8010424e:	85 c0                	test   %eax,%eax
80104250:	0f 84 a0 00 00 00    	je     801042f6 <wait+0x116>
80104256:	8b 46 24             	mov    0x24(%esi),%eax
80104259:	85 c0                	test   %eax,%eax
8010425b:	0f 85 95 00 00 00    	jne    801042f6 <wait+0x116>
  pushcli();
80104261:	e8 6a 05 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104266:	e8 95 f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
80104278:	0f 84 8f 00 00 00    	je     8010430d <wait+0x12d>
  p->chan = chan;
8010427e:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104281:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104288:	e8 13 fc ff ff       	call   80103ea0 <sched>
  p->chan = 0;
8010428d:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80104294:	e9 71 ff ff ff       	jmp    8010420a <wait+0x2a>
...
801042a9:	e8 12 e2 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
801042ae:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801042b5:	5a                   	pop    %edx
801042b6:	ff 73 04             	push   0x4(%ebx)
801042b9:	e8 72 2f 00 00       	call   80107230 <freevm>
        p->pid = 0;
...
801042d7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801042de:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
801042f9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801042fe:	68 20 1d 11 80       	push   $0x80111d20
80104303:	e8 b8 05 00 00       	call   801048c0 <release>
      return -1;
80104308:	83 c4 10             	add    $0x10,%esp
8010430b:	eb e0                	jmp    801042ed <wait+0x10d>
    panic("sleep");
8010430d:	83 ec 0c             	sub    $0xc,%esp
80104310:	68 d4 7b 10 80       	push   $0x80107bd4
...
80104331:	e8 9a 04 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104336:	e8 c5 f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
80104346:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
8010434d:	e8 4e fb ff ff       	call   80103ea0 <sched>
  release(&ptable.lock);
80104352:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
8010437f:	e8 4c 04 00 00       	call   801047d0 <pushcli>
  c = mycpu();
80104384:	e8 77 f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
801043a0:	81 fe 20 1d 11 80    	cmp    $0x80111d20,%esi
801043a6:	74 50                	je     801043f8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
801043a8:	83 ec 0c             	sub    $0xc,%esp
801043ab:	68 20 1d 11 80       	push   $0x80111d20
...
801043c0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801043c7:	e8 d4 fa ff ff       	call   80103ea0 <sched>
  p->chan = 0;
801043cc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801043d3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
801043fb:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104402:	e8 99 fa ff ff       	call   80103ea0 <sched>
  p->chan = 0;
...
80104419:	68 da 7b 10 80       	push   $0x80107bda
8010441e:	e8 5d bf ff ff       	call   80100380 <panic>
    panic("sleep");
80104423:	83 ec 0c             	sub    $0xc,%esp
80104426:	68 d4 7b 10 80       	push   $0x80107bd4
...
80104437:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010443a:	68 20 1d 11 80       	push   $0x80111d20
8010443f:	e8 dc 04 00 00       	call   80104920 <acquire>
80104444:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104447:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010444c:	eb 0e                	jmp    8010445c <wakeup+0x2c>
8010444e:	66 90                	xchg   %ax,%ax
80104450:	05 84 00 00 00       	add    $0x84,%eax
80104455:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
...
80104467:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010446e:	05 84 00 00 00       	add    $0x84,%eax
80104473:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80104478:	75 e2                	jne    8010445c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010447a:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
80104481:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104484:	c9                   	leave  
  release(&ptable.lock);
80104485:	e9 36 04 00 00       	jmp    801048c0 <release>
...
80104497:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010449a:	68 20 1d 11 80       	push   $0x80111d20
8010449f:	e8 7c 04 00 00       	call   80104920 <acquire>
801044a4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801044a7:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
801044ac:	eb 10                	jmp    801044be <kill+0x2e>
801044ae:	66 90                	xchg   %ax,%ax
801044b0:	81 c2 84 00 00 00    	add    $0x84,%edx
801044b6:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
801044bc:	74 7e                	je     8010453c <kill+0xac>
    if(p->pid == pid){
801044be:	39 5a 10             	cmp    %ebx,0x10(%edx)
801044c1:	75 ed                	jne    801044b0 <kill+0x20>
      p->killed = 1;
801044c3:	c7 42 24 01 00 00 00 	movl   $0x1,0x24(%edx)
      for(pc = ptable.proc; pc < &ptable.proc[NPROC]; pc++){
801044ca:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
801044cf:	eb 13                	jmp    801044e4 <kill+0x54>
801044d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801044d8:	05 84 00 00 00       	add    $0x84,%eax
801044dd:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
801044e2:	74 34                	je     80104518 <kill+0x88>
         if ((pc->parent == p) && (pc->isthread == 1)){
801044e4:	39 50 14             	cmp    %edx,0x14(%eax)
801044e7:	75 ef                	jne    801044d8 <kill+0x48>
801044e9:	83 b8 80 00 00 00 01 	cmpl   $0x1,0x80(%eax)
801044f0:	75 e6                	jne    801044d8 <kill+0x48>
            pc->killed = 1;
            if (pc->state == SLEEPING)
801044f2:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
            pc->killed = 1;
801044f6:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
            if (pc->state == SLEEPING)
801044fd:	75 d9                	jne    801044d8 <kill+0x48>
               pc->state = RUNNABLE;
801044ff:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      for(pc = ptable.proc; pc < &ptable.proc[NPROC]; pc++){
80104506:	05 84 00 00 00       	add    $0x84,%eax
8010450b:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80104510:	75 d2                	jne    801044e4 <kill+0x54>
80104512:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
         }
      }
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104518:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
8010451c:	75 07                	jne    80104525 <kill+0x95>
        p->state = RUNNABLE;
8010451e:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
      release(&ptable.lock);
80104525:	83 ec 0c             	sub    $0xc,%esp
80104528:	68 20 1d 11 80       	push   $0x80111d20
8010452d:	e8 8e 03 00 00       	call   801048c0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010453f:	68 20 1d 11 80       	push   $0x80111d20
80104544:	e8 77 03 00 00       	call   801048c0 <release>
}
...
80104565:	8d 75 e8             	lea    -0x18(%ebp),%esi
80104568:	53                   	push   %ebx
80104569:	bb c0 1d 11 80       	mov    $0x80111dc0,%ebx
...
8010457b:	68 5f 7f 10 80       	push   $0x80107f5f
80104580:	e8 1b c1 ff ff       	call   801006a0 <cprintf>
80104585:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104588:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010458e:	81 fb c0 3e 11 80    	cmp    $0x80113ec0,%ebx
80104594:	0f 84 7e 00 00 00    	je     80104618 <procdump+0xb8>
    if(p->state == UNUSED)
8010459a:	8b 43 a0             	mov    -0x60(%ebx),%eax
8010459d:	85 c0                	test   %eax,%eax
8010459f:	74 e7                	je     80104588 <procdump+0x28>
      state = "???";
801045a1:	ba eb 7b 10 80       	mov    $0x80107beb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801045a6:	83 f8 05             	cmp    $0x5,%eax
801045a9:	77 11                	ja     801045bc <procdump+0x5c>
801045ab:	8b 14 85 4c 7c 10 80 	mov    -0x7fef83b4(,%eax,4),%edx
      state = "???";
801045b2:	b8 eb 7b 10 80       	mov    $0x80107beb,%eax
801045b7:	85 d2                	test   %edx,%edx
801045b9:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801045bc:	53                   	push   %ebx
801045bd:	52                   	push   %edx
801045be:	ff 73 a4             	push   -0x5c(%ebx)
801045c1:	68 ef 7b 10 80       	push   $0x80107bef
801045c6:	e8 d5 c0 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
801045cb:	83 c4 10             	add    $0x10,%esp
801045ce:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
801045d2:	75 a4                	jne    80104578 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801045d4:	83 ec 08             	sub    $0x8,%esp
801045d7:	8d 45 c0             	lea    -0x40(%ebp),%eax
801045da:	8d 7d c0             	lea    -0x40(%ebp),%edi
801045dd:	50                   	push   %eax
801045de:	8b 43 b0             	mov    -0x50(%ebx),%eax
...
801045fd:	68 41 76 10 80       	push   $0x80107641
80104602:	e8 99 c0 ff ff       	call   801006a0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010462a:	68 64 7c 10 80       	push   $0x80107c64
...
80104865:	68 6f 7c 10 80       	push   $0x80107c6f
8010486a:	e8 11 bb ff ff       	call   80100380 <panic>
    panic("popcli");
8010486f:	83 ec 0c             	sub    $0xc,%esp
80104872:	68 86 7c 10 80       	push   $0x80107c86
...
801048db:	68 8d 7c 10 80       	push   $0x80107c8d
...
801049d0:	68 95 7c 10 80       	push   $0x80107c95
...
80104e28:	68 9d 7c 10 80       	push   $0x80107c9d
...
80104f84:	68 3c 7d 10 80       	push   $0x80107d3c
...
80104f9c:	68 3b 7d 10 80       	push   $0x80107d3b
...
80104fb1:	68 2f 7d 10 80       	push   $0x80107d2f
...
80104fcf:	68 3e 7d 10 80       	push   $0x80107d3e
80104fd4:	e8 a7 b3 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104fd9:	83 ec 0c             	sub    $0xc,%esp
80104fdc:	68 20 7d 10 80       	push   $0x80107d20
...
801053dd:	58                   	pop    %eax
801053de:	5a                   	pop    %edx
801053df:	68 3c 7d 10 80       	push   $0x80107d3c
...
801053f8:	68 3b 7d 10 80       	push   $0x80107d3b
...
{
  return fork();
80105a10:	e9 7b e1 ff ff       	jmp    80103b90 <fork>
...
80105a23:	83 ec 08             	sub    $0x8,%esp
  exit();
80105a26:	e8 35 e5 ff ff       	call   80103f60 <exit>
...
{
  return wait();
80105a30:	e9 ab e7 ff ff       	jmp    801041e0 <wait>
...
80105a5e:	e8 2d ea ff ff       	call   80104490 <kill>
...
80105b00:	68 80 3e 11 80       	push   $0x80113e80
80105b05:	e8 16 ee ff ff       	call   80104920 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105b0a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105b0d:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  while(ticks - ticks0 < n){
...
80105b23:	68 80 3e 11 80       	push   $0x80113e80
80105b28:	68 60 3e 11 80       	push   $0x80113e60
80105b2d:	e8 3e e8 ff ff       	call   80104370 <sleep>
  while(ticks - ticks0 < n){
80105b32:	a1 60 3e 11 80       	mov    0x80113e60,%eax
...
80105b50:	68 80 3e 11 80       	push   $0x80113e80
...
80105b73:	68 80 3e 11 80       	push   $0x80113e80
...
80105b94:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b97:	68 80 3e 11 80       	push   $0x80113e80
80105b9c:	e8 7f ed ff ff       	call   80104920 <acquire>
  xticks = ticks;
80105ba1:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  release(&tickslock);
80105ba7:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
...
80105bc6:	8d 45 e8             	lea    -0x18(%ebp),%eax
    void * fcn = 0;
80105bc9:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    if(argint(0, (int *) &fcn) < 0 
80105bd0:	50                   	push   %eax
80105bd1:	6a 00                	push   $0x0
    void * arg1 = 0;
80105bd3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    void * arg2 = 0;
80105bda:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    void * sArg = 0;
80105be1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(argint(0, (int *) &fcn) < 0 
80105be8:	e8 b3 f0 ff ff       	call   80104ca0 <argint>
80105bed:	83 c4 10             	add    $0x10,%esp
80105bf0:	85 c0                	test   %eax,%eax
80105bf2:	78 5c                	js     80105c50 <sys_clone+0x90>
      || argint(1, (int *) &arg1) < 0 
80105bf4:	83 ec 08             	sub    $0x8,%esp
80105bf7:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105bfa:	50                   	push   %eax
80105bfb:	6a 01                	push   $0x1
80105bfd:	e8 9e f0 ff ff       	call   80104ca0 <argint>
80105c02:	83 c4 10             	add    $0x10,%esp
80105c05:	85 c0                	test   %eax,%eax
80105c07:	78 47                	js     80105c50 <sys_clone+0x90>
      || argint(2, (int *) &arg2) < 0
80105c09:	83 ec 08             	sub    $0x8,%esp
80105c0c:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105c0f:	50                   	push   %eax
80105c10:	6a 02                	push   $0x2
80105c12:	e8 89 f0 ff ff       	call   80104ca0 <argint>
80105c17:	83 c4 10             	add    $0x10,%esp
80105c1a:	85 c0                	test   %eax,%eax
80105c1c:	78 32                	js     80105c50 <sys_clone+0x90>
      || argint(3, (int *) &sArg) < 0)
80105c1e:	83 ec 08             	sub    $0x8,%esp
80105c21:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105c24:	50                   	push   %eax
80105c25:	6a 03                	push   $0x3
80105c27:	e8 74 f0 ff ff       	call   80104ca0 <argint>
80105c2c:	83 c4 10             	add    $0x10,%esp
80105c2f:	85 c0                	test   %eax,%eax
80105c31:	78 1d                	js     80105c50 <sys_clone+0x90>
        return -1;

    return clone(fcn, arg1, arg2, sArg);
80105c33:	ff 75 f4             	push   -0xc(%ebp)
80105c36:	ff 75 f0             	push   -0x10(%ebp)
80105c39:	ff 75 ec             	push   -0x14(%ebp)
80105c3c:	ff 75 e8             	push   -0x18(%ebp)
80105c3f:	e8 6c e0 ff ff       	call   80103cb0 <clone>
...
80105c6c:	6a 00                	push   $0x0
    void *sArg=0;
80105c6e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(argptr( 0,(char**) &sArg, sizeof(void *)) < 0){
80105c75:	e8 76 f0 ff ff       	call   80104cf0 <argptr>
80105c7a:	83 c4 10             	add    $0x10,%esp
80105c7d:	85 c0                	test   %eax,%eax
80105c7f:	78 17                	js     80105c98 <sys_join+0x38>
      return -1;
    }
    return join(sArg);
80105c81:	83 ec 0c             	sub    $0xc,%esp
80105c84:	ff 75 f4             	push   -0xc(%ebp)
80105c87:	e8 14 e4 ff ff       	call   801040a0 <join>
...
80105cb7:	61                   	popa   
  popl %gs
80105cb8:	0f a9                	pop    %gs
  popl %fs
80105cba:	0f a1                	pop    %fs
  popl %es
80105cbc:	07                   	pop    %es
  popl %ds
80105cbd:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105cbe:	83 c4 08             	add    $0x8,%esp
  iret
80105cc1:	cf                   	iret   
...
80105ce7:	c7 04 c5 c2 3e 11 80 	movl   $0x8e000008,-0x7feec13e(,%eax,8)
80105cee:	08 00 00 8e 
80105cf2:	66 89 14 c5 c0 3e 11 	mov    %dx,-0x7feec140(,%eax,8)
80105cf9:	80 
80105cfa:	c1 ea 10             	shr    $0x10,%edx
80105cfd:	66 89 14 c5 c6 3e 11 	mov    %dx,-0x7feec13a(,%eax,8)
80105d04:	80 
  for(i = 0; i < 256; i++)
...
80105d17:	c7 05 c2 40 11 80 08 	movl   $0xef000008,0x801140c2
80105d1e:	00 00 ef 
  initlock(&tickslock, "time");
80105d21:	68 81 7d 10 80       	push   $0x80107d81
80105d26:	68 80 3e 11 80       	push   $0x80113e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105d2b:	66 a3 c0 40 11 80    	mov    %ax,0x801140c0
80105d31:	c1 e8 10             	shr    $0x10,%eax
80105d34:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
80105d3a:	e8 11 ea ff ff       	call   80104750 <initlock>
}
...
80105d5b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105d5f:	b8 c0 3e 11 80       	mov    $0x80113ec0,%eax
...
80105da4:	ff 24 85 28 7e 10 80 	jmp    *-0x7fef81d8(,%eax,4)
...
80105e85:	68 e4 7d 10 80       	push   $0x80107de4
...
80105eb4:	0f 85 3e ff ff ff    	jne    80105df8 <trap+0x78>
    yield();
80105eba:	e8 61 e4 ff ff       	call   80104320 <yield>
...
80105ed7:	68 8c 7d 10 80       	push   $0x80107d8c
...
80105f15:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f18:	e8 c3 ee ff ff       	call   80104de0 <syscall>
    if(myproc()->killed)
...
80105f33:	5d                   	pop    %ebp
      exit();
80105f34:	e9 27 e0 ff ff       	jmp    80103f60 <exit>
...
80105f90:	68 80 3e 11 80       	push   $0x80113e80
80105f95:	e8 86 e9 ff ff       	call   80104920 <acquire>
      wakeup(&ticks);
80105f9a:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
      ticks++;
80105fa1:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
80105fa8:	e8 83 e4 ff ff       	call   80104430 <wakeup>
      release(&tickslock);
80105fad:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
...
80105ff3:	68 b0 7d 10 80       	push   $0x80107db0
80105ff8:	e8 a3 a6 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105ffd:	83 c4 14             	add    $0x14,%esp
80106000:	68 86 7d 10 80       	push   $0x80107d86
...
80106097:	74 78                	je     80106111 <uartinit+0xd1>
  uart = 1;
80106099:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
801060a0:	00 00 00 
...
801060ac:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801060af:	bf a8 7e 10 80       	mov    $0x80107ea8,%edi
...
80106120 <uartputc>:
  if(!uart)
80106120:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80106197:	6a 00                	push   $0x0
  jmp alltraps
80106199:	e9 01 fb ff ff       	jmp    80105c9f <alltraps>
...
801061a0:	6a 01                	push   $0x1
  jmp alltraps
801061a2:	e9 f8 fa ff ff       	jmp    80105c9f <alltraps>
...
801061a9:	6a 02                	push   $0x2
  jmp alltraps
801061ab:	e9 ef fa ff ff       	jmp    80105c9f <alltraps>
...
801061b2:	6a 03                	push   $0x3
  jmp alltraps
801061b4:	e9 e6 fa ff ff       	jmp    80105c9f <alltraps>
...
801061bb:	6a 04                	push   $0x4
  jmp alltraps
801061bd:	e9 dd fa ff ff       	jmp    80105c9f <alltraps>
...
801061c4:	6a 05                	push   $0x5
  jmp alltraps
801061c6:	e9 d4 fa ff ff       	jmp    80105c9f <alltraps>
...
801061e6:	6a 09                	push   $0x9
  jmp alltraps
801061e8:	e9 b2 fa ff ff       	jmp    80105c9f <alltraps>
...
801061ed:	6a 0a                	push   $0xa
  jmp alltraps
801061ef:	e9 ab fa ff ff       	jmp    80105c9f <alltraps>
...
801061f4:	6a 0b                	push   $0xb
  jmp alltraps
801061f6:	e9 a4 fa ff ff       	jmp    80105c9f <alltraps>
...
801061fb:	6a 0c                	push   $0xc
  jmp alltraps
801061fd:	e9 9d fa ff ff       	jmp    80105c9f <alltraps>
...
80106209:	6a 0e                	push   $0xe
  jmp alltraps
8010620b:	e9 8f fa ff ff       	jmp    80105c9f <alltraps>
...
80106222:	6a 11                	push   $0x11
  jmp alltraps
80106224:	e9 76 fa ff ff       	jmp    80105c9f <alltraps>
...
8010622b:	6a 12                	push   $0x12
  jmp alltraps
8010622d:	e9 6d fa ff ff       	jmp    80105c9f <alltraps>
...
80106234:	6a 13                	push   $0x13
  jmp alltraps
80106236:	e9 64 fa ff ff       	jmp    80105c9f <alltraps>
...
8010623d:	6a 14                	push   $0x14
  jmp alltraps
8010623f:	e9 5b fa ff ff       	jmp    80105c9f <alltraps>
...
80106246:	6a 15                	push   $0x15
  jmp alltraps
80106248:	e9 52 fa ff ff       	jmp    80105c9f <alltraps>
...
8010624f:	6a 16                	push   $0x16
  jmp alltraps
80106251:	e9 49 fa ff ff       	jmp    80105c9f <alltraps>
...
80106258:	6a 17                	push   $0x17
  jmp alltraps
8010625a:	e9 40 fa ff ff       	jmp    80105c9f <alltraps>
...
80106261:	6a 18                	push   $0x18
  jmp alltraps
80106263:	e9 37 fa ff ff       	jmp    80105c9f <alltraps>
...
8010626a:	6a 19                	push   $0x19
  jmp alltraps
8010626c:	e9 2e fa ff ff       	jmp    80105c9f <alltraps>
...
80106273:	6a 1a                	push   $0x1a
  jmp alltraps
80106275:	e9 25 fa ff ff       	jmp    80105c9f <alltraps>
...
8010627c:	6a 1b                	push   $0x1b
  jmp alltraps
8010627e:	e9 1c fa ff ff       	jmp    80105c9f <alltraps>
...
80106285:	6a 1c                	push   $0x1c
  jmp alltraps
80106287:	e9 13 fa ff ff       	jmp    80105c9f <alltraps>
...
8010628e:	6a 1d                	push   $0x1d
  jmp alltraps
80106290:	e9 0a fa ff ff       	jmp    80105c9f <alltraps>
...
80106297:	6a 1e                	push   $0x1e
  jmp alltraps
80106299:	e9 01 fa ff ff       	jmp    80105c9f <alltraps>
...
801062a0:	6a 1f                	push   $0x1f
  jmp alltraps
801062a2:	e9 f8 f9 ff ff       	jmp    80105c9f <alltraps>
...
801062a9:	6a 20                	push   $0x20
  jmp alltraps
801062ab:	e9 ef f9 ff ff       	jmp    80105c9f <alltraps>
...
801062b2:	6a 21                	push   $0x21
  jmp alltraps
801062b4:	e9 e6 f9 ff ff       	jmp    80105c9f <alltraps>
...
801062bb:	6a 22                	push   $0x22
  jmp alltraps
801062bd:	e9 dd f9 ff ff       	jmp    80105c9f <alltraps>
...
801062c4:	6a 23                	push   $0x23
  jmp alltraps
801062c6:	e9 d4 f9 ff ff       	jmp    80105c9f <alltraps>
...
801062cd:	6a 24                	push   $0x24
  jmp alltraps
801062cf:	e9 cb f9 ff ff       	jmp    80105c9f <alltraps>
...
801062d6:	6a 25                	push   $0x25
  jmp alltraps
801062d8:	e9 c2 f9 ff ff       	jmp    80105c9f <alltraps>
...
801062df:	6a 26                	push   $0x26
  jmp alltraps
801062e1:	e9 b9 f9 ff ff       	jmp    80105c9f <alltraps>
...
801062e8:	6a 27                	push   $0x27
  jmp alltraps
801062ea:	e9 b0 f9 ff ff       	jmp    80105c9f <alltraps>
...
801062f1:	6a 28                	push   $0x28
  jmp alltraps
801062f3:	e9 a7 f9 ff ff       	jmp    80105c9f <alltraps>
...
801062fa:	6a 29                	push   $0x29
  jmp alltraps
801062fc:	e9 9e f9 ff ff       	jmp    80105c9f <alltraps>
...
80106303:	6a 2a                	push   $0x2a
  jmp alltraps
80106305:	e9 95 f9 ff ff       	jmp    80105c9f <alltraps>
...
8010630c:	6a 2b                	push   $0x2b
  jmp alltraps
8010630e:	e9 8c f9 ff ff       	jmp    80105c9f <alltraps>
...
80106315:	6a 2c                	push   $0x2c
  jmp alltraps
80106317:	e9 83 f9 ff ff       	jmp    80105c9f <alltraps>
...
8010631e:	6a 2d                	push   $0x2d
  jmp alltraps
80106320:	e9 7a f9 ff ff       	jmp    80105c9f <alltraps>
...
80106327:	6a 2e                	push   $0x2e
  jmp alltraps
80106329:	e9 71 f9 ff ff       	jmp    80105c9f <alltraps>
...
80106330:	6a 2f                	push   $0x2f
  jmp alltraps
80106332:	e9 68 f9 ff ff       	jmp    80105c9f <alltraps>
...
80106339:	6a 30                	push   $0x30
  jmp alltraps
8010633b:	e9 5f f9 ff ff       	jmp    80105c9f <alltraps>
...
80106342:	6a 31                	push   $0x31
  jmp alltraps
80106344:	e9 56 f9 ff ff       	jmp    80105c9f <alltraps>
...
8010634b:	6a 32                	push   $0x32
  jmp alltraps
8010634d:	e9 4d f9 ff ff       	jmp    80105c9f <alltraps>
...
80106354:	6a 33                	push   $0x33
  jmp alltraps
80106356:	e9 44 f9 ff ff       	jmp    80105c9f <alltraps>
...
8010635d:	6a 34                	push   $0x34
  jmp alltraps
8010635f:	e9 3b f9 ff ff       	jmp    80105c9f <alltraps>
...
80106366:	6a 35                	push   $0x35
  jmp alltraps
80106368:	e9 32 f9 ff ff       	jmp    80105c9f <alltraps>
...
8010636f:	6a 36                	push   $0x36
  jmp alltraps
80106371:	e9 29 f9 ff ff       	jmp    80105c9f <alltraps>
...
80106378:	6a 37                	push   $0x37
  jmp alltraps
8010637a:	e9 20 f9 ff ff       	jmp    80105c9f <alltraps>
...
80106381:	6a 38                	push   $0x38
  jmp alltraps
80106383:	e9 17 f9 ff ff       	jmp    80105c9f <alltraps>
...
8010638a:	6a 39                	push   $0x39
  jmp alltraps
8010638c:	e9 0e f9 ff ff       	jmp    80105c9f <alltraps>
...
80106393:	6a 3a                	push   $0x3a
  jmp alltraps
80106395:	e9 05 f9 ff ff       	jmp    80105c9f <alltraps>
...
8010639c:	6a 3b                	push   $0x3b
  jmp alltraps
8010639e:	e9 fc f8 ff ff       	jmp    80105c9f <alltraps>
...
801063a5:	6a 3c                	push   $0x3c
  jmp alltraps
801063a7:	e9 f3 f8 ff ff       	jmp    80105c9f <alltraps>
...
801063ae:	6a 3d                	push   $0x3d
  jmp alltraps
801063b0:	e9 ea f8 ff ff       	jmp    80105c9f <alltraps>
...
801063b7:	6a 3e                	push   $0x3e
  jmp alltraps
801063b9:	e9 e1 f8 ff ff       	jmp    80105c9f <alltraps>
...
801063c0:	6a 3f                	push   $0x3f
  jmp alltraps
801063c2:	e9 d8 f8 ff ff       	jmp    80105c9f <alltraps>
...
801063c9:	6a 40                	push   $0x40
  jmp alltraps
801063cb:	e9 cf f8 ff ff       	jmp    80105c9f <alltraps>
...
801063d2:	6a 41                	push   $0x41
  jmp alltraps
801063d4:	e9 c6 f8 ff ff       	jmp    80105c9f <alltraps>
...
801063db:	6a 42                	push   $0x42
  jmp alltraps
801063dd:	e9 bd f8 ff ff       	jmp    80105c9f <alltraps>
...
801063e4:	6a 43                	push   $0x43
  jmp alltraps
801063e6:	e9 b4 f8 ff ff       	jmp    80105c9f <alltraps>
...
801063ed:	6a 44                	push   $0x44
  jmp alltraps
801063ef:	e9 ab f8 ff ff       	jmp    80105c9f <alltraps>
...
801063f6:	6a 45                	push   $0x45
  jmp alltraps
801063f8:	e9 a2 f8 ff ff       	jmp    80105c9f <alltraps>
...
801063ff:	6a 46                	push   $0x46
  jmp alltraps
80106401:	e9 99 f8 ff ff       	jmp    80105c9f <alltraps>
...
80106408:	6a 47                	push   $0x47
  jmp alltraps
8010640a:	e9 90 f8 ff ff       	jmp    80105c9f <alltraps>
...
80106411:	6a 48                	push   $0x48
  jmp alltraps
80106413:	e9 87 f8 ff ff       	jmp    80105c9f <alltraps>
...
8010641a:	6a 49                	push   $0x49
  jmp alltraps
8010641c:	e9 7e f8 ff ff       	jmp    80105c9f <alltraps>
...
80106423:	6a 4a                	push   $0x4a
  jmp alltraps
80106425:	e9 75 f8 ff ff       	jmp    80105c9f <alltraps>
...
8010642c:	6a 4b                	push   $0x4b
  jmp alltraps
8010642e:	e9 6c f8 ff ff       	jmp    80105c9f <alltraps>
...
80106435:	6a 4c                	push   $0x4c
  jmp alltraps
80106437:	e9 63 f8 ff ff       	jmp    80105c9f <alltraps>
...
8010643e:	6a 4d                	push   $0x4d
  jmp alltraps
80106440:	e9 5a f8 ff ff       	jmp    80105c9f <alltraps>
...
80106447:	6a 4e                	push   $0x4e
  jmp alltraps
80106449:	e9 51 f8 ff ff       	jmp    80105c9f <alltraps>
...
80106450:	6a 4f                	push   $0x4f
  jmp alltraps
80106452:	e9 48 f8 ff ff       	jmp    80105c9f <alltraps>
...
80106459:	6a 50                	push   $0x50
  jmp alltraps
8010645b:	e9 3f f8 ff ff       	jmp    80105c9f <alltraps>
...
80106462:	6a 51                	push   $0x51
  jmp alltraps
80106464:	e9 36 f8 ff ff       	jmp    80105c9f <alltraps>
...
8010646b:	6a 52                	push   $0x52
  jmp alltraps
8010646d:	e9 2d f8 ff ff       	jmp    80105c9f <alltraps>
...
80106474:	6a 53                	push   $0x53
  jmp alltraps
80106476:	e9 24 f8 ff ff       	jmp    80105c9f <alltraps>
...
8010647d:	6a 54                	push   $0x54
  jmp alltraps
8010647f:	e9 1b f8 ff ff       	jmp    80105c9f <alltraps>
...
80106486:	6a 55                	push   $0x55
  jmp alltraps
80106488:	e9 12 f8 ff ff       	jmp    80105c9f <alltraps>
...
8010648f:	6a 56                	push   $0x56
  jmp alltraps
80106491:	e9 09 f8 ff ff       	jmp    80105c9f <alltraps>
...
80106498:	6a 57                	push   $0x57
  jmp alltraps
8010649a:	e9 00 f8 ff ff       	jmp    80105c9f <alltraps>
...
801064a1:	6a 58                	push   $0x58
  jmp alltraps
801064a3:	e9 f7 f7 ff ff       	jmp    80105c9f <alltraps>
...
801064aa:	6a 59                	push   $0x59
  jmp alltraps
801064ac:	e9 ee f7 ff ff       	jmp    80105c9f <alltraps>
...
801064b3:	6a 5a                	push   $0x5a
  jmp alltraps
801064b5:	e9 e5 f7 ff ff       	jmp    80105c9f <alltraps>
...
801064bc:	6a 5b                	push   $0x5b
  jmp alltraps
801064be:	e9 dc f7 ff ff       	jmp    80105c9f <alltraps>
...
801064c5:	6a 5c                	push   $0x5c
  jmp alltraps
801064c7:	e9 d3 f7 ff ff       	jmp    80105c9f <alltraps>
...
801064ce:	6a 5d                	push   $0x5d
  jmp alltraps
801064d0:	e9 ca f7 ff ff       	jmp    80105c9f <alltraps>
...
801064d7:	6a 5e                	push   $0x5e
  jmp alltraps
801064d9:	e9 c1 f7 ff ff       	jmp    80105c9f <alltraps>
...
801064e0:	6a 5f                	push   $0x5f
  jmp alltraps
801064e2:	e9 b8 f7 ff ff       	jmp    80105c9f <alltraps>
...
801064e9:	6a 60                	push   $0x60
  jmp alltraps
801064eb:	e9 af f7 ff ff       	jmp    80105c9f <alltraps>
...
801064f2:	6a 61                	push   $0x61
  jmp alltraps
801064f4:	e9 a6 f7 ff ff       	jmp    80105c9f <alltraps>
...
801064fb:	6a 62                	push   $0x62
  jmp alltraps
801064fd:	e9 9d f7 ff ff       	jmp    80105c9f <alltraps>
...
80106504:	6a 63                	push   $0x63
  jmp alltraps
80106506:	e9 94 f7 ff ff       	jmp    80105c9f <alltraps>
...
8010650d:	6a 64                	push   $0x64
  jmp alltraps
8010650f:	e9 8b f7 ff ff       	jmp    80105c9f <alltraps>
...
80106516:	6a 65                	push   $0x65
  jmp alltraps
80106518:	e9 82 f7 ff ff       	jmp    80105c9f <alltraps>
...
8010651f:	6a 66                	push   $0x66
  jmp alltraps
80106521:	e9 79 f7 ff ff       	jmp    80105c9f <alltraps>
...
80106528:	6a 67                	push   $0x67
  jmp alltraps
8010652a:	e9 70 f7 ff ff       	jmp    80105c9f <alltraps>
...
80106531:	6a 68                	push   $0x68
  jmp alltraps
80106533:	e9 67 f7 ff ff       	jmp    80105c9f <alltraps>
...
8010653a:	6a 69                	push   $0x69
  jmp alltraps
8010653c:	e9 5e f7 ff ff       	jmp    80105c9f <alltraps>
...
80106543:	6a 6a                	push   $0x6a
  jmp alltraps
80106545:	e9 55 f7 ff ff       	jmp    80105c9f <alltraps>
...
8010654c:	6a 6b                	push   $0x6b
  jmp alltraps
8010654e:	e9 4c f7 ff ff       	jmp    80105c9f <alltraps>
...
80106555:	6a 6c                	push   $0x6c
  jmp alltraps
80106557:	e9 43 f7 ff ff       	jmp    80105c9f <alltraps>
...
8010655e:	6a 6d                	push   $0x6d
  jmp alltraps
80106560:	e9 3a f7 ff ff       	jmp    80105c9f <alltraps>
...
80106567:	6a 6e                	push   $0x6e
  jmp alltraps
80106569:	e9 31 f7 ff ff       	jmp    80105c9f <alltraps>
...
80106570:	6a 6f                	push   $0x6f
  jmp alltraps
80106572:	e9 28 f7 ff ff       	jmp    80105c9f <alltraps>
...
80106579:	6a 70                	push   $0x70
  jmp alltraps
8010657b:	e9 1f f7 ff ff       	jmp    80105c9f <alltraps>
...
80106582:	6a 71                	push   $0x71
  jmp alltraps
80106584:	e9 16 f7 ff ff       	jmp    80105c9f <alltraps>
...
8010658b:	6a 72                	push   $0x72
  jmp alltraps
8010658d:	e9 0d f7 ff ff       	jmp    80105c9f <alltraps>
...
80106594:	6a 73                	push   $0x73
  jmp alltraps
80106596:	e9 04 f7 ff ff       	jmp    80105c9f <alltraps>
...
8010659d:	6a 74                	push   $0x74
  jmp alltraps
8010659f:	e9 fb f6 ff ff       	jmp    80105c9f <alltraps>
...
801065a6:	6a 75                	push   $0x75
  jmp alltraps
801065a8:	e9 f2 f6 ff ff       	jmp    80105c9f <alltraps>
...
801065af:	6a 76                	push   $0x76
  jmp alltraps
801065b1:	e9 e9 f6 ff ff       	jmp    80105c9f <alltraps>
...
801065b8:	6a 77                	push   $0x77
  jmp alltraps
801065ba:	e9 e0 f6 ff ff       	jmp    80105c9f <alltraps>
...
801065c1:	6a 78                	push   $0x78
  jmp alltraps
801065c3:	e9 d7 f6 ff ff       	jmp    80105c9f <alltraps>
...
801065ca:	6a 79                	push   $0x79
  jmp alltraps
801065cc:	e9 ce f6 ff ff       	jmp    80105c9f <alltraps>
...
801065d3:	6a 7a                	push   $0x7a
  jmp alltraps
801065d5:	e9 c5 f6 ff ff       	jmp    80105c9f <alltraps>
...
801065dc:	6a 7b                	push   $0x7b
  jmp alltraps
801065de:	e9 bc f6 ff ff       	jmp    80105c9f <alltraps>
...
801065e5:	6a 7c                	push   $0x7c
  jmp alltraps
801065e7:	e9 b3 f6 ff ff       	jmp    80105c9f <alltraps>
...
801065ee:	6a 7d                	push   $0x7d
  jmp alltraps
801065f0:	e9 aa f6 ff ff       	jmp    80105c9f <alltraps>
...
801065f7:	6a 7e                	push   $0x7e
  jmp alltraps
801065f9:	e9 a1 f6 ff ff       	jmp    80105c9f <alltraps>
...
80106600:	6a 7f                	push   $0x7f
  jmp alltraps
80106602:	e9 98 f6 ff ff       	jmp    80105c9f <alltraps>
...
80106609:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010660e:	e9 8c f6 ff ff       	jmp    80105c9f <alltraps>
...
80106615:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010661a:	e9 80 f6 ff ff       	jmp    80105c9f <alltraps>
...
80106621:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106626:	e9 74 f6 ff ff       	jmp    80105c9f <alltraps>
...
8010662d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106632:	e9 68 f6 ff ff       	jmp    80105c9f <alltraps>
...
80106639:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010663e:	e9 5c f6 ff ff       	jmp    80105c9f <alltraps>
...
80106645:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010664a:	e9 50 f6 ff ff       	jmp    80105c9f <alltraps>
...
80106651:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106656:	e9 44 f6 ff ff       	jmp    80105c9f <alltraps>
...
8010665d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106662:	e9 38 f6 ff ff       	jmp    80105c9f <alltraps>
...
80106669:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010666e:	e9 2c f6 ff ff       	jmp    80105c9f <alltraps>
...
80106675:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010667a:	e9 20 f6 ff ff       	jmp    80105c9f <alltraps>
...
80106681:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106686:	e9 14 f6 ff ff       	jmp    80105c9f <alltraps>
...
8010668d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106692:	e9 08 f6 ff ff       	jmp    80105c9f <alltraps>
...
80106699:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010669e:	e9 fc f5 ff ff       	jmp    80105c9f <alltraps>
...
801066a5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801066aa:	e9 f0 f5 ff ff       	jmp    80105c9f <alltraps>
...
801066b1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801066b6:	e9 e4 f5 ff ff       	jmp    80105c9f <alltraps>
...
801066bd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801066c2:	e9 d8 f5 ff ff       	jmp    80105c9f <alltraps>
...
801066c9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801066ce:	e9 cc f5 ff ff       	jmp    80105c9f <alltraps>
...
801066d5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801066da:	e9 c0 f5 ff ff       	jmp    80105c9f <alltraps>
...
801066e1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801066e6:	e9 b4 f5 ff ff       	jmp    80105c9f <alltraps>
...
801066ed:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801066f2:	e9 a8 f5 ff ff       	jmp    80105c9f <alltraps>
...
801066f9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801066fe:	e9 9c f5 ff ff       	jmp    80105c9f <alltraps>
...
80106705:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010670a:	e9 90 f5 ff ff       	jmp    80105c9f <alltraps>
...
80106711:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106716:	e9 84 f5 ff ff       	jmp    80105c9f <alltraps>
...
8010671d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106722:	e9 78 f5 ff ff       	jmp    80105c9f <alltraps>
...
80106729:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010672e:	e9 6c f5 ff ff       	jmp    80105c9f <alltraps>
...
80106735:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010673a:	e9 60 f5 ff ff       	jmp    80105c9f <alltraps>
...
80106741:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106746:	e9 54 f5 ff ff       	jmp    80105c9f <alltraps>
...
8010674d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106752:	e9 48 f5 ff ff       	jmp    80105c9f <alltraps>
...
80106759:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010675e:	e9 3c f5 ff ff       	jmp    80105c9f <alltraps>
...
80106765:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010676a:	e9 30 f5 ff ff       	jmp    80105c9f <alltraps>
...
80106771:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106776:	e9 24 f5 ff ff       	jmp    80105c9f <alltraps>
...
8010677d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106782:	e9 18 f5 ff ff       	jmp    80105c9f <alltraps>
...
80106789:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010678e:	e9 0c f5 ff ff       	jmp    80105c9f <alltraps>
...
80106795:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010679a:	e9 00 f5 ff ff       	jmp    80105c9f <alltraps>
...
801067a1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801067a6:	e9 f4 f4 ff ff       	jmp    80105c9f <alltraps>
...
801067ad:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801067b2:	e9 e8 f4 ff ff       	jmp    80105c9f <alltraps>
...
801067b9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801067be:	e9 dc f4 ff ff       	jmp    80105c9f <alltraps>
...
801067c5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801067ca:	e9 d0 f4 ff ff       	jmp    80105c9f <alltraps>
...
801067d1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801067d6:	e9 c4 f4 ff ff       	jmp    80105c9f <alltraps>
...
801067dd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801067e2:	e9 b8 f4 ff ff       	jmp    80105c9f <alltraps>
...
801067e9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801067ee:	e9 ac f4 ff ff       	jmp    80105c9f <alltraps>
...
801067f5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801067fa:	e9 a0 f4 ff ff       	jmp    80105c9f <alltraps>
...
80106801:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106806:	e9 94 f4 ff ff       	jmp    80105c9f <alltraps>
...
8010680d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106812:	e9 88 f4 ff ff       	jmp    80105c9f <alltraps>
...
80106819:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010681e:	e9 7c f4 ff ff       	jmp    80105c9f <alltraps>
...
80106825:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010682a:	e9 70 f4 ff ff       	jmp    80105c9f <alltraps>
...
80106831:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106836:	e9 64 f4 ff ff       	jmp    80105c9f <alltraps>
...
8010683d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106842:	e9 58 f4 ff ff       	jmp    80105c9f <alltraps>
...
80106849:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010684e:	e9 4c f4 ff ff       	jmp    80105c9f <alltraps>
...
80106855:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010685a:	e9 40 f4 ff ff       	jmp    80105c9f <alltraps>
...
80106861:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106866:	e9 34 f4 ff ff       	jmp    80105c9f <alltraps>
...
8010686d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106872:	e9 28 f4 ff ff       	jmp    80105c9f <alltraps>
...
80106879:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010687e:	e9 1c f4 ff ff       	jmp    80105c9f <alltraps>
...
80106885:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010688a:	e9 10 f4 ff ff       	jmp    80105c9f <alltraps>
...
80106891:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106896:	e9 04 f4 ff ff       	jmp    80105c9f <alltraps>
...
8010689d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801068a2:	e9 f8 f3 ff ff       	jmp    80105c9f <alltraps>
...
801068a9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801068ae:	e9 ec f3 ff ff       	jmp    80105c9f <alltraps>
...
801068b5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801068ba:	e9 e0 f3 ff ff       	jmp    80105c9f <alltraps>
...
801068c1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801068c6:	e9 d4 f3 ff ff       	jmp    80105c9f <alltraps>
...
801068cd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801068d2:	e9 c8 f3 ff ff       	jmp    80105c9f <alltraps>
...
801068d9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801068de:	e9 bc f3 ff ff       	jmp    80105c9f <alltraps>
...
801068e5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801068ea:	e9 b0 f3 ff ff       	jmp    80105c9f <alltraps>
...
801068f1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801068f6:	e9 a4 f3 ff ff       	jmp    80105c9f <alltraps>
...
801068fd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106902:	e9 98 f3 ff ff       	jmp    80105c9f <alltraps>
...
80106909:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010690e:	e9 8c f3 ff ff       	jmp    80105c9f <alltraps>
...
80106915:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010691a:	e9 80 f3 ff ff       	jmp    80105c9f <alltraps>
...
80106921:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106926:	e9 74 f3 ff ff       	jmp    80105c9f <alltraps>
...
8010692d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106932:	e9 68 f3 ff ff       	jmp    80105c9f <alltraps>
...
80106939:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010693e:	e9 5c f3 ff ff       	jmp    80105c9f <alltraps>
...
80106945:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010694a:	e9 50 f3 ff ff       	jmp    80105c9f <alltraps>
...
80106951:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106956:	e9 44 f3 ff ff       	jmp    80105c9f <alltraps>
...
8010695d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106962:	e9 38 f3 ff ff       	jmp    80105c9f <alltraps>
...
80106969:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010696e:	e9 2c f3 ff ff       	jmp    80105c9f <alltraps>
...
80106975:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010697a:	e9 20 f3 ff ff       	jmp    80105c9f <alltraps>
...
80106981:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106986:	e9 14 f3 ff ff       	jmp    80105c9f <alltraps>
...
8010698d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106992:	e9 08 f3 ff ff       	jmp    80105c9f <alltraps>
...
80106999:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010699e:	e9 fc f2 ff ff       	jmp    80105c9f <alltraps>
...
801069a5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801069aa:	e9 f0 f2 ff ff       	jmp    80105c9f <alltraps>
...
801069b1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801069b6:	e9 e4 f2 ff ff       	jmp    80105c9f <alltraps>
...
801069bd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801069c2:	e9 d8 f2 ff ff       	jmp    80105c9f <alltraps>
...
801069c9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801069ce:	e9 cc f2 ff ff       	jmp    80105c9f <alltraps>
...
801069d5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801069da:	e9 c0 f2 ff ff       	jmp    80105c9f <alltraps>
...
801069e1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801069e6:	e9 b4 f2 ff ff       	jmp    80105c9f <alltraps>
...
801069ed:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801069f2:	e9 a8 f2 ff ff       	jmp    80105c9f <alltraps>
...
801069f9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801069fe:	e9 9c f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a05:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106a0a:	e9 90 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a11:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106a16:	e9 84 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a1d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106a22:	e9 78 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a29:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106a2e:	e9 6c f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a35:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106a3a:	e9 60 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a41:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106a46:	e9 54 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a4d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106a52:	e9 48 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a59:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106a5e:	e9 3c f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a65:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106a6a:	e9 30 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a71:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106a76:	e9 24 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a7d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106a82:	e9 18 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a89:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106a8e:	e9 0c f2 ff ff       	jmp    80105c9f <alltraps>
...
80106a95:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106a9a:	e9 00 f2 ff ff       	jmp    80105c9f <alltraps>
...
80106aa1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106aa6:	e9 f4 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106aad:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106ab2:	e9 e8 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106ab9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106abe:	e9 dc f1 ff ff       	jmp    80105c9f <alltraps>
...
80106ac5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106aca:	e9 d0 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106ad1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106ad6:	e9 c4 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106add:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106ae2:	e9 b8 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106ae9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106aee:	e9 ac f1 ff ff       	jmp    80105c9f <alltraps>
...
80106af5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106afa:	e9 a0 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b01:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106b06:	e9 94 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b0d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106b12:	e9 88 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b19:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106b1e:	e9 7c f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b25:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106b2a:	e9 70 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b31:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106b36:	e9 64 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b3d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106b42:	e9 58 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b49:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106b4e:	e9 4c f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b55:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106b5a:	e9 40 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b61:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106b66:	e9 34 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b6d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106b72:	e9 28 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b79:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106b7e:	e9 1c f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b85:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106b8a:	e9 10 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b91:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106b96:	e9 04 f1 ff ff       	jmp    80105c9f <alltraps>
...
80106b9d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106ba2:	e9 f8 f0 ff ff       	jmp    80105c9f <alltraps>
...
80106ba9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106bae:	e9 ec f0 ff ff       	jmp    80105c9f <alltraps>
...
80106bb5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106bba:	e9 e0 f0 ff ff       	jmp    80105c9f <alltraps>
...
80106bc1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106bc6:	e9 d4 f0 ff ff       	jmp    80105c9f <alltraps>
...
80106bcd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106bd2:	e9 c8 f0 ff ff       	jmp    80105c9f <alltraps>
...
80106bd9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106bde:	e9 bc f0 ff ff       	jmp    80105c9f <alltraps>
...
80106be5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106bea:	e9 b0 f0 ff ff       	jmp    80105c9f <alltraps>
...
80106bf1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106bf6:	e9 a4 f0 ff ff       	jmp    80105c9f <alltraps>
...
80106bfd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106c02:	e9 98 f0 ff ff       	jmp    80105c9f <alltraps>
...
80106d55:	e8 86 dc ff ff       	call   801049e0 <memset>
...
80106d9d:	68 b0 7e 10 80       	push   $0x80107eb0
...
80106e74:	0f 84 c2 00 00 00    	je     80106f3c <switchuvm+0xec>
  pushcli();
80106e7a:	e8 51 d9 ff ff       	call   801047d0 <pushcli>
...
80106fc2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106fc3:	e9 b8 da ff ff       	jmp    80104a80 <memmove>
    panic("inituvm: more than a page");
80106fc8:	83 ec 0c             	sub    $0xc,%esp
80106fcb:	68 f5 7e 10 80       	push   $0x80107ef5
...
80107030:	68 0f 7f 10 80       	push   $0x80107f0f
...
801070b8:	68 b0 7f 10 80       	push   $0x80107fb0
...
8010711b:	e8 c0 d8 ff ff       	call   801049e0 <memset>
...
80107159:	68 2d 7f 10 80       	push   $0x80107f2d
...
801071bb:	68 45 7f 10 80       	push   $0x80107f45
...
8010729c:	68 61 7f 10 80       	push   $0x80107f61
...
801072d0:	e8 0b d7 ff ff       	call   801049e0 <memset>
...
8010733b:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010736c:	68 72 7f 10 80       	push   $0x80107f72
...
801073e2:	68 7c 7f 10 80       	push   $0x80107f7c
...
80107440:	e8 3b d6 ff ff       	call   80104a80 <memmove>
...
801074b7:	68 96 7f 10 80       	push   $0x80107f96
...
80107570:	e8 0b d5 ff ff       	call   80104a80 <memmove>
    len -= n;
    buf += n;
