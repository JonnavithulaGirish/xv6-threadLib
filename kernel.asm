...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 5f 7f 10 80 	movl   $0x80107f5f,(%esp)
...
80100551:	e8 1a 45 00 00       	call   80104a70 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 65 44 00 00       	call   801049d0 <memset>
  outb(CRTPORT+1, pos);
...
801005ab:	e8 60 43 00 00       	call   80104910 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 c7 42 00 00       	call   801048b0 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 23 41 00 00       	call   80104910 <acquire>
...
8010085b:	e8 50 40 00 00       	call   801048b0 <release>
...
80100893:	e8 78 40 00 00       	call   80104910 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 db 3e 00 00       	call   801048b0 <release>
  if(doprocdump) {
...
80100a70:	e8 cb 3c 00 00       	call   80104740 <initlock>
...
80100cd3:	e8 f8 3e 00 00       	call   80104bd0 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 e4 3e 00 00       	call   80104bd0 <strlen>
...
80100da1:	e8 ea 3d 00 00       	call   80104b90 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e20:	e8 1b 39 00 00       	call   80104740 <initlock>
}
...
80100e41:	e8 ca 3a 00 00       	call   80104910 <acquire>
...
80100e71:	e8 3a 3a 00 00       	call   801048b0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 21 3a 00 00       	call   801048b0 <release>
}
...
80100eaf:	e8 5c 3a 00 00       	call   80104910 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 df 39 00 00       	call   801048b0 <release>
  return f;
}
...
80100f01:	e8 0a 3a 00 00       	call   80104910 <acquire>
  if(f->ref < 1)
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 3d 39 00 00       	jmp    801048b0 <release>
...
80101325:	e8 a6 36 00 00       	call   801049d0 <memset>
  log_write(bp);
...
8010136a:	e8 a1 35 00 00       	call   80104910 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 d4 34 00 00       	call   801048b0 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 a6 34 00 00       	call   801048b0 <release>
      return ip;
...
80101541:	e8 2a 35 00 00       	call   80104a70 <memmove>
  brelse(bp);
...
80101576:	e8 c5 31 00 00       	call   80104740 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 7c 30 00 00       	call   80104610 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 af 34 00 00       	call   80104a70 <memmove>
  brelse(bp);
...
8010168e:	e8 3d 33 00 00       	call   801049d0 <memset>
      dip->type = type;
...
80101731:	e8 3a 33 00 00       	call   80104a70 <memmove>
  log_write(bp);
...
8010175f:	e8 ac 31 00 00       	call   80104910 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 3c 31 00 00       	call   801048b0 <release>
}
...
801017a2:	e8 a9 2e 00 00       	call   80104650 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 53 32 00 00       	call   80104a70 <memmove>
    brelse(bp);
...
80101873:	e8 78 2e 00 00       	call   801046f0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 1c 2e 00 00       	jmp    801046b0 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 8b 2d 00 00       	call   80104650 <acquiresleep>
...
801018da:	e8 d1 2d 00 00       	call   801046b0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 25 30 00 00       	call   80104910 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 ab 2f 00 00       	jmp    801048b0 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 fb 2f 00 00       	call   80104910 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 8c 2f 00 00       	call   801048b0 <release>
    if(r == 1){
...
80101a23:	e8 c8 2c 00 00       	call   801046f0 <holdingsleep>
...
80101a3a:	e8 71 2c 00 00       	call   801046b0 <releasesleep>
  iput(ip);
...
80101b37:	e8 34 2f 00 00       	call   80104a70 <memmove>
    brelse(bp);
...
80101c33:	e8 38 2e 00 00       	call   80104a70 <memmove>
    log_write(bp);
...
80101cce:	e8 0d 2e 00 00       	call   80104ae0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 ae 2d 00 00       	call   80104ae0 <strncmp>
      continue;
...
80101dba:	e8 51 2b 00 00       	call   80104910 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 e1 2a 00 00       	call   801048b0 <release>
...
80101e27:	e8 44 2c 00 00       	call   80104a70 <memmove>
...
80101e8c:	e8 5f 28 00 00       	call   801046f0 <holdingsleep>
...
80101eae:	e8 fd 27 00 00       	call   801046b0 <releasesleep>
  iput(ip);
...
80101edb:	e8 90 2b 00 00       	call   80104a70 <memmove>
    name[len] = 0;
...
80101f2b:	e8 c0 27 00 00       	call   801046f0 <holdingsleep>
...
80101f4a:	e8 61 27 00 00       	call   801046b0 <releasesleep>
  iput(ip);
...
80101f6d:	e8 7e 27 00 00       	call   801046f0 <holdingsleep>
...
80101f90:	e8 5b 27 00 00       	call   801046f0 <holdingsleep>
...
80101fa7:	e8 04 27 00 00       	call   801046b0 <releasesleep>
}
...
8010203d:	e8 ee 2a 00 00       	call   80104b30 <strncpy>
...
80102088:	68 46 7d 10 80       	push   $0x80107d46
...
801021d0:	e8 6b 25 00 00       	call   80104740 <initlock>
...
8010224e:	e8 bd 26 00 00       	call   80104910 <acquire>
...
801022cb:	e8 e0 25 00 00       	call   801048b0 <release>
...
801022ee:	e8 fd 23 00 00       	call   801046f0 <holdingsleep>
...
80102328:	e8 e3 25 00 00       	call   80104910 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 25 25 00 00       	jmp    801048b0 <release>
...
801024f2:	e8 d9 24 00 00       	call   801049d0 <memset>
...
80102528:	e8 e3 23 00 00       	call   80104910 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 68 23 00 00       	jmp    801048b0 <release>
    panic("kfree");
...
80102625:	e8 16 21 00 00       	call   80104740 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 58 22 00 00       	call   80104910 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 ca 21 00 00       	call   801048b0 <release>
  return (char*)r;
...
80102af7:	e8 24 1f 00 00       	call   80104a20 <memcmp>
...
80102c24:	e8 47 1e 00 00       	call   80104a70 <memmove>
...
80102cd4:	e8 67 1a 00 00       	call   80104740 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 a0 1b 00 00       	call   80104910 <acquire>
...
80102d85:	e8 d6 15 00 00       	call   80104360 <sleep>
...
80102dbc:	e8 ef 1a 00 00       	call   801048b0 <release>
      break;
    }
  }
}
...
80102e1c:	e8 8f 1a 00 00       	call   801048b0 <release>
}
...
80102e36:	e8 d5 1a 00 00       	call   80104910 <acquire>
    wakeup(&log);
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 cf 15 00 00       	call   80104420 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
80102e58:	e8 53 1a 00 00       	call   801048b0 <release>
...
80102eb4:	e8 b7 1b 00 00       	call   80104a70 <memmove>
...
80102f08:	e8 13 15 00 00       	call   80104420 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
80102f14:	e8 97 19 00 00       	call   801048b0 <release>
...
80102f76:	e8 95 19 00 00       	call   80104910 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 f6 18 00 00       	jmp    801048b0 <release>
...
801030d4:	e8 97 19 00 00       	call   80104a70 <memmove>
...
801031c4:	e8 57 18 00 00       	call   80104a20 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 9c 17 00 00       	call   80104a20 <memcmp>
...
801033c8:	e8 53 16 00 00       	call   80104a20 <memcmp>
...
801034a9:	e8 92 12 00 00       	call   80104740 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 cc 13 00 00       	call   80104910 <acquire>
  if(writable){
...
8010355f:	e8 bc 0e 00 00       	call   80104420 <wakeup>
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 27 13 00 00       	jmp    801048b0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 17 13 00 00       	call   801048b0 <release>
    kfree((char*)p);
...
801035c4:	e8 57 0e 00 00       	call   80104420 <wakeup>
...
801035dd:	e8 2e 13 00 00       	call   80104910 <acquire>
  for(i = 0; i < n; i++){
...
80103638:	e8 e3 0d 00 00       	call   80104420 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010363d:	58                   	pop    %eax
8010363e:	5a                   	pop    %edx
8010363f:	53                   	push   %ebx
80103640:	56                   	push   %esi
80103641:	e8 1a 0d 00 00       	call   80104360 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010366c:	e8 3f 12 00 00       	call   801048b0 <release>
        return -1;
...
801036ba:	e8 61 0d 00 00       	call   80104420 <wakeup>
  release(&p->lock);
801036bf:	89 1c 24             	mov    %ebx,(%esp)
801036c2:	e8 e9 11 00 00       	call   801048b0 <release>
  return n;
...
801036e6:	e8 25 12 00 00       	call   80104910 <acquire>
...
80103715:	e8 46 0c 00 00       	call   80104360 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103776:	e8 a5 0c 00 00       	call   80104420 <wakeup>
  release(&p->lock);
8010377b:	89 34 24             	mov    %esi,(%esp)
8010377e:	e8 2d 11 00 00       	call   801048b0 <release>
  return i;
...
80103799:	e8 12 11 00 00       	call   801048b0 <release>
      return -1;
...
801037c1:	e8 4a 11 00 00       	call   80104910 <acquire>
...
80103803:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103809:	e8 a2 10 00 00       	call   801048b0 <release>
...
8010382b:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382e:	c7 40 14 a7 5c 10 80 	movl   $0x80105ca7,0x14(%eax)
  p->isthread = 0; 
80103835:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
8010383c:	00 00 00 
  p->context = (struct context*)sp;
...
80103847:	e8 84 11 00 00       	call   801049d0 <memset>
...
8010386a:	e8 41 10 00 00       	call   801048b0 <release>
}
...
8010389b:	e8 10 10 00 00       	call   801048b0 <release>
...
801038f0:	e8 4b 0e 00 00       	call   80104740 <initlock>
}
...
80103955:	68 24 7c 10 80       	push   $0x80107c24
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 34 0e 00 00       	call   801047c0 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 74 0e 00 00       	call   80104810 <popcli>
}
...
80103a55:	e8 36 11 00 00       	call   80104b90 <safestrcpy>
  p->cwd = namei("/");
...
80103aa9:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
80103aac:	e8 0f 0d 00 00       	call   801047c0 <pushcli>
  c = mycpu();
80103ab1:	e8 4a fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103abc:	e8 4f 0d 00 00       	call   80104810 <popcli>
  sz = curproc->sz;
...
80103ad7:	e8 34 0e 00 00       	call   80104910 <acquire>
...
80103b0e:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
80103b14:	75 e8                	jne    80103afe <growproc+0x5e>
  release(&ptable.lock);
80103b16:	83 ec 0c             	sub    $0xc,%esp
80103b19:	68 20 1d 11 80       	push   $0x80111d20
80103b1e:	e8 8d 0d 00 00       	call   801048b0 <release>
  switchuvm(curproc);
...
80103b86:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b89:	e8 32 0c 00 00       	call   801047c0 <pushcli>
  c = mycpu();
80103b8e:	e8 6d fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b93:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b99:	e8 72 0c 00 00       	call   80104810 <popcli>
  if((np = allocproc()) == 0){
...
80103ca6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103ca9:	e8 12 0b 00 00       	call   801047c0 <pushcli>
  c = mycpu();
80103cae:	e8 4d fc ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103cb3:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80103cb9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  popcli();
80103cbc:	e8 4f 0b 00 00       	call   80104810 <popcli>
  if((uint)stack%PGSIZE!=0){
80103cc1:	f7 45 14 ff 0f 00 00 	testl  $0xfff,0x14(%ebp)
80103cc8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103ccb:	0f 85 14 01 00 00    	jne    80103de5 <clone+0x145>
	if((curproc->sz - (uint)stack) < PGSIZE){
80103cd1:	8b 02                	mov    (%edx),%eax
80103cd3:	2b 45 14             	sub    0x14(%ebp),%eax
80103cd6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80103cd9:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80103cde:	0f 86 01 01 00 00    	jbe    80103de5 <clone+0x145>
  if((np = allocproc()) == 0){
80103ce4:	e8 c7 fa ff ff       	call   801037b0 <allocproc>
80103ce9:	89 c3                	mov    %eax,%ebx
80103ceb:	85 c0                	test   %eax,%eax
80103ced:	0f 84 f2 00 00 00    	je     80103de5 <clone+0x145>
  np->pgdir = curproc->pgdir;
80103cf3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  *np->tf = *curproc->tf;
80103cf6:	8b 7b 18             	mov    0x18(%ebx),%edi
80103cf9:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->pgdir = curproc->pgdir;
80103cfe:	8b 42 04             	mov    0x4(%edx),%eax
80103d01:	89 43 04             	mov    %eax,0x4(%ebx)
  np->sz = curproc->sz;
80103d04:	8b 02                	mov    (%edx),%eax
  np->parent = curproc;
80103d06:	89 53 14             	mov    %edx,0x14(%ebx)
  np->sz = curproc->sz;
80103d09:	89 03                	mov    %eax,(%ebx)
  ((uint *)stack)[size-3] = 0xFFFFFFFF;
80103d0b:	8b 45 14             	mov    0x14(%ebp),%eax
  *np->tf = *curproc->tf;
80103d0e:	8b 72 18             	mov    0x18(%edx),%esi
80103d11:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  ((uint *)stack)[size-2] = (uint)arg1;
80103d13:	8b 4d 14             	mov    0x14(%ebp),%ecx
  for(i = 0; i < NOFILE; i++)
80103d16:	31 f6                	xor    %esi,%esi
80103d18:	89 d7                	mov    %edx,%edi
  ((uint *)stack)[size-3] = 0xFFFFFFFF;
80103d1a:	c7 80 f4 0f 00 00 ff 	movl   $0xffffffff,0xff4(%eax)
80103d21:	ff ff ff 
  ((uint *)stack)[size-2] = (uint)arg1;
80103d24:	8b 45 0c             	mov    0xc(%ebp),%eax
  np->tf->ebp = (uint) stack +  PGSIZE - 3 * sizeof(void*);
80103d27:	81 c1 f4 0f 00 00    	add    $0xff4,%ecx
  ((uint *)stack)[size-2] = (uint)arg1;
80103d2d:	89 41 04             	mov    %eax,0x4(%ecx)
  ((uint *)stack)[size-1] = (uint)arg2;
80103d30:	8b 45 10             	mov    0x10(%ebp),%eax
80103d33:	89 41 08             	mov    %eax,0x8(%ecx)
  np->tf->ebp = (uint) stack +  PGSIZE - 3 * sizeof(void*);
80103d36:	8b 43 18             	mov    0x18(%ebx),%eax
80103d39:	89 48 08             	mov    %ecx,0x8(%eax)
  np->tf->esp = (uint) np->tf->ebp;
80103d3c:	8b 43 18             	mov    0x18(%ebx),%eax
80103d3f:	8b 48 08             	mov    0x8(%eax),%ecx
80103d42:	89 48 44             	mov    %ecx,0x44(%eax)
  np->tf->eip = (uint) fcn;
80103d45:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103d48:	8b 43 18             	mov    0x18(%ebx),%eax
80103d4b:	89 48 38             	mov    %ecx,0x38(%eax)
  np->stack = stack;
80103d4e:	8b 45 14             	mov    0x14(%ebp),%eax
  np->isthread =1;
80103d51:	c7 83 80 00 00 00 01 	movl   $0x1,0x80(%ebx)
80103d58:	00 00 00 
  np->stack = stack;
80103d5b:	89 43 7c             	mov    %eax,0x7c(%ebx)
  np->tf->eax = 0;
80103d5e:	8b 43 18             	mov    0x18(%ebx),%eax
80103d61:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103d68:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103d6f:	90                   	nop
    if(curproc->ofile[i])
80103d70:	8b 44 b7 28          	mov    0x28(%edi,%esi,4),%eax
80103d74:	85 c0                	test   %eax,%eax
80103d76:	74 10                	je     80103d88 <clone+0xe8>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103d78:	83 ec 0c             	sub    $0xc,%esp
80103d7b:	50                   	push   %eax
80103d7c:	e8 1f d1 ff ff       	call   80100ea0 <filedup>
...
80103d8e:	75 e0                	jne    80103d70 <clone+0xd0>
  np->cwd = idup(curproc->cwd);
80103d90:	83 ec 0c             	sub    $0xc,%esp
80103d93:	ff 77 68             	push   0x68(%edi)
80103d96:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80103d99:	e8 b2 d9 ff ff       	call   80101750 <idup>
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d9e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103da1:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103da4:	89 43 68             	mov    %eax,0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103da7:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103daa:	83 c2 6c             	add    $0x6c,%edx
80103dad:	6a 10                	push   $0x10
80103daf:	52                   	push   %edx
80103db0:	50                   	push   %eax
80103db1:	e8 da 0d 00 00       	call   80104b90 <safestrcpy>
  pid = np->pid;
80103db6:	8b 73 10             	mov    0x10(%ebx),%esi
  acquire(&ptable.lock);
80103db9:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103dc0:	e8 4b 0b 00 00       	call   80104910 <acquire>
  np->state = RUNNABLE;
80103dc5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103dcc:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103dd3:	e8 d8 0a 00 00       	call   801048b0 <release>
  return pid;
80103dd8:	83 c4 10             	add    $0x10,%esp
}
80103ddb:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103dde:	89 f0                	mov    %esi,%eax
80103de0:	5b                   	pop    %ebx
80103de1:	5e                   	pop    %esi
80103de2:	5f                   	pop    %edi
80103de3:	5d                   	pop    %ebp
80103de4:	c3                   	ret    
		return -1;
80103de5:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103dea:	eb ef                	jmp    80103ddb <clone+0x13b>
...
80103df6:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103df9:	e8 02 fb ff ff       	call   80103900 <mycpu>
  c->proc = 0;
...
80103e1e:	e8 ed 0a 00 00       	call   80104910 <acquire>
...
80103e40:	e8 fb 2f 00 00       	call   80106e40 <switchuvm>
...
80103e4b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103e52:	e8 94 0d 00 00       	call   80104beb <swtch>
      switchkvm();
80103e57:	e8 d4 2f 00 00       	call   80106e30 <switchkvm>
      c->proc = 0;
...
80103e6f:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80103e75:	75 b9                	jne    80103e30 <scheduler+0x40>
    release(&ptable.lock);
80103e77:	83 ec 0c             	sub    $0xc,%esp
80103e7a:	68 20 1d 11 80       	push   $0x80111d20
80103e7f:	e8 2c 0a 00 00       	call   801048b0 <release>
    sti();
...
80103e94:	53                   	push   %ebx
  pushcli();
80103e95:	e8 26 09 00 00       	call   801047c0 <pushcli>
  c = mycpu();
80103e9a:	e8 61 fa ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103e9f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ea5:	e8 66 09 00 00       	call   80104810 <popcli>
  if(!holding(&ptable.lock))
80103eaa:	83 ec 0c             	sub    $0xc,%esp
80103ead:	68 20 1d 11 80       	push   $0x80111d20
80103eb2:	e8 b9 09 00 00       	call   80104870 <holding>
80103eb7:	83 c4 10             	add    $0x10,%esp
80103eba:	85 c0                	test   %eax,%eax
80103ebc:	74 4f                	je     80103f0d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103ebe:	e8 3d fa ff ff       	call   80103900 <mycpu>
...
80103ed7:	75 41                	jne    80103f1a <sched+0x8a>
  intena = mycpu()->intena;
80103ed9:	e8 22 fa ff ff       	call   80103900 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103ede:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103ee1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103ee7:	e8 14 fa ff ff       	call   80103900 <mycpu>
80103eec:	83 ec 08             	sub    $0x8,%esp
80103eef:	ff 70 04             	push   0x4(%eax)
80103ef2:	53                   	push   %ebx
80103ef3:	e8 f3 0c 00 00       	call   80104beb <swtch>
  mycpu()->intena = intena;
80103ef8:	e8 03 fa ff ff       	call   80103900 <mycpu>
}
...
80103f56:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103f59:	e8 22 fa ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103f5e:	39 05 54 3e 11 80    	cmp    %eax,0x80113e54
80103f64:	0f 84 0f 01 00 00    	je     80104079 <exit+0x129>
...
80103fba:	e8 51 09 00 00       	call   80104910 <acquire>
...
80103fd5:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
...
80103ff3:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103ff8:	75 e2                	jne    80103fdc <exit+0x8c>
        p->parent = initproc;
80103ffa:	8b 0d 54 3e 11 80    	mov    0x80113e54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104000:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
...
80104016:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
8010401c:	74 42                	je     80104060 <exit+0x110>
    if(p->parent == curproc){
8010401e:	39 5a 14             	cmp    %ebx,0x14(%edx)
80104021:	75 ed                	jne    80104010 <exit+0xc0>
      if (p->isthread != 1){ 
80104023:	83 ba 80 00 00 00 01 	cmpl   $0x1,0x80(%edx)
8010402a:	74 e4                	je     80104010 <exit+0xc0>
        if(p->state == ZOMBIE)
8010402c:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
        p->parent = initproc;
80104030:	89 4a 14             	mov    %ecx,0x14(%edx)
        if(p->state == ZOMBIE)
80104033:	75 db                	jne    80104010 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104035:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010403a:	eb 10                	jmp    8010404c <exit+0xfc>
8010403c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104040:	05 84 00 00 00       	add    $0x84,%eax
80104045:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
8010404a:	74 c4                	je     80104010 <exit+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
8010404c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104050:	75 ee                	jne    80104040 <exit+0xf0>
80104052:	3b 48 20             	cmp    0x20(%eax),%ecx
80104055:	75 e9                	jne    80104040 <exit+0xf0>
      p->state = RUNNABLE;
80104057:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
8010405e:	eb e0                	jmp    80104040 <exit+0xf0>
  curproc->state = ZOMBIE;
80104060:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80104067:	e8 24 fe ff ff       	call   80103e90 <sched>
  panic("zombie exit");
8010406c:	83 ec 0c             	sub    $0xc,%esp
8010406f:	68 c8 7b 10 80       	push   $0x80107bc8
80104074:	e8 07 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80104079:	83 ec 0c             	sub    $0xc,%esp
8010407c:	68 bb 7b 10 80       	push   $0x80107bbb
80104081:	e8 fa c2 ff ff       	call   80100380 <panic>
...
80104095:	e8 26 07 00 00       	call   801047c0 <pushcli>
  c = mycpu();
8010409a:	e8 61 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010409f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040a5:	e8 66 07 00 00       	call   80104810 <popcli>
  acquire(&ptable.lock);
801040aa:	83 ec 0c             	sub    $0xc,%esp
801040ad:	68 20 1d 11 80       	push   $0x80111d20
801040b2:	e8 59 08 00 00       	call   80104910 <acquire>
801040b7:	83 c4 10             	add    $0x10,%esp
    havethreads = 0;
801040ba:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040bc:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801040c1:	eb 13                	jmp    801040d6 <join+0x46>
801040c3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801040c7:	90                   	nop
801040c8:	81 c3 84 00 00 00    	add    $0x84,%ebx
801040ce:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
801040d4:	74 27                	je     801040fd <join+0x6d>
      if(p->parent != curproc ||  p->isthread!=1)
801040d6:	39 73 14             	cmp    %esi,0x14(%ebx)
801040d9:	75 ed                	jne    801040c8 <join+0x38>
801040db:	83 bb 80 00 00 00 01 	cmpl   $0x1,0x80(%ebx)
801040e2:	75 e4                	jne    801040c8 <join+0x38>
      if(p->state == ZOMBIE){
801040e4:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801040e8:	74 66                	je     80104150 <join+0xc0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040ea:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havethreads = 1;
801040f0:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040f5:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
801040fb:	75 d9                	jne    801040d6 <join+0x46>
    if(!havethreads || curproc->killed){
801040fd:	85 c0                	test   %eax,%eax
801040ff:	0f 84 a7 00 00 00    	je     801041ac <join+0x11c>
80104105:	8b 46 24             	mov    0x24(%esi),%eax
80104108:	85 c0                	test   %eax,%eax
8010410a:	0f 85 9c 00 00 00    	jne    801041ac <join+0x11c>
  pushcli();
80104110:	e8 ab 06 00 00       	call   801047c0 <pushcli>
  c = mycpu();
80104115:	e8 e6 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010411a:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104120:	e8 eb 06 00 00       	call   80104810 <popcli>
  if(p == 0)
80104125:	85 db                	test   %ebx,%ebx
80104127:	0f 84 96 00 00 00    	je     801041c3 <join+0x133>
  p->chan = chan;
8010412d:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
...
80104143:	e9 72 ff ff ff       	jmp    801040ba <join+0x2a>
80104148:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010414f:	90                   	nop
        *stack = p->stack;
80104150:	8b 53 7c             	mov    0x7c(%ebx),%edx
...
80104159:	89 10                	mov    %edx,(%eax)
        pid = p->pid;
8010415b:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
8010415e:	ff 73 08             	push   0x8(%ebx)
80104161:	e8 5a e3 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
80104166:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        p->pid = 0;
...
80104186:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        p->stack = 0; 
8010418d:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        release(&ptable.lock);
80104194:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010419b:	e8 10 07 00 00       	call   801048b0 <release>
        return pid;
801041a0:	83 c4 10             	add    $0x10,%esp
}
801041a3:	8d 65 f8             	lea    -0x8(%ebp),%esp
801041a6:	89 f0                	mov    %esi,%eax
801041a8:	5b                   	pop    %ebx
801041a9:	5e                   	pop    %esi
801041aa:	5d                   	pop    %ebp
801041ab:	c3                   	ret    
...
801041ac:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801041af:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801041b4:	68 20 1d 11 80       	push   $0x80111d20
801041b9:	e8 f2 06 00 00       	call   801048b0 <release>
      return -1;
801041be:	83 c4 10             	add    $0x10,%esp
801041c1:	eb e0                	jmp    801041a3 <join+0x113>
    panic("sleep");
801041c3:	83 ec 0c             	sub    $0xc,%esp
801041c6:	68 d4 7b 10 80       	push   $0x80107bd4
...
801041d4:	53                   	push   %ebx
  pushcli();
801041d5:	e8 e6 05 00 00       	call   801047c0 <pushcli>
  c = mycpu();
801041da:	e8 21 f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801041df:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801041e5:	e8 26 06 00 00       	call   80104810 <popcli>
  acquire(&ptable.lock);
801041ea:	83 ec 0c             	sub    $0xc,%esp
801041ed:	68 20 1d 11 80       	push   $0x80111d20
801041f2:	e8 19 07 00 00       	call   80104910 <acquire>
...
8010420e:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80104214:	74 28                	je     8010423e <wait+0x6e>
      if(p->parent != curproc || p->isthread!=0)
80104216:	39 73 14             	cmp    %esi,0x14(%ebx)
80104219:	75 ed                	jne    80104208 <wait+0x38>
8010421b:	8b 8b 80 00 00 00    	mov    0x80(%ebx),%ecx
80104221:	85 c9                	test   %ecx,%ecx
80104223:	75 e3                	jne    80104208 <wait+0x38>
      if(p->state == ZOMBIE){
80104225:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104229:	74 65                	je     80104290 <wait+0xc0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010422b:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80104231:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104236:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
8010423c:	75 d8                	jne    80104216 <wait+0x46>
    if(!havekids || curproc->killed){
8010423e:	85 c0                	test   %eax,%eax
80104240:	0f 84 a0 00 00 00    	je     801042e6 <wait+0x116>
80104246:	8b 46 24             	mov    0x24(%esi),%eax
80104249:	85 c0                	test   %eax,%eax
8010424b:	0f 85 95 00 00 00    	jne    801042e6 <wait+0x116>
  pushcli();
80104251:	e8 6a 05 00 00       	call   801047c0 <pushcli>
  c = mycpu();
80104256:	e8 a5 f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010425b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104261:	e8 aa 05 00 00       	call   80104810 <popcli>
  if(p == 0)
80104266:	85 db                	test   %ebx,%ebx
80104268:	0f 84 8f 00 00 00    	je     801042fd <wait+0x12d>
  p->chan = chan;
8010426e:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104271:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104278:	e8 13 fc ff ff       	call   80103e90 <sched>
  p->chan = 0;
8010427d:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80104284:	e9 71 ff ff ff       	jmp    801041fa <wait+0x2a>
...
801042a9:	e8 72 2f 00 00       	call   80107220 <freevm>
        p->pid = 0;
...
801042c7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801042ce:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801042d5:	e8 d6 05 00 00       	call   801048b0 <release>
        return pid;
...
801042e9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801042ee:	68 20 1d 11 80       	push   $0x80111d20
801042f3:	e8 b8 05 00 00       	call   801048b0 <release>
      return -1;
801042f8:	83 c4 10             	add    $0x10,%esp
801042fb:	eb e0                	jmp    801042dd <wait+0x10d>
    panic("sleep");
801042fd:	83 ec 0c             	sub    $0xc,%esp
80104300:	68 d4 7b 10 80       	push   $0x80107bd4
...
80104317:	68 20 1d 11 80       	push   $0x80111d20
8010431c:	e8 ef 05 00 00       	call   80104910 <acquire>
  pushcli();
80104321:	e8 9a 04 00 00       	call   801047c0 <pushcli>
  c = mycpu();
80104326:	e8 d5 f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010432b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104331:	e8 da 04 00 00       	call   80104810 <popcli>
  myproc()->state = RUNNABLE;
80104336:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
8010433d:	e8 4e fb ff ff       	call   80103e90 <sched>
  release(&ptable.lock);
80104342:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104349:	e8 62 05 00 00       	call   801048b0 <release>
}
...
8010436c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010436f:	e8 4c 04 00 00       	call   801047c0 <pushcli>
  c = mycpu();
80104374:	e8 87 f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104379:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010437f:	e8 8c 04 00 00       	call   80104810 <popcli>
  if(p == 0)
...
80104390:	81 fe 20 1d 11 80    	cmp    $0x80111d20,%esi
80104396:	74 50                	je     801043e8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104398:	83 ec 0c             	sub    $0xc,%esp
8010439b:	68 20 1d 11 80       	push   $0x80111d20
801043a0:	e8 6b 05 00 00       	call   80104910 <acquire>
    release(lk);
801043a5:	89 34 24             	mov    %esi,(%esp)
801043a8:	e8 03 05 00 00       	call   801048b0 <release>
  p->chan = chan;
801043ad:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
801043b0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801043b7:	e8 d4 fa ff ff       	call   80103e90 <sched>
  p->chan = 0;
801043bc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801043c3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801043ca:	e8 e1 04 00 00       	call   801048b0 <release>
    acquire(lk);
...
801043db:	5d                   	pop    %ebp
    acquire(lk);
801043dc:	e9 2f 05 00 00       	jmp    80104910 <acquire>
...
801043eb:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801043f2:	e8 99 fa ff ff       	call   80103e90 <sched>
  p->chan = 0;
...
80104409:	68 da 7b 10 80       	push   $0x80107bda
8010440e:	e8 6d bf ff ff       	call   80100380 <panic>
    panic("sleep");
80104413:	83 ec 0c             	sub    $0xc,%esp
80104416:	68 d4 7b 10 80       	push   $0x80107bd4
...
8010442f:	e8 dc 04 00 00       	call   80104910 <acquire>
80104434:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104437:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
8010443c:	eb 0e                	jmp    8010444c <wakeup+0x2c>
8010443e:	66 90                	xchg   %ax,%ax
80104440:	05 84 00 00 00       	add    $0x84,%eax
80104445:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
8010444a:	74 1e                	je     8010446a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
8010444c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104450:	75 ee                	jne    80104440 <wakeup+0x20>
80104452:	3b 58 20             	cmp    0x20(%eax),%ebx
80104455:	75 e9                	jne    80104440 <wakeup+0x20>
      p->state = RUNNABLE;
80104457:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010445e:	05 84 00 00 00       	add    $0x84,%eax
80104463:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80104468:	75 e2                	jne    8010444c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010446a:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
80104471:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104474:	c9                   	leave  
  release(&ptable.lock);
80104475:	e9 36 04 00 00       	jmp    801048b0 <release>
...
80104487:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010448a:	68 20 1d 11 80       	push   $0x80111d20
8010448f:	e8 7c 04 00 00       	call   80104910 <acquire>
80104494:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104497:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
8010449c:	eb 10                	jmp    801044ae <kill+0x2e>
8010449e:	66 90                	xchg   %ax,%ax
801044a0:	81 c2 84 00 00 00    	add    $0x84,%edx
801044a6:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
801044ac:	74 7e                	je     8010452c <kill+0xac>
    if(p->pid == pid){
801044ae:	39 5a 10             	cmp    %ebx,0x10(%edx)
801044b1:	75 ed                	jne    801044a0 <kill+0x20>
      p->killed = 1;
801044b3:	c7 42 24 01 00 00 00 	movl   $0x1,0x24(%edx)
      for(pc = ptable.proc; pc < &ptable.proc[NPROC]; pc++){
801044ba:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
801044bf:	eb 13                	jmp    801044d4 <kill+0x54>
801044c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801044c8:	05 84 00 00 00       	add    $0x84,%eax
801044cd:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
801044d2:	74 34                	je     80104508 <kill+0x88>
         if ((pc->parent == p) && (pc->isthread == 1)){
801044d4:	39 50 14             	cmp    %edx,0x14(%eax)
801044d7:	75 ef                	jne    801044c8 <kill+0x48>
801044d9:	83 b8 80 00 00 00 01 	cmpl   $0x1,0x80(%eax)
801044e0:	75 e6                	jne    801044c8 <kill+0x48>
            pc->killed = 1;
            if (pc->state == SLEEPING)
801044e2:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
            pc->killed = 1;
801044e6:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
            if (pc->state == SLEEPING)
801044ed:	75 d9                	jne    801044c8 <kill+0x48>
               pc->state = RUNNABLE;
801044ef:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      for(pc = ptable.proc; pc < &ptable.proc[NPROC]; pc++){
801044f6:	05 84 00 00 00       	add    $0x84,%eax
801044fb:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80104500:	75 d2                	jne    801044d4 <kill+0x54>
80104502:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
         }
      }
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104508:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
8010450c:	75 07                	jne    80104515 <kill+0x95>
        p->state = RUNNABLE;
8010450e:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
      release(&ptable.lock);
80104515:	83 ec 0c             	sub    $0xc,%esp
80104518:	68 20 1d 11 80       	push   $0x80111d20
...
8010452f:	68 20 1d 11 80       	push   $0x80111d20
80104534:	e8 77 03 00 00       	call   801048b0 <release>
}
...
80104559:	bb c0 1d 11 80       	mov    $0x80111dc0,%ebx
...
8010456b:	68 5f 7f 10 80       	push   $0x80107f5f
80104570:	e8 2b c1 ff ff       	call   801006a0 <cprintf>
80104575:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104578:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010457e:	81 fb c0 3e 11 80    	cmp    $0x80113ec0,%ebx
...
8010458f:	74 e7                	je     80104578 <procdump+0x28>
      state = "???";
80104591:	ba eb 7b 10 80       	mov    $0x80107beb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104596:	83 f8 05             	cmp    $0x5,%eax
80104599:	77 11                	ja     801045ac <procdump+0x5c>
8010459b:	8b 14 85 4c 7c 10 80 	mov    -0x7fef83b4(,%eax,4),%edx
      state = "???";
801045a2:	b8 eb 7b 10 80       	mov    $0x80107beb,%eax
...
801045b1:	68 ef 7b 10 80       	push   $0x80107bef
...
801045d8:	e8 83 01 00 00       	call   80104760 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801045ed:	68 41 76 10 80       	push   $0x80107641
...
80104675:	e8 e6 fc ff ff       	call   80104360 <sleep>
  while (lk->locked) {
...
80104683:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104689:	e8 f2 f2 ff ff       	call   80103980 <myproc>
...
801046d4:	e8 47 fd ff ff       	call   80104420 <wakeup>
  release(&lk->lk);
...
8010472b:	e8 50 f2 ff ff       	call   80103980 <myproc>
...
8010481b:	75 35                	jne    80104852 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010481d:	e8 de f0 ff ff       	call   80103900 <mycpu>
...
80104855:	68 6f 7c 10 80       	push   $0x80107c6f
8010485a:	e8 21 bb ff ff       	call   80100380 <panic>
    panic("popcli");
8010485f:	83 ec 0c             	sub    $0xc,%esp
80104862:	68 86 7c 10 80       	push   $0x80107c86
...
80104893:	e8 68 f0 ff ff       	call   80103900 <mycpu>
...
801048cb:	68 8d 7c 10 80       	push   $0x80107c8d
...
8010494c:	e8 af ef ff ff       	call   80103900 <mycpu>
...
801049c0:	68 95 7c 10 80       	push   $0x80107c95
...
80104af0:	74 2e                	je     80104b20 <strncmp+0x40>
80104af2:	01 d6                	add    %edx,%esi
...
80104b00:	38 d8                	cmp    %bl,%al
80104b02:	75 14                	jne    80104b18 <strncmp+0x38>
    n--, p++, q++;
80104b04:	83 c2 01             	add    $0x1,%edx
80104b07:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104b0a:	39 f2                	cmp    %esi,%edx
80104b0c:	74 12                	je     80104b20 <strncmp+0x40>
80104b0e:	0f b6 01             	movzbl (%ecx),%eax
80104b11:	0f b6 1a             	movzbl (%edx),%ebx
80104b14:	84 c0                	test   %al,%al
80104b16:	75 e8                	jne    80104b00 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104b18:	29 d8                	sub    %ebx,%eax
}
80104b1a:	5b                   	pop    %ebx
80104b1b:	5e                   	pop    %esi
80104b1c:	5d                   	pop    %ebp
...
80104b39:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104b3c:	89 f0                	mov    %esi,%eax
80104b3e:	eb 15                	jmp    80104b55 <strncpy+0x25>
80104b40:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104b44:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104b47:	83 c0 01             	add    $0x1,%eax
80104b4a:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
80104b4e:	88 50 ff             	mov    %dl,-0x1(%eax)
80104b51:	84 d2                	test   %dl,%dl
80104b53:	74 09                	je     80104b5e <strncpy+0x2e>
80104b55:	89 cb                	mov    %ecx,%ebx
80104b57:	83 e9 01             	sub    $0x1,%ecx
80104b5a:	85 db                	test   %ebx,%ebx
80104b5c:	7f e2                	jg     80104b40 <strncpy+0x10>
    ;
  while(n-- > 0)
80104b5e:	89 c2                	mov    %eax,%edx
80104b60:	85 c9                	test   %ecx,%ecx
80104b62:	7e 17                	jle    80104b7b <strncpy+0x4b>
80104b64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
80104b68:	83 c2 01             	add    $0x1,%edx
80104b6b:	89 c1                	mov    %eax,%ecx
80104b6d:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
80104b71:	29 d1                	sub    %edx,%ecx
80104b73:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
80104b77:	85 c9                	test   %ecx,%ecx
80104b79:	7f ed                	jg     80104b68 <strncpy+0x38>
  return os;
}
80104b7b:	5b                   	pop    %ebx
...
80104c07:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104c0a:	e8 71 ed ff ff       	call   80103980 <myproc>
...
80104c95:	e8 e6 ec ff ff       	call   80103980 <myproc>
...
80104ca3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ca6:	e8 d5 ec ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ce6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104ce9:	e8 92 ec ff ff       	call   80103980 <myproc>
80104cee:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104cf0:	e8 8b ec ff ff       	call   80103980 <myproc>
...
80104cfe:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104d01:	e8 7a ec ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d54:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104d55:	e8 26 ec ff ff       	call   80103980 <myproc>
...
80104d63:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104d66:	e8 15 ec ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d7b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104d7e:	e8 fd eb ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104dd4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104dd7:	e8 a4 eb ff ff       	call   80103980 <myproc>
...
80104de7:	83 fa 16             	cmp    $0x16,%edx
80104dea:	77 24                	ja     80104e10 <syscall+0x40>
80104dec:	8b 14 85 c0 7c 10 80 	mov    -0x7fef8340(,%eax,4),%edx
80104df3:	85 d2                	test   %edx,%edx
80104df5:	74 19                	je     80104e10 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104df7:	ff d2                	call   *%edx
80104df9:	89 c2                	mov    %eax,%edx
80104dfb:	8b 43 18             	mov    0x18(%ebx),%eax
80104dfe:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104e18:	68 9d 7c 10 80       	push   $0x80107c9d
...
80104e4c:	89 4d d0             	mov    %ecx,-0x30(%ebp)
80104e4f:	8b 4d 08             	mov    0x8(%ebp),%ecx
  if((dp = nameiparent(path, name)) == 0)
80104e52:	57                   	push   %edi
80104e53:	50                   	push   %eax
{
80104e54:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104e57:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104e5a:	e8 61 d2 ff ff       	call   801020c0 <nameiparent>
...
80104e70:	e8 0b c9 ff ff       	call   80101780 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104e75:	83 c4 0c             	add    $0xc,%esp
80104e78:	6a 00                	push   $0x0
80104e7a:	57                   	push   %edi
80104e7b:	53                   	push   %ebx
80104e7c:	e8 5f ce ff ff       	call   80101ce0 <dirlookup>
80104e81:	83 c4 10             	add    $0x10,%esp
80104e84:	89 c6                	mov    %eax,%esi
80104e86:	85 c0                	test   %eax,%eax
80104e88:	74 56                	je     80104ee0 <create+0xa0>
    iunlockput(dp);
80104e8a:	83 ec 0c             	sub    $0xc,%esp
80104e8d:	53                   	push   %ebx
80104e8e:	e8 7d cb ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104e93:	89 34 24             	mov    %esi,(%esp)
80104e96:	e8 e5 c8 ff ff       	call   80101780 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104e9b:	83 c4 10             	add    $0x10,%esp
80104e9e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104ea3:	75 1b                	jne    80104ec0 <create+0x80>
80104ea5:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104eaa:	75 14                	jne    80104ec0 <create+0x80>
...
80104ec4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104ec6:	e8 45 cb ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104eea:	e8 21 c7 ff ff       	call   80101610 <ialloc>
...
80104f21:	e8 aa c7 ff ff       	call   801016d0 <iupdate>
...
80104f38:	e8 a3 d0 ff ff       	call   80101fe0 <dirlink>
...
80104f48:	e8 c3 ca ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104f69:	e8 62 c7 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104f6e:	83 c4 0c             	add    $0xc,%esp
80104f71:	ff 76 04             	push   0x4(%esi)
80104f74:	68 3c 7d 10 80       	push   $0x80107d3c
80104f79:	56                   	push   %esi
80104f7a:	e8 61 d0 ff ff       	call   80101fe0 <dirlink>
...
80104f8c:	68 3b 7d 10 80       	push   $0x80107d3b
80104f91:	56                   	push   %esi
80104f92:	e8 49 d0 ff ff       	call   80101fe0 <dirlink>
...
80104fa1:	68 2f 7d 10 80       	push   $0x80107d2f
...
80104fbf:	68 3e 7d 10 80       	push   $0x80107d3e
80104fc4:	e8 b7 b3 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104fc9:	83 ec 0c             	sub    $0xc,%esp
80104fcc:	68 20 7d 10 80       	push   $0x80107d20
80104fd1:	e8 aa b3 ff ff       	call   80100380 <panic>
...
80104fee:	e8 9d fc ff ff       	call   80104c90 <argint>
...
80105048:	e8 53 be ff ff       	call   80100ea0 <filedup>
  return fd;
...
8010506e:	e8 1d fc ff ff       	call   80104c90 <argint>
...
80105080:	e8 fb e8 ff ff       	call   80103980 <myproc>
...
80105099:	e8 f2 fb ff ff       	call   80104c90 <argint>
...
801050ae:	e8 2d fc ff ff       	call   80104ce0 <argptr>
...
801050c4:	e8 57 bf ff ff       	call   80101020 <fileread>
...
801050ee:	e8 9d fb ff ff       	call   80104c90 <argint>
...
80105119:	e8 72 fb ff ff       	call   80104c90 <argint>
...
8010512e:	e8 ad fb ff ff       	call   80104ce0 <argptr>
...
80105144:	e8 67 bf ff ff       	call   801010b0 <filewrite>
...
8010516e:	e8 1d fb ff ff       	call   80104c90 <argint>
...
80105191:	74 25                	je     801051b8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105193:	e8 e8 e7 ff ff       	call   80103980 <myproc>
  fileclose(f);
...
801051a4:	e8 47 bd ff ff       	call   80100ef0 <fileclose>
  return 0;
...
801051ce:	e8 bd fa ff ff       	call   80104c90 <argint>
...
801051f8:	e8 e3 fa ff ff       	call   80104ce0 <argptr>
...
8010520b:	e8 c0 bd ff ff       	call   80100fd0 <filestat>
...
8010523f:	e8 0c fb ff ff       	call   80104d50 <argstr>
...
801052a8:	e8 23 c4 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
801052ad:	89 1c 24             	mov    %ebx,(%esp)
801052b0:	e8 ab c5 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801052b5:	58                   	pop    %eax
801052b6:	5a                   	pop    %edx
801052b7:	57                   	push   %edi
801052b8:	ff 75 d0             	push   -0x30(%ebp)
801052bb:	e8 00 ce ff ff       	call   801020c0 <nameiparent>
...
801052cd:	e8 ae c4 ff ff       	call   80101780 <ilock>
...
801052e3:	e8 f8 cc ff ff       	call   80101fe0 <dirlink>
...
801052f3:	e8 18 c7 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
801052f8:	89 1c 24             	mov    %ebx,(%esp)
801052fb:	e8 b0 c5 ff ff       	call   801018b0 <iput>
  end_op();
80105300:	e8 cb da ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010531c:	e8 ef c6 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
80105335:	e8 96 c3 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010533a:	89 1c 24             	mov    %ebx,(%esp)
8010533d:	e8 ce c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105342:	e8 89 da ff ff       	call   80102dd0 <end_op>
  return -1;
...
80105384:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80105385:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
80105388:	53                   	push   %ebx
80105389:	83 ec 54             	sub    $0x54,%esp
  if(argstr(0, &path) < 0)
8010538c:	50                   	push   %eax
8010538d:	6a 00                	push   $0x0
8010538f:	e8 bc f9 ff ff       	call   80104d50 <argstr>
80105394:	83 c4 10             	add    $0x10,%esp
80105397:	85 c0                	test   %eax,%eax
80105399:	0f 88 7a 01 00 00    	js     80105519 <sys_unlink+0x199>
  begin_op();
8010539f:	e8 bc d9 ff ff       	call   80102d60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801053a4:	8d 5d ca             	lea    -0x36(%ebp),%ebx
801053a7:	83 ec 08             	sub    $0x8,%esp
801053aa:	53                   	push   %ebx
801053ab:	ff 75 c0             	push   -0x40(%ebp)
801053ae:	e8 0d cd ff ff       	call   801020c0 <nameiparent>
801053b3:	83 c4 10             	add    $0x10,%esp
801053b6:	89 45 b4             	mov    %eax,-0x4c(%ebp)
801053b9:	85 c0                	test   %eax,%eax
801053bb:	0f 84 62 01 00 00    	je     80105523 <sys_unlink+0x1a3>
  ilock(dp);
801053c1:	8b 7d b4             	mov    -0x4c(%ebp),%edi
...
801053cd:	58                   	pop    %eax
801053ce:	5a                   	pop    %edx
801053cf:	68 3c 7d 10 80       	push   $0x80107d3c
801053d4:	53                   	push   %ebx
801053d5:	e8 e6 c8 ff ff       	call   80101cc0 <namecmp>
801053da:	83 c4 10             	add    $0x10,%esp
801053dd:	85 c0                	test   %eax,%eax
801053df:	0f 84 fb 00 00 00    	je     801054e0 <sys_unlink+0x160>
801053e5:	83 ec 08             	sub    $0x8,%esp
801053e8:	68 3b 7d 10 80       	push   $0x80107d3b
801053ed:	53                   	push   %ebx
801053ee:	e8 cd c8 ff ff       	call   80101cc0 <namecmp>
801053f3:	83 c4 10             	add    $0x10,%esp
801053f6:	85 c0                	test   %eax,%eax
801053f8:	0f 84 e2 00 00 00    	je     801054e0 <sys_unlink+0x160>
  if((ip = dirlookup(dp, name, &off)) == 0)
801053fe:	83 ec 04             	sub    $0x4,%esp
80105401:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80105404:	50                   	push   %eax
80105405:	53                   	push   %ebx
80105406:	57                   	push   %edi
80105407:	e8 d4 c8 ff ff       	call   80101ce0 <dirlookup>
8010540c:	83 c4 10             	add    $0x10,%esp
8010540f:	89 c3                	mov    %eax,%ebx
80105411:	85 c0                	test   %eax,%eax
80105413:	0f 84 c7 00 00 00    	je     801054e0 <sys_unlink+0x160>
  ilock(ip);
80105419:	83 ec 0c             	sub    $0xc,%esp
8010541c:	50                   	push   %eax
8010541d:	e8 5e c3 ff ff       	call   80101780 <ilock>
  if(ip->nlink < 1)
80105422:	83 c4 10             	add    $0x10,%esp
80105425:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
8010542a:	0f 8e 1c 01 00 00    	jle    8010554c <sys_unlink+0x1cc>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105430:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105435:	8d 7d d8             	lea    -0x28(%ebp),%edi
80105438:	74 66                	je     801054a0 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
8010543a:	83 ec 04             	sub    $0x4,%esp
8010543d:	6a 10                	push   $0x10
8010543f:	6a 00                	push   $0x0
80105441:	57                   	push   %edi
80105442:	e8 89 f5 ff ff       	call   801049d0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105447:	6a 10                	push   $0x10
80105449:	ff 75 c4             	push   -0x3c(%ebp)
8010544c:	57                   	push   %edi
8010544d:	ff 75 b4             	push   -0x4c(%ebp)
80105450:	e8 3b c7 ff ff       	call   80101b90 <writei>
80105455:	83 c4 20             	add    $0x20,%esp
80105458:	83 f8 10             	cmp    $0x10,%eax
8010545b:	0f 85 de 00 00 00    	jne    8010553f <sys_unlink+0x1bf>
  if(ip->type == T_DIR){
80105461:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105466:	0f 84 94 00 00 00    	je     80105500 <sys_unlink+0x180>
  iunlockput(dp);
8010546c:	83 ec 0c             	sub    $0xc,%esp
8010546f:	ff 75 b4             	push   -0x4c(%ebp)
80105472:	e8 99 c5 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
80105477:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010547c:	89 1c 24             	mov    %ebx,(%esp)
8010547f:	e8 4c c2 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
80105484:	89 1c 24             	mov    %ebx,(%esp)
80105487:	e8 84 c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010548c:	e8 3f d9 ff ff       	call   80102dd0 <end_op>
  return 0;
80105491:	83 c4 10             	add    $0x10,%esp
80105494:	31 c0                	xor    %eax,%eax
}
80105496:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105499:	5b                   	pop    %ebx
8010549a:	5e                   	pop    %esi
8010549b:	5f                   	pop    %edi
8010549c:	5d                   	pop    %ebp
...
801054a0:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
801054a4:	76 94                	jbe    8010543a <sys_unlink+0xba>
801054a6:	be 20 00 00 00       	mov    $0x20,%esi
801054ab:	eb 0b                	jmp    801054b8 <sys_unlink+0x138>
801054ad:	8d 76 00             	lea    0x0(%esi),%esi
801054b0:	83 c6 10             	add    $0x10,%esi
801054b3:	3b 73 58             	cmp    0x58(%ebx),%esi
801054b6:	73 82                	jae    8010543a <sys_unlink+0xba>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801054b8:	6a 10                	push   $0x10
801054ba:	56                   	push   %esi
801054bb:	57                   	push   %edi
801054bc:	53                   	push   %ebx
801054bd:	e8 ce c5 ff ff       	call   80101a90 <readi>
801054c2:	83 c4 10             	add    $0x10,%esp
801054c5:	83 f8 10             	cmp    $0x10,%eax
801054c8:	75 68                	jne    80105532 <sys_unlink+0x1b2>
    if(de.inum != 0)
801054ca:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
801054cf:	74 df                	je     801054b0 <sys_unlink+0x130>
    iunlockput(ip);
...
801054e3:	ff 75 b4             	push   -0x4c(%ebp)
801054e6:	e8 25 c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
801054eb:	e8 e0 d8 ff ff       	call   80102dd0 <end_op>
  return -1;
801054f0:	83 c4 10             	add    $0x10,%esp
801054f3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054f8:	eb 9c                	jmp    80105496 <sys_unlink+0x116>
801054fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
80105500:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
80105503:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
80105506:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
8010550b:	50                   	push   %eax
8010550c:	e8 bf c1 ff ff       	call   801016d0 <iupdate>
80105511:	83 c4 10             	add    $0x10,%esp
80105514:	e9 53 ff ff ff       	jmp    8010546c <sys_unlink+0xec>
    return -1;
80105519:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010551e:	e9 73 ff ff ff       	jmp    80105496 <sys_unlink+0x116>
    end_op();
80105523:	e8 a8 d8 ff ff       	call   80102dd0 <end_op>
    return -1;
80105528:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010552d:	e9 64 ff ff ff       	jmp    80105496 <sys_unlink+0x116>
      panic("isdirempty: readi");
80105532:	83 ec 0c             	sub    $0xc,%esp
80105535:	68 60 7d 10 80       	push   $0x80107d60
8010553a:	e8 41 ae ff ff       	call   80100380 <panic>
    panic("unlink: writei");
8010553f:	83 ec 0c             	sub    $0xc,%esp
80105542:	68 72 7d 10 80       	push   $0x80107d72
80105547:	e8 34 ae ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
8010554c:	83 ec 0c             	sub    $0xc,%esp
8010554f:	68 4e 7d 10 80       	push   $0x80107d4e
80105554:	e8 27 ae ff ff       	call   80100380 <panic>
...
8010556f:	e8 dc f7 ff ff       	call   80104d50 <argstr>
...
80105588:	e8 03 f7 ff ff       	call   80104c90 <argint>
...
80105592:	78 79                	js     8010560d <sys_open+0xad>
  ...
  begin_op();
80105594:	e8 c7 d7 ff ff       	call   80102d60 <begin_op>
...
801055a5:	e8 f6 ca ff ff       	call   801020a0 <namei>
...
801055bb:	e8 c0 c1 ff ff       	call   80101780 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801055c0:	83 c4 10             	add    $0x10,%esp
801055c3:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801055c8:	0f 84 c2 00 00 00    	je     80105690 <sys_open+0x130>
      end_op();
      return -1;
    }
  }
...
801055ce:	e8 5d b8 ff ff       	call   80100e30 <filealloc>
...
801055e6:	74 60                	je     80105648 <sys_open+0xe8>
  for(fd = 0; fd < NOFILE; fd++){
...
80105600:	e8 0b c4 ff ff       	call   80101a10 <iunlockput>
    end_op();
80105605:	e8 c6 d7 ff ff       	call   80102dd0 <end_op>
    return -1;
8010560a:	83 c4 10             	add    $0x10,%esp
8010560d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105612:	eb 6d                	jmp    80105681 <sys_open+0x121>
80105614:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
80105618:	83 ec 0c             	sub    $0xc,%esp
8010561b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010561e:	31 c9                	xor    %ecx,%ecx
80105620:	ba 02 00 00 00       	mov    $0x2,%edx
80105625:	6a 00                	push   $0x0
80105627:	e8 14 f8 ff ff       	call   80104e40 <create>
    if(ip == 0){
...
80105635:	e8 96 d7 ff ff       	call   80102dd0 <end_op>
      return -1;
8010563a:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010563f:	eb 40                	jmp    80105681 <sys_open+0x121>
80105641:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
80105648:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
8010564b:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
  iunlock(ip);
8010564f:	56                   	push   %esi
80105650:	e8 0b c2 ff ff       	call   80101860 <iunlock>
  end_op();
80105655:	e8 76 d7 ff ff       	call   80102dd0 <end_op>

  f->type = FD_INODE;
8010565a:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105660:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105663:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
80105666:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80105669:	89 d0                	mov    %edx,%eax
  f->off = 0;
8010566b:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80105672:	f7 d0                	not    %eax
80105674:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105677:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
8010567a:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010567d:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
...
80105695:	0f 84 33 ff ff ff    	je     801055ce <sys_open+0x6e>
8010569b:	e9 5c ff ff ff       	jmp    801055fc <sys_open+0x9c>
...
801056cf:	e8 6c f7 ff ff       	call   80104e40 <create>
...
801056df:	e8 2c c3 ff ff       	call   80101a10 <iunlockput>
  end_op();
801056e4:	e8 e7 d6 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801056ef:	c3                   	ret    
    end_op();
801056f0:	e8 db d6 ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105703:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105706:	e8 55 d6 ff ff       	call   80102d60 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
80105729:	e8 62 f5 ff ff       	call   80104c90 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010573e:	e8 4d f5 ff ff       	call   80104c90 <argint>
     argint(1, &major) < 0 ||
...
8010575e:	e8 dd f6 ff ff       	call   80104e40 <create>
     argint(2, &minor) < 0 ||
...
8010576e:	e8 9d c2 ff ff       	call   80101a10 <iunlockput>
  end_op();
...
8010579d:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
8010579f:	e8 bc d5 ff ff       	call   80102d60 <begin_op>
...
801057bf:	e8 dc c8 ff ff       	call   801020a0 <namei>
...
801057d1:	e8 aa bf ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
801057e4:	e8 77 c0 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
801057e9:	58                   	pop    %eax
801057ea:	ff 76 68             	push   0x68(%esi)
801057ed:	e8 be c0 ff ff       	call   801018b0 <iput>
  end_op();
...
80105814:	e8 f7 c1 ff ff       	call   80101a10 <iunlockput>
    end_op();
80105819:	e8 b2 d5 ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105871:	e8 1a f4 ff ff       	call   80104c90 <argint>
...
80105890:	e8 3b f1 ff ff       	call   801049d0 <memset>
...
801058ba:	e8 41 f3 ff ff       	call   80104c00 <fetchint>
...
801058d8:	e8 63 f3 ff ff       	call   80104c40 <fetchstr>
...
80105941:	e8 9a f3 ff ff       	call   80104ce0 <argptr>
...
80105950:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105953:	50                   	push   %eax
80105954:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105957:	50                   	push   %eax
80105958:	e8 d3 da ff ff       	call   80103430 <pipealloc>
...
80105964:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80105967:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105969:	e8 12 e0 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010596e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105970:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80105974:	85 f6                	test   %esi,%esi
80105976:	74 28                	je     801059a0 <sys_pipe+0x70>
  for(fd = 0; fd < NOFILE; fd++){
...
80105983:	ff 75 e0             	push   -0x20(%ebp)
80105986:	e8 65 b5 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
8010598b:	58                   	pop    %eax
8010598c:	ff 75 e4             	push   -0x1c(%ebp)
8010598f:	e8 5c b5 ff ff       	call   80100ef0 <fileclose>
    return -1;
80105994:	83 c4 10             	add    $0x10,%esp
80105997:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010599c:	eb 53                	jmp    801059f1 <sys_pipe+0xc1>
...
{
  return fork();
80105a00:	e9 7b e1 ff ff       	jmp    80103b80 <fork>
...
80105a13:	83 ec 08             	sub    $0x8,%esp
  exit();
80105a16:	e8 35 e5 ff ff       	call   80103f50 <exit>
...
{
  return wait();
80105a20:	e9 ab e7 ff ff       	jmp    801041d0 <wait>
...
80105a3c:	e8 4f f2 ff ff       	call   80104c90 <argint>
...
80105a4e:	e8 2d ea ff ff       	call   80104480 <kill>
...
80105a8d:	e8 fe f1 ff ff       	call   80104c90 <argint>
...
80105add:	e8 ae f1 ff ff       	call   80104c90 <argint>
...
80105af0:	68 80 3e 11 80       	push   $0x80113e80
80105af5:	e8 16 ee ff ff       	call   80104910 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105afa:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105afd:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  while(ticks - ticks0 < n){
...
80105b13:	68 80 3e 11 80       	push   $0x80113e80
80105b18:	68 60 3e 11 80       	push   $0x80113e60
80105b1d:	e8 3e e8 ff ff       	call   80104360 <sleep>
  while(ticks - ticks0 < n){
80105b22:	a1 60 3e 11 80       	mov    0x80113e60,%eax
...
80105b40:	68 80 3e 11 80       	push   $0x80113e80
80105b45:	e8 66 ed ff ff       	call   801048b0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105b68:	e8 43 ed ff ff       	call   801048b0 <release>
  return 0;
...
80105b84:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b87:	68 80 3e 11 80       	push   $0x80113e80
80105b8c:	e8 7f ed ff ff       	call   80104910 <acquire>
  xticks = ticks;
80105b91:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  release(&tickslock);
80105b97:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105b9e:	e8 0d ed ff ff       	call   801048b0 <release>
  return xticks;
}
...
80105bb6:	8d 45 e8             	lea    -0x18(%ebp),%eax
    void * fcn = 0;
80105bb9:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
    if(argint(0, (int *) &fcn) < 0 
80105bc0:	50                   	push   %eax
80105bc1:	6a 00                	push   $0x0
    void * arg1 = 0;
80105bc3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    void * arg2 = 0;
80105bca:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    void * sArg = 0;
80105bd1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(argint(0, (int *) &fcn) < 0 
80105bd8:	e8 b3 f0 ff ff       	call   80104c90 <argint>
80105bdd:	83 c4 10             	add    $0x10,%esp
80105be0:	85 c0                	test   %eax,%eax
80105be2:	78 5c                	js     80105c40 <sys_clone+0x90>
      || argint(1, (int *) &arg1) < 0 
80105be4:	83 ec 08             	sub    $0x8,%esp
80105be7:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105bea:	50                   	push   %eax
80105beb:	6a 01                	push   $0x1
80105bed:	e8 9e f0 ff ff       	call   80104c90 <argint>
80105bf2:	83 c4 10             	add    $0x10,%esp
80105bf5:	85 c0                	test   %eax,%eax
80105bf7:	78 47                	js     80105c40 <sys_clone+0x90>
      || argint(2, (int *) &arg2) < 0
80105bf9:	83 ec 08             	sub    $0x8,%esp
80105bfc:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105bff:	50                   	push   %eax
80105c00:	6a 02                	push   $0x2
80105c02:	e8 89 f0 ff ff       	call   80104c90 <argint>
80105c07:	83 c4 10             	add    $0x10,%esp
80105c0a:	85 c0                	test   %eax,%eax
80105c0c:	78 32                	js     80105c40 <sys_clone+0x90>
      || argint(3, (int *) &sArg) < 0)
80105c0e:	83 ec 08             	sub    $0x8,%esp
80105c11:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105c14:	50                   	push   %eax
80105c15:	6a 03                	push   $0x3
80105c17:	e8 74 f0 ff ff       	call   80104c90 <argint>
80105c1c:	83 c4 10             	add    $0x10,%esp
80105c1f:	85 c0                	test   %eax,%eax
80105c21:	78 1d                	js     80105c40 <sys_clone+0x90>
        return -1;

    return clone(fcn, arg1, arg2, sArg);
80105c23:	ff 75 f4             	push   -0xc(%ebp)
80105c26:	ff 75 f0             	push   -0x10(%ebp)
80105c29:	ff 75 ec             	push   -0x14(%ebp)
80105c2c:	ff 75 e8             	push   -0x18(%ebp)
80105c2f:	e8 6c e0 ff ff       	call   80103ca0 <clone>
...
80105c5c:	6a 00                	push   $0x0
    void *sArg=0;
80105c5e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(argptr( 0,(char**) &sArg, sizeof(void *)) < 0){
80105c65:	e8 76 f0 ff ff       	call   80104ce0 <argptr>
80105c6a:	83 c4 10             	add    $0x10,%esp
80105c6d:	85 c0                	test   %eax,%eax
80105c6f:	78 17                	js     80105c88 <sys_join+0x38>
      return -1;
    }
    return join(sArg);
80105c71:	83 ec 0c             	sub    $0xc,%esp
80105c74:	ff 75 f4             	push   -0xc(%ebp)
80105c77:	e8 14 e4 ff ff       	call   80104090 <join>
...
80105c90:	06                   	push   %es
  pushl %fs
80105c91:	0f a0                	push   %fs
  pushl %gs
80105c93:	0f a8                	push   %gs
  pushal
80105c95:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105c96:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105c9a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105c9c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105c9e:	54                   	push   %esp
  call trap
80105c9f:	e8 cc 00 00 00       	call   80105d70 <trap>
  addl $4, %esp
80105ca4:	83 c4 04             	add    $0x4,%esp
...
80105ca7:	61                   	popa   
  popl %gs
80105ca8:	0f a9                	pop    %gs
  popl %fs
80105caa:	0f a1                	pop    %fs
  popl %es
80105cac:	07                   	pop    %es
  popl %ds
80105cad:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105cae:	83 c4 08             	add    $0x8,%esp
  iret
80105cb1:	cf                   	iret   
...
80105cd7:	c7 04 c5 c2 3e 11 80 	movl   $0x8e000008,-0x7feec13e(,%eax,8)
80105cde:	08 00 00 8e 
80105ce2:	66 89 14 c5 c0 3e 11 	mov    %dx,-0x7feec140(,%eax,8)
80105ce9:	80 
80105cea:	c1 ea 10             	shr    $0x10,%edx
80105ced:	66 89 14 c5 c6 3e 11 	mov    %dx,-0x7feec13a(,%eax,8)
80105cf4:	80 
  for(i = 0; i < 256; i++)
...
80105d07:	c7 05 c2 40 11 80 08 	movl   $0xef000008,0x801140c2
80105d0e:	00 00 ef 
  initlock(&tickslock, "time");
80105d11:	68 81 7d 10 80       	push   $0x80107d81
80105d16:	68 80 3e 11 80       	push   $0x80113e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105d1b:	66 a3 c0 40 11 80    	mov    %ax,0x801140c0
80105d21:	c1 e8 10             	shr    $0x10,%eax
80105d24:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
80105d2a:	e8 11 ea ff ff       	call   80104740 <initlock>
}
...
80105d4b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105d4f:	b8 c0 3e 11 80       	mov    $0x80113ec0,%eax
...
80105d94:	ff 24 85 28 7e 10 80 	jmp    *-0x7fef81d8(,%eax,4)
...
80105e75:	68 e4 7d 10 80       	push   $0x80107de4
...
80105ea4:	0f 85 3e ff ff ff    	jne    80105de8 <trap+0x78>
    yield();
80105eaa:	e8 61 e4 ff ff       	call   80104310 <yield>
...
80105ec7:	68 8c 7d 10 80       	push   $0x80107d8c
...
80105f05:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f08:	e8 c3 ee ff ff       	call   80104dd0 <syscall>
    if(myproc()->killed)
...
80105f23:	5d                   	pop    %ebp
      exit();
80105f24:	e9 27 e0 ff ff       	jmp    80103f50 <exit>
...
80105f80:	68 80 3e 11 80       	push   $0x80113e80
80105f85:	e8 86 e9 ff ff       	call   80104910 <acquire>
      wakeup(&ticks);
80105f8a:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
      ticks++;
80105f91:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
80105f98:	e8 83 e4 ff ff       	call   80104420 <wakeup>
      release(&tickslock);
80105f9d:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105fa4:	e8 07 e9 ff ff       	call   801048b0 <release>
...
80105fe3:	68 b0 7d 10 80       	push   $0x80107db0
80105fe8:	e8 b3 a6 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105fed:	83 c4 14             	add    $0x14,%esp
80105ff0:	68 86 7d 10 80       	push   $0x80107d86
...
{
  if(!uart)
80106000:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80106087:	74 78                	je     80106101 <uartinit+0xd1>
  uart = 1;
80106089:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
80106090:	00 00 00 
...
8010609c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010609f:	bf a8 7e 10 80       	mov    $0x80107ea8,%edi
...
801060b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
801060c0:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80106110 <uartputc>:
  if(!uart)
80106110:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80106187:	6a 00                	push   $0x0
  jmp alltraps
80106189:	e9 01 fb ff ff       	jmp    80105c8f <alltraps>
...
80106190:	6a 01                	push   $0x1
  jmp alltraps
80106192:	e9 f8 fa ff ff       	jmp    80105c8f <alltraps>
...
80106199:	6a 02                	push   $0x2
  jmp alltraps
8010619b:	e9 ef fa ff ff       	jmp    80105c8f <alltraps>
...
801061a2:	6a 03                	push   $0x3
  jmp alltraps
801061a4:	e9 e6 fa ff ff       	jmp    80105c8f <alltraps>
...
801061ab:	6a 04                	push   $0x4
  jmp alltraps
801061ad:	e9 dd fa ff ff       	jmp    80105c8f <alltraps>
...
801061b4:	6a 05                	push   $0x5
  jmp alltraps
801061b6:	e9 d4 fa ff ff       	jmp    80105c8f <alltraps>
...
801061bd:	6a 06                	push   $0x6
  jmp alltraps
801061bf:	e9 cb fa ff ff       	jmp    80105c8f <alltraps>
...
801061c6:	6a 07                	push   $0x7
  jmp alltraps
801061c8:	e9 c2 fa ff ff       	jmp    80105c8f <alltraps>
...
801061cd:	6a 08                	push   $0x8
  jmp alltraps
801061cf:	e9 bb fa ff ff       	jmp    80105c8f <alltraps>
...
801061d6:	6a 09                	push   $0x9
  jmp alltraps
801061d8:	e9 b2 fa ff ff       	jmp    80105c8f <alltraps>
...
801061dd:	6a 0a                	push   $0xa
  jmp alltraps
801061df:	e9 ab fa ff ff       	jmp    80105c8f <alltraps>
...
801061e4:	6a 0b                	push   $0xb
  jmp alltraps
801061e6:	e9 a4 fa ff ff       	jmp    80105c8f <alltraps>
...
801061eb:	6a 0c                	push   $0xc
  jmp alltraps
801061ed:	e9 9d fa ff ff       	jmp    80105c8f <alltraps>
...
801061f2:	6a 0d                	push   $0xd
  jmp alltraps
801061f4:	e9 96 fa ff ff       	jmp    80105c8f <alltraps>
...
801061f9:	6a 0e                	push   $0xe
  jmp alltraps
801061fb:	e9 8f fa ff ff       	jmp    80105c8f <alltraps>
...
80106202:	6a 0f                	push   $0xf
  jmp alltraps
80106204:	e9 86 fa ff ff       	jmp    80105c8f <alltraps>
...
8010620b:	6a 10                	push   $0x10
  jmp alltraps
8010620d:	e9 7d fa ff ff       	jmp    80105c8f <alltraps>
...
80106212:	6a 11                	push   $0x11
  jmp alltraps
80106214:	e9 76 fa ff ff       	jmp    80105c8f <alltraps>
...
8010621b:	6a 12                	push   $0x12
  jmp alltraps
8010621d:	e9 6d fa ff ff       	jmp    80105c8f <alltraps>
...
80106224:	6a 13                	push   $0x13
  jmp alltraps
80106226:	e9 64 fa ff ff       	jmp    80105c8f <alltraps>
...
8010622d:	6a 14                	push   $0x14
  jmp alltraps
8010622f:	e9 5b fa ff ff       	jmp    80105c8f <alltraps>
...
80106236:	6a 15                	push   $0x15
  jmp alltraps
80106238:	e9 52 fa ff ff       	jmp    80105c8f <alltraps>
...
8010623f:	6a 16                	push   $0x16
  jmp alltraps
80106241:	e9 49 fa ff ff       	jmp    80105c8f <alltraps>
...
80106248:	6a 17                	push   $0x17
  jmp alltraps
8010624a:	e9 40 fa ff ff       	jmp    80105c8f <alltraps>
...
80106251:	6a 18                	push   $0x18
  jmp alltraps
80106253:	e9 37 fa ff ff       	jmp    80105c8f <alltraps>
...
8010625a:	6a 19                	push   $0x19
  jmp alltraps
8010625c:	e9 2e fa ff ff       	jmp    80105c8f <alltraps>
...
80106263:	6a 1a                	push   $0x1a
  jmp alltraps
80106265:	e9 25 fa ff ff       	jmp    80105c8f <alltraps>
...
8010626c:	6a 1b                	push   $0x1b
  jmp alltraps
8010626e:	e9 1c fa ff ff       	jmp    80105c8f <alltraps>
...
80106275:	6a 1c                	push   $0x1c
  jmp alltraps
80106277:	e9 13 fa ff ff       	jmp    80105c8f <alltraps>
...
8010627e:	6a 1d                	push   $0x1d
  jmp alltraps
80106280:	e9 0a fa ff ff       	jmp    80105c8f <alltraps>
...
80106287:	6a 1e                	push   $0x1e
  jmp alltraps
80106289:	e9 01 fa ff ff       	jmp    80105c8f <alltraps>
...
80106290:	6a 1f                	push   $0x1f
  jmp alltraps
80106292:	e9 f8 f9 ff ff       	jmp    80105c8f <alltraps>
...
80106299:	6a 20                	push   $0x20
  jmp alltraps
8010629b:	e9 ef f9 ff ff       	jmp    80105c8f <alltraps>
...
801062a2:	6a 21                	push   $0x21
  jmp alltraps
801062a4:	e9 e6 f9 ff ff       	jmp    80105c8f <alltraps>
...
801062ab:	6a 22                	push   $0x22
  jmp alltraps
801062ad:	e9 dd f9 ff ff       	jmp    80105c8f <alltraps>
...
801062b4:	6a 23                	push   $0x23
  jmp alltraps
801062b6:	e9 d4 f9 ff ff       	jmp    80105c8f <alltraps>
...
801062bd:	6a 24                	push   $0x24
  jmp alltraps
801062bf:	e9 cb f9 ff ff       	jmp    80105c8f <alltraps>
...
801062c6:	6a 25                	push   $0x25
  jmp alltraps
801062c8:	e9 c2 f9 ff ff       	jmp    80105c8f <alltraps>
...
801062cf:	6a 26                	push   $0x26
  jmp alltraps
801062d1:	e9 b9 f9 ff ff       	jmp    80105c8f <alltraps>
...
801062d8:	6a 27                	push   $0x27
  jmp alltraps
801062da:	e9 b0 f9 ff ff       	jmp    80105c8f <alltraps>
...
801062e1:	6a 28                	push   $0x28
  jmp alltraps
801062e3:	e9 a7 f9 ff ff       	jmp    80105c8f <alltraps>
...
801062ea:	6a 29                	push   $0x29
  jmp alltraps
801062ec:	e9 9e f9 ff ff       	jmp    80105c8f <alltraps>
...
801062f3:	6a 2a                	push   $0x2a
  jmp alltraps
801062f5:	e9 95 f9 ff ff       	jmp    80105c8f <alltraps>
...
801062fc:	6a 2b                	push   $0x2b
  jmp alltraps
801062fe:	e9 8c f9 ff ff       	jmp    80105c8f <alltraps>
...
80106305:	6a 2c                	push   $0x2c
  jmp alltraps
80106307:	e9 83 f9 ff ff       	jmp    80105c8f <alltraps>
...
8010630e:	6a 2d                	push   $0x2d
  jmp alltraps
80106310:	e9 7a f9 ff ff       	jmp    80105c8f <alltraps>
...
80106317:	6a 2e                	push   $0x2e
  jmp alltraps
80106319:	e9 71 f9 ff ff       	jmp    80105c8f <alltraps>
...
80106320:	6a 2f                	push   $0x2f
  jmp alltraps
80106322:	e9 68 f9 ff ff       	jmp    80105c8f <alltraps>
...
80106329:	6a 30                	push   $0x30
  jmp alltraps
8010632b:	e9 5f f9 ff ff       	jmp    80105c8f <alltraps>
...
80106332:	6a 31                	push   $0x31
  jmp alltraps
80106334:	e9 56 f9 ff ff       	jmp    80105c8f <alltraps>
...
8010633b:	6a 32                	push   $0x32
  jmp alltraps
8010633d:	e9 4d f9 ff ff       	jmp    80105c8f <alltraps>
...
80106344:	6a 33                	push   $0x33
  jmp alltraps
80106346:	e9 44 f9 ff ff       	jmp    80105c8f <alltraps>
...
8010634d:	6a 34                	push   $0x34
  jmp alltraps
8010634f:	e9 3b f9 ff ff       	jmp    80105c8f <alltraps>
...
80106356:	6a 35                	push   $0x35
  jmp alltraps
80106358:	e9 32 f9 ff ff       	jmp    80105c8f <alltraps>
...
8010635f:	6a 36                	push   $0x36
  jmp alltraps
80106361:	e9 29 f9 ff ff       	jmp    80105c8f <alltraps>
...
80106368:	6a 37                	push   $0x37
  jmp alltraps
8010636a:	e9 20 f9 ff ff       	jmp    80105c8f <alltraps>
...
80106371:	6a 38                	push   $0x38
  jmp alltraps
80106373:	e9 17 f9 ff ff       	jmp    80105c8f <alltraps>
...
8010637a:	6a 39                	push   $0x39
  jmp alltraps
8010637c:	e9 0e f9 ff ff       	jmp    80105c8f <alltraps>
...
80106383:	6a 3a                	push   $0x3a
  jmp alltraps
80106385:	e9 05 f9 ff ff       	jmp    80105c8f <alltraps>
...
8010638c:	6a 3b                	push   $0x3b
  jmp alltraps
8010638e:	e9 fc f8 ff ff       	jmp    80105c8f <alltraps>
...
80106395:	6a 3c                	push   $0x3c
  jmp alltraps
80106397:	e9 f3 f8 ff ff       	jmp    80105c8f <alltraps>
...
8010639e:	6a 3d                	push   $0x3d
  jmp alltraps
801063a0:	e9 ea f8 ff ff       	jmp    80105c8f <alltraps>
...
801063a7:	6a 3e                	push   $0x3e
  jmp alltraps
801063a9:	e9 e1 f8 ff ff       	jmp    80105c8f <alltraps>
...
801063b0:	6a 3f                	push   $0x3f
  jmp alltraps
801063b2:	e9 d8 f8 ff ff       	jmp    80105c8f <alltraps>
...
801063b9:	6a 40                	push   $0x40
  jmp alltraps
801063bb:	e9 cf f8 ff ff       	jmp    80105c8f <alltraps>
...
801063c2:	6a 41                	push   $0x41
  jmp alltraps
801063c4:	e9 c6 f8 ff ff       	jmp    80105c8f <alltraps>
...
801063cb:	6a 42                	push   $0x42
  jmp alltraps
801063cd:	e9 bd f8 ff ff       	jmp    80105c8f <alltraps>
...
801063d4:	6a 43                	push   $0x43
  jmp alltraps
801063d6:	e9 b4 f8 ff ff       	jmp    80105c8f <alltraps>
...
801063dd:	6a 44                	push   $0x44
  jmp alltraps
801063df:	e9 ab f8 ff ff       	jmp    80105c8f <alltraps>
...
801063e6:	6a 45                	push   $0x45
  jmp alltraps
801063e8:	e9 a2 f8 ff ff       	jmp    80105c8f <alltraps>
...
801063ef:	6a 46                	push   $0x46
  jmp alltraps
801063f1:	e9 99 f8 ff ff       	jmp    80105c8f <alltraps>
...
801063f8:	6a 47                	push   $0x47
  jmp alltraps
801063fa:	e9 90 f8 ff ff       	jmp    80105c8f <alltraps>
...
80106401:	6a 48                	push   $0x48
  jmp alltraps
80106403:	e9 87 f8 ff ff       	jmp    80105c8f <alltraps>
...
8010640a:	6a 49                	push   $0x49
  jmp alltraps
8010640c:	e9 7e f8 ff ff       	jmp    80105c8f <alltraps>
...
80106413:	6a 4a                	push   $0x4a
  jmp alltraps
80106415:	e9 75 f8 ff ff       	jmp    80105c8f <alltraps>
...
8010641c:	6a 4b                	push   $0x4b
  jmp alltraps
8010641e:	e9 6c f8 ff ff       	jmp    80105c8f <alltraps>
...
80106425:	6a 4c                	push   $0x4c
  jmp alltraps
80106427:	e9 63 f8 ff ff       	jmp    80105c8f <alltraps>
...
8010642e:	6a 4d                	push   $0x4d
  jmp alltraps
80106430:	e9 5a f8 ff ff       	jmp    80105c8f <alltraps>
...
80106437:	6a 4e                	push   $0x4e
  jmp alltraps
80106439:	e9 51 f8 ff ff       	jmp    80105c8f <alltraps>
...
80106440:	6a 4f                	push   $0x4f
  jmp alltraps
80106442:	e9 48 f8 ff ff       	jmp    80105c8f <alltraps>
...
80106449:	6a 50                	push   $0x50
  jmp alltraps
8010644b:	e9 3f f8 ff ff       	jmp    80105c8f <alltraps>
...
80106452:	6a 51                	push   $0x51
  jmp alltraps
80106454:	e9 36 f8 ff ff       	jmp    80105c8f <alltraps>
...
8010645b:	6a 52                	push   $0x52
  jmp alltraps
8010645d:	e9 2d f8 ff ff       	jmp    80105c8f <alltraps>
...
80106464:	6a 53                	push   $0x53
  jmp alltraps
80106466:	e9 24 f8 ff ff       	jmp    80105c8f <alltraps>
...
8010646d:	6a 54                	push   $0x54
  jmp alltraps
8010646f:	e9 1b f8 ff ff       	jmp    80105c8f <alltraps>
...
80106476:	6a 55                	push   $0x55
  jmp alltraps
80106478:	e9 12 f8 ff ff       	jmp    80105c8f <alltraps>
...
8010647f:	6a 56                	push   $0x56
  jmp alltraps
80106481:	e9 09 f8 ff ff       	jmp    80105c8f <alltraps>
...
80106488:	6a 57                	push   $0x57
  jmp alltraps
8010648a:	e9 00 f8 ff ff       	jmp    80105c8f <alltraps>
...
80106491:	6a 58                	push   $0x58
  jmp alltraps
80106493:	e9 f7 f7 ff ff       	jmp    80105c8f <alltraps>
...
8010649a:	6a 59                	push   $0x59
  jmp alltraps
8010649c:	e9 ee f7 ff ff       	jmp    80105c8f <alltraps>
...
801064a3:	6a 5a                	push   $0x5a
  jmp alltraps
801064a5:	e9 e5 f7 ff ff       	jmp    80105c8f <alltraps>
...
801064ac:	6a 5b                	push   $0x5b
  jmp alltraps
801064ae:	e9 dc f7 ff ff       	jmp    80105c8f <alltraps>
...
801064b5:	6a 5c                	push   $0x5c
  jmp alltraps
801064b7:	e9 d3 f7 ff ff       	jmp    80105c8f <alltraps>
...
801064be:	6a 5d                	push   $0x5d
  jmp alltraps
801064c0:	e9 ca f7 ff ff       	jmp    80105c8f <alltraps>
...
801064c7:	6a 5e                	push   $0x5e
  jmp alltraps
801064c9:	e9 c1 f7 ff ff       	jmp    80105c8f <alltraps>
...
801064d0:	6a 5f                	push   $0x5f
  jmp alltraps
801064d2:	e9 b8 f7 ff ff       	jmp    80105c8f <alltraps>
...
801064d9:	6a 60                	push   $0x60
  jmp alltraps
801064db:	e9 af f7 ff ff       	jmp    80105c8f <alltraps>
...
801064e2:	6a 61                	push   $0x61
  jmp alltraps
801064e4:	e9 a6 f7 ff ff       	jmp    80105c8f <alltraps>
...
801064eb:	6a 62                	push   $0x62
  jmp alltraps
801064ed:	e9 9d f7 ff ff       	jmp    80105c8f <alltraps>
...
801064f4:	6a 63                	push   $0x63
  jmp alltraps
801064f6:	e9 94 f7 ff ff       	jmp    80105c8f <alltraps>
...
801064fd:	6a 64                	push   $0x64
  jmp alltraps
801064ff:	e9 8b f7 ff ff       	jmp    80105c8f <alltraps>
...
80106506:	6a 65                	push   $0x65
  jmp alltraps
80106508:	e9 82 f7 ff ff       	jmp    80105c8f <alltraps>
...
8010650f:	6a 66                	push   $0x66
  jmp alltraps
80106511:	e9 79 f7 ff ff       	jmp    80105c8f <alltraps>
...
80106518:	6a 67                	push   $0x67
  jmp alltraps
8010651a:	e9 70 f7 ff ff       	jmp    80105c8f <alltraps>
...
80106521:	6a 68                	push   $0x68
  jmp alltraps
80106523:	e9 67 f7 ff ff       	jmp    80105c8f <alltraps>
...
8010652a:	6a 69                	push   $0x69
  jmp alltraps
8010652c:	e9 5e f7 ff ff       	jmp    80105c8f <alltraps>
...
80106533:	6a 6a                	push   $0x6a
  jmp alltraps
80106535:	e9 55 f7 ff ff       	jmp    80105c8f <alltraps>
...
8010653c:	6a 6b                	push   $0x6b
  jmp alltraps
8010653e:	e9 4c f7 ff ff       	jmp    80105c8f <alltraps>
...
80106545:	6a 6c                	push   $0x6c
  jmp alltraps
80106547:	e9 43 f7 ff ff       	jmp    80105c8f <alltraps>
...
8010654e:	6a 6d                	push   $0x6d
  jmp alltraps
80106550:	e9 3a f7 ff ff       	jmp    80105c8f <alltraps>
...
80106557:	6a 6e                	push   $0x6e
  jmp alltraps
80106559:	e9 31 f7 ff ff       	jmp    80105c8f <alltraps>
...
80106560:	6a 6f                	push   $0x6f
  jmp alltraps
80106562:	e9 28 f7 ff ff       	jmp    80105c8f <alltraps>
...
80106569:	6a 70                	push   $0x70
  jmp alltraps
8010656b:	e9 1f f7 ff ff       	jmp    80105c8f <alltraps>
...
80106572:	6a 71                	push   $0x71
  jmp alltraps
80106574:	e9 16 f7 ff ff       	jmp    80105c8f <alltraps>
...
8010657b:	6a 72                	push   $0x72
  jmp alltraps
8010657d:	e9 0d f7 ff ff       	jmp    80105c8f <alltraps>
...
80106584:	6a 73                	push   $0x73
  jmp alltraps
80106586:	e9 04 f7 ff ff       	jmp    80105c8f <alltraps>
...
8010658d:	6a 74                	push   $0x74
  jmp alltraps
8010658f:	e9 fb f6 ff ff       	jmp    80105c8f <alltraps>
...
80106596:	6a 75                	push   $0x75
  jmp alltraps
80106598:	e9 f2 f6 ff ff       	jmp    80105c8f <alltraps>
...
8010659f:	6a 76                	push   $0x76
  jmp alltraps
801065a1:	e9 e9 f6 ff ff       	jmp    80105c8f <alltraps>
...
801065a8:	6a 77                	push   $0x77
  jmp alltraps
801065aa:	e9 e0 f6 ff ff       	jmp    80105c8f <alltraps>
...
801065b1:	6a 78                	push   $0x78
  jmp alltraps
801065b3:	e9 d7 f6 ff ff       	jmp    80105c8f <alltraps>
...
801065ba:	6a 79                	push   $0x79
  jmp alltraps
801065bc:	e9 ce f6 ff ff       	jmp    80105c8f <alltraps>
...
801065c3:	6a 7a                	push   $0x7a
  jmp alltraps
801065c5:	e9 c5 f6 ff ff       	jmp    80105c8f <alltraps>
...
801065cc:	6a 7b                	push   $0x7b
  jmp alltraps
801065ce:	e9 bc f6 ff ff       	jmp    80105c8f <alltraps>
...
801065d5:	6a 7c                	push   $0x7c
  jmp alltraps
801065d7:	e9 b3 f6 ff ff       	jmp    80105c8f <alltraps>
...
801065de:	6a 7d                	push   $0x7d
  jmp alltraps
801065e0:	e9 aa f6 ff ff       	jmp    80105c8f <alltraps>
...
801065e7:	6a 7e                	push   $0x7e
  jmp alltraps
801065e9:	e9 a1 f6 ff ff       	jmp    80105c8f <alltraps>
...
801065f0:	6a 7f                	push   $0x7f
  jmp alltraps
801065f2:	e9 98 f6 ff ff       	jmp    80105c8f <alltraps>
...
801065f9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801065fe:	e9 8c f6 ff ff       	jmp    80105c8f <alltraps>
...
80106605:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010660a:	e9 80 f6 ff ff       	jmp    80105c8f <alltraps>
...
80106611:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106616:	e9 74 f6 ff ff       	jmp    80105c8f <alltraps>
...
8010661d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106622:	e9 68 f6 ff ff       	jmp    80105c8f <alltraps>
...
80106629:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010662e:	e9 5c f6 ff ff       	jmp    80105c8f <alltraps>
...
80106635:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010663a:	e9 50 f6 ff ff       	jmp    80105c8f <alltraps>
...
80106641:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106646:	e9 44 f6 ff ff       	jmp    80105c8f <alltraps>
...
8010664d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106652:	e9 38 f6 ff ff       	jmp    80105c8f <alltraps>
...
80106659:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010665e:	e9 2c f6 ff ff       	jmp    80105c8f <alltraps>
...
80106665:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010666a:	e9 20 f6 ff ff       	jmp    80105c8f <alltraps>
...
80106671:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106676:	e9 14 f6 ff ff       	jmp    80105c8f <alltraps>
...
8010667d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106682:	e9 08 f6 ff ff       	jmp    80105c8f <alltraps>
...
80106689:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010668e:	e9 fc f5 ff ff       	jmp    80105c8f <alltraps>
...
80106695:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010669a:	e9 f0 f5 ff ff       	jmp    80105c8f <alltraps>
...
801066a1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801066a6:	e9 e4 f5 ff ff       	jmp    80105c8f <alltraps>
...
801066ad:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801066b2:	e9 d8 f5 ff ff       	jmp    80105c8f <alltraps>
...
801066b9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801066be:	e9 cc f5 ff ff       	jmp    80105c8f <alltraps>
...
801066c5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801066ca:	e9 c0 f5 ff ff       	jmp    80105c8f <alltraps>
...
801066d1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801066d6:	e9 b4 f5 ff ff       	jmp    80105c8f <alltraps>
...
801066dd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801066e2:	e9 a8 f5 ff ff       	jmp    80105c8f <alltraps>
...
801066e9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801066ee:	e9 9c f5 ff ff       	jmp    80105c8f <alltraps>
...
801066f5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801066fa:	e9 90 f5 ff ff       	jmp    80105c8f <alltraps>
...
80106701:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106706:	e9 84 f5 ff ff       	jmp    80105c8f <alltraps>
...
8010670d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106712:	e9 78 f5 ff ff       	jmp    80105c8f <alltraps>
...
80106719:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010671e:	e9 6c f5 ff ff       	jmp    80105c8f <alltraps>
...
80106725:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010672a:	e9 60 f5 ff ff       	jmp    80105c8f <alltraps>
...
80106731:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106736:	e9 54 f5 ff ff       	jmp    80105c8f <alltraps>
...
8010673d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106742:	e9 48 f5 ff ff       	jmp    80105c8f <alltraps>
...
80106749:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010674e:	e9 3c f5 ff ff       	jmp    80105c8f <alltraps>
...
80106755:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010675a:	e9 30 f5 ff ff       	jmp    80105c8f <alltraps>
...
80106761:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106766:	e9 24 f5 ff ff       	jmp    80105c8f <alltraps>
...
8010676d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106772:	e9 18 f5 ff ff       	jmp    80105c8f <alltraps>
...
80106779:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010677e:	e9 0c f5 ff ff       	jmp    80105c8f <alltraps>
...
80106785:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010678a:	e9 00 f5 ff ff       	jmp    80105c8f <alltraps>
...
80106791:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106796:	e9 f4 f4 ff ff       	jmp    80105c8f <alltraps>
...
8010679d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801067a2:	e9 e8 f4 ff ff       	jmp    80105c8f <alltraps>
...
801067a9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801067ae:	e9 dc f4 ff ff       	jmp    80105c8f <alltraps>
...
801067b5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801067ba:	e9 d0 f4 ff ff       	jmp    80105c8f <alltraps>
...
801067c1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801067c6:	e9 c4 f4 ff ff       	jmp    80105c8f <alltraps>
...
801067cd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801067d2:	e9 b8 f4 ff ff       	jmp    80105c8f <alltraps>
...
801067d9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801067de:	e9 ac f4 ff ff       	jmp    80105c8f <alltraps>
...
801067e5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801067ea:	e9 a0 f4 ff ff       	jmp    80105c8f <alltraps>
...
801067f1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801067f6:	e9 94 f4 ff ff       	jmp    80105c8f <alltraps>
...
801067fd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106802:	e9 88 f4 ff ff       	jmp    80105c8f <alltraps>
...
80106809:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010680e:	e9 7c f4 ff ff       	jmp    80105c8f <alltraps>
...
80106815:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010681a:	e9 70 f4 ff ff       	jmp    80105c8f <alltraps>
...
80106821:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106826:	e9 64 f4 ff ff       	jmp    80105c8f <alltraps>
...
8010682d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106832:	e9 58 f4 ff ff       	jmp    80105c8f <alltraps>
...
80106839:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010683e:	e9 4c f4 ff ff       	jmp    80105c8f <alltraps>
...
80106845:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010684a:	e9 40 f4 ff ff       	jmp    80105c8f <alltraps>
...
80106851:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106856:	e9 34 f4 ff ff       	jmp    80105c8f <alltraps>
...
8010685d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106862:	e9 28 f4 ff ff       	jmp    80105c8f <alltraps>
...
80106869:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010686e:	e9 1c f4 ff ff       	jmp    80105c8f <alltraps>
...
80106875:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010687a:	e9 10 f4 ff ff       	jmp    80105c8f <alltraps>
...
80106881:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106886:	e9 04 f4 ff ff       	jmp    80105c8f <alltraps>
...
8010688d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106892:	e9 f8 f3 ff ff       	jmp    80105c8f <alltraps>
...
80106899:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010689e:	e9 ec f3 ff ff       	jmp    80105c8f <alltraps>
...
801068a5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801068aa:	e9 e0 f3 ff ff       	jmp    80105c8f <alltraps>
...
801068b1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801068b6:	e9 d4 f3 ff ff       	jmp    80105c8f <alltraps>
...
801068bd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801068c2:	e9 c8 f3 ff ff       	jmp    80105c8f <alltraps>
...
801068c9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801068ce:	e9 bc f3 ff ff       	jmp    80105c8f <alltraps>
...
801068d5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801068da:	e9 b0 f3 ff ff       	jmp    80105c8f <alltraps>
...
801068e1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801068e6:	e9 a4 f3 ff ff       	jmp    80105c8f <alltraps>
...
801068ed:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801068f2:	e9 98 f3 ff ff       	jmp    80105c8f <alltraps>
...
801068f9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801068fe:	e9 8c f3 ff ff       	jmp    80105c8f <alltraps>
...
80106905:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010690a:	e9 80 f3 ff ff       	jmp    80105c8f <alltraps>
...
80106911:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106916:	e9 74 f3 ff ff       	jmp    80105c8f <alltraps>
...
8010691d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106922:	e9 68 f3 ff ff       	jmp    80105c8f <alltraps>
...
80106929:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010692e:	e9 5c f3 ff ff       	jmp    80105c8f <alltraps>
...
80106935:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010693a:	e9 50 f3 ff ff       	jmp    80105c8f <alltraps>
...
80106941:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106946:	e9 44 f3 ff ff       	jmp    80105c8f <alltraps>
...
8010694d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106952:	e9 38 f3 ff ff       	jmp    80105c8f <alltraps>
...
80106959:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010695e:	e9 2c f3 ff ff       	jmp    80105c8f <alltraps>
...
80106965:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010696a:	e9 20 f3 ff ff       	jmp    80105c8f <alltraps>
...
80106971:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106976:	e9 14 f3 ff ff       	jmp    80105c8f <alltraps>
...
8010697d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106982:	e9 08 f3 ff ff       	jmp    80105c8f <alltraps>
...
80106989:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010698e:	e9 fc f2 ff ff       	jmp    80105c8f <alltraps>
...
80106995:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010699a:	e9 f0 f2 ff ff       	jmp    80105c8f <alltraps>
...
801069a1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801069a6:	e9 e4 f2 ff ff       	jmp    80105c8f <alltraps>
...
801069ad:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801069b2:	e9 d8 f2 ff ff       	jmp    80105c8f <alltraps>
...
801069b9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801069be:	e9 cc f2 ff ff       	jmp    80105c8f <alltraps>
...
801069c5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801069ca:	e9 c0 f2 ff ff       	jmp    80105c8f <alltraps>
...
801069d1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801069d6:	e9 b4 f2 ff ff       	jmp    80105c8f <alltraps>
...
801069dd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801069e2:	e9 a8 f2 ff ff       	jmp    80105c8f <alltraps>
...
801069e9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801069ee:	e9 9c f2 ff ff       	jmp    80105c8f <alltraps>
...
801069f5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801069fa:	e9 90 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a01:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106a06:	e9 84 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a0d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106a12:	e9 78 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a19:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106a1e:	e9 6c f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a25:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106a2a:	e9 60 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a31:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106a36:	e9 54 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a3d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106a42:	e9 48 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a49:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106a4e:	e9 3c f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a55:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106a5a:	e9 30 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a61:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106a66:	e9 24 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a6d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106a72:	e9 18 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a79:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106a7e:	e9 0c f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a85:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106a8a:	e9 00 f2 ff ff       	jmp    80105c8f <alltraps>
...
80106a91:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106a96:	e9 f4 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106a9d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106aa2:	e9 e8 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106aa9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106aae:	e9 dc f1 ff ff       	jmp    80105c8f <alltraps>
...
80106ab5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106aba:	e9 d0 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106ac1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106ac6:	e9 c4 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106acd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106ad2:	e9 b8 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106ad9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106ade:	e9 ac f1 ff ff       	jmp    80105c8f <alltraps>
...
80106ae5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106aea:	e9 a0 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106af1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106af6:	e9 94 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106afd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106b02:	e9 88 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b09:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106b0e:	e9 7c f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b15:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106b1a:	e9 70 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b21:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106b26:	e9 64 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b2d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106b32:	e9 58 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b39:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106b3e:	e9 4c f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b45:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106b4a:	e9 40 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b51:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106b56:	e9 34 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b5d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106b62:	e9 28 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b69:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106b6e:	e9 1c f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b75:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106b7a:	e9 10 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b81:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106b86:	e9 04 f1 ff ff       	jmp    80105c8f <alltraps>
...
80106b8d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106b92:	e9 f8 f0 ff ff       	jmp    80105c8f <alltraps>
...
80106b99:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106b9e:	e9 ec f0 ff ff       	jmp    80105c8f <alltraps>
...
80106ba5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106baa:	e9 e0 f0 ff ff       	jmp    80105c8f <alltraps>
...
80106bb1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106bb6:	e9 d4 f0 ff ff       	jmp    80105c8f <alltraps>
...
80106bbd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106bc2:	e9 c8 f0 ff ff       	jmp    80105c8f <alltraps>
...
80106bc9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106bce:	e9 bc f0 ff ff       	jmp    80105c8f <alltraps>
...
80106bd5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106bda:	e9 b0 f0 ff ff       	jmp    80105c8f <alltraps>
...
80106be1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106be6:	e9 a4 f0 ff ff       	jmp    80105c8f <alltraps>
...
80106bed:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106bf2:	e9 98 f0 ff ff       	jmp    80105c8f <alltraps>
...
80106d45:	e8 86 dc ff ff       	call   801049d0 <memset>
...
80106d8d:	68 b0 7e 10 80       	push   $0x80107eb0
...
80106dba:	c7 80 18 18 11 80 ff 	movl   $0xffff,-0x7feee7e8(%eax)
80106dc1:	ff 00 00 
80106dc4:	c7 80 1c 18 11 80 00 	movl   $0xcf9a00,-0x7feee7e4(%eax)
80106dcb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106dce:	c7 80 20 18 11 80 ff 	movl   $0xffff,-0x7feee7e0(%eax)
80106dd5:	ff 00 00 
80106dd8:	c7 80 24 18 11 80 00 	movl   $0xcf9200,-0x7feee7dc(%eax)
80106ddf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106de2:	c7 80 28 18 11 80 ff 	movl   $0xffff,-0x7feee7d8(%eax)
80106de9:	ff 00 00 
80106dec:	c7 80 2c 18 11 80 00 	movl   $0xcffa00,-0x7feee7d4(%eax)
80106df3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106df6:	c7 80 30 18 11 80 ff 	movl   $0xffff,-0x7feee7d0(%eax)
80106dfd:	ff 00 00 
80106e00:	c7 80 34 18 11 80 00 	movl   $0xcff200,-0x7feee7cc(%eax)
80106e07:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106e0a:	05 10 18 11 80       	add    $0x80111810,%eax
  pd[1] = (uint)p;
...
80106e30:	a1 c4 46 11 80       	mov    0x801146c4,%eax
...
80106e64:	0f 84 c2 00 00 00    	je     80106f2c <switchuvm+0xec>
  pushcli();
80106e6a:	e8 51 d9 ff ff       	call   801047c0 <pushcli>
...
80106f7f:	e8 4c da ff ff       	call   801049d0 <memset>
...
80106fb2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106fb3:	e9 b8 da ff ff       	jmp    80104a70 <memmove>
    panic("inituvm: more than a page");
80106fb8:	83 ec 0c             	sub    $0xc,%esp
80106fbb:	68 f5 7e 10 80       	push   $0x80107ef5
...
80107020:	68 0f 7f 10 80       	push   $0x80107f0f
...
801070a8:	68 b0 7f 10 80       	push   $0x80107fb0
...
80107149:	68 2d 7f 10 80       	push   $0x80107f2d
...
801071ab:	68 45 7f 10 80       	push   $0x80107f45
...
8010728c:	68 61 7f 10 80       	push   $0x80107f61
...
801072c0:	e8 0b d7 ff ff       	call   801049d0 <memset>
...
8010732b:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010735c:	68 72 7f 10 80       	push   $0x80107f72
...
801073d2:	68 7c 7f 10 80       	push   $0x80107f7c
...
80107430:	e8 3b d6 ff ff       	call   80104a70 <memmove>
...
801074a7:	68 96 7f 10 80       	push   $0x80107f96
...
80107560:	e8 0b d5 ff ff       	call   80104a70 <memmove>
    len -= n;
    buf += n;
