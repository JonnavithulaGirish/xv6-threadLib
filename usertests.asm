...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 99 39 00 00       	call   39c4 <open>
    ...
    exit();
      40:	e8 3f 39 00 00       	call   3984 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 6e 39 00 00       	call   39c4 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 4e 39 00 00       	call   39ac <close>
  ...
  exit();
     10d:	e8 72 38 00 00       	call   3984 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 9e 38 00 00       	call   39f4 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 66 38 00 00       	call   39d4 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 72 38 00 00       	call   39f4 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 ac 5f 00 00    	push   0x5fac
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 ac 5f 00 00    	push   0x5fac
     1ae:	e8 3d 39 00 00       	call   3af0 <printf>
    exit();
     1b3:	e8 cc 37 00 00       	call   3984 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 63 3e 00 00       	push   $0x3e63
     1bf:	ff 35 ac 5f 00 00    	push   0x5fac
     1c5:	e8 26 39 00 00       	call   3af0 <printf>
    exit();
     1ca:	e8 b5 37 00 00       	call   3984 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 47 3e 00 00       	push   $0x3e47
     1d6:	ff 35 ac 5f 00 00    	push   0x5fac
     1dc:	e8 0f 39 00 00       	call   3af0 <printf>
    exit();
     1e1:	e8 9e 37 00 00       	call   3984 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 26 3e 00 00       	push   $0x3e26
     1ed:	ff 35 ac 5f 00 00    	push   0x5fac
     1f3:	e8 f8 38 00 00       	call   3af0 <printf>
    exit();
     1f8:	e8 87 37 00 00       	call   3984 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 ac 5f 00 00    	push   0x5fac
     211:	e8 da 38 00 00       	call   3af0 <printf>
  pid = fork();
     216:	e8 61 37 00 00       	call   397c <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 b7 37 00 00       	call   39ec <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 a7 37 00 00       	call   39f4 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 6f 37 00 00       	call   39d4 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 13 37 00 00       	call   3984 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 0f 37 00 00       	call   398c <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 96 3e 00 00       	push   $0x3e96
     285:	ff 35 ac 5f 00 00    	push   0x5fac
     ...
     2a0:	ff 35 ac 5f 00 00    	push   0x5fac
     2a6:	e8 45 38 00 00       	call   3af0 <printf>
      exit();
     2ab:	e8 d4 36 00 00       	call   3984 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 59 4d 00 00       	push   $0x4d59
     2b7:	ff 35 ac 5f 00 00    	push   0x5fac
     2bd:	e8 2e 38 00 00       	call   3af0 <printf>
    exit();
     2c2:	e8 bd 36 00 00       	call   3984 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 18 3e 00 00       	push   $0x3e18
     2ce:	ff 35 ac 5f 00 00    	push   0x5fac
     2d4:	e8 17 38 00 00       	call   3af0 <printf>
      exit();
     2d9:	e8 a6 36 00 00       	call   3984 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 82 3e 00 00       	push   $0x3e82
     2e5:	ff 35 ac 5f 00 00    	push   0x5fac
     2eb:	e8 00 38 00 00       	call   3af0 <printf>
      exit();
     2f0:	e8 8f 36 00 00       	call   3984 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 7d 36 00 00       	call   39c4 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 cf 35 00 00       	call   3984 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 59 4d 00 00       	push   $0x4d59
     3bc:	ff 35 ac 5f 00 00    	push   0x5fac
     3c2:	e8 29 37 00 00       	call   3af0 <printf>
    exit();
     3c7:	e8 b8 35 00 00       	call   3984 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 bd 3e 00 00       	push   $0x3ebd
     3d3:	ff 35 ac 5f 00 00    	push   0x5fac
     3d9:	e8 12 37 00 00       	call   3af0 <printf>
    exit();
     3de:	e8 a1 35 00 00       	call   3984 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 d1 3e 00 00       	push   $0x3ed1
     3ea:	ff 35 ac 5f 00 00    	push   0x5fac
     3f0:	e8 fb 36 00 00       	call   3af0 <printf>
    exit();
     3f5:	e8 8a 35 00 00       	call   3984 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 ac 5f 00 00    	push   0x5fac
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 a0 35 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 78 35 00 00       	call   39ac <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 15 3f 00 00       	push   $0x3f15
     43d:	e8 82 35 00 00       	call   39c4 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 ac 5f 00 00    	push   0x5fac
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 ac 5f 00 00    	push   0x5fac
     46e:	e8 7d 36 00 00       	call   3af0 <printf>
    exit();
     473:	e8 0c 35 00 00       	call   3984 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 22 3f 00 00       	push   $0x3f22
     47f:	ff 35 ac 5f 00 00    	push   0x5fac
     485:	e8 66 36 00 00       	call   3af0 <printf>
    exit();
     48a:	e8 f5 34 00 00       	call   3984 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 ac 5f 00 00    	push   0x5fac
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 0b 35 00 00       	call   39c4 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 ac 5f 00 00    	push   0x5fac
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 b4 34 00 00       	call   39a4 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 98 34 00 00       	call   39a4 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 ac 5f 00 00    	push   0x5fac
     52e:	e8 bd 35 00 00       	call   3af0 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 71 34 00 00       	call   39ac <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 5f 3f 00 00       	push   $0x3f5f
     544:	e8 7b 34 00 00       	call   39c4 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 ac 5f 00 00    	push   0x5fac
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 20 34 00 00       	call   399c <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 ac 5f 00 00    	push   0x5fac
     598:	e8 53 35 00 00       	call   3af0 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 07 34 00 00       	call   39ac <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 5f 3f 00 00 	movl   $0x3f5f,(%esp)
     5ac:	e8 23 34 00 00       	call   39d4 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 ac 5f 00 00    	push   0x5fac
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 ac 5f 00 00    	push   0x5fac
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 2b 33 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 db 32 00 00       	call   39a4 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 c1 32 00 00       	call   39ac <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 a7 40 00 00       	push   $0x40a7
     6f4:	e8 cb 32 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 62 32 00 00       	call   399c <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 56 32 00 00       	call   39ac <close>
  if(unlink("big") < 0){
     756:	c7 04 24 a7 40 00 00 	movl   $0x40a7,(%esp)
     75d:	e8 72 32 00 00       	call   39d4 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 ac 5f 00 00    	push   0x5fac
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 ac 5f 00 00    	push   0x5fac
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 39 31 00 00       	call   39c4 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 19 31 00 00       	call   39ac <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 0e 31 00 00       	call   39d4 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 ac 5f 00 00    	push   0x5fac
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 ce 30 00 00       	call   39f4 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 b6 30 00 00       	call   39f4 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 82 30 00 00       	call   39d4 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 ac 5f 00 00    	push   0x5fac
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 ac 5f 00 00    	push   0x5fac
     97e:	e8 6d 31 00 00       	call   3af0 <printf>
    exit();
     983:	e8 fc 2f 00 00       	call   3984 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 11 41 00 00       	push   $0x4111
     98f:	ff 35 ac 5f 00 00    	push   0x5fac
     995:	e8 56 31 00 00       	call   3af0 <printf>
    exit();
     99a:	e8 e5 2f 00 00       	call   3984 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 00 41 00 00       	push   $0x4100
     9a6:	ff 35 ac 5f 00 00    	push   0x5fac
     9ac:	e8 3f 31 00 00       	call   3af0 <printf>
    exit();
     9b1:	e8 ce 2f 00 00       	call   3984 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 ed 40 00 00       	push   $0x40ed
     9bd:	ff 35 ac 5f 00 00    	push   0x5fac
     9c3:	e8 28 31 00 00       	call   3af0 <printf>
    exit();
     9c8:	e8 b7 2f 00 00       	call   3984 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 ac 5f 00 00    	push   0x5fac
     9e1:	e8 0a 31 00 00       	call   3af0 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 b0 5f 00 00       	push   $0x5fb0
     9ed:	68 fd 3e 00 00       	push   $0x3efd
     9f2:	e8 c5 2f 00 00       	call   39bc <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 ac 5f 00 00    	push   0x5fac
     a0d:	e8 de 30 00 00       	call   3af0 <printf>
    exit();
     a12:	e8 6d 2f 00 00       	call   3984 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 4a 2f 00 00       	call   39ac <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 1f 2f 00 00       	call   399c <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 d0 2e 00 00       	call   39ac <close>
     ...
     b11:	e8 8e 2e 00 00       	call   39a4 <write>
    ...
    exit();
     b28:	e8 57 2e 00 00       	call   3984 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 6b 2e 00 00       	call   39ac <close>
    wait();
     b41:	e8 46 2e 00 00       	call   398c <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 84 2f 00 00       	call   3af0 <printf>
      exit();
     b6c:	e8 13 2e 00 00       	call   3984 <exit>
    ...
    exit();
     b7f:	e8 00 2e 00 00       	call   3984 <exit>
    ...
    exit();
     b92:	e8 ed 2d 00 00       	call   3984 <exit>
     ...
     ba0:	e8 4b 2f 00 00       	call   3af0 <printf>
        exit();
     ba5:	e8 da 2d 00 00       	call   3984 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 b2 2d 00 00       	call   397c <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 9d 2d 00 00       	call   397c <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 98 2d 00 00       	call   3994 <pipe>
  pid3 = fork();
     bfc:	e8 7b 2d 00 00       	call   397c <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 6e 2d 00 00       	call   39ac <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 31 2d 00 00       	call   39ac <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 23 2d 00 00       	call   39b4 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 1b 2d 00 00       	call   39b4 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 13 2d 00 00       	call   39b4 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 d8 2c 00 00       	call   398c <wait>
  wait();
     cb4:	e8 d3 2c 00 00       	call   398c <wait>
  wait();
     cb9:	e8 ce 2c 00 00       	call   398c <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 65 2c 00 00       	call   398c <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 47 2c 00 00       	call   397c <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 f5 2b 00 00       	call   3984 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 59 2c 00 00       	call   3a04 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 ca 2b 00 00       	call   397c <fork>
    ...
    exit();
     e1f:	e8 60 2b 00 00       	call   3984 <exit>
     ...
     e3a:	e8 75 2b 00 00       	call   39b4 <kill>
      exit();
     e3f:	e8 40 2b 00 00       	call   3984 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 39 2b 00 00       	jmp    398c <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 53 2b 00 00       	call   39d4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 53 42 00 00       	push   $0x4253
     e8d:	e8 32 2b 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 d0 2a 00 00       	call   397c <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 c3 2a 00 00       	call   39a4 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 81 2a 00 00       	call   398c <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 93 2a 00 00       	call   39ac <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 53 42 00 00       	push   $0x4253
     f22:	e8 9d 2a 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 4b 2a 00 00       	call   399c <read>
  ...
  close(fd);
     ...
     f86:	e8 21 2a 00 00       	call   39ac <close>
  unlink("sharedfd");
     f8b:	c7 04 24 53 42 00 00 	movl   $0x4253,(%esp)
     f92:	e8 3d 2a 00 00       	call   39d4 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 84 29 00 00       	call   3984 <exit>
    ...
    exit();
    100e:	e8 71 29 00 00       	call   3984 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 70 29 00 00       	call   39d4 <unlink>
    pid = fork();
    1064:	e8 13 29 00 00       	call   397c <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 ff 28 00 00       	call   398c <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 f8 28 00 00       	call   398c <wait>
    1094:	e8 f3 28 00 00       	call   398c <wait>
    1099:	e8 ee 28 00 00       	call   398c <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 12 29 00 00       	call   39c4 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 c7 28 00 00       	call   399c <read>
    ...
    1104:	e8 a3 28 00 00       	call   39ac <close>
    if(total != 12*500){
    ...
    111e:	e8 b1 28 00 00       	call   39d4 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 92 29 00 00       	call   3af0 <printf>
          exit();
    115e:	e8 21 28 00 00       	call   3984 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 53 28 00 00       	call   39c4 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 f9 27 00 00       	call   39a4 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 c5 27 00 00       	call   3984 <exit>
    ...
    11c8:	e8 23 29 00 00       	call   3af0 <printf>
        exit();
    11cd:	e8 b2 27 00 00       	call   3984 <exit>
    ...
    11e2:	e8 09 29 00 00       	call   3af0 <printf>
      exit();
    11e7:	e8 98 27 00 00       	call   3984 <exit>
    ...
    11f5:	e8 f6 28 00 00       	call   3af0 <printf>
      exit();
    11fa:	e8 85 27 00 00       	call   3984 <exit>
    ...
    1208:	e8 e3 28 00 00       	call   3af0 <printf>
          exit();
    120d:	e8 72 27 00 00       	call   3984 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 3d 27 00 00       	call   397c <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 32 27 00 00       	call   398c <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 28 27 00 00       	call   398c <wait>
    1264:	e8 23 27 00 00       	call   398c <wait>
    1269:	e8 1e 27 00 00       	call   398c <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 16 27 00 00       	call   39c4 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 da 26 00 00       	call   39ac <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 c4 26 00 00       	call   39d4 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 9e 27 00 00       	call   3af0 <printf>
        exit();
    1352:	e8 2d 26 00 00       	call   3984 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 25 26 00 00       	call   39c4 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 fd 25 00 00       	call   39ac <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 06 26 00 00       	call   39d4 <unlink>
    ...
    13de:	e8 0d 27 00 00       	call   3af0 <printf>
            exit();
    13e3:	e8 9c 25 00 00       	call   3984 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 8f 25 00 00       	call   3984 <exit>
    ...
    1400:	e8 eb 26 00 00       	call   3af0 <printf>
        exit();
    1405:	e8 7a 25 00 00       	call   3984 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 d7 26 00 00       	call   3af0 <printf>
      exit();
    1419:	e8 66 25 00 00       	call   3984 <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 c3 26 00 00       	call   3af0 <printf>
          exit();
    142d:	e8 52 25 00 00       	call   3984 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 5f 25 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 22 25 00 00       	call   39a4 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 22 25 00 00       	call   39ac <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 05 43 00 00       	push   $0x4305
    1493:	e8 2c 25 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 22 25 00 00       	call   39d4 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 f5 24 00 00       	call   39c4 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 83 24 00 00       	call   39a4 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 7a 24 00 00       	call   39ac <close>
  unlink("unlinkread");
    1532:	c7 04 24 05 43 00 00 	movl   $0x4305,(%esp)
    1539:	e8 96 24 00 00       	call   39d4 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 1b 24 00 00       	call   3984 <exit>
    ...
    exit();
    1577:	e8 08 24 00 00       	call   3984 <exit>
    ...
    exit();
    158a:	e8 f5 23 00 00       	call   3984 <exit>
    ...
    exit();
    159d:	e8 e2 23 00 00       	call   3984 <exit>
    ...
    exit();
    15b0:	e8 cf 23 00 00       	call   3984 <exit>
    ...
    exit();
    15c3:	e8 bc 23 00 00       	call   3984 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 7b 23 00 00       	call   39a4 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 6e 23 00 00       	call   39ac <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 ca 43 00 00       	push   $0x43ca
    1645:	68 c6 43 00 00       	push   $0x43c6
    164a:	e8 95 23 00 00       	call   39e4 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 6d 23 00 00       	call   39d4 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 c6 43 00 00       	push   $0x43c6
    1670:	e8 4f 23 00 00       	call   39c4 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 35 23 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 ed 22 00 00       	call   399c <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 e8 22 00 00       	call   39ac <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 ca 43 00 00       	push   $0x43ca
    16cb:	68 ca 43 00 00       	push   $0x43ca
    16d0:	e8 0f 23 00 00       	call   39e4 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 e7 22 00 00       	call   39d4 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 c6 43 00 00       	push   $0x43c6
    16f4:	68 ca 43 00 00       	push   $0x43ca
    16f9:	e8 e6 22 00 00       	call   39e4 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 cd 22 00 00       	call   39e4 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 3c 22 00 00       	call   3984 <exit>
    ...
    exit();
    1756:	e8 29 22 00 00       	call   3984 <exit>
    ...
    exit();
    1769:	e8 16 22 00 00       	call   3984 <exit>
    ...
    exit();
    177c:	e8 03 22 00 00       	call   3984 <exit>
    ...
    exit();
    178f:	e8 f0 21 00 00       	call   3984 <exit>
    ...
    exit();
    17a2:	e8 dd 21 00 00       	call   3984 <exit>
    ...
    exit();
    17b5:	e8 ca 21 00 00       	call   3984 <exit>
    ...
    exit();
    17c8:	e8 b7 21 00 00       	call   3984 <exit>
    ...
    exit();
    17db:	e8 a4 21 00 00       	call   3984 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 95 21 00 00       	call   39c4 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 6a 21 00 00       	call   39ac <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 42 21 00 00       	call   398c <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 72 21 00 00       	call   39d4 <unlink>
    pid = fork();
    1862:	e8 15 21 00 00       	call   397c <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 3a 21 00 00       	call   39c4 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 03 21 00 00       	call   39e4 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 a3 20 00 00       	call   398c <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 b1 20 00 00       	call   39c4 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 70 20 00 00       	call   399c <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 33 20 00 00       	call   39ac <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 32 20 00 00       	call   39d4 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 2a 20 00 00       	call   39d4 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 22 20 00 00       	call   39d4 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 1a 20 00 00       	call   39d4 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 c2 1f 00 00       	call   398c <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 9b 1f 00 00       	call   397c <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 b4 1f 00 00       	call   39c4 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 94 1f 00 00       	call   39ac <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 a2 1f 00 00       	call   39c4 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 82 1f 00 00       	call   39ac <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 90 1f 00 00       	call   39c4 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 70 1f 00 00       	call   39ac <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 7e 1f 00 00       	call   39c4 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 5e 1f 00 00       	call   39ac <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 6a 20 00 00       	call   3af0 <printf>
      exit();
    1a86:	e8 f9 1e 00 00       	call   3984 <exit>
    ...
    exit();
    1a99:	e8 e6 1e 00 00       	call   3984 <exit>
    ...
    1aac:	e8 3f 20 00 00       	call   3af0 <printf>
        exit();
    1ab1:	e8 ce 1e 00 00       	call   3984 <exit>
    ...
    1ac4:	e8 27 20 00 00       	call   3af0 <printf>
        exit();
    1ac9:	e8 b6 1e 00 00       	call   3984 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 d5 1e 00 00       	call   39ac <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 d3 1e 00 00       	call   39d4 <unlink>
  pid = fork();
    1b01:	e8 76 1e 00 00       	call   397c <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 92 1e 00 00       	call   39d4 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 49 1e 00 00       	call   39c4 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 29 1e 00 00       	call   39ac <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 f5 1d 00 00       	call   398c <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 22 1e 00 00       	call   39e4 <link>
    ...
    exit();
    1bd8:	e8 a7 1d 00 00       	call   3984 <exit>
    exit();
    1bdd:	e8 a2 1d 00 00       	call   3984 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 c3 1d 00 00       	call   39d4 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 15 45 00 00       	push   $0x4515
    1c1d:	e8 a2 1d 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 71 1d 00 00       	call   39ac <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 78 1d 00 00       	call   39e4 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 47 1d 00 00       	call   39d4 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 1d 1d 00 00       	call   39d4 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 fe 1d 00 00       	call   3af0 <printf>
      exit();
    1cf2:	e8 8d 1c 00 00       	call   3984 <exit>
    ...
    1d01:	e8 ea 1d 00 00       	call   3af0 <printf>
      exit();
    1d06:	e8 79 1c 00 00       	call   3984 <exit>
    ...
    exit();
    1d19:	e8 66 1c 00 00       	call   3984 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 95 1c 00 00       	call   39d4 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 88 46 00 00 	movl   $0x4688,(%esp)
    1d46:	e8 a1 1c 00 00       	call   39ec <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 5c 1c 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 1f 1c 00 00       	call   39a4 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 1f 1c 00 00       	call   39ac <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 88 46 00 00 	movl   $0x4688,(%esp)
    1d94:	e8 3b 1c 00 00       	call   39d4 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 3b 1c 00 00       	call   39ec <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 f6 1b 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 b9 1b 00 00       	call   39a4 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 b9 1b 00 00       	call   39ac <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 e2 45 00 00       	push   $0x45e2
    1dfc:	e8 c3 1b 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 7b 1b 00 00       	call   399c <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 69 1b 00 00       	call   39ac <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 22 46 00 00       	push   $0x4622
    1e4a:	68 be 45 00 00       	push   $0x45be
    1e4f:	e8 90 1b 00 00       	call   39e4 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 68 1b 00 00       	call   39d4 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 3e 1b 00 00       	call   39c4 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 56 1b 00 00       	call   39f4 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 3e 1b 00 00       	call   39f4 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 26 1b 00 00       	call   39f4 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 0e 1b 00 00       	call   39f4 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 c4 1a 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 7c 1a 00 00       	call   399c <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 77 1a 00 00       	call   39ac <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 be 45 00 00       	push   $0x45be
    1f3e:	e8 81 1a 00 00       	call   39c4 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 64 1a 00 00       	call   39c4 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 47 1a 00 00       	call   39c4 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 2a 1a 00 00       	call   39c4 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 10 1a 00 00       	call   39c4 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 f6 19 00 00       	call   39c4 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 f9 19 00 00       	call   39e4 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 dc 19 00 00       	call   39e4 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 bf 19 00 00       	call   39e4 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 af 19 00 00       	call   39ec <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 97 19 00 00       	call   39ec <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 7f 19 00 00       	call   39ec <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 4f 19 00 00       	call   39d4 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 37 19 00 00       	call   39d4 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 3f 19 00 00       	call   39f4 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 27 19 00 00       	call   39f4 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 ef 18 00 00       	call   39d4 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 d7 18 00 00       	call   39d4 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 bf 18 00 00       	call   39d4 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 a7 18 00 00       	call   39d4 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 8f 18 00 00       	call   39d4 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 0a 18 00 00       	call   3984 <exit>
    ...
    exit();
    2188:	e8 f7 17 00 00       	call   3984 <exit>
    ...
    exit();
    219b:	e8 e4 17 00 00       	call   3984 <exit>
    ...
    exit();
    21ae:	e8 d1 17 00 00       	call   3984 <exit>
    ...
    exit();
    21c1:	e8 be 17 00 00       	call   3984 <exit>
    ...
    exit();
    21d4:	e8 ab 17 00 00       	call   3984 <exit>
    ...
    exit();
    21e7:	e8 98 17 00 00       	call   3984 <exit>
    ...
    exit();
    21fa:	e8 85 17 00 00       	call   3984 <exit>
    ...
    exit();
    220d:	e8 72 17 00 00       	call   3984 <exit>
    ...
    exit();
    2220:	e8 5f 17 00 00       	call   3984 <exit>
    ...
    exit();
    2233:	e8 4c 17 00 00       	call   3984 <exit>
    ...
    exit();
    2246:	e8 39 17 00 00       	call   3984 <exit>
    ...
    exit();
    2259:	e8 26 17 00 00       	call   3984 <exit>
    ...
    exit();
    226c:	e8 13 17 00 00       	call   3984 <exit>
    ...
    exit();
    227f:	e8 00 17 00 00       	call   3984 <exit>
    ...
    exit();
    2292:	e8 ed 16 00 00       	call   3984 <exit>
    ...
    exit();
    22a5:	e8 da 16 00 00       	call   3984 <exit>
    ...
    exit();
    22b8:	e8 c7 16 00 00       	call   3984 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 b4 16 00 00       	call   3984 <exit>
    ...
    exit();
    22de:	e8 a1 16 00 00       	call   3984 <exit>
    ...
    exit();
    22f1:	e8 8e 16 00 00       	call   3984 <exit>
    ...
    exit();
    2304:	e8 7b 16 00 00       	call   3984 <exit>
    ...
    exit();
    2317:	e8 68 16 00 00       	call   3984 <exit>
    ...
    exit();
    232a:	e8 55 16 00 00       	call   3984 <exit>
    ...
    exit();
    233d:	e8 42 16 00 00       	call   3984 <exit>
    ...
    exit();
    2350:	e8 2f 16 00 00       	call   3984 <exit>
    ...
    exit();
    2363:	e8 1c 16 00 00       	call   3984 <exit>
    ...
    exit();
    2376:	e8 09 16 00 00       	call   3984 <exit>
    ...
    exit();
    2389:	e8 f6 15 00 00       	call   3984 <exit>
    ...
    exit();
    239c:	e8 e3 15 00 00       	call   3984 <exit>
    ...
    exit();
    23af:	e8 d0 15 00 00       	call   3984 <exit>
    ...
    exit();
    23c2:	e8 bd 15 00 00       	call   3984 <exit>
    ...
    exit();
    23d5:	e8 aa 15 00 00       	call   3984 <exit>
    ...
    exit();
    23e8:	e8 97 15 00 00       	call   3984 <exit>
    ...
    exit();
    23fb:	e8 84 15 00 00       	call   3984 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 af 15 00 00       	call   39d4 <unlink>
    ...
    243d:	e8 82 15 00 00       	call   39c4 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 4a 15 00 00       	call   39a4 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 34 15 00 00       	call   39a4 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 26 15 00 00       	call   39ac <close>
    unlink("bigwrite");
    2486:	c7 04 24 84 48 00 00 	movl   $0x4884,(%esp)
    248d:	e8 42 15 00 00       	call   39d4 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 2c 16 00 00       	call   3af0 <printf>
        exit();
    24c4:	e8 bb 14 00 00       	call   3984 <exit>
    ...
    24d3:	e8 18 16 00 00       	call   3af0 <printf>
      exit();
    24d8:	e8 a7 14 00 00       	call   3984 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 d3 14 00 00       	call   39d4 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 e0 48 00 00       	push   $0x48e0
    250d:	e8 b2 14 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 56 14 00 00       	call   39a4 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 3f 14 00 00       	call   39ac <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 e0 48 00 00       	push   $0x48e0
    2576:	e8 49 14 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 cb 13 00 00       	call   399c <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 c9 13 00 00       	call   39ac <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 d5 13 00 00       	call   39d4 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 c9 14 00 00       	call   3af0 <printf>
      exit();
    2627:	e8 58 13 00 00       	call   3984 <exit>
    ...
    2636:	e8 b5 14 00 00       	call   3af0 <printf>
      exit();
    263b:	e8 44 13 00 00       	call   3984 <exit>
    ...
    264a:	e8 a1 14 00 00       	call   3af0 <printf>
      exit();
    264f:	e8 30 13 00 00       	call   3984 <exit>
    ...
    265e:	e8 8d 14 00 00       	call   3af0 <printf>
      exit();
    2663:	e8 1c 13 00 00       	call   3984 <exit>
    ...
    exit();
    2676:	e8 09 13 00 00       	call   3984 <exit>
    ...
    exit();
    2689:	e8 f6 12 00 00       	call   3984 <exit>
    ...
    exit();
    269c:	e8 e3 12 00 00       	call   3984 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 1e 13 00 00       	call   39ec <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 06 13 00 00       	call   39ec <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 c1 12 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 95 12 00 00       	call   39ac <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 38 52 00 00       	push   $0x5238
    2720:	e8 9f 12 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 77 12 00 00       	call   39ac <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 ac 49 00 00 	movl   $0x49ac,(%esp)
    273c:	e8 ab 12 00 00       	call   39ec <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 97 12 00 00       	call   39ec <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 01 12 00 00       	call   3984 <exit>
    ...
    exit();
    2791:	e8 ee 11 00 00       	call   3984 <exit>
    ...
    exit();
    27a4:	e8 db 11 00 00       	call   3984 <exit>
    ...
    exit();
    27b7:	e8 c8 11 00 00       	call   3984 <exit>
    ...
    exit();
    27ca:	e8 b5 11 00 00       	call   3984 <exit>
    ...
    exit();
    27dd:	e8 a2 11 00 00       	call   3984 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 de 11 00 00       	call   39ec <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 ce 11 00 00       	call   39f4 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 96 11 00 00       	call   39d4 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 7e 11 00 00       	call   39d4 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 86 11 00 00       	call   39f4 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 4e 11 00 00       	call   39d4 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 3a 11 00 00       	call   39d4 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 26 11 00 00       	call   39d4 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 a8 10 00 00       	call   3984 <exit>
    ...
    exit();
    28ea:	e8 95 10 00 00       	call   3984 <exit>
    ...
    exit();
    28fd:	e8 82 10 00 00       	call   3984 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 6f 10 00 00       	call   3984 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 5c 10 00 00       	call   3984 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 49 10 00 00       	call   3984 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 36 10 00 00       	call   3984 <exit>
    ...
    exit();
    295c:	e8 23 10 00 00       	call   3984 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 30 10 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 04 10 00 00       	call   39ac <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 95 4a 00 00 	movl   $0x4a95,(%esp)
    29af:	e8 40 10 00 00       	call   39f4 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 f6 0f 00 00       	call   39c4 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 d9 0f 00 00       	call   39c4 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 e9 0f 00 00       	call   39ec <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 b9 0f 00 00       	call   39d4 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 ac 0f 00 00       	call   39e4 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 84 0f 00 00       	call   39d4 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 5a 0f 00 00       	call   39c4 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 40 0f 00 00       	call   39c4 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 0e 0f 00 00       	call   39a4 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 06 0f 00 00       	call   39ac <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 b5 0e 00 00       	call   3984 <exit>
    ...
    exit();
    2add:	e8 a2 0e 00 00       	call   3984 <exit>
    ...
    exit();
    2af0:	e8 8f 0e 00 00       	call   3984 <exit>
    ...
    exit();
    2b03:	e8 7c 0e 00 00       	call   3984 <exit>
    ...
    exit();
    2b16:	e8 69 0e 00 00       	call   3984 <exit>
    ...
    exit();
    2b29:	e8 56 0e 00 00       	call   3984 <exit>
    ...
    exit();
    2b3c:	e8 43 0e 00 00       	call   3984 <exit>
    ...
    exit();
    2b4f:	e8 30 0e 00 00       	call   3984 <exit>
    ...
    exit();
    2b62:	e8 1d 0e 00 00       	call   3984 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 4f 0e 00 00       	call   39ec <mkdir>
    ...
    2bb0:	e8 3f 0e 00 00       	call   39f4 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 88 0d 00 00       	call   39ac <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 70 47 00 00       	push   $0x4770
    2c2f:	e8 a0 0d 00 00       	call   39d4 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 a7 0d 00 00       	call   39f4 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 7e 0e 00 00       	call   3af0 <printf>
      exit();
    2c72:	e8 0d 0d 00 00       	call   3984 <exit>
    ...
    2c81:	e8 6a 0e 00 00       	call   3af0 <printf>
      exit();
    2c86:	e8 f9 0c 00 00       	call   3984 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 ba 0c 00 00       	call   397c <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 b7 0c 00 00       	call   398c <wait>
  ...
  if(wait() != -1){
    2cde:	e8 a9 0c 00 00       	call   398c <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 83 0c 00 00       	call   3984 <exit>
    ...
    2d0b:	e8 e0 0d 00 00       	call   3af0 <printf>
      exit();
    2d10:	e8 6f 0c 00 00       	call   3984 <exit>
    ...
    exit();
    2d23:	e8 5c 0c 00 00       	call   3984 <exit>
    ...
    exit();
    2d36:	e8 49 0c 00 00       	call   3984 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 80 0c 00 00       	call   3a0c <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 cf 0b 00 00       	call   397c <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 48 0c 00 00       	call   3a0c <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 3c 0c 00 00       	call   3a0c <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 a4 0b 00 00       	call   398c <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 1a 0c 00 00       	call   3a0c <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 09 0c 00 00       	call   3a0c <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 f4 0b 00 00       	call   3a0c <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 e6 0b 00 00       	call   3a0c <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 d0 0b 00 00       	call   3a0c <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 b5 0b 00 00       	call   3a0c <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 a7 0b 00 00       	call   3a0c <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 90 0b 00 00       	call   3a0c <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 27 0b 00 00       	call   3a04 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 98 0a 00 00       	call   397c <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 95 0a 00 00       	call   398c <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 83 0a 00 00       	call   3994 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 4f 0a 00 00       	call   397c <fork>
    ...
    2f48:	e8 4f 0a 00 00       	call   399c <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 a8 0a 00 00       	call   3a0c <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 34 0a 00 00       	call   39b4 <kill>
    wait();
    2f80:	e8 07 0a 00 00       	call   398c <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 6a 0a 00 00       	call   3a0c <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fb2:	ff 35 ac 5f 00 00    	push   0x5fac
    ...
    exit();
    310c:	e8 73 08 00 00       	call   3984 <exit>
    exit();
    3111:	e8 6e 08 00 00       	call   3984 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 45 4c 00 00       	push   $0x4c45
    311d:	ff 35 ac 5f 00 00    	push   0x5fac
    3123:	e8 c8 09 00 00       	call   3af0 <printf>
    exit();
    3128:	e8 57 08 00 00       	call   3984 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 04 54 00 00       	push   $0x5404
    3134:	ff 35 ac 5f 00 00    	push   0x5fac
    313a:	e8 b1 09 00 00       	call   3af0 <printf>
    exit();
    313f:	e8 40 08 00 00       	call   3984 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 cc 53 00 00       	push   $0x53cc
    314b:	ff 35 ac 5f 00 00    	push   0x5fac
    3151:	e8 9a 09 00 00       	call   3af0 <printf>
    exit();
    3156:	e8 29 08 00 00       	call   3984 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 61 4c 00 00       	push   $0x4c61
    3162:	ff 35 ac 5f 00 00    	push   0x5fac
    3168:	e8 83 09 00 00       	call   3af0 <printf>
    exit();
    316d:	e8 12 08 00 00       	call   3984 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 4f 08 00 00       	call   3a14 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 43 08 00 00       	call   3a14 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 db 07 00 00       	call   39b4 <kill>
    wait();
    31d9:	e8 ae 07 00 00       	call   398c <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 cd 4c 00 00       	push   $0x4ccd
    31e6:	e8 f9 07 00 00       	call   39e4 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 ac 5f 00 00    	push   0x5fac
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 61 07 00 00       	call   3984 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 d8 4c 00 00       	push   $0x4cd8
    322b:	ff 35 ac 5f 00 00    	push   0x5fac
    3231:	e8 ba 08 00 00       	call   3af0 <printf>
      exit();
    3236:	e8 49 07 00 00       	call   3984 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 ac 5f 00 00    	push   0x5fac
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 ac 5f 00 00    	push   0x5fac
    ...
    3293:	ff 35 ac 5f 00 00    	push   0x5fac
    3299:	e8 52 08 00 00       	call   3af0 <printf>
      exit();
    329e:	e8 e1 06 00 00       	call   3984 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 14 07 00 00       	call   39d4 <unlink>
  pid = fork();
    32c0:	e8 b7 06 00 00       	call   397c <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 b5 06 00 00       	call   398c <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 26 4d 00 00       	push   $0x4d26
    32e1:	e8 de 06 00 00       	call   39c4 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 b2 06 00 00       	call   39ac <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 26 4d 00 00 	movl   $0x4d26,(%esp)
    3301:	e8 ce 06 00 00       	call   39d4 <unlink>
}
    ...
    332a:	ff 35 ac 5f 00 00    	push   0x5fac
    args[MAXARG-1] = 0;
    ...
    334b:	e8 6c 06 00 00       	call   39bc <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 3d 4d 00 00       	push   $0x4d3d
    3357:	ff 35 ac 5f 00 00    	push   0x5fac
    ...
    336e:	e8 51 06 00 00       	call   39c4 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 31 06 00 00       	call   39ac <close>
    exit();
    337b:	e8 04 06 00 00       	call   3984 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 66 4d 00 00       	push   $0x4d66
    3387:	ff 35 ac 5f 00 00    	push   0x5fac
    338d:	e8 5e 07 00 00       	call   3af0 <printf>
    exit();
    3392:	e8 ed 05 00 00       	call   3984 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 4d 4d 00 00       	push   $0x4d4d
    339e:	ff 35 ac 5f 00 00    	push   0x5fac
    33a4:	e8 47 07 00 00       	call   3af0 <printf>
    exit();
    33a9:	e8 d6 05 00 00       	call   3984 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 66 05 00 00       	call   39c4 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 1f 05 00 00       	call   39a4 <write>
      if(cc < 512)
    ...
    34a2:	e8 05 05 00 00       	call   39ac <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 83 04 00 00       	call   39d4 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 e5 03 00 00       	call   397c <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 e7 03 00 00       	call   398c <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 a7 03 00 00       	call   3984 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 94 03 00 00       	call   3984 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 c1 03 00 00       	call   39c4 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 f6 03 00 00       	call   3a0c <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 77 03 00 00       	call   399c <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 7f 03 00 00       	call   39ac <close>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 df 01 00 00       	call   399c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 a2 01 00 00       	call   39c4 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 a5 01 00 00       	call   39dc <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 6b 01 00 00       	call   39ac <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
   ...
   return clone(start_routine, arg1, arg2, stack);
    ...
    38ea:	e8 35 01 00 00       	call   3a24 <clone>
}
    38ef:	c9                   	leave  
    38f0:	c3                   	ret    
...
int thread_join(){
  ...
  void *stack;
  int pid= join(&stack);
    3904:	8d 45 f4             	lea    -0xc(%ebp),%eax
int thread_join(){
    3907:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
    390a:	50                   	push   %eax
    390b:	e8 1c 01 00 00       	call   3a2c <join>
  if(pid >0 ){
  ...
  if(pid >0 ){
    ...
    3917:	7e 0d                	jle    3926 <thread_join+0x26>
    3919:	8b 7d f4             	mov    -0xc(%ebp),%edi
    391c:	b9 00 10 00 00       	mov    $0x1000,%ecx
    3921:	31 c0                	xor    %eax,%eax
    3923:	fc                   	cld    
    3924:	f3 aa                	rep stos %al,%es:(%edi)
    memset(stack,0,PGSIZE);
  }
  return pid;
}
    3926:	8b 7d fc             	mov    -0x4(%ebp),%edi
    3929:	89 d0                	mov    %edx,%eax
    392b:	c9                   	leave  
    392c:	c3                   	ret    
...
void lock_init(lock_t *lock) {
  ...
  lock->ticket = 0;
    3936:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
    393c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
    3943:	5d                   	pop    %ebp
    3944:	c3                   	ret    
    3945:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
void lock_acquire(lock_t *lock){
  ...
  asm volatile("lock; xaddl %%eax, %2;" :
    3951:	b8 01 00 00 00       	mov    $0x1,%eax
    3956:	89 e5                	mov    %esp,%ebp
    3958:	8b 55 08             	mov    0x8(%ebp),%edx
    395b:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
    395f:	8b 52 04             	mov    0x4(%edx),%edx
    3962:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3968:	39 c2                	cmp    %eax,%edx
    396a:	75 fc                	jne    3968 <lock_acquire+0x18>
}
    396c:	5d                   	pop    %ebp
    396d:	c3                   	ret    
...
void lock_release(lock_t *lock){
  ...
  lock->turn = lock->turn + 1;
    3976:	83 40 04 01          	addl   $0x1,0x4(%eax)
    397a:	5d                   	pop    %ebp
    397b:	c3                   	ret    
...
SYSCALL(fork)
    397c:	b8 01 00 00 00       	mov    $0x1,%eax
    3981:	cd 40                	int    $0x40
    3983:	c3                   	ret    

00003984 <exit>:
SYSCALL(exit)
    3984:	b8 02 00 00 00       	mov    $0x2,%eax
    3989:	cd 40                	int    $0x40
    398b:	c3                   	ret    

0000398c <wait>:
SYSCALL(wait)
    398c:	b8 03 00 00 00       	mov    $0x3,%eax
    3991:	cd 40                	int    $0x40
    3993:	c3                   	ret    

00003994 <pipe>:
SYSCALL(pipe)
    3994:	b8 04 00 00 00       	mov    $0x4,%eax
    3999:	cd 40                	int    $0x40
    399b:	c3                   	ret    

0000399c <read>:
SYSCALL(read)
    399c:	b8 05 00 00 00       	mov    $0x5,%eax
    39a1:	cd 40                	int    $0x40
    39a3:	c3                   	ret    

000039a4 <write>:
SYSCALL(write)
    39a4:	b8 10 00 00 00       	mov    $0x10,%eax
    39a9:	cd 40                	int    $0x40
    39ab:	c3                   	ret    

000039ac <close>:
SYSCALL(close)
    39ac:	b8 15 00 00 00       	mov    $0x15,%eax
    39b1:	cd 40                	int    $0x40
    39b3:	c3                   	ret    

000039b4 <kill>:
SYSCALL(kill)
    39b4:	b8 06 00 00 00       	mov    $0x6,%eax
    39b9:	cd 40                	int    $0x40
    39bb:	c3                   	ret    

000039bc <exec>:
SYSCALL(exec)
    39bc:	b8 07 00 00 00       	mov    $0x7,%eax
    39c1:	cd 40                	int    $0x40
    39c3:	c3                   	ret    

000039c4 <open>:
SYSCALL(open)
    39c4:	b8 0f 00 00 00       	mov    $0xf,%eax
    39c9:	cd 40                	int    $0x40
    39cb:	c3                   	ret    

000039cc <mknod>:
SYSCALL(mknod)
    39cc:	b8 11 00 00 00       	mov    $0x11,%eax
    39d1:	cd 40                	int    $0x40
    39d3:	c3                   	ret    

000039d4 <unlink>:
SYSCALL(unlink)
    39d4:	b8 12 00 00 00       	mov    $0x12,%eax
    39d9:	cd 40                	int    $0x40
    39db:	c3                   	ret    

000039dc <fstat>:
SYSCALL(fstat)
    39dc:	b8 08 00 00 00       	mov    $0x8,%eax
    39e1:	cd 40                	int    $0x40
    39e3:	c3                   	ret    

000039e4 <link>:
SYSCALL(link)
    39e4:	b8 13 00 00 00       	mov    $0x13,%eax
    39e9:	cd 40                	int    $0x40
    39eb:	c3                   	ret    

000039ec <mkdir>:
SYSCALL(mkdir)
    39ec:	b8 14 00 00 00       	mov    $0x14,%eax
    39f1:	cd 40                	int    $0x40
    39f3:	c3                   	ret    

000039f4 <chdir>:
SYSCALL(chdir)
    39f4:	b8 09 00 00 00       	mov    $0x9,%eax
    39f9:	cd 40                	int    $0x40
    39fb:	c3                   	ret    

000039fc <dup>:
SYSCALL(dup)
    39fc:	b8 0a 00 00 00       	mov    $0xa,%eax
    3a01:	cd 40                	int    $0x40
    3a03:	c3                   	ret    

00003a04 <getpid>:
SYSCALL(getpid)
    3a04:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a09:	cd 40                	int    $0x40
    3a0b:	c3                   	ret    

00003a0c <sbrk>:
SYSCALL(sbrk)
    3a0c:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a11:	cd 40                	int    $0x40
    3a13:	c3                   	ret    

00003a14 <sleep>:
SYSCALL(sleep)
    3a14:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a19:	cd 40                	int    $0x40
    3a1b:	c3                   	ret    

00003a1c <uptime>:
SYSCALL(uptime)
    3a1c:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a21:	cd 40                	int    $0x40
    3a23:	c3                   	ret    

00003a24 <clone>:
SYSCALL(clone)
    3a24:	b8 16 00 00 00       	mov    $0x16,%eax
    3a29:	cd 40                	int    $0x40
    3a2b:	c3                   	ret    

00003a2c <join>:
SYSCALL(join)
    3a2c:	b8 17 00 00 00       	mov    $0x17,%eax
    3a31:	cd 40                	int    $0x40
    3a33:	c3                   	ret    
    ...
    3a4c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3abe:	56                   	push   %esi
    3abf:	57                   	push   %edi
    3ac0:	e8 df fe ff ff       	call   39a4 <write>
  while(--i >= 0)
    ...
    3af9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b35:	57                   	push   %edi
    3b36:	56                   	push   %esi
    3b37:	e8 68 fe ff ff       	call   39a4 <write>
  ...
  write(fd, &c, 1);
    ...
    3b8e:	e8 11 fe ff ff       	call   39a4 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b9f:	57                   	push   %edi
    3ba0:	56                   	push   %esi
    3ba1:	e8 fe fd ff ff       	call   39a4 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3c0b:	57                   	push   %edi
    3c0c:	56                   	push   %esi
    3c0d:	e8 92 fd ff ff       	call   39a4 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c4f:	e8 50 fd ff ff       	call   39a4 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d83:	e8 84 fc ff ff       	call   3a0c <sbrk>
  if(p == (char*)-1)
