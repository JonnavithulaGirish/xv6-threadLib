...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      ...
      16:	6a 01                	push   $0x1
      18:	e8 63 3b 00 00       	call   3b80 <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 2b 3a 00 00       	call   3a56 <open>
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      ...
      39:	6a 01                	push   $0x1
      3b:	e8 40 3b 00 00       	call   3b80 <printf>
    exit();
      40:	e8 d1 39 00 00       	call   3a16 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 00 3a 00 00       	call   3a56 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 e0 39 00 00       	call   3a3e <close>
  ...
  exit();
     10d:	e8 04 39 00 00       	call   3a16 <exit>
...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     131:	e8 4a 3a 00 00       	call   3b80 <printf>
  if(mkdir("iputdir") < 0){
     136:	c7 04 24 cf 3e 00 00 	movl   $0x3ecf,(%esp)
     13d:	e8 3c 39 00 00       	call   3a7e <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 30 39 00 00       	call   3a86 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 f8 38 00 00       	call   3a66 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 04 39 00 00       	call   3a86 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     197:	e8 e4 39 00 00       	call   3b80 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1ae:	e8 cd 39 00 00       	call   3b80 <printf>
    exit();
     1b3:	e8 5e 38 00 00       	call   3a16 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 f3 3e 00 00       	push   $0x3ef3
     1bf:	ff 35 50 60 00 00    	push   0x6050
     1c5:	e8 b6 39 00 00       	call   3b80 <printf>
    exit();
     1ca:	e8 47 38 00 00       	call   3a16 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 d7 3e 00 00       	push   $0x3ed7
     1d6:	ff 35 50 60 00 00    	push   0x6050
     1dc:	e8 9f 39 00 00       	call   3b80 <printf>
    exit();
     1e1:	e8 30 38 00 00       	call   3a16 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 b6 3e 00 00       	push   $0x3eb6
     1ed:	ff 35 50 60 00 00    	push   0x6050
     1f3:	e8 88 39 00 00       	call   3b80 <printf>
    exit();
     1f8:	e8 19 38 00 00       	call   3a16 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     211:	e8 6a 39 00 00       	call   3b80 <printf>
  pid = fork();
     216:	e8 f3 37 00 00       	call   3a0e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 49 38 00 00       	call   3a7e <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 39 38 00 00       	call   3a86 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 01 38 00 00       	call   3a66 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 a5 37 00 00       	call   3a16 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 a1 37 00 00       	call   3a1e <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 26 3f 00 00       	push   $0x3f26
     285:	ff 35 50 60 00 00    	push   0x6050
     28b:	e8 f0 38 00 00       	call   3b80 <printf>
}
     ...
     2a6:	e8 d5 38 00 00       	call   3b80 <printf>
      exit();
     2ab:	e8 66 37 00 00       	call   3a16 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 e9 4d 00 00       	push   $0x4de9
     2b7:	ff 35 50 60 00 00    	push   0x6050
     2bd:	e8 be 38 00 00       	call   3b80 <printf>
    exit();
     2c2:	e8 4f 37 00 00       	call   3a16 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 a8 3e 00 00       	push   $0x3ea8
     2ce:	ff 35 50 60 00 00    	push   0x6050
     2d4:	e8 a7 38 00 00       	call   3b80 <printf>
      exit();
     2d9:	e8 38 37 00 00       	call   3a16 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 12 3f 00 00       	push   $0x3f12
     2e5:	ff 35 50 60 00 00    	push   0x6050
     2eb:	e8 90 38 00 00       	call   3b80 <printf>
      exit();
     2f0:	e8 21 37 00 00       	call   3a16 <exit>
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     311:	e8 6a 38 00 00       	call   3b80 <printf>
  if(mkdir("oidir") < 0){
     316:	c7 04 24 47 3f 00 00 	movl   $0x3f47,(%esp)
     31d:	e8 5c 37 00 00       	call   3a7e <mkdir>
     322:	83 c4 10             	add    $0x10,%esp
     325:	85 c0                	test   %eax,%eax
     327:	0f 88 9f 00 00 00    	js     3cc <openiputtest+0xcc>
  pid = fork();
     32d:	e8 dc 36 00 00       	call   3a0e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 0f 37 00 00       	call   3a56 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 61 36 00 00       	call   3a16 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 e9 4d 00 00       	push   $0x4de9
     3bc:	ff 35 50 60 00 00    	push   0x6050
     3c2:	e8 b9 37 00 00       	call   3b80 <printf>
    exit();
     3c7:	e8 4a 36 00 00       	call   3a16 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 4d 3f 00 00       	push   $0x3f4d
     3d3:	ff 35 50 60 00 00    	push   0x6050
     3d9:	e8 a2 37 00 00       	call   3b80 <printf>
    exit();
     3de:	e8 33 36 00 00       	call   3a16 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 61 3f 00 00       	push   $0x3f61
     3ea:	ff 35 50 60 00 00    	push   0x6050
     3f0:	e8 8b 37 00 00       	call   3b80 <printf>
    exit();
     3f5:	e8 1c 36 00 00       	call   3a16 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     411:	e8 6a 37 00 00       	call   3b80 <printf>
  fd = open("echo", 0);
     416:	58                   	pop    %eax
     417:	5a                   	pop    %edx
     418:	6a 00                	push   $0x0
     41a:	68 8d 3f 00 00       	push   $0x3f8d
     41f:	e8 32 36 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 0a 36 00 00       	call   3a3e <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 a5 3f 00 00       	push   $0x3fa5
     43d:	e8 14 36 00 00       	call   3a56 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     457:	e8 24 37 00 00       	call   3b80 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     46e:	e8 0d 37 00 00       	call   3b80 <printf>
    exit();
     473:	e8 9e 35 00 00       	call   3a16 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 b2 3f 00 00       	push   $0x3fb2
     47f:	ff 35 50 60 00 00    	push   0x6050
     485:	e8 f6 36 00 00       	call   3b80 <printf>
    exit();
     48a:	e8 87 35 00 00       	call   3a16 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4a3:	e8 d8 36 00 00       	call   3b80 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     4a8:	58                   	pop    %eax
     4a9:	5a                   	pop    %edx
     4aa:	68 02 02 00 00       	push   $0x202
     4af:	68 ef 3f 00 00       	push   $0x3fef
     4b4:	e8 9d 35 00 00       	call   3a56 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d6:	e8 a5 36 00 00       	call   3b80 <printf>
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 46 35 00 00       	call   3a36 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 2a 35 00 00       	call   3a36 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     52e:	e8 4d 36 00 00       	call   3b80 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 03 35 00 00       	call   3a3e <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 ef 3f 00 00       	push   $0x3fef
     544:	e8 0d 35 00 00       	call   3a56 <open>
  if(fd >= 0){
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     598:	e8 e3 35 00 00       	call   3b80 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 99 34 00 00       	call   3a3e <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 ef 3f 00 00 	movl   $0x3fef,(%esp)
     5ac:	e8 b5 34 00 00       	call   3a66 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c6:	e8 b5 35 00 00       	call   3b80 <printf>
}
     ...
     5e4:	e8 97 35 00 00       	call   3b80 <printf>
      exit();
     5e9:	e8 28 34 00 00       	call   3a16 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5ee:	83 ec 04             	sub    $0x4,%esp
     5f1:	53                   	push   %ebx
     5f2:	68 14 4f 00 00       	push   $0x4f14
     5f7:	ff 35 50 60 00 00    	push   0x6050
     5fd:	e8 7e 35 00 00       	call   3b80 <printf>
      exit();
     602:	e8 0f 34 00 00       	call   3a16 <exit>
    printf(stdout, "error: open small failed!\n");
     607:	51                   	push   %ecx
     608:	51                   	push   %ecx
     609:	68 66 40 00 00       	push   $0x4066
     60e:	ff 35 50 60 00 00    	push   0x6050
     614:	e8 67 35 00 00       	call   3b80 <printf>
    exit();
     619:	e8 f8 33 00 00       	call   3a16 <exit>
    printf(stdout, "read failed\n");
     61e:	52                   	push   %edx
     61f:	52                   	push   %edx
     620:	68 ad 43 00 00       	push   $0x43ad
     625:	ff 35 50 60 00 00    	push   0x6050
     62b:	e8 50 35 00 00       	call   3b80 <printf>
    exit();
     630:	e8 e1 33 00 00       	call   3a16 <exit>
    printf(stdout, "unlink small failed\n");
     635:	50                   	push   %eax
     636:	50                   	push   %eax
     637:	68 94 40 00 00       	push   $0x4094
     63c:	ff 35 50 60 00 00    	push   0x6050
     642:	e8 39 35 00 00       	call   3b80 <printf>
    exit();
     647:	e8 ca 33 00 00       	call   3a16 <exit>
    printf(stdout, "error: creat small failed!\n");
     64c:	50                   	push   %eax
     64d:	50                   	push   %eax
     64e:	68 10 40 00 00       	push   $0x4010
     653:	ff 35 50 60 00 00    	push   0x6050
     659:	e8 22 35 00 00       	call   3b80 <printf>
    exit();
     65e:	e8 b3 33 00 00       	call   3a16 <exit>
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     683:	e8 f8 34 00 00       	call   3b80 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     688:	58                   	pop    %eax
     689:	5a                   	pop    %edx
     68a:	68 02 02 00 00       	push   $0x202
     68f:	68 37 41 00 00       	push   $0x4137
     694:	e8 bd 33 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 6d 33 00 00       	call   3a36 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 53 33 00 00       	call   3a3e <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 37 41 00 00       	push   $0x4137
     6f4:	e8 5d 33 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 f4 32 00 00       	call   3a2e <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 e8 32 00 00       	call   3a3e <close>
  if(unlink("big") < 0){
     756:	c7 04 24 37 41 00 00 	movl   $0x4137,(%esp)
     75d:	e8 04 33 00 00       	call   3a66 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     77b:	e8 00 34 00 00       	call   3b80 <printf>
}
     ...
     799:	e8 e2 33 00 00       	call   3b80 <printf>
      exit();
     79e:	e8 73 32 00 00       	call   3a16 <exit>
      printf(stdout, "read content of block %d is %d\n",
     7a3:	50                   	push   %eax
     7a4:	56                   	push   %esi
     7a5:	68 38 4f 00 00       	push   $0x4f38
     7aa:	ff 35 50 60 00 00    	push   0x6050
     7b0:	e8 cb 33 00 00       	call   3b80 <printf>
      exit();
     7b5:	e8 5c 32 00 00       	call   3a16 <exit>
      printf(stdout, "read failed %d\n", i);
     7ba:	83 ec 04             	sub    $0x4,%esp
     7bd:	50                   	push   %eax
     7be:	68 3b 41 00 00       	push   $0x413b
     7c3:	ff 35 50 60 00 00    	push   0x6050
     7c9:	e8 b2 33 00 00       	call   3b80 <printf>
      exit();
     7ce:	e8 43 32 00 00       	call   3a16 <exit>
        printf(stdout, "read only %d blocks from big", n);
     7d3:	52                   	push   %edx
     7d4:	68 8b 00 00 00       	push   $0x8b
     7d9:	68 1e 41 00 00       	push   $0x411e
     7de:	ff 35 50 60 00 00    	push   0x6050
     7e4:	e8 97 33 00 00       	call   3b80 <printf>
        exit();
     7e9:	e8 28 32 00 00       	call   3a16 <exit>
    printf(stdout, "error: open big failed!\n");
     7ee:	51                   	push   %ecx
     7ef:	51                   	push   %ecx
     7f0:	68 05 41 00 00       	push   $0x4105
     7f5:	ff 35 50 60 00 00    	push   0x6050
     7fb:	e8 80 33 00 00       	call   3b80 <printf>
    exit();
     800:	e8 11 32 00 00       	call   3a16 <exit>
    printf(stdout, "error: creat big failed!\n");
     805:	50                   	push   %eax
     806:	50                   	push   %eax
     807:	68 cd 40 00 00       	push   $0x40cd
     80c:	ff 35 50 60 00 00    	push   0x6050
     812:	e8 69 33 00 00       	call   3b80 <printf>
    exit();
     817:	e8 fa 31 00 00       	call   3a16 <exit>
    printf(stdout, "unlink big failed\n");
     81c:	50                   	push   %eax
     81d:	50                   	push   %eax
     81e:	68 4b 41 00 00       	push   $0x414b
     823:	ff 35 50 60 00 00    	push   0x6050
     829:	e8 52 33 00 00       	call   3b80 <printf>
    exit();
     82e:	e8 e3 31 00 00       	call   3a16 <exit>
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     857:	e8 24 33 00 00       	call   3b80 <printf>
  name[0] = 'a';
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 cb 31 00 00       	call   3a56 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 ab 31 00 00       	call   3a3e <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 a0 31 00 00       	call   3a66 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8dc:	e8 9f 32 00 00       	call   3b80 <printf>
}
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     901:	e8 7a 32 00 00       	call   3b80 <printf>
  if(mkdir("dir0") < 0){
     906:	c7 04 24 78 41 00 00 	movl   $0x4178,(%esp)
     90d:	e8 6c 31 00 00       	call   3a7e <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 60 31 00 00       	call   3a86 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 48 31 00 00       	call   3a86 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 14 31 00 00       	call   3a66 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     967:	e8 14 32 00 00       	call   3b80 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     97e:	e8 fd 31 00 00       	call   3b80 <printf>
    exit();
     983:	e8 8e 30 00 00       	call   3a16 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 a1 41 00 00       	push   $0x41a1
     98f:	ff 35 50 60 00 00    	push   0x6050
     995:	e8 e6 31 00 00       	call   3b80 <printf>
    exit();
     99a:	e8 77 30 00 00       	call   3a16 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 90 41 00 00       	push   $0x4190
     9a6:	ff 35 50 60 00 00    	push   0x6050
     9ac:	e8 cf 31 00 00       	call   3b80 <printf>
    exit();
     9b1:	e8 60 30 00 00       	call   3a16 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 7d 41 00 00       	push   $0x417d
     9bd:	ff 35 50 60 00 00    	push   0x6050
     9c3:	e8 b8 31 00 00       	call   3b80 <printf>
    exit();
     9c8:	e8 49 30 00 00       	call   3a16 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9e1:	e8 9a 31 00 00       	call   3b80 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 54 60 00 00       	push   $0x6054
     9ed:	68 8d 3f 00 00       	push   $0x3f8d
     9f2:	e8 57 30 00 00       	call   3a4e <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a0d:	e8 6e 31 00 00       	call   3b80 <printf>
    exit();
     a12:	e8 ff 2f 00 00       	call   3a16 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 dc 2f 00 00       	call   3a3e <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 b1 2f 00 00       	call   3a2e <read>
     ...
     ab8:	68 fe 41 00 00       	push   $0x41fe
     abd:	6a 01                	push   $0x1
     abf:	e8 bc 30 00 00       	call   3b80 <printf>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 62 2f 00 00       	call   3a3e <close>
     ...
     b11:	e8 20 2f 00 00       	call   3a36 <write>
    ...
    exit();
     b28:	e8 e9 2e 00 00       	call   3a16 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 fd 2e 00 00       	call   3a3e <close>
    wait();
     b41:	e8 d8 2e 00 00       	call   3a1e <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     b48:	68 23 42 00 00       	push   $0x4223
     b4d:	6a 01                	push   $0x1
     b4f:	e8 2c 30 00 00       	call   3b80 <printf>
     ...
     b65:	6a 01                	push   $0x1
     b67:	e8 14 30 00 00       	call   3b80 <printf>
      exit();
     b6c:	e8 a5 2e 00 00       	call   3a16 <exit>
    printf(1, "pipe() failed\n");
     b71:	57                   	push   %edi
     b72:	57                   	push   %edi
     b73:	68 e1 41 00 00       	push   $0x41e1
     b78:	6a 01                	push   $0x1
     b7a:	e8 01 30 00 00       	call   3b80 <printf>
    exit();
     b7f:	e8 92 2e 00 00       	call   3a16 <exit>
    printf(1, "fork() failed\n");
     b84:	50                   	push   %eax
     b85:	50                   	push   %eax
     b86:	68 2d 42 00 00       	push   $0x422d
     b8b:	6a 01                	push   $0x1
     b8d:	e8 ee 2f 00 00       	call   3b80 <printf>
    exit();
     b92:	e8 7f 2e 00 00       	call   3a16 <exit>
        printf(1, "pipe1 oops 1\n");
     b97:	56                   	push   %esi
     b98:	56                   	push   %esi
     b99:	68 f0 41 00 00       	push   $0x41f0
     b9e:	6a 01                	push   $0x1
     ba0:	e8 db 2f 00 00       	call   3b80 <printf>
        exit();
     ba5:	e8 6c 2e 00 00       	call   3a16 <exit>
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     ...
     bbe:	6a 01                	push   $0x1
     bc0:	e8 bb 2f 00 00       	call   3b80 <printf>
  pid1 = fork();
     bc5:	e8 44 2e 00 00       	call   3a0e <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 2f 2e 00 00       	call   3a0e <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 2a 2e 00 00       	call   3a26 <pipe>
  pid3 = fork();
     bfc:	e8 0d 2e 00 00       	call   3a0e <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 00 2e 00 00       	call   3a3e <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 c3 2d 00 00       	call   3a3e <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
     c7d:	68 6d 42 00 00       	push   $0x426d
     c82:	6a 01                	push   $0x1
     c84:	e8 f7 2e 00 00       	call   3b80 <printf>
  kill(pid1);
     c89:	89 1c 24             	mov    %ebx,(%esp)
     c8c:	e8 b5 2d 00 00       	call   3a46 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 ad 2d 00 00       	call   3a46 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 a5 2d 00 00       	call   3a46 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
     ca3:	68 76 42 00 00       	push   $0x4276
     ca8:	6a 01                	push   $0x1
     caa:	e8 d1 2e 00 00       	call   3b80 <printf>
  wait();
     caf:	e8 6a 2d 00 00       	call   3a1e <wait>
  wait();
     cb4:	e8 65 2d 00 00       	call   3a1e <wait>
  wait();
     cb9:	e8 60 2d 00 00       	call   3a1e <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
     cc0:	68 7f 42 00 00       	push   $0x427f
     cc5:	6a 01                	push   $0x1
     cc7:	e8 b4 2e 00 00       	call   3b80 <printf>
    ...
    printf(1, "preempt read error");
     ...
     cdf:	6a 01                	push   $0x1
     ce1:	e8 9a 2e 00 00       	call   3b80 <printf>
     ...
     cf3:	6a 01                	push   $0x1
     cf5:	e8 86 2e 00 00       	call   3b80 <printf>
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 f7 2c 00 00       	call   3a1e <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 d9 2c 00 00       	call   3a0e <fork>
    ...
    if(pid < 0){
     ...
     d43:	6a 01                	push   $0x1
     d45:	e8 36 2e 00 00       	call   3b80 <printf>
      return;
     ...
     d60:	6a 01                	push   $0x1
     d62:	e8 19 2e 00 00       	call   3b80 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d79:	6a 01                	push   $0x1
     d7b:	e8 00 2e 00 00       	call   3b80 <printf>
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 87 2c 00 00       	call   3a16 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     d9f:	6a 01                	push   $0x1
     da1:	e8 da 2d 00 00       	call   3b80 <printf>
  ppid = getpid();
     da6:	e8 eb 2c 00 00       	call   3a96 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 5c 2c 00 00       	call   3a0e <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dcc:	e8 df 2f 00 00       	call   3db0 <malloc>
    ...
    m1 = malloc(1024*20);
     ...
     dfc:	e8 af 2f 00 00       	call   3db0 <malloc>
    if(m1 == 0){
    ...
    printf(1, "mem ok\n");
     ...
     e18:	6a 01                	push   $0x1
     e1a:	e8 61 2d 00 00       	call   3b80 <printf>
    exit();
     e1f:	e8 f2 2b 00 00       	call   3a16 <exit>
     e24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e28:	83 ec 08             	sub    $0x8,%esp
     e2b:	68 b2 42 00 00       	push   $0x42b2
     e30:	6a 01                	push   $0x1
     e32:	e8 49 2d 00 00       	call   3b80 <printf>
      kill(ppid);
     e37:	89 1c 24             	mov    %ebx,(%esp)
     e3a:	e8 07 2c 00 00       	call   3a46 <kill>
      exit();
     e3f:	e8 d2 2b 00 00       	call   3a16 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 cb 2b 00 00       	jmp    3a1e <wait>
...
00000e60 <sharedfd>:
{
  ...
  pid = fork();
     ea7:	e8 62 2b 00 00       	call   3a0e <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 55 2b 00 00       	call   3a36 <write>
     ...
     ef1:	6a 01                	push   $0x1
     ef3:	e8 88 2c 00 00       	call   3b80 <printf>
      break;
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 13 2b 00 00       	call   3a1e <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 25 2b 00 00       	call   3a3e <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 e3 42 00 00       	push   $0x42e3
     f22:	e8 2f 2b 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 dd 2a 00 00       	call   3a2e <read>
  ...
  close(fd);
     ...
     f86:	e8 b3 2a 00 00       	call   3a3e <close>
  unlink("sharedfd");
     f8b:	c7 04 24 e3 42 00 00 	movl   $0x42e3,(%esp)
     f92:	e8 cf 2a 00 00       	call   3a66 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fb5:	6a 01                	push   $0x1
     fb7:	e8 c4 2b 00 00       	call   3b80 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fcf:	6a 01                	push   $0x1
     fd1:	e8 aa 2b 00 00       	call   3b80 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fe9:	6a 01                	push   $0x1
     feb:	e8 90 2b 00 00       	call   3b80 <printf>
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 16 2a 00 00       	call   3a16 <exit>
    printf(1, "sharedfd oops %d %d\n", nc, np);
    1000:	53                   	push   %ebx
    1001:	52                   	push   %edx
    1002:	68 f9 42 00 00       	push   $0x42f9
    1007:	6a 01                	push   $0x1
    1009:	e8 72 2b 00 00       	call   3b80 <printf>
    exit();
    100e:	e8 03 2a 00 00       	call   3a16 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    1053:	e8 28 2b 00 00       	call   3b80 <printf>
    1058:	83 c4 10             	add    $0x10,%esp
    unlink(fname);
    105b:	83 ec 0c             	sub    $0xc,%esp
    105e:	56                   	push   %esi
    105f:	e8 02 2a 00 00       	call   3a66 <unlink>
    pid = fork();
    1064:	e8 a5 29 00 00       	call   3a0e <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 91 29 00 00       	call   3a1e <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 8a 29 00 00       	call   3a1e <wait>
    1094:	e8 85 29 00 00       	call   3a1e <wait>
    1099:	e8 80 29 00 00       	call   3a1e <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 a4 29 00 00       	call   3a56 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 59 29 00 00       	call   3a2e <read>
    ...
    1104:	e8 35 29 00 00       	call   3a3e <close>
    if(total != 12*500){
    ...
    111e:	e8 43 29 00 00       	call   3a66 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1133:	6a 01                	push   $0x1
    1135:	e8 46 2a 00 00       	call   3b80 <printf>
}
    ...
    1152:	68 35 43 00 00       	push   $0x4335
    1157:	6a 01                	push   $0x1
    1159:	e8 22 2a 00 00       	call   3b80 <printf>
          exit();
    115e:	e8 b3 28 00 00       	call   3a16 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 e5 28 00 00       	call   3a56 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 8b 28 00 00       	call   3a36 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 57 28 00 00       	call   3a16 <exit>
        printf(1, "create failed\n");
    11bf:	51                   	push   %ecx
    11c0:	51                   	push   %ecx
    11c1:	68 af 45 00 00       	push   $0x45af
    11c6:	6a 01                	push   $0x1
    11c8:	e8 b3 29 00 00       	call   3b80 <printf>
        exit();
    11cd:	e8 44 28 00 00       	call   3a16 <exit>
    11d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      printf(1, "fork failed\n");
    11d8:	83 ec 08             	sub    $0x8,%esp
    11db:	68 e9 4d 00 00       	push   $0x4de9
    11e0:	6a 01                	push   $0x1
    11e2:	e8 99 29 00 00       	call   3b80 <printf>
      exit();
    11e7:	e8 2a 28 00 00       	call   3a16 <exit>
      printf(1, "wrong length %d\n", total);
    11ec:	50                   	push   %eax
    11ed:	53                   	push   %ebx
    11ee:	68 41 43 00 00       	push   $0x4341
    11f3:	6a 01                	push   $0x1
    11f5:	e8 86 29 00 00       	call   3b80 <printf>
      exit();
    11fa:	e8 17 28 00 00       	call   3a16 <exit>
          printf(1, "write failed %d\n", n);
    11ff:	52                   	push   %edx
    1200:	50                   	push   %eax
    1201:	68 24 43 00 00       	push   $0x4324
    1206:	6a 01                	push   $0x1
    1208:	e8 73 29 00 00       	call   3b80 <printf>
          exit();
    120d:	e8 04 28 00 00       	call   3a16 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    1230:	6a 01                	push   $0x1
    1232:	e8 49 29 00 00       	call   3b80 <printf>
    1237:	83 c4 10             	add    $0x10,%esp
    pid = fork();
    123a:	e8 cf 27 00 00       	call   3a0e <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 c4 27 00 00       	call   3a1e <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 ba 27 00 00       	call   3a1e <wait>
    1264:	e8 b5 27 00 00       	call   3a1e <wait>
    1269:	e8 b0 27 00 00       	call   3a1e <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 a8 27 00 00       	call   3a56 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 6c 27 00 00       	call   3a3e <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 56 27 00 00       	call   3a66 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1329:	6a 01                	push   $0x1
    132b:	e8 50 28 00 00       	call   3b80 <printf>
}
    ...
    1344:	50                   	push   %eax
    1345:	57                   	push   %edi
    1346:	68 44 50 00 00       	push   $0x5044
    134b:	6a 01                	push   $0x1
    134d:	e8 2e 28 00 00       	call   3b80 <printf>
        exit();
    1352:	e8 bf 26 00 00       	call   3a16 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 b7 26 00 00       	call   3a56 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 8f 26 00 00       	call   3a3e <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 98 26 00 00       	call   3a66 <unlink>
    ...
    13d5:	52                   	push   %edx
    13d6:	52                   	push   %edx
    13d7:	68 61 3f 00 00       	push   $0x3f61
    13dc:	6a 01                	push   $0x1
    13de:	e8 9d 27 00 00       	call   3b80 <printf>
            exit();
    13e3:	e8 2e 26 00 00       	call   3a16 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 21 26 00 00       	call   3a16 <exit>
        printf(1, "oops createdelete %s didn't exist\n", name);
    13f5:	83 ec 04             	sub    $0x4,%esp
    13f8:	57                   	push   %edi
    13f9:	68 20 50 00 00       	push   $0x5020
    13fe:	6a 01                	push   $0x1
    1400:	e8 7b 27 00 00       	call   3b80 <printf>
        exit();
    1405:	e8 0c 26 00 00       	call   3a16 <exit>
      printf(1, "fork failed\n");
    140a:	83 ec 08             	sub    $0x8,%esp
    140d:	68 e9 4d 00 00       	push   $0x4de9
    1412:	6a 01                	push   $0x1
    1414:	e8 67 27 00 00       	call   3b80 <printf>
      exit();
    1419:	e8 f8 25 00 00       	call   3a16 <exit>
          printf(1, "create failed\n");
    141e:	83 ec 08             	sub    $0x8,%esp
    1421:	68 af 45 00 00       	push   $0x45af
    1426:	6a 01                	push   $0x1
    1428:	e8 53 27 00 00       	call   3b80 <printf>
          exit();
    142d:	e8 e4 25 00 00       	call   3a16 <exit>
...
00001440 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    144d:	6a 01                	push   $0x1
    144f:	e8 2c 27 00 00       	call   3b80 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1454:	5b                   	pop    %ebx
    1455:	5e                   	pop    %esi
    1456:	68 02 02 00 00       	push   $0x202
    145b:	68 95 43 00 00       	push   $0x4395
    1460:	e8 f1 25 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 b4 25 00 00       	call   3a36 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 b4 25 00 00       	call   3a3e <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 95 43 00 00       	push   $0x4395
    1493:	e8 be 25 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 b4 25 00 00       	call   3a66 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 87 25 00 00       	call   3a56 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 15 25 00 00       	call   3a36 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 0c 25 00 00       	call   3a3e <close>
  unlink("unlinkread");
    1532:	c7 04 24 95 43 00 00 	movl   $0x4395,(%esp)
    1539:	e8 28 25 00 00       	call   3a66 <unlink>
  printf(1, "unlinkread ok\n");
    153e:	58                   	pop    %eax
    153f:	5a                   	pop    %edx
    1540:	68 3d 44 00 00       	push   $0x443d
    1545:	6a 01                	push   $0x1
    1547:	e8 34 26 00 00       	call   3b80 <printf>
}
    ...
    155d:	6a 01                	push   $0x1
    155f:	e8 1c 26 00 00       	call   3b80 <printf>
    exit();
    1564:	e8 ad 24 00 00       	call   3a16 <exit>
    printf(1, "unlinkread write failed\n");
    1569:	51                   	push   %ecx
    156a:	51                   	push   %ecx
    156b:	68 24 44 00 00       	push   $0x4424
    1570:	6a 01                	push   $0x1
    1572:	e8 09 26 00 00       	call   3b80 <printf>
    exit();
    1577:	e8 9a 24 00 00       	call   3a16 <exit>
    printf(1, "unlinkread wrong data\n");
    157c:	53                   	push   %ebx
    157d:	53                   	push   %ebx
    157e:	68 0d 44 00 00       	push   $0x440d
    1583:	6a 01                	push   $0x1
    1585:	e8 f6 25 00 00       	call   3b80 <printf>
    exit();
    158a:	e8 87 24 00 00       	call   3a16 <exit>
    printf(1, "unlinkread read failed");
    158f:	56                   	push   %esi
    1590:	56                   	push   %esi
    1591:	68 f6 43 00 00       	push   $0x43f6
    1596:	6a 01                	push   $0x1
    1598:	e8 e3 25 00 00       	call   3b80 <printf>
    exit();
    159d:	e8 74 24 00 00       	call   3a16 <exit>
    printf(1, "unlink unlinkread failed\n");
    15a2:	50                   	push   %eax
    15a3:	50                   	push   %eax
    15a4:	68 d8 43 00 00       	push   $0x43d8
    15a9:	6a 01                	push   $0x1
    15ab:	e8 d0 25 00 00       	call   3b80 <printf>
    exit();
    15b0:	e8 61 24 00 00       	call   3a16 <exit>
    printf(1, "open unlinkread failed\n");
    15b5:	50                   	push   %eax
    15b6:	50                   	push   %eax
    15b7:	68 c0 43 00 00       	push   $0x43c0
    15bc:	6a 01                	push   $0x1
    15be:	e8 bd 25 00 00       	call   3b80 <printf>
    exit();
    15c3:	e8 4e 24 00 00       	call   3a16 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 0d 24 00 00       	call   3a36 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 00 24 00 00       	call   3a3e <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 5a 44 00 00       	push   $0x445a
    1645:	68 56 44 00 00       	push   $0x4456
    164a:	e8 27 24 00 00       	call   3a76 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 ff 23 00 00       	call   3a66 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 56 44 00 00       	push   $0x4456
    1670:	e8 e1 23 00 00       	call   3a56 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 c7 23 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 7f 23 00 00       	call   3a2e <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 7a 23 00 00       	call   3a3e <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 5a 44 00 00       	push   $0x445a
    16cb:	68 5a 44 00 00       	push   $0x445a
    16d0:	e8 a1 23 00 00       	call   3a76 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 79 23 00 00       	call   3a66 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 56 44 00 00       	push   $0x4456
    16f4:	68 5a 44 00 00       	push   $0x445a
    16f9:	e8 78 23 00 00       	call   3a76 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 5f 23 00 00       	call   3a76 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    1726:	6a 01                	push   $0x1
    1728:	e8 53 24 00 00       	call   3b80 <printf>
}
    ...
    173c:	6a 01                	push   $0x1
    173e:	e8 3d 24 00 00       	call   3b80 <printf>
    exit();
    1743:	e8 ce 22 00 00       	call   3a16 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1748:	50                   	push   %eax
    1749:	50                   	push   %eax
    174a:	68 d8 44 00 00       	push   $0x44d8
    174f:	6a 01                	push   $0x1
    1751:	e8 2a 24 00 00       	call   3b80 <printf>
    exit();
    1756:	e8 bb 22 00 00       	call   3a16 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    175b:	52                   	push   %edx
    175c:	52                   	push   %edx
    175d:	68 8c 50 00 00       	push   $0x508c
    1762:	6a 01                	push   $0x1
    1764:	e8 17 24 00 00       	call   3b80 <printf>
    exit();
    1769:	e8 a8 22 00 00       	call   3a16 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    176e:	50                   	push   %eax
    176f:	50                   	push   %eax
    1770:	68 ba 44 00 00       	push   $0x44ba
    1775:	6a 01                	push   $0x1
    1777:	e8 04 24 00 00       	call   3b80 <printf>
    exit();
    177c:	e8 95 22 00 00       	call   3a16 <exit>
    printf(1, "read lf2 failed\n");
    1781:	51                   	push   %ecx
    1782:	51                   	push   %ecx
    1783:	68 a9 44 00 00       	push   $0x44a9
    1788:	6a 01                	push   $0x1
    178a:	e8 f1 23 00 00       	call   3b80 <printf>
    exit();
    178f:	e8 82 22 00 00       	call   3a16 <exit>
    printf(1, "open lf2 failed\n");
    1794:	53                   	push   %ebx
    1795:	53                   	push   %ebx
    1796:	68 98 44 00 00       	push   $0x4498
    179b:	6a 01                	push   $0x1
    179d:	e8 de 23 00 00       	call   3b80 <printf>
    exit();
    17a2:	e8 6f 22 00 00       	call   3a16 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    17a7:	50                   	push   %eax
    17a8:	50                   	push   %eax
    17a9:	68 64 50 00 00       	push   $0x5064
    17ae:	6a 01                	push   $0x1
    17b0:	e8 cb 23 00 00       	call   3b80 <printf>
    exit();
    17b5:	e8 5c 22 00 00       	call   3a16 <exit>
    printf(1, "link lf1 lf2 failed\n");
    17ba:	51                   	push   %ecx
    17bb:	51                   	push   %ecx
    17bc:	68 83 44 00 00       	push   $0x4483
    17c1:	6a 01                	push   $0x1
    17c3:	e8 b8 23 00 00       	call   3b80 <printf>
    exit();
    17c8:	e8 49 22 00 00       	call   3a16 <exit>
    printf(1, "write lf1 failed\n");
    17cd:	50                   	push   %eax
    17ce:	50                   	push   %eax
    17cf:	68 71 44 00 00       	push   $0x4471
    17d4:	6a 01                	push   $0x1
    17d6:	e8 a5 23 00 00       	call   3b80 <printf>
    exit();
    17db:	e8 36 22 00 00       	call   3a16 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17ee:	68 01 45 00 00       	push   $0x4501
    17f3:	6a 01                	push   $0x1
    17f5:	e8 86 23 00 00       	call   3b80 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 27 22 00 00       	call   3a56 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 fc 21 00 00       	call   3a3e <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 d4 21 00 00       	call   3a1e <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 04 22 00 00       	call   3a66 <unlink>
    pid = fork();
    1862:	e8 a7 21 00 00       	call   3a0e <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 cc 21 00 00       	call   3a56 <open>
      if(fd < 0){
    ...
    1898:	53                   	push   %ebx
    1899:	68 14 45 00 00       	push   $0x4514
    189e:	6a 01                	push   $0x1
    18a0:	e8 db 22 00 00       	call   3b80 <printf>
        exit();
    18a5:	e8 6c 21 00 00       	call   3a16 <exit>
    18aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      link("C0", file);
    18b0:	83 ec 08             	sub    $0x8,%esp
    18b3:	53                   	push   %ebx
    18b4:	68 11 45 00 00       	push   $0x4511
    18b9:	e8 b8 21 00 00       	call   3a76 <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 50 21 00 00       	call   3a16 <exit>
  ...
  for(i = 0; i < 40; i++){
    18d3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18d6:	53                   	push   %ebx
    18d7:	68 11 45 00 00       	push   $0x4511
    18dc:	e8 95 21 00 00       	call   3a76 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 35 21 00 00       	call   3a1e <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    1903:	5f                   	pop    %edi
    1904:	6a 00                	push   $0x0
    1906:	68 1e 47 00 00       	push   $0x471e
    190b:	8d 7d b0             	lea    -0x50(%ebp),%edi
    190e:	e8 43 21 00 00       	call   3a56 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 02 21 00 00       	call   3a2e <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 c5 20 00 00       	call   3a3e <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 c4 20 00 00       	call   3a66 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 bc 20 00 00       	call   3a66 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 b4 20 00 00       	call   3a66 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 ac 20 00 00       	call   3a66 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 54 20 00 00       	call   3a1e <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 2d 20 00 00       	call   3a0e <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 46 20 00 00       	call   3a56 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 26 20 00 00       	call   3a3e <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 34 20 00 00       	call   3a56 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 14 20 00 00       	call   3a3e <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 22 20 00 00       	call   3a56 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 02 20 00 00       	call   3a3e <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 10 20 00 00       	call   3a56 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 f0 1f 00 00       	call   3a3e <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a68:	6a 01                	push   $0x1
    1a6a:	e8 11 21 00 00       	call   3b80 <printf>
}
    ...
    1a7f:	6a 01                	push   $0x1
    1a81:	e8 fa 20 00 00       	call   3b80 <printf>
      exit();
    1a86:	e8 8b 1f 00 00       	call   3a16 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a8b:	51                   	push   %ecx
    1a8c:	51                   	push   %ecx
    1a8d:	68 b0 50 00 00       	push   $0x50b0
    1a92:	6a 01                	push   $0x1
    1a94:	e8 e7 20 00 00       	call   3b80 <printf>
    exit();
    1a99:	e8 78 1f 00 00       	call   3a16 <exit>
    ...
    1aaa:	6a 01                	push   $0x1
    1aac:	e8 cf 20 00 00       	call   3b80 <printf>
        exit();
    1ab1:	e8 60 1f 00 00       	call   3a16 <exit>
    ...
    1ac2:	6a 01                	push   $0x1
    1ac4:	e8 b7 20 00 00       	call   3b80 <printf>
        exit();
    1ac9:	e8 48 1f 00 00       	call   3a16 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 67 1f 00 00       	call   3a3e <close>
...
00001ae0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1aee:	6a 01                	push   $0x1
    1af0:	e8 8b 20 00 00       	call   3b80 <printf>
  unlink("x");
    1af5:	c7 04 24 01 48 00 00 	movl   $0x4801,(%esp)
    1afc:	e8 65 1f 00 00       	call   3a66 <unlink>
  pid = fork();
    1b01:	e8 08 1f 00 00       	call   3a0e <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 24 1f 00 00       	call   3a66 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b71:	68 01 48 00 00       	push   $0x4801
    1b76:	e8 db 1e 00 00       	call   3a56 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 bb 1e 00 00       	call   3a3e <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 87 1e 00 00       	call   3a1e <wait>
  printf(1, "linkunlink ok\n");
    1b97:	83 ec 08             	sub    $0x8,%esp
    1b9a:	68 89 45 00 00       	push   $0x4589
    1b9f:	6a 01                	push   $0x1
    1ba1:	e8 da 1f 00 00       	call   3b80 <printf>
}
    ...
    1bbd:	e8 b4 1e 00 00       	call   3a76 <link>
    ...
    1bd1:	6a 01                	push   $0x1
    1bd3:	e8 a8 1f 00 00       	call   3b80 <printf>
    exit();
    1bd8:	e8 39 1e 00 00       	call   3a16 <exit>
    exit();
    1bdd:	e8 34 1e 00 00       	call   3a16 <exit>
...
00001bf0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    ...
    1bfe:	6a 01                	push   $0x1
    1c00:	e8 7b 1f 00 00       	call   3b80 <printf>
  unlink("bd");
    1c05:	c7 04 24 a5 45 00 00 	movl   $0x45a5,(%esp)
    1c0c:	e8 55 1e 00 00       	call   3a66 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 a5 45 00 00       	push   $0x45a5
    1c1d:	e8 34 1e 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 03 1e 00 00       	call   3a3e <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 0a 1e 00 00       	call   3a76 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 d9 1d 00 00       	call   3a66 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 af 1d 00 00       	call   3a66 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cd1:	6a 01                	push   $0x1
    1cd3:	e8 a8 1e 00 00       	call   3b80 <printf>
    ...
    1ceb:	6a 01                	push   $0x1
    1ced:	e8 8e 1e 00 00       	call   3b80 <printf>
      exit();
    1cf2:	e8 1f 1d 00 00       	call   3a16 <exit>
      printf(1, "bigdir unlink failed");
    1cf7:	83 ec 08             	sub    $0x8,%esp
    1cfa:	68 d2 45 00 00       	push   $0x45d2
    1cff:	6a 01                	push   $0x1
    1d01:	e8 7a 1e 00 00       	call   3b80 <printf>
      exit();
    1d06:	e8 0b 1d 00 00       	call   3a16 <exit>
    printf(1, "bigdir create failed\n");
    1d0b:	50                   	push   %eax
    1d0c:	50                   	push   %eax
    1d0d:	68 a8 45 00 00       	push   $0x45a8
    1d12:	6a 01                	push   $0x1
    1d14:	e8 67 1e 00 00       	call   3b80 <printf>
    exit();
    1d19:	e8 f8 1c 00 00       	call   3a16 <exit>
...
00001d20 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    ...
    1d2c:	6a 01                	push   $0x1
    1d2e:	e8 4d 1e 00 00       	call   3b80 <printf>
  unlink("ff");
    1d33:	c7 04 24 7b 46 00 00 	movl   $0x467b,(%esp)
    1d3a:	e8 27 1d 00 00       	call   3a66 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
    1d46:	e8 33 1d 00 00       	call   3a7e <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 ee 1c 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 b1 1c 00 00       	call   3a36 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 b1 1c 00 00       	call   3a3e <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 18 47 00 00 	movl   $0x4718,(%esp)
    1d94:	e8 cd 1c 00 00       	call   3a66 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 cd 1c 00 00       	call   3a7e <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 88 1c 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 4b 1c 00 00       	call   3a36 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 4b 1c 00 00       	call   3a3e <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 72 46 00 00       	push   $0x4672
    1dfc:	e8 55 1c 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 0d 1c 00 00       	call   3a2e <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 fb 1b 00 00       	call   3a3e <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 b2 46 00 00       	push   $0x46b2
    1e4a:	68 4e 46 00 00       	push   $0x464e
    1e4f:	e8 22 1c 00 00       	call   3a76 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 fa 1b 00 00       	call   3a66 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 d0 1b 00 00       	call   3a56 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 e8 1b 00 00       	call   3a86 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 d0 1b 00 00       	call   3a86 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 b8 1b 00 00       	call   3a86 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 a0 1b 00 00       	call   3a86 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 56 1b 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 0e 1b 00 00       	call   3a2e <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 09 1b 00 00       	call   3a3e <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 4e 46 00 00       	push   $0x464e
    1f3e:	e8 13 1b 00 00       	call   3a56 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 f6 1a 00 00       	call   3a56 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 d9 1a 00 00       	call   3a56 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 bc 1a 00 00       	call   3a56 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 a2 1a 00 00       	call   3a56 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 88 1a 00 00       	call   3a56 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 8b 1a 00 00       	call   3a76 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 6e 1a 00 00       	call   3a76 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 51 1a 00 00       	call   3a76 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 41 1a 00 00       	call   3a7e <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 29 1a 00 00       	call   3a7e <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 11 1a 00 00       	call   3a7e <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 e1 19 00 00       	call   3a66 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 c9 19 00 00       	call   3a66 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 d1 19 00 00       	call   3a86 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 b9 19 00 00       	call   3a86 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 81 19 00 00       	call   3a66 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 69 19 00 00       	call   3a66 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 51 19 00 00       	call   3a66 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 39 19 00 00       	call   3a66 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 21 19 00 00       	call   3a66 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2158:	6a 01                	push   $0x1
    215a:	e8 21 1a 00 00       	call   3b80 <printf>
}
    ...
    216e:	6a 01                	push   $0x1
    2170:	e8 0b 1a 00 00       	call   3b80 <printf>
    exit();
    2175:	e8 9c 18 00 00       	call   3a16 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    217a:	50                   	push   %eax
    217b:	50                   	push   %eax
    217c:	68 f2 46 00 00       	push   $0x46f2
    2181:	6a 01                	push   $0x1
    2183:	e8 f8 19 00 00       	call   3b80 <printf>
    exit();
    2188:	e8 89 18 00 00       	call   3a16 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    218d:	50                   	push   %eax
    218e:	50                   	push   %eax
    218f:	68 bd 46 00 00       	push   $0x46bd
    2194:	6a 01                	push   $0x1
    2196:	e8 e5 19 00 00       	call   3b80 <printf>
    exit();
    219b:	e8 76 18 00 00       	call   3a16 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    21a0:	51                   	push   %ecx
    21a1:	51                   	push   %ecx
    21a2:	68 6f 47 00 00       	push   $0x476f
    21a7:	6a 01                	push   $0x1
    21a9:	e8 d2 19 00 00       	call   3b80 <printf>
    exit();
    21ae:	e8 63 18 00 00       	call   3a16 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    21b3:	53                   	push   %ebx
    21b4:	53                   	push   %ebx
    21b5:	68 54 51 00 00       	push   $0x5154
    21ba:	6a 01                	push   $0x1
    21bc:	e8 bf 19 00 00       	call   3b80 <printf>
    exit();
    21c1:	e8 50 18 00 00       	call   3a16 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21c6:	51                   	push   %ecx
    21c7:	51                   	push   %ecx
    21c8:	68 03 48 00 00       	push   $0x4803
    21cd:	6a 01                	push   $0x1
    21cf:	e8 ac 19 00 00       	call   3b80 <printf>
    exit();
    21d4:	e8 3d 18 00 00       	call   3a16 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21d9:	53                   	push   %ebx
    21da:	53                   	push   %ebx
    21db:	68 c4 51 00 00       	push   $0x51c4
    21e0:	6a 01                	push   $0x1
    21e2:	e8 99 19 00 00       	call   3b80 <printf>
    exit();
    21e7:	e8 2a 18 00 00       	call   3a16 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21ec:	50                   	push   %eax
    21ed:	50                   	push   %eax
    21ee:	68 7e 46 00 00       	push   $0x467e
    21f3:	6a 01                	push   $0x1
    21f5:	e8 86 19 00 00       	call   3b80 <printf>
    exit();
    21fa:	e8 17 18 00 00       	call   3a16 <exit>
    printf(1, "create dd/dd/ff failed\n");
    21ff:	51                   	push   %ecx
    2200:	51                   	push   %ecx
    2201:	68 57 46 00 00       	push   $0x4657
    2206:	6a 01                	push   $0x1
    2208:	e8 73 19 00 00       	call   3b80 <printf>
    exit();
    220d:	e8 04 18 00 00       	call   3a16 <exit>
    printf(1, "chdir ./.. failed\n");
    2212:	50                   	push   %eax
    2213:	50                   	push   %eax
    2214:	68 20 47 00 00       	push   $0x4720
    2219:	6a 01                	push   $0x1
    221b:	e8 60 19 00 00       	call   3b80 <printf>
    exit();
    2220:	e8 f1 17 00 00       	call   3a16 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2225:	52                   	push   %edx
    2226:	52                   	push   %edx
    2227:	68 0c 51 00 00       	push   $0x510c
    222c:	6a 01                	push   $0x1
    222e:	e8 4d 19 00 00       	call   3b80 <printf>
    exit();
    2233:	e8 de 17 00 00       	call   3a16 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2238:	50                   	push   %eax
    2239:	50                   	push   %eax
    223a:	68 a0 51 00 00       	push   $0x51a0
    223f:	6a 01                	push   $0x1
    2241:	e8 3a 19 00 00       	call   3b80 <printf>
    exit();
    2246:	e8 cb 17 00 00       	call   3a16 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    224b:	50                   	push   %eax
    224c:	50                   	push   %eax
    224d:	68 7c 51 00 00       	push   $0x517c
    2252:	6a 01                	push   $0x1
    2254:	e8 27 19 00 00       	call   3b80 <printf>
    exit();
    2259:	e8 b8 17 00 00       	call   3a16 <exit>
    printf(1, "open dd wronly succeeded!\n");
    225e:	50                   	push   %eax
    225f:	50                   	push   %eax
    2260:	68 df 47 00 00       	push   $0x47df
    2265:	6a 01                	push   $0x1
    2267:	e8 14 19 00 00       	call   3b80 <printf>
    exit();
    226c:	e8 a5 17 00 00       	call   3a16 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2271:	50                   	push   %eax
    2272:	50                   	push   %eax
    2273:	68 c6 47 00 00       	push   $0x47c6
    2278:	6a 01                	push   $0x1
    227a:	e8 01 19 00 00       	call   3b80 <printf>
    exit();
    227f:	e8 92 17 00 00       	call   3a16 <exit>
    printf(1, "create dd succeeded!\n");
    2284:	50                   	push   %eax
    2285:	50                   	push   %eax
    2286:	68 b0 47 00 00       	push   $0x47b0
    228b:	6a 01                	push   $0x1
    228d:	e8 ee 18 00 00       	call   3b80 <printf>
    exit();
    2292:	e8 7f 17 00 00       	call   3a16 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2297:	52                   	push   %edx
    2298:	52                   	push   %edx
    2299:	68 94 47 00 00       	push   $0x4794
    229e:	6a 01                	push   $0x1
    22a0:	e8 db 18 00 00       	call   3b80 <printf>
    exit();
    22a5:	e8 6c 17 00 00       	call   3a16 <exit>
    printf(1, "chdir dd failed\n");
    22aa:	50                   	push   %eax
    22ab:	50                   	push   %eax
    22ac:	68 d5 46 00 00       	push   $0x46d5
    22b1:	6a 01                	push   $0x1
    22b3:	e8 c8 18 00 00       	call   3b80 <printf>
    exit();
    22b8:	e8 59 17 00 00       	call   3a16 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    22bf:	68 30 51 00 00       	push   $0x5130
    22c4:	6a 01                	push   $0x1
    22c6:	e8 b5 18 00 00       	call   3b80 <printf>
    exit();
    22cb:	e8 46 17 00 00       	call   3a16 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22d0:	53                   	push   %ebx
    22d1:	53                   	push   %ebx
    22d2:	68 33 46 00 00       	push   $0x4633
    22d7:	6a 01                	push   $0x1
    22d9:	e8 a2 18 00 00       	call   3b80 <printf>
    exit();
    22de:	e8 33 17 00 00       	call   3a16 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22e3:	50                   	push   %eax
    22e4:	50                   	push   %eax
    22e5:	68 e4 50 00 00       	push   $0x50e4
    22ea:	6a 01                	push   $0x1
    22ec:	e8 8f 18 00 00       	call   3b80 <printf>
    exit();
    22f1:	e8 20 17 00 00       	call   3a16 <exit>
    printf(1, "create dd/ff failed\n");
    22f6:	50                   	push   %eax
    22f7:	50                   	push   %eax
    22f8:	68 17 46 00 00       	push   $0x4617
    22fd:	6a 01                	push   $0x1
    22ff:	e8 7c 18 00 00       	call   3b80 <printf>
    exit();
    2304:	e8 0d 17 00 00       	call   3a16 <exit>
    printf(1, "subdir mkdir dd failed\n");
    2309:	50                   	push   %eax
    230a:	50                   	push   %eax
    230b:	68 ff 45 00 00       	push   $0x45ff
    2310:	6a 01                	push   $0x1
    2312:	e8 69 18 00 00       	call   3b80 <printf>
    exit();
    2317:	e8 fa 16 00 00       	call   3a16 <exit>
    printf(1, "unlink dd failed\n");
    231c:	50                   	push   %eax
    231d:	50                   	push   %eax
    231e:	68 e8 48 00 00       	push   $0x48e8
    2323:	6a 01                	push   $0x1
    2325:	e8 56 18 00 00       	call   3b80 <printf>
    exit();
    232a:	e8 e7 16 00 00       	call   3a16 <exit>
    printf(1, "unlink dd/dd failed\n");
    232f:	52                   	push   %edx
    2330:	52                   	push   %edx
    2331:	68 d3 48 00 00       	push   $0x48d3
    2336:	6a 01                	push   $0x1
    2338:	e8 43 18 00 00       	call   3b80 <printf>
    exit();
    233d:	e8 d4 16 00 00       	call   3a16 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2342:	51                   	push   %ecx
    2343:	51                   	push   %ecx
    2344:	68 e8 51 00 00       	push   $0x51e8
    2349:	6a 01                	push   $0x1
    234b:	e8 30 18 00 00       	call   3b80 <printf>
    exit();
    2350:	e8 c1 16 00 00       	call   3a16 <exit>
    printf(1, "unlink dd/ff failed\n");
    2355:	53                   	push   %ebx
    2356:	53                   	push   %ebx
    2357:	68 be 48 00 00       	push   $0x48be
    235c:	6a 01                	push   $0x1
    235e:	e8 1d 18 00 00       	call   3b80 <printf>
    exit();
    2363:	e8 ae 16 00 00       	call   3a16 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2368:	50                   	push   %eax
    2369:	50                   	push   %eax
    236a:	68 a6 48 00 00       	push   $0x48a6
    236f:	6a 01                	push   $0x1
    2371:	e8 0a 18 00 00       	call   3b80 <printf>
    exit();
    2376:	e8 9b 16 00 00       	call   3a16 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    237b:	50                   	push   %eax
    237c:	50                   	push   %eax
    237d:	68 8e 48 00 00       	push   $0x488e
    2382:	6a 01                	push   $0x1
    2384:	e8 f7 17 00 00       	call   3b80 <printf>
    exit();
    2389:	e8 88 16 00 00       	call   3a16 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    238e:	50                   	push   %eax
    238f:	50                   	push   %eax
    2390:	68 72 48 00 00       	push   $0x4872
    2395:	6a 01                	push   $0x1
    2397:	e8 e4 17 00 00       	call   3b80 <printf>
    exit();
    239c:	e8 75 16 00 00       	call   3a16 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    23a1:	50                   	push   %eax
    23a2:	50                   	push   %eax
    23a3:	68 56 48 00 00       	push   $0x4856
    23a8:	6a 01                	push   $0x1
    23aa:	e8 d1 17 00 00       	call   3b80 <printf>
    exit();
    23af:	e8 62 16 00 00       	call   3a16 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    23b4:	50                   	push   %eax
    23b5:	50                   	push   %eax
    23b6:	68 39 48 00 00       	push   $0x4839
    23bb:	6a 01                	push   $0x1
    23bd:	e8 be 17 00 00       	call   3b80 <printf>
    exit();
    23c2:	e8 4f 16 00 00       	call   3a16 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23c7:	52                   	push   %edx
    23c8:	52                   	push   %edx
    23c9:	68 1e 48 00 00       	push   $0x481e
    23ce:	6a 01                	push   $0x1
    23d0:	e8 ab 17 00 00       	call   3b80 <printf>
    exit();
    23d5:	e8 3c 16 00 00       	call   3a16 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23da:	51                   	push   %ecx
    23db:	51                   	push   %ecx
    23dc:	68 4b 47 00 00       	push   $0x474b
    23e1:	6a 01                	push   $0x1
    23e3:	e8 98 17 00 00       	call   3b80 <printf>
    exit();
    23e8:	e8 29 16 00 00       	call   3a16 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23ed:	53                   	push   %ebx
    23ee:	53                   	push   %ebx
    23ef:	68 33 47 00 00       	push   $0x4733
    23f4:	6a 01                	push   $0x1
    23f6:	e8 85 17 00 00       	call   3b80 <printf>
    exit();
    23fb:	e8 16 16 00 00       	call   3a16 <exit>
...
00002400 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2412:	6a 01                	push   $0x1
    2414:	e8 67 17 00 00       	call   3b80 <printf>
  unlink("bigwrite");
    2419:	c7 04 24 14 49 00 00 	movl   $0x4914,(%esp)
    2420:	e8 41 16 00 00       	call   3a66 <unlink>
    ...
    243d:	e8 14 16 00 00       	call   3a56 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 dc 15 00 00       	call   3a36 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 c6 15 00 00       	call   3a36 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 b8 15 00 00       	call   3a3e <close>
    unlink("bigwrite");
    2486:	c7 04 24 14 49 00 00 	movl   $0x4914,(%esp)
    248d:	e8 d4 15 00 00       	call   3a66 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24a5:	6a 01                	push   $0x1
    24a7:	e8 d4 16 00 00       	call   3b80 <printf>
}
    ...
    24bd:	6a 01                	push   $0x1
    24bf:	e8 bc 16 00 00       	call   3b80 <printf>
        exit();
    24c4:	e8 4d 15 00 00       	call   3a16 <exit>
      printf(1, "cannot create bigwrite\n");
    24c9:	83 ec 08             	sub    $0x8,%esp
    24cc:	68 1d 49 00 00       	push   $0x491d
    24d1:	6a 01                	push   $0x1
    24d3:	e8 a8 16 00 00       	call   3b80 <printf>
      exit();
    24d8:	e8 39 15 00 00       	call   3a16 <exit>
...
000024e0 <bigfile>:
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 e8 14 00 00       	call   3a36 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 d1 14 00 00       	call   3a3e <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 70 49 00 00       	push   $0x4970
    2576:	e8 db 14 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 5d 14 00 00       	call   3a2e <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 5b 14 00 00       	call   3a3e <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 67 14 00 00       	call   3a66 <unlink>
  printf(1, "bigfile test ok\n");
    25ff:	58                   	pop    %eax
    2600:	5a                   	pop    %edx
    2601:	68 ff 49 00 00       	push   $0x49ff
    2606:	6a 01                	push   $0x1
    2608:	e8 73 15 00 00       	call   3b80 <printf>
}
    ...
    2620:	6a 01                	push   $0x1
    2622:	e8 59 15 00 00       	call   3b80 <printf>
      exit();
    2627:	e8 ea 13 00 00       	call   3a16 <exit>
      printf(1, "short read bigfile\n");
    262c:	83 ec 08             	sub    $0x8,%esp
    262f:	68 b8 49 00 00       	push   $0x49b8
    2634:	6a 01                	push   $0x1
    2636:	e8 45 15 00 00       	call   3b80 <printf>
      exit();
    263b:	e8 d6 13 00 00       	call   3a16 <exit>
      printf(1, "read bigfile failed\n");
    2640:	83 ec 08             	sub    $0x8,%esp
    2643:	68 a3 49 00 00       	push   $0x49a3
    2648:	6a 01                	push   $0x1
    264a:	e8 31 15 00 00       	call   3b80 <printf>
      exit();
    264f:	e8 c2 13 00 00       	call   3a16 <exit>
      printf(1, "write bigfile failed\n");
    2654:	83 ec 08             	sub    $0x8,%esp
    2657:	68 78 49 00 00       	push   $0x4978
    265c:	6a 01                	push   $0x1
    265e:	e8 1d 15 00 00       	call   3b80 <printf>
      exit();
    2663:	e8 ae 13 00 00       	call   3a16 <exit>
    printf(1, "cannot open bigfile\n");
    2668:	53                   	push   %ebx
    2669:	53                   	push   %ebx
    266a:	68 8e 49 00 00       	push   $0x498e
    266f:	6a 01                	push   $0x1
    2671:	e8 0a 15 00 00       	call   3b80 <printf>
    exit();
    2676:	e8 9b 13 00 00       	call   3a16 <exit>
    printf(1, "cannot create bigfile");
    267b:	50                   	push   %eax
    267c:	50                   	push   %eax
    267d:	68 62 49 00 00       	push   $0x4962
    2682:	6a 01                	push   $0x1
    2684:	e8 f7 14 00 00       	call   3b80 <printf>
    exit();
    2689:	e8 88 13 00 00       	call   3a16 <exit>
    printf(1, "read bigfile wrong total\n");
    268e:	51                   	push   %ecx
    268f:	51                   	push   %ecx
    2690:	68 e5 49 00 00       	push   $0x49e5
    2695:	6a 01                	push   $0x1
    2697:	e8 e4 14 00 00       	call   3b80 <printf>
    exit();
    269c:	e8 75 13 00 00       	call   3a16 <exit>
...
000026b0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    ...
    26bb:	6a 01                	push   $0x1
    26bd:	e8 be 14 00 00       	call   3b80 <printf>
  if(mkdir("12345678901234") != 0){
    26c2:	c7 04 24 4b 4a 00 00 	movl   $0x4a4b,(%esp)
    26c9:	e8 b0 13 00 00       	call   3a7e <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 98 13 00 00       	call   3a7e <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 53 13 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 27 13 00 00       	call   3a3e <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 c8 52 00 00       	push   $0x52c8
    2720:	e8 31 13 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 09 13 00 00       	call   3a3e <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 3c 4a 00 00 	movl   $0x4a3c,(%esp)
    273c:	e8 3d 13 00 00       	call   3a7e <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 29 13 00 00       	call   3a7e <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    2764:	6a 01                	push   $0x1
    2766:	e8 15 14 00 00       	call   3b80 <printf>
}
    ...
    2777:	6a 01                	push   $0x1
    2779:	e8 02 14 00 00       	call   3b80 <printf>
    exit();
    277e:	e8 93 12 00 00       	call   3a16 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2783:	50                   	push   %eax
    2784:	50                   	push   %eax
    2785:	68 84 53 00 00       	push   $0x5384
    278a:	6a 01                	push   $0x1
    278c:	e8 ef 13 00 00       	call   3b80 <printf>
    exit();
    2791:	e8 80 12 00 00       	call   3a16 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2796:	52                   	push   %edx
    2797:	52                   	push   %edx
    2798:	68 34 53 00 00       	push   $0x5334
    279d:	6a 01                	push   $0x1
    279f:	e8 dc 13 00 00       	call   3b80 <printf>
    exit();
    27a4:	e8 6d 12 00 00       	call   3a16 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    27a9:	51                   	push   %ecx
    27aa:	51                   	push   %ecx
    27ab:	68 f8 52 00 00       	push   $0x52f8
    27b0:	6a 01                	push   $0x1
    27b2:	e8 c9 13 00 00       	call   3b80 <printf>
    exit();
    27b7:	e8 5a 12 00 00       	call   3a16 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27bc:	51                   	push   %ecx
    27bd:	51                   	push   %ecx
    27be:	68 88 52 00 00       	push   $0x5288
    27c3:	6a 01                	push   $0x1
    27c5:	e8 b6 13 00 00       	call   3b80 <printf>
    exit();
    27ca:	e8 47 12 00 00       	call   3a16 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27cf:	50                   	push   %eax
    27d0:	50                   	push   %eax
    27d1:	68 28 52 00 00       	push   $0x5228
    27d6:	6a 01                	push   $0x1
    27d8:	e8 a3 13 00 00       	call   3b80 <printf>
    exit();
    27dd:	e8 34 12 00 00       	call   3a16 <exit>
...
000027f0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    ...
    27fb:	6a 01                	push   $0x1
    27fd:	e8 7e 13 00 00       	call   3b80 <printf>
  if(mkdir("dots") != 0){
    2802:	c7 04 24 73 4a 00 00 	movl   $0x4a73,(%esp)
    2809:	e8 70 12 00 00       	call   3a7e <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 60 12 00 00       	call   3a86 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 28 12 00 00       	call   3a66 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 10 12 00 00       	call   3a66 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 18 12 00 00       	call   3a86 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 e0 11 00 00       	call   3a66 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 cc 11 00 00       	call   3a66 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 b8 11 00 00       	call   3a66 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    28bd:	6a 01                	push   $0x1
    28bf:	e8 bc 12 00 00       	call   3b80 <printf>
}
    ...
    28d0:	6a 01                	push   $0x1
    28d2:	e8 a9 12 00 00       	call   3b80 <printf>
    exit();
    28d7:	e8 3a 11 00 00       	call   3a16 <exit>
    printf(1, "unlink dots failed!\n");
    28dc:	50                   	push   %eax
    28dd:	50                   	push   %eax
    28de:	68 f9 4a 00 00       	push   $0x4af9
    28e3:	6a 01                	push   $0x1
    28e5:	e8 96 12 00 00       	call   3b80 <printf>
    exit();
    28ea:	e8 27 11 00 00       	call   3a16 <exit>
    printf(1, "unlink dots/.. worked!\n");
    28ef:	52                   	push   %edx
    28f0:	52                   	push   %edx
    28f1:	68 e1 4a 00 00       	push   $0x4ae1
    28f6:	6a 01                	push   $0x1
    28f8:	e8 83 12 00 00       	call   3b80 <printf>
    exit();
    28fd:	e8 14 11 00 00       	call   3a16 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    2904:	68 c2 4a 00 00       	push   $0x4ac2
    2909:	6a 01                	push   $0x1
    290b:	e8 70 12 00 00       	call   3b80 <printf>
    exit();
    2910:	e8 01 11 00 00       	call   3a16 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    2917:	68 f3 3e 00 00       	push   $0x3ef3
    291c:	6a 01                	push   $0x1
    291e:	e8 5d 12 00 00       	call   3b80 <printf>
    exit();
    2923:	e8 ee 10 00 00       	call   3a16 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    292a:	68 ac 4a 00 00       	push   $0x4aac
    292f:	6a 01                	push   $0x1
    2931:	e8 4a 12 00 00       	call   3b80 <printf>
    exit();
    2936:	e8 db 10 00 00       	call   3a16 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    293d:	68 9e 4a 00 00       	push   $0x4a9e
    2942:	6a 01                	push   $0x1
    2944:	e8 37 12 00 00       	call   3b80 <printf>
    exit();
    2949:	e8 c8 10 00 00       	call   3a16 <exit>
    printf(1, "chdir dots failed\n");
    294e:	50                   	push   %eax
    294f:	50                   	push   %eax
    2950:	68 8b 4a 00 00       	push   $0x4a8b
    2955:	6a 01                	push   $0x1
    2957:	e8 24 12 00 00       	call   3b80 <printf>
    exit();
    295c:	e8 b5 10 00 00       	call   3a16 <exit>
...
00002970 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    ...
    297c:	6a 01                	push   $0x1
    297e:	e8 fd 11 00 00       	call   3b80 <printf>
  fd = open("dirfile", O_CREATE);
    2983:	5b                   	pop    %ebx
    2984:	58                   	pop    %eax
    2985:	68 00 02 00 00       	push   $0x200
    298a:	68 25 4b 00 00       	push   $0x4b25
    298f:	e8 c2 10 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 96 10 00 00       	call   3a3e <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 25 4b 00 00 	movl   $0x4b25,(%esp)
    29af:	e8 d2 10 00 00       	call   3a86 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 88 10 00 00       	call   3a56 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 6b 10 00 00       	call   3a56 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 7b 10 00 00       	call   3a7e <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 4b 10 00 00       	call   3a66 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 3e 10 00 00       	call   3a76 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 16 10 00 00       	call   3a66 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 ec 0f 00 00       	call   3a56 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 d2 0f 00 00       	call   3a56 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 a0 0f 00 00       	call   3a36 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 98 0f 00 00       	call   3a3e <close>
  printf(1, "dir vs file OK\n");
    2aa6:	58                   	pop    %eax
    2aa7:	5a                   	pop    %edx
    2aa8:	68 f5 4b 00 00       	push   $0x4bf5
    2aad:	6a 01                	push   $0x1
    2aaf:	e8 cc 10 00 00       	call   3b80 <printf>
}
    ...
    2ac3:	6a 01                	push   $0x1
    2ac5:	e8 b6 10 00 00       	call   3b80 <printf>
    exit();
    2aca:	e8 47 0f 00 00       	call   3a16 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2acf:	52                   	push   %edx
    2ad0:	52                   	push   %edx
    2ad1:	68 44 4b 00 00       	push   $0x4b44
    2ad6:	6a 01                	push   $0x1
    2ad8:	e8 a3 10 00 00       	call   3b80 <printf>
    exit();
    2add:	e8 34 0f 00 00       	call   3a16 <exit>
    printf(1, "create dirfile failed\n");
    2ae2:	51                   	push   %ecx
    2ae3:	51                   	push   %ecx
    2ae4:	68 2d 4b 00 00       	push   $0x4b2d
    2ae9:	6a 01                	push   $0x1
    2aeb:	e8 90 10 00 00       	call   3b80 <printf>
    exit();
    2af0:	e8 21 0f 00 00       	call   3a16 <exit>
    printf(1, "write . succeeded!\n");
    2af5:	51                   	push   %ecx
    2af6:	51                   	push   %ecx
    2af7:	68 e1 4b 00 00       	push   $0x4be1
    2afc:	6a 01                	push   $0x1
    2afe:	e8 7d 10 00 00       	call   3b80 <printf>
    exit();
    2b03:	e8 0e 0f 00 00       	call   3a16 <exit>
    printf(1, "open . for writing succeeded!\n");
    2b08:	53                   	push   %ebx
    2b09:	53                   	push   %ebx
    2b0a:	68 d8 53 00 00       	push   $0x53d8
    2b0f:	6a 01                	push   $0x1
    2b11:	e8 6a 10 00 00       	call   3b80 <printf>
    exit();
    2b16:	e8 fb 0e 00 00       	call   3a16 <exit>
    printf(1, "unlink dirfile failed!\n");
    2b1b:	50                   	push   %eax
    2b1c:	50                   	push   %eax
    2b1d:	68 c9 4b 00 00       	push   $0x4bc9
    2b22:	6a 01                	push   $0x1
    2b24:	e8 57 10 00 00       	call   3b80 <printf>
    exit();
    2b29:	e8 e8 0e 00 00       	call   3a16 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b2e:	50                   	push   %eax
    2b2f:	50                   	push   %eax
    2b30:	68 b8 53 00 00       	push   $0x53b8
    2b35:	6a 01                	push   $0x1
    2b37:	e8 44 10 00 00       	call   3b80 <printf>
    exit();
    2b3c:	e8 d5 0e 00 00       	call   3a16 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b41:	50                   	push   %eax
    2b42:	50                   	push   %eax
    2b43:	68 a4 4b 00 00       	push   $0x4ba4
    2b48:	6a 01                	push   $0x1
    2b4a:	e8 31 10 00 00       	call   3b80 <printf>
    exit();
    2b4f:	e8 c2 0e 00 00       	call   3a16 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b54:	50                   	push   %eax
    2b55:	50                   	push   %eax
    2b56:	68 87 4b 00 00       	push   $0x4b87
    2b5b:	6a 01                	push   $0x1
    2b5d:	e8 1e 10 00 00       	call   3b80 <printf>
    exit();
    2b62:	e8 af 0e 00 00       	call   3a16 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b81:	6a 01                	push   $0x1
    2b83:	e8 f8 0f 00 00       	call   3b80 <printf>
    ...
    2b98:	e8 e1 0e 00 00       	call   3a7e <mkdir>
    ...
    2bb0:	e8 d1 0e 00 00       	call   3a86 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 1a 0e 00 00       	call   3a3e <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 00 48 00 00       	push   $0x4800
    2c2f:	e8 32 0e 00 00       	call   3a66 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 39 0e 00 00       	call   3a86 <chdir>
  printf(1, "empty file name OK\n");
    2c4d:	58                   	pop    %eax
    2c4e:	5a                   	pop    %edx
    2c4f:	68 44 4c 00 00       	push   $0x4c44
    2c54:	6a 01                	push   $0x1
    2c56:	e8 25 0f 00 00       	call   3b80 <printf>
}
    ...
    2c6b:	6a 01                	push   $0x1
    2c6d:	e8 0e 0f 00 00       	call   3b80 <printf>
      exit();
    2c72:	e8 9f 0d 00 00       	call   3a16 <exit>
      printf(1, "chdir irefd failed\n");
    2c77:	83 ec 08             	sub    $0x8,%esp
    2c7a:	68 30 4c 00 00       	push   $0x4c30
    2c7f:	6a 01                	push   $0x1
    2c81:	e8 fa 0e 00 00       	call   3b80 <printf>
      exit();
    2c86:	e8 8b 0d 00 00       	call   3a16 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    ...
    2c9e:	6a 01                	push   $0x1
    2ca0:	e8 db 0e 00 00       	call   3b80 <printf>
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 4c 0d 00 00       	call   3a0e <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 49 0d 00 00       	call   3a1e <wait>
  ...
  if(wait() != -1){
    2cde:	e8 3b 0d 00 00       	call   3a1e <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cf0:	6a 01                	push   $0x1
    2cf2:	e8 89 0e 00 00       	call   3b80 <printf>
}
    2cf7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2cfa:	c9                   	leave  
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 15 0d 00 00       	call   3a16 <exit>
      printf(1, "wait stopped early\n");
    2d01:	83 ec 08             	sub    $0x8,%esp
    2d04:	68 63 4c 00 00       	push   $0x4c63
    2d09:	6a 01                	push   $0x1
    2d0b:	e8 70 0e 00 00       	call   3b80 <printf>
      exit();
    2d10:	e8 01 0d 00 00       	call   3a16 <exit>
    printf(1, "wait got too many\n");
    2d15:	52                   	push   %edx
    2d16:	52                   	push   %edx
    2d17:	68 77 4c 00 00       	push   $0x4c77
    2d1c:	6a 01                	push   $0x1
    2d1e:	e8 5d 0e 00 00       	call   3b80 <printf>
    exit();
    2d23:	e8 ee 0c 00 00       	call   3a16 <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2d28:	50                   	push   %eax
    2d29:	50                   	push   %eax
    2d2a:	68 f8 53 00 00       	push   $0x53f8
    2d2f:	6a 01                	push   $0x1
    2d31:	e8 4a 0e 00 00       	call   3b80 <printf>
    exit();
    2d36:	e8 db 0c 00 00       	call   3a16 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 12 0d 00 00       	call   3a9e <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 61 0c 00 00       	call   3a0e <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 da 0c 00 00       	call   3a9e <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 ce 0c 00 00       	call   3a9e <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 36 0c 00 00       	call   3a1e <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 ac 0c 00 00       	call   3a9e <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 9b 0c 00 00       	call   3a9e <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 86 0c 00 00       	call   3a9e <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 78 0c 00 00       	call   3a9e <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 62 0c 00 00       	call   3a9e <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 47 0c 00 00       	call   3a9e <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 39 0c 00 00       	call   3a9e <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 22 0c 00 00       	call   3a9e <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 b9 0b 00 00       	call   3a96 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 2a 0b 00 00       	call   3a0e <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 27 0b 00 00       	call   3a1e <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 15 0b 00 00       	call   3a26 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 e1 0a 00 00       	call   3a0e <fork>
    ...
    2f48:	e8 e1 0a 00 00       	call   3a2e <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 3a 0b 00 00       	call   3a9e <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 c6 0a 00 00       	call   3a46 <kill>
    wait();
    2f80:	e8 99 0a 00 00       	call   3a1e <wait>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3037:	53                   	push   %ebx
    3038:	56                   	push   %esi
    3039:	68 a3 4c 00 00       	push   $0x4ca3
    303e:	ff 35 50 60 00 00    	push   0x6050
    3044:	e8 37 0b 00 00       	call   3b80 <printf>
      exit();
    3049:	83 c4 20             	add    $0x20,%esp
    304c:	e8 c5 09 00 00       	call   3a16 <exit>
      printf(stdout, "fork failed\n");
    3051:	83 ec 08             	sub    $0x8,%esp
    3054:	68 e9 4d 00 00       	push   $0x4de9
    3059:	ff 35 50 60 00 00    	push   0x6050
    305f:	e8 1c 0b 00 00       	call   3b80 <printf>
      exit();
    3064:	e8 ad 09 00 00       	call   3a16 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3069:	0f be 03             	movsbl (%ebx),%eax
    306c:	50                   	push   %eax
    306d:	53                   	push   %ebx
    306e:	68 0c 4d 00 00       	push   $0x4d0c
    3073:	ff 35 50 60 00 00    	push   0x6050
    3079:	e8 02 0b 00 00       	call   3b80 <printf>
      kill(ppid);
    307e:	89 34 24             	mov    %esi,(%esp)
    3081:	e8 c0 09 00 00       	call   3a46 <kill>
      exit();
    3086:	e8 8b 09 00 00       	call   3a16 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    308b:	50                   	push   %eax
    308c:	53                   	push   %ebx
    308d:	68 ec 54 00 00       	push   $0x54ec
    3092:	ff 35 50 60 00 00    	push   0x6050
    3098:	e8 e3 0a 00 00       	call   3b80 <printf>
    exit();
    309d:	e8 74 09 00 00       	call   3a16 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    30a2:	56                   	push   %esi
    30a3:	56                   	push   %esi
    30a4:	68 1c 54 00 00       	push   $0x541c
    30a9:	ff 35 50 60 00 00    	push   0x6050
    30af:	e8 cc 0a 00 00       	call   3b80 <printf>
    exit();
    30b4:	e8 5d 09 00 00       	call   3a16 <exit>
    printf(stdout, "sbrk test fork failed\n");
    30b9:	50                   	push   %eax
    30ba:	50                   	push   %eax
    30bb:	68 be 4c 00 00       	push   $0x4cbe
    30c0:	ff 35 50 60 00 00    	push   0x6050
    30c6:	e8 b5 0a 00 00       	call   3b80 <printf>
    exit();
    30cb:	e8 46 09 00 00       	call   3a16 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30d0:	51                   	push   %ecx
    30d1:	51                   	push   %ecx
    30d2:	68 bc 54 00 00       	push   $0x54bc
    30d7:	ff 35 50 60 00 00    	push   0x6050
    30dd:	e8 9e 0a 00 00       	call   3b80 <printf>
    exit();
    30e2:	e8 2f 09 00 00       	call   3a16 <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30e7:	50                   	push   %eax
    30e8:	50                   	push   %eax
    30e9:	68 25 4d 00 00       	push   $0x4d25
    30ee:	ff 35 50 60 00 00    	push   0x6050
    30f4:	e8 87 0a 00 00       	call   3b80 <printf>
    exit();
    30f9:	e8 18 09 00 00       	call   3a16 <exit>
    printf(1, "pipe() failed\n");
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    3100:	68 e1 41 00 00       	push   $0x41e1
    3105:	6a 01                	push   $0x1
    3107:	e8 74 0a 00 00       	call   3b80 <printf>
    exit();
    310c:	e8 05 09 00 00       	call   3a16 <exit>
    exit();
    3111:	e8 00 09 00 00       	call   3a16 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 d5 4c 00 00       	push   $0x4cd5
    311d:	ff 35 50 60 00 00    	push   0x6050
    3123:	e8 58 0a 00 00       	call   3b80 <printf>
    exit();
    3128:	e8 e9 08 00 00       	call   3a16 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 94 54 00 00       	push   $0x5494
    3134:	ff 35 50 60 00 00    	push   0x6050
    313a:	e8 41 0a 00 00       	call   3b80 <printf>
    exit();
    313f:	e8 d2 08 00 00       	call   3a16 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 5c 54 00 00       	push   $0x545c
    314b:	ff 35 50 60 00 00    	push   0x6050
    3151:	e8 2a 0a 00 00       	call   3b80 <printf>
    exit();
    3156:	e8 bb 08 00 00       	call   3a16 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 f1 4c 00 00       	push   $0x4cf1
    3162:	ff 35 50 60 00 00    	push   0x6050
    3168:	e8 13 0a 00 00       	call   3b80 <printf>
    exit();
    316d:	e8 a4 08 00 00       	call   3a16 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319a:	68 4e 4d 00 00       	push   $0x4d4e
    319f:	ff 35 50 60 00 00    	push   0x6050
    31a5:	e8 d6 09 00 00       	call   3b80 <printf>
    31aa:	83 c4 10             	add    $0x10,%esp
    31ad:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31b0:	e8 59 08 00 00       	call   3a0e <fork>
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 e1 08 00 00       	call   3aa6 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 d5 08 00 00       	call   3aa6 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 6d 08 00 00       	call   3a46 <kill>
    wait();
    31d9:	e8 40 08 00 00       	call   3a1e <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 5d 4d 00 00       	push   $0x4d5d
    31e6:	e8 8b 08 00 00       	call   3a76 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3204:	68 81 4d 00 00       	push   $0x4d81
    3209:	ff 35 50 60 00 00    	push   0x6050
    320f:	e8 6c 09 00 00       	call   3b80 <printf>
}
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 f3 07 00 00       	call   3a16 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 68 4d 00 00       	push   $0x4d68
    322b:	ff 35 50 60 00 00    	push   0x6050
    3231:	e8 4a 09 00 00       	call   3b80 <printf>
      exit();
    3236:	e8 db 07 00 00       	call   3a16 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3246:	68 8e 4d 00 00       	push   $0x4d8e
    324b:	ff 35 50 60 00 00    	push   0x6050
    3251:	e8 2a 09 00 00       	call   3b80 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    3281:	e8 fa 08 00 00       	call   3b80 <printf>
}
    ...
    3299:	e8 e2 08 00 00       	call   3b80 <printf>
      exit();
    329e:	e8 73 07 00 00       	call   3a16 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 a6 07 00 00       	call   3a66 <unlink>
  pid = fork();
    32c0:	e8 49 07 00 00       	call   3a0e <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 47 07 00 00       	call   3a1e <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 b6 4d 00 00       	push   $0x4db6
    32e1:	e8 70 07 00 00       	call   3a56 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 44 07 00 00       	call   3a3e <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 b6 4d 00 00 	movl   $0x4db6,(%esp)
    3301:	e8 60 07 00 00       	call   3a66 <unlink>
}
    ...
    3310:	c7 04 85 a0 a7 00 00 	movl   $0x5510,0xa7a0(,%eax,4)
    3317:	10 55 00 00 
    ...
    3323:	51                   	push   %ecx
    3324:	51                   	push   %ecx
    3325:	68 c0 4d 00 00       	push   $0x4dc0
    332a:	ff 35 50 60 00 00    	push   0x6050
    args[MAXARG-1] = 0;
    3330:	c7 05 1c a8 00 00 00 	movl   $0x0,0xa81c
    3337:	00 00 00 
    printf(stdout, "bigarg test\n");
    333a:	e8 41 08 00 00       	call   3b80 <printf>
    exec("echo", args);
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    3341:	68 a0 a7 00 00       	push   $0xa7a0
    3346:	68 8d 3f 00 00       	push   $0x3f8d
    334b:	e8 fe 06 00 00       	call   3a4e <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 cd 4d 00 00       	push   $0x4dcd
    3357:	ff 35 50 60 00 00    	push   0x6050
    335d:	e8 1e 08 00 00       	call   3b80 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3362:	58                   	pop    %eax
    3363:	5a                   	pop    %edx
    3364:	68 00 02 00 00       	push   $0x200
    3369:	68 b6 4d 00 00       	push   $0x4db6
    336e:	e8 e3 06 00 00       	call   3a56 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 c3 06 00 00       	call   3a3e <close>
    exit();
    337b:	e8 96 06 00 00       	call   3a16 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 f6 4d 00 00       	push   $0x4df6
    3387:	ff 35 50 60 00 00    	push   0x6050
    338d:	e8 ee 07 00 00       	call   3b80 <printf>
    exit();
    3392:	e8 7f 06 00 00       	call   3a16 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 dd 4d 00 00       	push   $0x4ddd
    339e:	ff 35 50 60 00 00    	push   0x6050
    33a4:	e8 d7 07 00 00       	call   3b80 <printf>
    exit();
    33a9:	e8 68 06 00 00       	call   3a16 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    33bb:	68 0b 4e 00 00       	push   $0x4e0b
    33c0:	6a 01                	push   $0x1
    33c2:	e8 b9 07 00 00       	call   3b80 <printf>
    ...
    3441:	50                   	push   %eax
    3442:	68 18 4e 00 00       	push   $0x4e18
    3447:	6a 01                	push   $0x1
    3449:	e8 32 07 00 00       	call   3b80 <printf>
    ...
    3458:	50                   	push   %eax
    3459:	e8 f8 05 00 00       	call   3a56 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 b1 05 00 00       	call   3a36 <write>
      if(cc < 512)
    ...
    3492:	53                   	push   %ebx
    3493:	68 34 4e 00 00       	push   $0x4e34
    3498:	6a 01                	push   $0x1
    349a:	e8 e1 06 00 00       	call   3b80 <printf>
    close(fd);
    349f:	89 3c 24             	mov    %edi,(%esp)
    34a2:	e8 97 05 00 00       	call   3a3e <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34bc:	50                   	push   %eax
    34bd:	68 24 4e 00 00       	push   $0x4e24
    34c2:	6a 01                	push   $0x1
    34c4:	e8 b7 06 00 00       	call   3b80 <printf>
      break;
    ...
    354b:	50                   	push   %eax
    354c:	e8 15 05 00 00       	call   3a66 <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    355c:	68 44 4e 00 00       	push   $0x4e44
    3561:	6a 01                	push   $0x1
    3563:	e8 18 06 00 00       	call   3b80 <printf>
}
...
00003580 <uio>:
{
  ...
  printf(1, "uio test\n");
    ...
    358b:	6a 01                	push   $0x1
    358d:	e8 ee 05 00 00       	call   3b80 <printf>
  pid = fork();
    3592:	e8 77 04 00 00       	call   3a0e <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 79 04 00 00       	call   3a1e <wait>
  printf(1, "uio test done\n");
    35a5:	83 ec 08             	sub    $0x8,%esp
    35a8:	68 64 4e 00 00       	push   $0x4e64
    35ad:	6a 01                	push   $0x1
    35af:	e8 cc 05 00 00       	call   3b80 <printf>
}
    ...
    35d1:	6a 01                	push   $0x1
    35d3:	e8 a8 05 00 00       	call   3b80 <printf>
    exit();
    35d8:	e8 39 04 00 00       	call   3a16 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    35df:	68 e9 4d 00 00       	push   $0x4de9
    35e4:	6a 01                	push   $0x1
    35e6:	e8 95 05 00 00       	call   3b80 <printf>
    exit();
    35eb:	e8 26 04 00 00       	call   3a16 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 53 04 00 00       	call   3a56 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 88 04 00 00       	call   3a9e <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 09 04 00 00       	call   3a2e <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 11 04 00 00       	call   3a3e <close>
  printf(1, "arg test passed\n");
    362d:	58                   	pop    %eax
    362e:	5a                   	pop    %edx
    362f:	68 85 4e 00 00       	push   $0x4e85
    3634:	6a 01                	push   $0x1
    3636:	e8 45 05 00 00       	call   3b80 <printf>
}
    ...
    364a:	6a 02                	push   $0x2
    364c:	e8 2f 05 00 00       	call   3b80 <printf>
    exit();
    3651:	e8 c0 03 00 00       	call   3a16 <exit>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 71 02 00 00       	call   3a2e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 34 02 00 00       	call   3a56 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 37 02 00 00       	call   3a6e <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 fd 01 00 00       	call   3a3e <close>
  return r;
...
xchg(volatile uint *addr, uint newval)
{
  ...
  asm volatile("lock; xchgl %0, %1" :
    38d1:	ba 01 00 00 00       	mov    $0x1,%edx
    38d6:	89 e5                	mov    %esp,%ebp
    38d8:	83 ec 08             	sub    $0x8,%esp
    38db:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    38df:	90                   	nop
    38e0:	89 d0                	mov    %edx,%eax
    38e2:	f0 87 05 24 a8 00 00 	lock xchg %eax,0xa824
  lock_init(&lk_join);
}
...
void lock_acquire(lock_t *lock){
  // The xchg is atomic.
    ...
    38eb:	75 f3                	jne    38e0 <thread_create+0x10>
    __sync_synchronize();
    38ed:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	void *stack= malloc(PGSIZE*2);
    38f2:	83 ec 0c             	sub    $0xc,%esp
    38f5:	68 00 20 00 00       	push   $0x2000
    38fa:	e8 b1 04 00 00       	call   3db0 <malloc>
}

void lock_release(lock_t *lock){
   __sync_synchronize();
    38ff:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
    3904:	c7 05 24 a8 00 00 00 	movl   $0x0,0xa824
    390b:	00 00 00 
	if((uint)stack % PGSIZE)
    390e:	89 c2                	mov    %eax,%edx
    3910:	83 c4 10             	add    $0x10,%esp
    3913:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    3919:	74 07                	je     3922 <thread_create+0x52>
		stack = stack + PGSIZE - (uint)stack % PGSIZE;
    391b:	29 d0                	sub    %edx,%eax
    391d:	05 00 10 00 00       	add    $0x1000,%eax
	int result = clone(start_routine,arg1, arg2 ,stack);
    3922:	50                   	push   %eax
    3923:	ff 75 10             	push   0x10(%ebp)
    3926:	ff 75 0c             	push   0xc(%ebp)
    3929:	ff 75 08             	push   0x8(%ebp)
    392c:	e8 85 01 00 00       	call   3ab6 <clone>
}
    3931:	c9                   	leave  
    3932:	c3                   	ret    
    3933:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
int thread_join(){
    ...
    3944:	8d 45 f4             	lea    -0xc(%ebp),%eax
int thread_join(){
    3947:	83 ec 20             	sub    $0x20,%esp
	void *stack = 0;
    394a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	int result= join(&stack);
    3951:	50                   	push   %eax
    3952:	e8 67 01 00 00       	call   3abe <join>
    while(xchg(&(lock->mutex), 1) != 0);
    3957:	83 c4 10             	add    $0x10,%esp
    395a:	ba 01 00 00 00       	mov    $0x1,%edx
	int result= join(&stack);
    395f:	89 c3                	mov    %eax,%ebx
    while(xchg(&(lock->mutex), 1) != 0);
    3961:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3968:	89 d0                	mov    %edx,%eax
    396a:	f0 87 05 20 a8 00 00 	lock xchg %eax,0xa820
    3971:	85 c0                	test   %eax,%eax
    3973:	75 f3                	jne    3968 <thread_join+0x28>
    __sync_synchronize();
    3975:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
	free(stack);
    397a:	83 ec 0c             	sub    $0xc,%esp
    397d:	ff 75 f4             	push   -0xc(%ebp)
    3980:	e8 9b 03 00 00       	call   3d20 <free>
   __sync_synchronize();
    3985:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
    398a:	c7 05 20 a8 00 00 00 	movl   $0x0,0xa820
    3991:	00 00 00 
}
    3994:	89 d8                	mov    %ebx,%eax
    3996:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3999:	c9                   	leave  
    399a:	c3                   	ret    
...
void lock_init(lock_t *lock) {
  lock->mutex = 0;
    39a0:	c7 05 24 a8 00 00 00 	movl   $0x0,0xa824
    39a7:	00 00 00 
    39aa:	c7 05 20 a8 00 00 00 	movl   $0x0,0xa820
    39b1:	00 00 00 
}
    39b4:	c3                   	ret    
    39b5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    39bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

000039c0 <lock_acquire>:
void lock_acquire(lock_t *lock){
    39c0:	55                   	push   %ebp
    39c1:	b9 01 00 00 00       	mov    $0x1,%ecx
    39c6:	89 e5                	mov    %esp,%ebp
    39c8:	8b 55 08             	mov    0x8(%ebp),%edx
    39cb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    39cf:	90                   	nop
    ...
    __sync_synchronize();
    39d9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
    39de:	5d                   	pop    %ebp
    39df:	c3                   	ret    
...
void lock_release(lock_t *lock){
   ...
   __sync_synchronize();
    39e6:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
    asm volatile("movl $0, %0" : "+m" (lock->mutex) : );
    39eb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    39f1:	5d                   	pop    %ebp
    39f2:	c3                   	ret    
    39f3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
void lock_init(lock_t *lock) {
  ...
  lock->mutex = 0;
    ...
    3a06:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    3a0c:	5d                   	pop    %ebp
    3a0d:	c3                   	ret    
...
SYSCALL(fork)
    3a0e:	b8 01 00 00 00       	mov    $0x1,%eax
    3a13:	cd 40                	int    $0x40
    3a15:	c3                   	ret    

00003a16 <exit>:
SYSCALL(exit)
    3a16:	b8 02 00 00 00       	mov    $0x2,%eax
    3a1b:	cd 40                	int    $0x40
    3a1d:	c3                   	ret    

00003a1e <wait>:
SYSCALL(wait)
    3a1e:	b8 03 00 00 00       	mov    $0x3,%eax
    3a23:	cd 40                	int    $0x40
    3a25:	c3                   	ret    

00003a26 <pipe>:
SYSCALL(pipe)
    3a26:	b8 04 00 00 00       	mov    $0x4,%eax
    3a2b:	cd 40                	int    $0x40
    3a2d:	c3                   	ret    

00003a2e <read>:
SYSCALL(read)
    3a2e:	b8 05 00 00 00       	mov    $0x5,%eax
    3a33:	cd 40                	int    $0x40
    3a35:	c3                   	ret    

00003a36 <write>:
SYSCALL(write)
    3a36:	b8 10 00 00 00       	mov    $0x10,%eax
    3a3b:	cd 40                	int    $0x40
    3a3d:	c3                   	ret    

00003a3e <close>:
SYSCALL(close)
    3a3e:	b8 15 00 00 00       	mov    $0x15,%eax
    3a43:	cd 40                	int    $0x40
    3a45:	c3                   	ret    

00003a46 <kill>:
SYSCALL(kill)
    3a46:	b8 06 00 00 00       	mov    $0x6,%eax
    3a4b:	cd 40                	int    $0x40
    3a4d:	c3                   	ret    

00003a4e <exec>:
SYSCALL(exec)
    3a4e:	b8 07 00 00 00       	mov    $0x7,%eax
    3a53:	cd 40                	int    $0x40
    3a55:	c3                   	ret    

00003a56 <open>:
SYSCALL(open)
    3a56:	b8 0f 00 00 00       	mov    $0xf,%eax
    3a5b:	cd 40                	int    $0x40
    3a5d:	c3                   	ret    

00003a5e <mknod>:
SYSCALL(mknod)
    3a5e:	b8 11 00 00 00       	mov    $0x11,%eax
    3a63:	cd 40                	int    $0x40
    3a65:	c3                   	ret    

00003a66 <unlink>:
SYSCALL(unlink)
    3a66:	b8 12 00 00 00       	mov    $0x12,%eax
    3a6b:	cd 40                	int    $0x40
    3a6d:	c3                   	ret    

00003a6e <fstat>:
SYSCALL(fstat)
    3a6e:	b8 08 00 00 00       	mov    $0x8,%eax
    3a73:	cd 40                	int    $0x40
    3a75:	c3                   	ret    

00003a76 <link>:
SYSCALL(link)
    3a76:	b8 13 00 00 00       	mov    $0x13,%eax
    3a7b:	cd 40                	int    $0x40
    3a7d:	c3                   	ret    

00003a7e <mkdir>:
SYSCALL(mkdir)
    3a7e:	b8 14 00 00 00       	mov    $0x14,%eax
    3a83:	cd 40                	int    $0x40
    3a85:	c3                   	ret    

00003a86 <chdir>:
SYSCALL(chdir)
    3a86:	b8 09 00 00 00       	mov    $0x9,%eax
    3a8b:	cd 40                	int    $0x40
    3a8d:	c3                   	ret    

00003a8e <dup>:
SYSCALL(dup)
    3a8e:	b8 0a 00 00 00       	mov    $0xa,%eax
    3a93:	cd 40                	int    $0x40
    3a95:	c3                   	ret    

00003a96 <getpid>:
SYSCALL(getpid)
    3a96:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a9b:	cd 40                	int    $0x40
    3a9d:	c3                   	ret    

00003a9e <sbrk>:
SYSCALL(sbrk)
    3a9e:	b8 0c 00 00 00       	mov    $0xc,%eax
    3aa3:	cd 40                	int    $0x40
    3aa5:	c3                   	ret    

00003aa6 <sleep>:
SYSCALL(sleep)
    3aa6:	b8 0d 00 00 00       	mov    $0xd,%eax
    3aab:	cd 40                	int    $0x40
    3aad:	c3                   	ret    

00003aae <uptime>:
SYSCALL(uptime)
    3aae:	b8 0e 00 00 00       	mov    $0xe,%eax
    3ab3:	cd 40                	int    $0x40
    3ab5:	c3                   	ret    

00003ab6 <clone>:
SYSCALL(clone)
    3ab6:	b8 16 00 00 00       	mov    $0x16,%eax
    3abb:	cd 40                	int    $0x40
    3abd:	c3                   	ret    

00003abe <join>:
SYSCALL(join)
    3abe:	b8 17 00 00 00       	mov    $0x17,%eax
    3ac3:	cd 40                	int    $0x40
    3ac5:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3ad4:	56                   	push   %esi
    3ad5:	53                   	push   %ebx
    3ad6:	83 ec 3c             	sub    $0x3c,%esp
    3ad9:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    3adc:	89 d1                	mov    %edx,%ecx
{
    3ade:	89 45 b8             	mov    %eax,-0x48(%ebp)
  if(sgn && xx < 0){
    3ae1:	85 d2                	test   %edx,%edx
    3ae3:	0f 89 7f 00 00 00    	jns    3b68 <printint+0x98>
    3ae9:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    3aed:	74 79                	je     3b68 <printint+0x98>
    neg = 1;
    3aef:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    x = -xx;
    3af6:	f7 d9                	neg    %ecx
  } else {
    x = xx;
  ...
  i = 0;
    3af8:	31 db                	xor    %ebx,%ebx
    3afa:	8d 75 d7             	lea    -0x29(%ebp),%esi
    3afd:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    3b00:	89 c8                	mov    %ecx,%eax
    3b02:	31 d2                	xor    %edx,%edx
    3b04:	89 cf                	mov    %ecx,%edi
    3b06:	f7 75 c4             	divl   -0x3c(%ebp)
    3b09:	0f b6 92 a0 56 00 00 	movzbl 0x56a0(%edx),%edx
    3b10:	89 45 c0             	mov    %eax,-0x40(%ebp)
    3b13:	89 d8                	mov    %ebx,%eax
    3b15:	8d 5b 01             	lea    0x1(%ebx),%ebx
  }while((x /= base) != 0);
    3b18:	8b 4d c0             	mov    -0x40(%ebp),%ecx
    buf[i++] = digits[x % base];
    3b1b:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
    3b1e:	39 7d c4             	cmp    %edi,-0x3c(%ebp)
    3b21:	76 dd                	jbe    3b00 <printint+0x30>
  if(neg)
    3b23:	8b 4d bc             	mov    -0x44(%ebp),%ecx
    3b26:	85 c9                	test   %ecx,%ecx
    3b28:	74 0c                	je     3b36 <printint+0x66>
    buf[i++] = '-';
    3b2a:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    buf[i++] = digits[x % base];
    3b2f:	89 d8                	mov    %ebx,%eax
    buf[i++] = '-';
    3b31:	ba 2d 00 00 00       	mov    $0x2d,%edx

  while(--i >= 0)
    3b36:	8b 7d b8             	mov    -0x48(%ebp),%edi
    3b39:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    3b3d:	eb 07                	jmp    3b46 <printint+0x76>
    3b3f:	90                   	nop
    putc(fd, buf[i]);
    3b40:	0f b6 13             	movzbl (%ebx),%edx
    3b43:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
    3b46:	83 ec 04             	sub    $0x4,%esp
    3b49:	88 55 d7             	mov    %dl,-0x29(%ebp)
    3b4c:	6a 01                	push   $0x1
    3b4e:	56                   	push   %esi
    3b4f:	57                   	push   %edi
    3b50:	e8 e1 fe ff ff       	call   3a36 <write>
  while(--i >= 0)
    3b55:	83 c4 10             	add    $0x10,%esp
    3b58:	39 de                	cmp    %ebx,%esi
    3b5a:	75 e4                	jne    3b40 <printint+0x70>
}
    3b5c:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3b5f:	5b                   	pop    %ebx
    3b60:	5e                   	pop    %esi
    3b61:	5f                   	pop    %edi
    3b62:	5d                   	pop    %ebp
  ...
  neg = 0;
    3b68:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
    3b6f:	eb 87                	jmp    3af8 <printint+0x28>
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3b89:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    3b8c:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    3b8f:	0f b6 13             	movzbl (%ebx),%edx
    3b92:	84 d2                	test   %dl,%dl
    3b94:	74 6a                	je     3c00 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    3b96:	8d 45 10             	lea    0x10(%ebp),%eax
    3b99:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    3b9c:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    3b9f:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    3ba1:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3ba4:	eb 36                	jmp    3bdc <printf+0x5c>
    3ba6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3bad:	8d 76 00             	lea    0x0(%esi),%esi
    3bb0:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    3bb3:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    3bb8:	83 f8 25             	cmp    $0x25,%eax
    3bbb:	74 15                	je     3bd2 <printf+0x52>
  write(fd, &c, 1);
    3bbd:	83 ec 04             	sub    $0x4,%esp
    3bc0:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3bc3:	6a 01                	push   $0x1
    3bc5:	57                   	push   %edi
    3bc6:	56                   	push   %esi
    3bc7:	e8 6a fe ff ff       	call   3a36 <write>
    3bcc:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    3bcf:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3bd2:	0f b6 13             	movzbl (%ebx),%edx
    3bd5:	83 c3 01             	add    $0x1,%ebx
    3bd8:	84 d2                	test   %dl,%dl
    3bda:	74 24                	je     3c00 <printf+0x80>
    c = fmt[i] & 0xff;
    3bdc:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    3bdf:	85 c9                	test   %ecx,%ecx
    3be1:	74 cd                	je     3bb0 <printf+0x30>
      }
    } else if(state == '%'){
    3be3:	83 f9 25             	cmp    $0x25,%ecx
    3be6:	75 ea                	jne    3bd2 <printf+0x52>
      if(c == 'd'){
    3be8:	83 f8 25             	cmp    $0x25,%eax
    3beb:	0f 84 07 01 00 00    	je     3cf8 <printf+0x178>
    3bf1:	83 e8 63             	sub    $0x63,%eax
    3bf4:	83 f8 15             	cmp    $0x15,%eax
    3bf7:	77 17                	ja     3c10 <printf+0x90>
    3bf9:	ff 24 85 48 56 00 00 	jmp    *0x5648(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3c13:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    3c16:	6a 01                	push   $0x1
    3c18:	57                   	push   %edi
    3c19:	56                   	push   %esi
    3c1a:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3c1e:	e8 13 fe ff ff       	call   3a36 <write>
        putc(fd, c);
    3c23:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    3c27:	83 c4 0c             	add    $0xc,%esp
    3c2a:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3c2d:	6a 01                	push   $0x1
    3c2f:	57                   	push   %edi
    3c30:	56                   	push   %esi
    3c31:	e8 00 fe ff ff       	call   3a36 <write>
        putc(fd, c);
    3c36:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3c39:	31 c9                	xor    %ecx,%ecx
    3c3b:	eb 95                	jmp    3bd2 <printf+0x52>
    3c3d:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    3c40:	83 ec 0c             	sub    $0xc,%esp
    3c43:	b9 10 00 00 00       	mov    $0x10,%ecx
    3c48:	6a 00                	push   $0x0
    3c4a:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3c4d:	8b 10                	mov    (%eax),%edx
    3c4f:	89 f0                	mov    %esi,%eax
    3c51:	e8 7a fe ff ff       	call   3ad0 <printint>
        ap++;
    3c56:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    3c5a:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3c5d:	31 c9                	xor    %ecx,%ecx
    3c5f:	e9 6e ff ff ff       	jmp    3bd2 <printf+0x52>
    3c64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    3c68:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3c6b:	8b 10                	mov    (%eax),%edx
        ap++;
    3c6d:	83 c0 04             	add    $0x4,%eax
    3c70:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    3c73:	85 d2                	test   %edx,%edx
    3c75:	0f 84 8d 00 00 00    	je     3d08 <printf+0x188>
        while(*s != 0){
    3c7b:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    3c7e:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    3c80:	84 c0                	test   %al,%al
    3c82:	0f 84 4a ff ff ff    	je     3bd2 <printf+0x52>
    3c88:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    3c8b:	89 d3                	mov    %edx,%ebx
    3c8d:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    3c90:	83 ec 04             	sub    $0x4,%esp
          s++;
    3c93:	83 c3 01             	add    $0x1,%ebx
    3c96:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3c99:	6a 01                	push   $0x1
    3c9b:	57                   	push   %edi
    3c9c:	56                   	push   %esi
    3c9d:	e8 94 fd ff ff       	call   3a36 <write>
        while(*s != 0){
    3ca2:	0f b6 03             	movzbl (%ebx),%eax
    3ca5:	83 c4 10             	add    $0x10,%esp
    3ca8:	84 c0                	test   %al,%al
    3caa:	75 e4                	jne    3c90 <printf+0x110>
      state = 0;
    3cac:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    3caf:	31 c9                	xor    %ecx,%ecx
    3cb1:	e9 1c ff ff ff       	jmp    3bd2 <printf+0x52>
    3cb6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3cbd:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    3cc0:	83 ec 0c             	sub    $0xc,%esp
    3cc3:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3cc8:	6a 01                	push   $0x1
    3cca:	e9 7b ff ff ff       	jmp    3c4a <printf+0xca>
    3ccf:	90                   	nop
        putc(fd, *ap);
    3cd0:	8b 45 d0             	mov    -0x30(%ebp),%eax
  write(fd, &c, 1);
    3cd3:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    3cd6:	8b 00                	mov    (%eax),%eax
  write(fd, &c, 1);
    3cd8:	6a 01                	push   $0x1
    3cda:	57                   	push   %edi
    3cdb:	56                   	push   %esi
        putc(fd, *ap);
    3cdc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3cdf:	e8 52 fd ff ff       	call   3a36 <write>
        ap++;
    3ce4:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    3ce8:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3ceb:	31 c9                	xor    %ecx,%ecx
    3ced:	e9 e0 fe ff ff       	jmp    3bd2 <printf+0x52>
    3cf2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    3cf8:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    3cfb:	83 ec 04             	sub    $0x4,%esp
    3cfe:	e9 2a ff ff ff       	jmp    3c2d <printf+0xad>
    3d03:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3d07:	90                   	nop
          s = "(null)";
    3d08:	ba 3e 56 00 00       	mov    $0x563e,%edx
        while(*s != 0){
    3d0d:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    3d10:	b8 28 00 00 00       	mov    $0x28,%eax
    3d15:	89 d3                	mov    %edx,%ebx
    3d17:	e9 74 ff ff ff       	jmp    3c90 <printf+0x110>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d21:	a1 28 a8 00 00       	mov    0xa828,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3d38:	89 c2                	mov    %eax,%edx
    3d3a:	8b 00                	mov    (%eax),%eax
    3d3c:	39 ca                	cmp    %ecx,%edx
    3d3e:	73 30                	jae    3d70 <free+0x50>
    3d40:	39 c1                	cmp    %eax,%ecx
    3d42:	72 04                	jb     3d48 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3d44:	39 c2                	cmp    %eax,%edx
    3d46:	72 f0                	jb     3d38 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3d48:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3d4b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3d4e:	39 f8                	cmp    %edi,%eax
    3d50:	74 30                	je     3d82 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    3d52:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3d55:	8b 42 04             	mov    0x4(%edx),%eax
    3d58:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3d5b:	39 f1                	cmp    %esi,%ecx
    3d5d:	74 3a                	je     3d99 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    3d5f:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    3d61:	5b                   	pop    %ebx
  freep = p;
    3d62:	89 15 28 a8 00 00    	mov    %edx,0xa828
}
    3d68:	5e                   	pop    %esi
    3d69:	5f                   	pop    %edi
    3d6a:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3d70:	39 c2                	cmp    %eax,%edx
    3d72:	72 c4                	jb     3d38 <free+0x18>
    3d74:	39 c1                	cmp    %eax,%ecx
    3d76:	73 c0                	jae    3d38 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    3d78:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3d7b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3d7e:	39 f8                	cmp    %edi,%eax
    3d80:	75 d0                	jne    3d52 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    3d82:	03 70 04             	add    0x4(%eax),%esi
    3d85:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3d88:	8b 02                	mov    (%edx),%eax
    3d8a:	8b 00                	mov    (%eax),%eax
    3d8c:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    3d8f:	8b 42 04             	mov    0x4(%edx),%eax
    3d92:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3d95:	39 f1                	cmp    %esi,%ecx
    3d97:	75 c6                	jne    3d5f <free+0x3f>
    p->s.size += bp->s.size;
    3d99:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    3d9c:	89 15 28 a8 00 00    	mov    %edx,0xa828
    p->s.size += bp->s.size;
    3da2:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3da5:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3da8:	89 0a                	mov    %ecx,(%edx)
}
    3daa:	5b                   	pop    %ebx
    3dab:	5e                   	pop    %esi
    3dac:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3dbc:	8b 3d 28 a8 00 00    	mov    0xa828,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3dc2:	8d 70 07             	lea    0x7(%eax),%esi
    3dc5:	c1 ee 03             	shr    $0x3,%esi
    3dc8:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    3dcb:	85 ff                	test   %edi,%edi
    3dcd:	0f 84 9d 00 00 00    	je     3e70 <malloc+0xc0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3dd3:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    3dd5:	8b 4a 04             	mov    0x4(%edx),%ecx
    3dd8:	39 f1                	cmp    %esi,%ecx
    3dda:	73 6a                	jae    3e46 <malloc+0x96>
    3ddc:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3de1:	39 de                	cmp    %ebx,%esi
    3de3:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    3de6:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3ded:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3df0:	eb 17                	jmp    3e09 <malloc+0x59>
    3df2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3df8:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3dfa:	8b 48 04             	mov    0x4(%eax),%ecx
    3dfd:	39 f1                	cmp    %esi,%ecx
    3dff:	73 4f                	jae    3e50 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3e01:	8b 3d 28 a8 00 00    	mov    0xa828,%edi
    3e07:	89 c2                	mov    %eax,%edx
    3e09:	39 d7                	cmp    %edx,%edi
    3e0b:	75 eb                	jne    3df8 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    3e0d:	83 ec 0c             	sub    $0xc,%esp
    3e10:	ff 75 e4             	push   -0x1c(%ebp)
    3e13:	e8 86 fc ff ff       	call   3a9e <sbrk>
  if(p == (char*)-1)
    3e18:	83 c4 10             	add    $0x10,%esp
    3e1b:	83 f8 ff             	cmp    $0xffffffff,%eax
    3e1e:	74 1c                	je     3e3c <malloc+0x8c>
  hp->s.size = nu;
    3e20:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3e23:	83 ec 0c             	sub    $0xc,%esp
    3e26:	83 c0 08             	add    $0x8,%eax
    3e29:	50                   	push   %eax
    3e2a:	e8 f1 fe ff ff       	call   3d20 <free>
  return freep;
    3e2f:	8b 15 28 a8 00 00    	mov    0xa828,%edx
      if((p = morecore(nunits)) == 0)
    3e35:	83 c4 10             	add    $0x10,%esp
    3e38:	85 d2                	test   %edx,%edx
    3e3a:	75 bc                	jne    3df8 <malloc+0x48>
        return 0;
  }
}
    ...
    3e45:	c3                   	ret    
    if(p->s.size >= nunits){
    3e46:	89 d0                	mov    %edx,%eax
    3e48:	89 fa                	mov    %edi,%edx
    3e4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3e50:	39 ce                	cmp    %ecx,%esi
    3e52:	74 4c                	je     3ea0 <malloc+0xf0>
        p->s.size -= nunits;
    3e54:	29 f1                	sub    %esi,%ecx
    3e56:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3e59:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3e5c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3e5f:	89 15 28 a8 00 00    	mov    %edx,0xa828
}
    ...
    3e6f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3e70:	c7 05 28 a8 00 00 2c 	movl   $0xa82c,0xa828
    3e77:	a8 00 00 
    base.s.size = 0;
    3e7a:	bf 2c a8 00 00       	mov    $0xa82c,%edi
    base.s.ptr = freep = prevp = &base;
    3e7f:	c7 05 2c a8 00 00 2c 	movl   $0xa82c,0xa82c
    3e86:	a8 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e89:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3e8b:	c7 05 30 a8 00 00 00 	movl   $0x0,0xa830
    3e92:	00 00 00 
    if(p->s.size >= nunits){
    3e95:	e9 42 ff ff ff       	jmp    3ddc <malloc+0x2c>
    3e9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    3ea0:	8b 08                	mov    (%eax),%ecx
    3ea2:	89 0a                	mov    %ecx,(%edx)
    3ea4:	eb b9                	jmp    3e5f <malloc+0xaf>
