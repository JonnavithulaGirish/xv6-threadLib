...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 18 04 00 00       	call   454 <open>
  ...
  57:	e8 e0 03 00 00       	call   43c <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 ab 03 00 00       	call   414 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 88 03 00 00       	call   414 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 84 03 00 00       	call   434 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 62 03 00 00       	call   42c <read>
  ...
  e6:	e8 95 04 00 00       	call   580 <printf>
      exit();
  eb:	e8 24 03 00 00       	call   414 <exit>
  ...
  f9:	e8 82 04 00 00       	call   580 <printf>
    exit();
  fe:	e8 11 03 00 00       	call   414 <exit>
 ...
 239:	31 db                	xor    %ebx,%ebx
{
 ...
 245:	57                   	push   %edi
 246:	6a 00                	push   $0x0
 248:	e8 df 01 00 00       	call   42c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 a2 01 00 00       	call   454 <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 a5 01 00 00       	call   46c <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 6b 01 00 00       	call   43c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 37a:	e8 35 01 00 00       	call   4b4 <clone>
}
 37f:	c9                   	leave  
 380:	c3                   	ret    
...
int thread_join(){
 397:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 39a:	50                   	push   %eax
 39b:	e8 1c 01 00 00       	call   4bc <join>
  if(pid >0 ){
 ...
 3a7:	7e 0d                	jle    3b6 <thread_join+0x26>
 3a9:	8b 7d f4             	mov    -0xc(%ebp),%edi
 3ac:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
void lock_acquire(lock_t *lock){
 ...
 3eb:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 3ef:	8b 52 04             	mov    0x4(%edx),%edx
 3f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 3f8:	39 c2                	cmp    %eax,%edx
 3fa:	75 fc                	jne    3f8 <lock_acquire+0x18>
}
 3fc:	5d                   	pop    %ebp
 3fd:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 406:	83 40 04 01          	addl   $0x1,0x4(%eax)
 40a:	5d                   	pop    %ebp
 40b:	c3                   	ret    
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 54e:	56                   	push   %esi
 54f:	57                   	push   %edi
 550:	e8 df fe ff ff       	call   434 <write>
  while(--i >= 0)
 ...
 589:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c5:	57                   	push   %edi
 5c6:	56                   	push   %esi
 5c7:	e8 68 fe ff ff       	call   434 <write>
 ...
 61e:	e8 11 fe ff ff       	call   434 <write>
        putc(fd, c);
 ...
 62f:	57                   	push   %edi
 630:	56                   	push   %esi
 631:	e8 fe fd ff ff       	call   434 <write>
        putc(fd, c);
 ...
 69b:	57                   	push   %edi
 69c:	56                   	push   %esi
 69d:	e8 92 fd ff ff       	call   434 <write>
        while(*s != 0){
 ...
 6dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6df:	e8 50 fd ff ff       	call   434 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 813:	e8 84 fc ff ff       	call   49c <sbrk>
  if(p == (char*)-1)
