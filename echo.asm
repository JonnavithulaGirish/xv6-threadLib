...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 0a 03 00 00       	call   374 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 df 01 00 00       	call   38c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 a2 01 00 00       	call   3b4 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 a5 01 00 00       	call   3cc <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 6b 01 00 00       	call   39c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2da:	e8 35 01 00 00       	call   414 <clone>
}
 2df:	c9                   	leave  
 2e0:	c3                   	ret    
...
int thread_join(){
 2f7:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 2fa:	50                   	push   %eax
 2fb:	e8 1c 01 00 00       	call   41c <join>
  if(pid >0 ){
 ...
 307:	7e 0d                	jle    316 <thread_join+0x26>
 309:	8b 7d f4             	mov    -0xc(%ebp),%edi
 30c:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
void lock_init(lock_t *lock) {
 ...
 326:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
 32c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
 333:	5d                   	pop    %ebp
 334:	c3                   	ret    
...
void lock_acquire(lock_t *lock){
 ...
 34b:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 34f:	8b 52 04             	mov    0x4(%edx),%edx
...
void lock_release(lock_t *lock){
 ...
 366:	83 40 04 01          	addl   $0x1,0x4(%eax)
 36a:	5d                   	pop    %ebp
 36b:	c3                   	ret    
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 4ae:	56                   	push   %esi
 4af:	57                   	push   %edi
 4b0:	e8 df fe ff ff       	call   394 <write>
  while(--i >= 0)
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 525:	57                   	push   %edi
 526:	56                   	push   %esi
 527:	e8 68 fe ff ff       	call   394 <write>
 ...
 57e:	e8 11 fe ff ff       	call   394 <write>
        putc(fd, c);
 ...
 58f:	57                   	push   %edi
 590:	56                   	push   %esi
 591:	e8 fe fd ff ff       	call   394 <write>
        putc(fd, c);
 ...
 5fb:	57                   	push   %edi
 5fc:	56                   	push   %esi
 5fd:	e8 92 fd ff ff       	call   394 <write>
        while(*s != 0){
 ...
 63c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 63f:	e8 50 fd ff ff       	call   394 <write>
        ap++;
...
free(void *ap)
{
 ...
 681:	a1 c8 0b 00 00       	mov    0xbc8,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 c8 0b 00 00    	mov    %edx,0xbc8
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 c8 0b 00 00    	mov    %edx,0xbc8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d c8 0b 00 00    	mov    0xbc8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d c8 0b 00 00    	mov    0xbc8,%edi
 ...
 773:	e8 84 fc ff ff       	call   3fc <sbrk>
  if(p == (char*)-1)
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 c8 0b 00 00    	mov    0xbc8,%edx
 ...
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf cc 0b 00 00       	mov    $0xbcc,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 d0 0b 00 00 00 	movl   $0x0,0xbd0
 7f2:	00 00 00 
    if(p->s.size >= nunits){
