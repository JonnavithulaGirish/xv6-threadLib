...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 02 06 00 00       	call   644 <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 20 0b 00 00       	push   $0xb20
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 f0 05 00 00       	call   644 <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 6d 05 00 00       	call   684 <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 68 05 00 00       	call   69c <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 11 05 00 00       	call   66c <close>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 4a 04 00 00       	call   65c <read>
 ...
 313:	e8 54 03 00 00       	call   66c <close>
    return;
 ...
 469:	31 db                	xor    %ebx,%ebx
{
 ...
 475:	57                   	push   %edi
 476:	6a 00                	push   $0x0
 478:	e8 df 01 00 00       	call   65c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4dd:	e8 a2 01 00 00       	call   684 <open>
  if(fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 a5 01 00 00       	call   69c <fstat>
  close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
  close(fd);
 4fc:	e8 6b 01 00 00       	call   66c <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 5aa:	e8 35 01 00 00       	call   6e4 <clone>
}
 5af:	c9                   	leave  
 5b0:	c3                   	ret    
...
int thread_join(){
 5c7:	83 ec 20             	sub    $0x20,%esp
  int pid= join(&stack);
 5ca:	50                   	push   %eax
 5cb:	e8 1c 01 00 00       	call   6ec <join>
  if(pid >0 ){
 5d0:	83 c4 10             	add    $0x10,%esp
  int pid= join(&stack);
 5d3:	89 c2                	mov    %eax,%edx
  if(pid >0 ){
 5d5:	85 c0                	test   %eax,%eax
 5d7:	7e 0d                	jle    5e6 <thread_join+0x26>
 5d9:	8b 7d f4             	mov    -0xc(%ebp),%edi
 5dc:	b9 00 10 00 00       	mov    $0x1000,%ecx
...
void lock_acquire(lock_t *lock){
 ...
 61b:	f0 0f c1 02          	lock xadd %eax,(%edx)
  int myturn = FetchAndAdd(&lock->ticket,1);
  while(lock->turn != myturn);
 61f:	8b 52 04             	mov    0x4(%edx),%edx
 622:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 628:	39 c2                	cmp    %eax,%edx
 62a:	75 fc                	jne    628 <lock_acquire+0x18>
}
 62c:	5d                   	pop    %ebp
 62d:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 636:	83 40 04 01          	addl   $0x1,0x4(%eax)
 63a:	5d                   	pop    %ebp
 63b:	c3                   	ret    
...
00000644 <exit>:
SYSCALL(exit)
 644:	b8 02 00 00 00       	mov    $0x2,%eax
 649:	cd 40                	int    $0x40
 64b:	c3                   	ret    

0000064c <wait>:
SYSCALL(wait)
 64c:	b8 03 00 00 00       	mov    $0x3,%eax
 651:	cd 40                	int    $0x40
 653:	c3                   	ret    
...
000006e4 <clone>:
SYSCALL(clone)
 6e4:	b8 16 00 00 00       	mov    $0x16,%eax
 6e9:	cd 40                	int    $0x40
 6eb:	c3                   	ret    

000006ec <join>:
SYSCALL(join)
 6ec:	b8 17 00 00 00       	mov    $0x17,%eax
 6f1:	cd 40                	int    $0x40
 6f3:	c3                   	ret    
 ...
 70c:	89 d1                	mov    %edx,%ecx
{
 ...
 77e:	56                   	push   %esi
 77f:	57                   	push   %edi
 780:	e8 df fe ff ff       	call   664 <write>
  while(--i >= 0)
 ...
 7b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7f5:	57                   	push   %edi
 7f6:	56                   	push   %esi
 7f7:	e8 68 fe ff ff       	call   664 <write>
 ...
 84e:	e8 11 fe ff ff       	call   664 <write>
        putc(fd, c);
 ...
 85f:	57                   	push   %edi
 860:	56                   	push   %esi
 861:	e8 fe fd ff ff       	call   664 <write>
        putc(fd, c);
 ...
 8cb:	57                   	push   %edi
 8cc:	56                   	push   %esi
 8cd:	e8 92 fd ff ff       	call   664 <write>
        while(*s != 0){
 ...
 90c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 90f:	e8 50 fd ff ff       	call   664 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 a43:	e8 84 fc ff ff       	call   6cc <sbrk>
  if(p == (char*)-1)
